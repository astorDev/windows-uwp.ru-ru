---
layout: LandingPage
description: Эта страница содержит сведения о для приступим к разработке приложений UWP и ARM64 win32.
...
ms.locfileid: "8879446"
---
# <a name="windows-10-on-arm"></a>Windows10 на архитектуре ARM
Windows 10 работает на ПК с процессорами ARM. Эта страница содержит сведения о Дополнительные сведения о платформе и приступим к разработке приложений. Мы также рекомендуем предоставить отзыв с помощью ссылок в нижней части страницы.
...
<ul class="cols cols3">
    ...
    <li>
        ...
        <h3>Build 2018 г. Windows 10 в ARM для разработчиков</h3><p>Сведения о Windows 10 на устройствах ARM, как возможностей x86 эмуляции работает и, наконец, как отправлять и создавать приложения для Windows 10 в ARM. Мы будет отображаться как создавать приложения ARM64 для рабочего стола и UWP.</p>
    </li>
    <li>
        ...
        <h3>Рабочие сообщества Windows с помощью Кевин Gallo</h3><p>Получить глубокое понимание того, как работает Windows 10 в ARM64 и получить представление об приложения и возможности на этой платформе.</p>
    </li>
</ul>
...
Запустите адаптации приложения для Windows 10 в ARM и воспользоваться преимуществами возможностей, доступных существует.  
        ...
        <div class="cardSize">
            <div class="cardPadding">
                ...
                <div class="cardText">
                    ...
                    <p class="x-hidden-focus">Разработка вашей x86 приложения для выполнения своих лучшие в Windows 10 в ARM.</p>
                </div>
            </div>
        </div>
    </li>
...
Мы постоянно расширяют наших продуктов путем использования обратной связи от вас и существующих клиентов. Есть идеи, проблемами на проблемы или просто хотите поделиться как отлично работать работы при, эти ссылки помогут вам.
    ...
    <li>
        <a class="card" href="https://github.com/MicrosoftDocs/windows-uwp/tree/docs/landing/arm-docs" data-linktype="absolute-path">
            ...
            <div class="cardText">
                ...
                <p>У вы столкнулись с проблемой с нашей документации? Вы хотите нам сделать что-то более четкими? Оповестить о проблеме в репозитории GitHub нашей документации.</p>
            </div>
        </a>
    </li>
</ul>