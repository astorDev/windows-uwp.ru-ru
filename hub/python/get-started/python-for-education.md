...
Для начинающих, которые не знакомы с Python, рекомендуется [установить Python из Microsoft Store](https://www.microsoft.com/en-us/p/python-37/9nj46sx7x90p?activetab=pivot:overviewtab). Это особенно важно, если вы используете образовательную среду или часть Организации, которая позволяет ограничивать разрешения или административный доступ на компьютере. Использование Microsoft Store для установки Python помещает его в путь к операционной системе для текущего пользователя (что позволяет избежать необходимости административного доступа).
