...
2. Установите один из этих пакетов NuGet в проекте. Убедитесь, что установлена версия 6.0.0-preview7 или более поздняя версия пакета.
...
* Если вы хотите ознакомиться с последним предварительным просмотром выпусков этих элементов управления версии 1,0 для .NET Framework и .NET Core 3, см. раздел пакеты NuGet **6.0.0-preview7** в коллекции [набора средств сообщества UWP](https://dotnet.myget.org/gallery/uwpcommunitytoolkit) .
