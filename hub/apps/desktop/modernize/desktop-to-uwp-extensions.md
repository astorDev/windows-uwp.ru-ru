...
|ActionDisplayName |Строка, представляющая действие, которое пользователи могут выполнять с устройством, которое они подключаются к компьютеру (например: "Импорт файлов" или "воспроизведение видео"). |
|ProviderDisplayName | Строка, представляющая ваше приложение или службу (например: "Проигрыватель Contoso Video"). |
