...
* [Часть 1. Перенос приложения Contoso "расходы" на .NET Core 3](modernize-wpf-tutorial-1.md)
* [Часть 2. Добавление элемента управления UWP, используя острова XAML](modernize-wpf-tutorial-2.md)
...
.NET Core 3 — это последний выпуск .NET Core. Выделение этого выпуска — поддержка классических приложений Windows, включая приложения Windows Forms и WPF. Вы можете запускать новые и существующие классические приложения Windows в .NET Core 3, а также использовать все преимущества, предоставляемые .NET Core. В приложениях для Windows Forms и WPF, предназначенных для .NET Core 3, вы сможете использовать элементы управления UWP, доступные в [XAML Islands](xaml-islands.md).
