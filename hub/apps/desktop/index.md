...
<td><a href="/dotnet/framework/winforms/getting-started-with-windows-forms">Начало работы</a><br/><a href="https://docs.microsoft.com/dotnet/api/index">Справочные материалы по API (.NET)</a></td>
</tr>
</tbody>
</table>

> [!NOTE]
> Все эти платформы приложений предоставляют полнофункциональную инфраструктуру и набор элементов управления пользовательского интерфейса. Они позволяют создавать такие приложения, как Word, Excel и Photoshop, которые работают в классической ОС Windows и используют все преимущества конкретных функций среды. В Windows 10 каждая из этих платформ позволяет использовать библиотеку пользовательского интерфейса Windows (WinUI) для создания пользовательских интерфейсов. Дополнительные сведения о WinUI для классических приложений см. в [этом разделе](choose-your-platform.md#windows-ui-library).
