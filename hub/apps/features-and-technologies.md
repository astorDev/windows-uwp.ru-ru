...
Дополнительные сведения о различных способах применения взаимодействия с помощью речи в приложениях для Windows см. в статье [Взаимодействие с помощью голосовых функций](/windows/uwp/design/input/speech-interactions).
