...
Контракт между неопубликованным приложением и классическим компонентом описывается в понятиях системы типов UWP. Это включает в себя один или несколько C объявления\# классы, которые могут представлять UWP. См. в разделе MSDN [создание компонентов среды выполнения Windows на языке C\# и Visual Basic](https://docs.microsoft.com/previous-versions/windows/apps/br230301(v=vs.140)) определенные требования для создания класса среды выполнения Windows, с помощью c#\#.
...
Процесс создания и регистрации, прокси и заглушки для использования внутри обычный пакет приложения универсальной платформы Windows описаны в разделе [создание событий в компонентах среды выполнения Windows](https://docs.microsoft.com/previous-versions/windows/apps/dn169426(v=vs.140)).
...
Затем возврат * PersonStruct\[\]* вместо *списка&lt;PersonObject&gt;* .
...
-   [Контракты и расширения (приложения для Windows Store) приложений](https://docs.microsoft.com/previous-versions/windows/apps/hh464906(v=win.10))

-   [Как для загрузки неопубликованных приложений в Windows 10](https://docs.microsoft.com/windows/uwp/get-started/enable-your-device-for-development)
