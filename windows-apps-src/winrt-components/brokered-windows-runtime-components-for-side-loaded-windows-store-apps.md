...
После того как ссылки настроены надлежащим образом, следующая задача— реализовать функциональность сервера. См. раздел MSDN [Рекомендации по взаимодействию с компонентами среды выполнения Windows (приложения UWP на C\#/VB/C++ и XAML)](https://msdn.microsoft.com/library/windows/apps/hh750311.aspx).
...
После этого можно вернуть* PersonStruct\[\]* вместо *List&lt;PersonObject&gt;*.
