...
>**Примечание**эта функция предназначено исключительно для использования с .NET. И клиентское приложение, и классический компонент должны быть созданы с использованием .NET.
...
Для описанных ниже шагах предполагается, что серверного компонента вызывается**MyWinRTComponent**.
...
Сервера брокера должен списке*clrhost.dll*в списке загруженных модулей.
