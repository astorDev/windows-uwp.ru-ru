...
<h1>Пошаговое руководство: создание компонента среды выполнения Windows на C++ и его вызов из JavaScript или C#</h1>
...
## Добавление делегата в область пространства имен
...
## Добавление директив заголовков и пространств имен
...
## Добавление реализации ComputeResult
...
```
## Добавление реализации GetPrimesOrdered и ее вспомогательного метода
...
## Добавление реализации GetPrimesUnordered
...
## Добавление кода HTML, вызывающего обработчики событий JavaScript
...
## Добавление обработчиков событий JavaScript, вызывающих библиотеку DLL компонента
...
## Добавление кода XAML, определяющего пользовательский интерфейс
