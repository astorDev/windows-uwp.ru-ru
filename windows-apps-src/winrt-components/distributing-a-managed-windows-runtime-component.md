...
3.  Определите структуру папок для пакета SDK. Структура папок начинается на корневом уровне проекта VSIX, содержащем папки **References**, **Redist** и **DesignTime**.
    ...
    -   В папке **Redist** расположены другие файлы, которые должны распространяться вместе с двоичными файлами в приложениях, создаваемых с помощью данного компонента.
    -   В папке **DesignTime** расположены файлы, которые используются, только если разработчики создают приложения, использующие данный компонент.
