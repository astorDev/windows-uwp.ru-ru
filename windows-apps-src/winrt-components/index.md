...
| Topic | Description |
|-------|-------------|
| [Создание компонентов среды выполнения Windows на C++](creating-windows-runtime-components-in-cpp.md) | В этой статье описывается использование C++ для создания компонента среды выполнения Windows, представляющего собой библиотеку DLL, которую можно вызывать из универсального приложения для Windows, созданного с помощью JavaScript, C#, Visual Basic или C++. |
