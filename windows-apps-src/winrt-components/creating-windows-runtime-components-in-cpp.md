...
description: В статье показано, как на C++ создать DLL, которую можно вызывать из универсального приложения для Windows, написанного на JavaScript, C#, Visual Basic или C++.
