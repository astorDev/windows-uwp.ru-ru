...
description: В этом разделе показано, как использовать C + +/ CX для создания компонента среды выполнения Windows, который является компонентом, который может быть вызван из приложения универсальной Windows, созданного с помощью C#, Visual Basic, C++ или Javascript.
...
В этом разделе показано, как использовать C + +/ CX для создания компонента среды выполнения Windows, который является компонентом, который может быть вызван из приложения универсальной Windows, созданного с помощью C#, Visual Basic, C++ или Javascript.
