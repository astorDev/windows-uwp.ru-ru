...
Функции makeToast необходимо подключить к кнопке. Обновление default.html кнопки и место на диске для вывода результатов, что всплывающее уведомление:
