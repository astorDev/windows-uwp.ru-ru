...
| WME1085      | {0}-Перегрузок {1}. {2} должны иметь ровно один метод как перегрузка по умолчанию с параметрами атрибутом Windows.Foundation.Metadata.DefaultOverloadAttribute. |
...
| WME1044      | Открытый тип имеет пространство имен ("{1}"), общие папки нет общего префикса с другими пространствами имен ("{0}"). Все типы в файле метаданных Windows должны находиться во вложенном пространстве имен пространства имен, заданного именем файла.                                                                                                                              |
...
| WME1103      | Метод "{0}«есть параметр»{1}", являющийся массивом и содержит с атрибутом System.Runtime.InteropServices.InAttribute или System.Runtime.InteropServices.OutAttribute. В среде выполнения Windows, у параметров массива должен быть либо {2} или {3}. Удалите эти атрибуты или при необходимости замените их соответствующими атрибутами среды выполнения Windows.                                                                                                                                                                                                                                                                                                                                                                                          |
| WME1104      | Метод "{0}«есть параметр»{1}" которого не является массивом и содержит {2} или {3}. Среда выполнения Windows не поддерживает отметка параметры являющихся {2} или {3}.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
> **Примечание**Если изменить имя возвращаемого значения, а новое имя конфликтует с именем другого параметра, возникнет ошибка WME1091.
