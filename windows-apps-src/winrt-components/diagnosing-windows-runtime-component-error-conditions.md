...
<td align="left"><p>В сигнатуре метода "{0}" имеется параметр типа "{1}". Хотя этот универсальный тип не является допустимым типом среды выполнения Windows, сам тип или его универсальные параметры реализуют интерфейсы, являющиеся допустимыми типами среды выполнения Windows. [https://blogs.technet.microsoft.com/askperf/2008/11/18/disabling-unnecessary-services-a-word-to-the-wise/]({2})</p>
...
| WME1104      | Метод "{0}" имеет параметр "{1}", который не является массивом и содержит либо {2}, либо {3}. Среда выполнения Windows не поддерживает использование {2} и {3} для пометки параметров, не являющихся массивами.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
