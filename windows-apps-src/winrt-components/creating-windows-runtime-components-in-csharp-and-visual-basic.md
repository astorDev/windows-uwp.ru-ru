...
description: Начиная с .NET Framework 4.5 с помощью управляемого кода можно создавать собственные типы среды выполнения Windows, упакованные в компонент этой среды.
