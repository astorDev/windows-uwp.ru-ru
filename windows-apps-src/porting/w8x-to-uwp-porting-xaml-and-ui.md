...
[
              **AutoSuggestBox**
            ](https://msdn.microsoft.com/library/windows/apps/dn633874) также поддерживает редакторы методов ввода (IME). Кроме того, можно отобразить значок поиска, если это необходимо (взаимодействие со значком приведет к вызову события **QuerySubmitted**).
