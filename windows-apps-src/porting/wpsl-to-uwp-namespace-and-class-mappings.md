---
description: В этом разделе подробно описывается сопоставление API Windows Phone Silverlight с их аналогами UWP.
...
В этом разделе подробно описывается сопоставление API Windows Phone Silverlight с их аналогами UWP. Обычно не существует полных функциональных аналогов, так как одна платформа может иметь большую или меньшую функциональность по сравнению с ее аналогом в пространстве имен или классе.
...
| Пространство имен **Microsoft.Phone.UserData** | Пространства имен[**Windows.ApplicationModel.Contacts**](https://msdn.microsoft.com/library/windows/apps/br225002), [**Windows.ApplicationModel.Appointments**](https://msdn.microsoft.com/library/windows/apps/dn263359) |
...
| (MPC = **Microsoft.Phone.Controls**) <br/>Классы **MPC.PhoneApplicationFrame**,<br/>(SWN = **System.Windows.Navigation**) <br/>**SWN.NavigationService** | Класс [**Frame**](https://msdn.microsoft.com/library/windows/apps/br242682) |
...
| Пространство имен **System.Windows.Controls.Shapes** | Пространство имен [**Windows.UI.Xaml.Controls.Shapes**](https://msdn.microsoft.com/library/windows/apps/br243401) | 
...
| Графика и анимация | |
| Пространства имен **Microsoft.Xna.Framework.\***, [Библиотека классов XNA Framework](http://go.microsoft.com/fwlink/p/?LinkId=263769), [Библиотека классов конвейера содержимого](http://go.microsoft.com/fwlink/p/?LinkId=263770) | Нет прямого эквивалента. Обычно используется [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) и C++. См. разделы [Разработка игр](https://msdn.microsoft.com/library/windows/apps/hh452744) и [Взаимодействие DirectX и XAML](https://msdn.microsoft.com/library/windows/apps/hh825871). |
...
| Пространство имен **System.Windows.Shapes** | Пространство имен [**Windows.UI.Xaml.Shapes**](https://msdn.microsoft.com/library/windows/apps/br243401) |
...
| Классы **System.Net.Sockets.UdpAnySourceMulticastClient**, **UdpSingleSourceMulticastClient** | Класс [**DatagramSocket**](https://msdn.microsoft.com/library/windows/apps/br241319) | 
