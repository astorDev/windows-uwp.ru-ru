---
description: Эта статья подробно описывается сопоставление API-интерфейсы WindowsPhone Silverlight с их эквивалентами универсальной платформы Windows (UWP).
