...
В этом разделе приведен пример переноса функционирующего однорангового приложения — игры-опроса — для WinRT 8.1 в приложение Windows 10 универсальной платформы Windows (UWP).
...
В этом примере мы выберем обычные параметры, описанные в разделе [Если у вас универсальное приложение для версии 8.1](w8x-to-uwp-root.md#if-you-have-an-81-universal-windows-app), которые относятся к поддержке устройств.
...
-   Создайте новый проект приложения Windows 10 (**Добавить** &gt; **Новый проект** &gt; **Универсальные приложения для Windows** &gt; **Пустое приложение (Windows Universal)**) и назовите его QuizGameHost.
...
-   Создайте новый проект приложения Windows 10 (**Добавить** &gt; **Новый проект** &gt; **Универсальные приложения для Windows** &gt; **Пустое приложение (Windows Universal)**) и назовите его QuizGameClient.
-   Добавьте ссылку на P2PHelper (**Добавить ссылку** &gt; **Проекты** &gt; **Решение** &gt; **P2PHelper**).
-   В **Обозревателе решений** создайте новую папку для каждой из общих папок на диске. Далее щелкните правой кнопкой мыши каждую только что созданную папку, выберите **Добавить** &gt; **Существующий элемент** и перейдите вверх по папке. Откройте соответствующую общую папку, выберите все файлы и нажмите **Добавить как связь**.
