...
-   Создайте новое решение (**Новый проект**&gt;**Другие типы проектов**&gt;**Решения Visual Studio**) и назовите его QuizGame10.

**P2PHelper**

-   В этом решении создайте новый проект библиотеки классов Windows10 (**Новый проект**&gt;**Универсальные приложения для Windows**&gt;**Библиотека классов (универсальные приложения для Windows)**) и назовите его P2PHelper.
...
-   В **Свойства**&gt;**Сборка**&gt;**символы условной компиляции** добавьте LOCALTESTMODEON.
