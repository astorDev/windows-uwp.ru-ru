...
# Пример переноса среды выполнения Windows 8.x в UWP - образец однорангового приложения QuizGame
...
**Примечание.**   Если при открытии QuizGame10 в Visual Studio отображается сообщение "Требуется обновление Visual Studio", следуйте инструкциям из [TargetPlatformVersion](w8x-to-uwp-troubleshooting.md#targetplatformversion).
...
## Пошаговое руководство использования QuizGame
...
В этом примере мы выберем обычные параметры, описанные в разделе [Если у вас универсальное приложение для версии8.1](w8x-to-uwp-root.md#if-you-have-an-81-universal-windows-app), которые относятся к поддержке устройств.
