...
**Примечание**в этом примере предполагается, что ваша сеть настроена для отправки и получения UDP настраиваемых пакетов многоадресной рассылки группы (Большинство домашних сетей, несмотря на то, что ваша сеть может не быть). В примере также отправляются и принимаются пакеты TCP.
...
-   Создайте новый проект приложения Windows10 (**Добавить** &gt; **Новый проект** &gt; **Универсальные** &gt; **Пустое приложение (Windows Universal)**) и назовите его QuizGameHost.
...
-   Создайте новый проект приложения Windows10 (**Добавить** &gt; **Новый проект** &gt; **Универсальные** &gt; **Пустое приложение (Windows Universal)**) и назовите его QuizGameClient.
-   Добавьте ссылку на P2PHelper (**Добавить ссылку** &gt; **Проекты** &gt; **Решение** &gt; **P2PHelper**).
-   В **Обозревателе решений** создайте новую папку для каждой из общих папок на диске. Далее щелкните правой кнопкой мыши каждую только что созданную папку, выберите **Добавить** &gt; **Существующий элемент** и перейдите вверх по папке. Откройте соответствующую общую папку, выберите все файлы и нажмите **Добавить как связь**.
