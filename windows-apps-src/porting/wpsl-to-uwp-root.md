...
ms.locfileid: "8807007"
---
#  <a name="move-from-windowsphone-silverlight-to-uwp"></a>Переход с WindowsPhone Silverlight на UWP


Если вы — разработчик с приложением WindowsPhone Silverlight, вы можете достичь использовать свои навыки и исходный код при переходе в Windows10. В Windows10 можно создать приложение универсальной платформы Windows (UWP), являющийся один пакет приложения, покупатели могут установить на любое устройство. Дополнительную информацию о Windows10 приложения UWP и концепциях адаптивного кода и пользовательского интерфейса, который мы будем говорить в этом руководстве по переносу, см. в [руководстве по приложениям универсальной платформы Windows (UWP)](https://msdn.microsoft.com/library/windows/apps/dn894631).
...
**Примечание**Windows10 поддерживает значительно большую часть .NET Framework, чем приложение магазина Windows Phone. Например Windows10 имеет несколько System.ServiceModel.\* пространства имен, а также System.Net System.Net.NetworkInformation и пространства имен System.Net.Sockets. Таким образом теперь — это самое время перенести WindowsPhone Silverlight и код .NET просто скомпилировать и работать на новой платформе. См. раздел [Сопоставление пространства имен и класса](wpsl-to-uwp-namespace-and-class-mappings.md).
...
| [Перенос проекта](wpsl-to-uwp-porting-to-a-uwp-project.md) | Начните процесс переноса с создания нового проекта Windows10 в Visual Studio и скопируйте в него свои файлы. |
