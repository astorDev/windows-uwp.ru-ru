...
|Приложения-объективы | [Фокусным для Windows Phone 8](https://msdn.microsoft.com/library/windows/apps/jj206990.aspx) |
...
* [Руководство по работе с приложениями UWP](https://msdn.microsoft.com/library/windows/apps/dn894631)
* [Схема создания приложений универсальной платформы Windows (UWP) с помощью C# или Visual Basic](https://msdn.microsoft.com/library/windows/apps/br229583)
