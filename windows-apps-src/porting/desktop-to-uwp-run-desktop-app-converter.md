...
|-MakeMSIX [&lt;переключатель&gt;]  |Необязательно |Параметр, если этот параметр указан, сообщающий этот скрипт, чтобы упаковать вывод, что пакет MSIX. |
