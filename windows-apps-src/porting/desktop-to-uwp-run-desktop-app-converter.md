...
* В преобразователе классических приложений версии v0.1.20 устранены все проблемы, которые не позволяли выполнять преобразование в среде последних сборок Windows 10 Insider Preview. 
