...
: heavy_check_mark: Проверка вашего приложения, упакованного приложения и требования к Microsoft Store.
...
С помощью параметров укажите пакет имени, издателя и номер версии приложения.
...
Вы можете проверить приложения с помощью ``Verify`` параметра.
...
Другой способ — подписать приложение с помощью сертификата. Если вы используете ```sign``` параметра, Desktop App Converter будет создать для вас, а затем подписать приложение с ним. Этот файл называется **auto-generated.cer** и находится в корневой папке вашего упакованного приложения.
