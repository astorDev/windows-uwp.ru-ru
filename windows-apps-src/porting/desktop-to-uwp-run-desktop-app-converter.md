...
|-MakeMSIX [&lt;SwitchParameter&gt;]  |Необязательно |Переключатель, при их наличии, сообщает, что этот сценарий для упаковки выходные данные в виде пакета MSIX. |
