...
```
> [!NOTE]
> Если вы зарезервировали имя приложения в Microsoft Store, можно получить имя и издателя с помощью [Центра партнеров](https://partner.microsoft.com/dashboard). Если вы планируете неопубликованного приложения на другие системы, вы можете предоставить для этих атрибутов собственные имена при условии, что имя издателя, выбранного вами соответствует имени в сертификате, который используется для подписания приложения.
