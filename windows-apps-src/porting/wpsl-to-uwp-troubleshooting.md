...
| _Ошибка XamlCompiler WMC0055: Не удается присвоить значение текста "&lt;вашего потока geometry&gt;" в свойство «Коллекции» типа «Практическое руководство.»_ | В UWP тип приложения UWP [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) и XAML C++. |
| _Ошибка XamlCompiler WMC0001: Неизвестный тип «RadialGradientBrush» в пространстве имен XML [...]_ | В UWP нет типа **RadialGradientBrush**. Удалите **RadialGradientBrush** из разметки и используйте другой тип приложения UWP [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) и XAML C++. |
| _Ошибка XamlCompiler WMC0011: Неизвестный элемент «OpacityMask» в элементе "&lt;типа UIElement&gt;"_ | Приложение UWP [Microsoft DirectX](https://msdn.microsoft.com/library/windows/desktop/ee663274) и XAML C++. |
