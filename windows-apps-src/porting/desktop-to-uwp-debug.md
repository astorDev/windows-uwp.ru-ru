...
1. Убедитесь, что Запуск упакованного приложения по крайней мере один раз, таким образом, чтобы оно полностью установилось на локальном компьютере.
