...
После этого из-за [изменений, связанных с пикселями представления](wpsl-to-uwp-porting-xaml-and-ui.md#effective-pixels) необходимо идти дальше и умножить все фиксированные измерения размеров, которые мы еще не изменили (поля, ширина, высота и т. д.) на 0,8. Например, изображения должны измениться с 70x70пикселей на 56x56пикселей.
