---
author: normesta
Description: "В этой статье подробно рассматривается внутренняя работа моста переноса классических приложений на UWP."
title: "Мост переноса классических приложений на UWP: за кулисами"
ms.author: normesta
ms.date: 03/09/2017
ms.topic: article
ms.prod: windows
...
translationtype: HT
---
# <a name="desktop-to-uwp-bridge-behind-the-scenes"></a>Мост переноса классических приложений на UWP: за кулисами

В этой статье подробно рассматривается внутренняя работа моста переноса классических приложений на UWP.
