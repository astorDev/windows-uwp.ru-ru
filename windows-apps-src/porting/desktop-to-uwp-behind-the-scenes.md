...
ms.locfileid: "4352914"
---
# <a name="behind-the-scenes-of-your-packaged-desktop-application"></a>За кулисами упакованного классического приложения

В этой статье подробно внутренняя на возникающие в файлы и параметры реестра, при создании пакета приложения для Windows для классического приложения.
