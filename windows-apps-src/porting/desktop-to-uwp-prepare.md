...
title: "Подготовка приложения к преобразованию в приложение UWP с помощью моста для классических приложений"
ms.author: alkoren
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
