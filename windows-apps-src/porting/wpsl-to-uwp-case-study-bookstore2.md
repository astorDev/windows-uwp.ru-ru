...
Перенесенное приложение Windows10, запущенное на настольном компьютере, с увеличенным масштабом, два размера окна  
![его перенесенное windows 10, запущенное на настольном компьютере, уменьшенное представление, два размеры окна](images/w8x-to-uwp-case-studies/c02-08-desk10-zo-ported.png)
