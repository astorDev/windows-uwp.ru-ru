...
>[!NOTE]
>В этом руководстве предполагается, что вы создали пакет приложения Windows для своего настольного приложения. Если вы еще не сделали этого, см. в разделе [пакет приложений для настольных компьютеров](desktop-to-uwp-root.md).
...
Если решение не содержит проект упаковки, см. в разделе [упаковки классического приложения с помощью Visual Studio](desktop-to-uwp-packaging-dot-net.md).
...
Чтобы сделать это, см. в разделе [во-первых, ваш проект установки](https://docs.microsoft.com/windows/uwp/porting/desktop-to-uwp-enhance#first-set-up-your-project) раздела [рабочего стола в приложении для Windows 10](https://docs.microsoft.com/windows/uwp/porting/desktop-to-uwp-enhance#first-set-up-your-project).
