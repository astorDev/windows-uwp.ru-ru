...
# Перенос проекта WindowsPhoneSilverlight в проект UWP
...
Если это так, и теперь вы хотите поддерживать Windows10, тогда вы можете сделать это.
...
См. раздел [Справочник по схеме манифеста пакета для Windows10](https://msdn.microsoft.com/library/windows/apps/dn934820).
