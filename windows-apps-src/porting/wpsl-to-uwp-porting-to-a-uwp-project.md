---
author: stevewhims
description: Начните процесс переноса с создания нового проекта Windows10 в Visual Studio и скопируйте в него файлы.
...
Начните процесс переноса с создания нового проекта Windows10 в Visual Studio и скопируйте в него файлы.
...
Если вы хотите поддерживать WindowsPhone Silverlight и Windows10 в одном файле кода, а затем вы можете сделать это. Если в проекте Windows10 изучить страницы свойств проекта, вы увидите, что проект определен WINDOWS\_UAP как символ условной компиляции. Как правило, можно использовать следующую логику для выполнения условной компиляции.
...
Если у вас есть код, который общий доступ к в приложении WindowsPhone Silverlight и в приложение среды выполнения Windows 8.x, может уже есть исходный код с логика следующим образом:
...
Если это так, и теперь вы хотите поддерживать Windows10 Кроме того, тогда вы можете сделать это, слишком.
