...
title: Перенос Windows Phone Silverlight в UWP для форм фактора и UX
...
ms.locfileid: "75684636"
---
#  <a name="porting-windowsphone-silverlight-to-uwp-for-form-factor-and-ux"></a>Перенос Windows Phone Silverlight в UWP для форм фактора и UX


Предыдущий раздел — [Перенос уровней бизнеса и данных](wpsl-to-uwp-business-and-data.md).

В приложениях для Windows используется общий вид и стиль на всех компьютерах, мобильных устройствах и множестве других устройств. Пользовательский интерфейс, ввод и шаблоны взаимодействия очень похожи, и пользователь, использующий приложения на разных устройствах, оценит это. Различия между устройствами, такие как физический размер, ориентация по умолчанию и эффективный фактор разрешения пикселя, в способе визуализации приложения универсальная платформа Windows (UWP) в Windows 10. К счастью, большая часть сложной работы выполняется за вас системой с помощью интеллектуальных концепций, в частности эффективных пикселей.
...
-   [Разработка приложений UWP](https://developer.microsoft.com/windows/apps/design)
-   [Рекомендации по использованию шрифтов](https://docs.microsoft.com/windows/uwp/controls-and-patterns/fonts)
-   [Планирование различных форм-факторов](https://docs.microsoft.com/windows/uwp/layout/screen-sizes-and-breakpoints-for-responsive-design)
