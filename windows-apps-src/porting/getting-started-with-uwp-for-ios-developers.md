...
ms.openlocfilehash: d477b4ec560df41ea30d2cf486f672c558e4b2e5
...
Если вы являетесь разработчиком приложений iOS и планируете разрабатывать приложения для Windows10, то данные документы послужат отличной отправной точкой. Они описываются некоторые основные понятия, которые необходимо знать, как начать создавать приложения, и они рассмотрим, как опубликовать работе в магазине Майкрософт.
...
Для работы с пошаговыми руководствами вам потребуется компьютер с установленной ОС Windows 10 и средой Microsoft Visual Studio. Вы можете скачать их из [загружаемые файлы для разработчиков для программирования UWP приложения](https://developer.microsoft.com/en-us/windows/downloads). Нет компьютера под управлением Windows? Не беспокойтесь: вы сможете работать на своем компьютере Mac. Обратитесь к разделу [Установка Windows и средств разработки на Mac](setting-up-your-mac-with-windows-10.md).
