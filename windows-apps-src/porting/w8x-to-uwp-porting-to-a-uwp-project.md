...
**Примечание**  Если вы хотите поддерживать Windows 8.1, Windows Phone 8.1 и Windows10 в одном файле кода, то вы можете сделать это слишком. Если в проекте Windows10 изучить страницы свойств проекта, вы увидите, что проект определен WINDOWS\_UAP как символ условной компиляции. Поэтому можно использовать этот символ в сочетании с WINDOWS\_APP и WINDOWS\_PHONE\_APP. Эти примеры показывают более простой случай удаления условной компиляции из универсальных приложений версии 8.1 и замены эквивалентного кода для приложения Windows10.
...
Windows10 интерфейс на [**PickSingleFileAsync**](https://msdn.microsoft.com/library/windows/apps/jj635275) API, поэтому код упрощается так:
