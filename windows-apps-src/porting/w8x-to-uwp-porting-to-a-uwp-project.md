...
-   Вы сможете удалить многие директивы условной компиляции в исходном коде универсального приложения версии 8.1, если вам необходима поддержка только Windows 10. См. подраздел [Условная компиляция и адаптивный код](#conditional-compilation-and-adaptive-code) в этом разделе.
