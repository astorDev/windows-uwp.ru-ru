---
author: mcleblanc
description: "Когда вы приступаете к переносу, у вас есть два варианта."
...
Если вы используете условную компиляцию (с директивами препроцессора C#), чтобы файлы кода работали в Windows 8.1 и Windows Phone 8.1, теперь вы можете пересмотреть эту условную компиляцию в свете конвергенции в Windows 10. Конвергенция означает, что в приложении Windows 10 некоторые условия можно удалить. А другие условия изменить на проверки во время выполнения, как показано в примерах ниже.
