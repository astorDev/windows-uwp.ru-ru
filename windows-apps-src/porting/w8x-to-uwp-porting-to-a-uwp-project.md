...
Если вы используете условную компиляцию (с директивами препроцессора C#), чтобы файлы кода работали в Windows 8.1 и Windows Phone 8.1, затем теперь можно просмотреть условную компиляцию благодаря конвергенции в Windows10. Конвергенция означает, что в вашем приложении Windows10 некоторые условия можно удалить вообще. А другие условия изменить на проверки во время выполнения, как показано в примерах ниже.
