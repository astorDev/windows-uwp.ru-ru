...
ms.locfileid: "57613829"
---
# <a name="integrate-your-packaged-desktop-application-with-windows-10"></a>Интеграция упакованные приложения рабочего стола с Windows 10

Используйте расширения для интеграции своего настольного приложения в пакете с Windows 10 одним из стандартных способов.
