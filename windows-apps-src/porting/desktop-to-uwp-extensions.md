...
Упакованные приложения могут связанные с расширениями типов файлов. Если пользователь щелкнет файл правой кнопкой мыши, а затем выбирает **Открыть с помощью** , приложение появится в списке вариантов.
...
> [!NOTE]
> Пользователю необходимо запустить приложение хотя бы один раз зарегистрировать эту задачу автозагрузки.
