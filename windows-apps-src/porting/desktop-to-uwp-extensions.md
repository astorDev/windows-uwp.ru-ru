...
* [Разрешите пользователям запускать приложение при подключении устройства к ПК](#autoplay)
...
### <a name="enable-users-to-start-your-app-when-they-connect-a-device-to-their-pc"></a>Разрешите пользователям запускать приложение при подключении устройства к ПК
