...
Как и в предыдущем примере, мы выберем вариант (из тех, что описаны в разделе [Если у вас универсальное приложение для версии 8.1](w8x-to-uwp-root.md)) переноса содержимого общего проекта в Windows 10, которая ориентирована на семейство универсальных устройств.
...
Изменения дизайна в Windows 10, связанные с элементом [**SemanticZoom**](https://msdn.microsoft.com/library/windows/apps/hh702601) описаны в разделе [Изменения SemanticZoom](w8x-to-uwp-porting-xaml-and-ui.md). У нас нет заданий для выполнения в этом разделе в ответ на эти изменения.
