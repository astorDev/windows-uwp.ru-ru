...
description: Этот пример на основе Bookstore1 начинается с универсального приложения для версии 8.1, отображающего сгруппированные данные в элементе управления SemanticZoom.
