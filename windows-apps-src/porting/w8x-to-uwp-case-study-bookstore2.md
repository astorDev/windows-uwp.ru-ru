...
description: В этом примере используются данные из примера Bookstore1, который начинается с универсального приложения для версии 8.1, отображающего сгруппированные данные в элементе управления SemanticZoom.
...
![Bookstore2\_81 в Windows Phone в увеличенном масштабе](images/w8x-to-uwp-case-studies/c02-03-wp81-zi-how-the-app-looks.png)

Bookstore2\_81 в Windows Phone в увеличенном масштабе

![Bookstore2\_81 в Windows Phone в уменьшенном масштабе](images/w8x-to-uwp-case-studies/c02-04-wp81-zo-how-the-app-looks.png)

Bookstore2\_81 в Windows Phone в уменьшенном масштабе

##  Перенос в проект Windows 10

Решение Bookstore2\_81 — это проект универсального приложения для версии 8.1. Проект Bookstore2\_81.Windows создает пакет приложения для Windows 8.1, и проект Bookstore2\_81.WindowsPhone создает пакет приложения для Windows Phone 8.1. Bookstore2\_81.Shared — это проект, который содержит исходный код, файлы разметки и другие ресурсы, используемые обоими приложениями.

Как и в предыдущем примере, мы выберем вариант (из тех, что описаны в разделе [Если у вас универсальное приложение для версии 8.1](w8x-to-uwp-root.md#if-you-have-a-universal-81-app)) переноса содержимого общего проекта в Windows 10, которая ориентирована на семейство универсальных устройств.
