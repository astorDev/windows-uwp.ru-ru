...
Если вы планируете опубликовать приложение в Microsoft Store, но еще не обращались к нам, заполните [эту форму](https://developer.microsoft.com/windows/projects/campaigns/desktop-bridge), и корпорация Microsoft свяжется с вами, чтобы начать процесс подключения.
