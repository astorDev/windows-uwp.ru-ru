...
Публикация приложения в Microsoft Store для более широкую аудиторию. Кроме того корпоративные клиенты могут приобрести ваше приложение, чтобы распространять его внутри своих организаций через [Магазин Майкрософт для бизнеса](https://www.microsoft.com/business-store).
...
Для распространения приложения на других устройствах, не размещая его в магазине, необходимо получить сертификат, подписать приложение с помощью этого сертификата, а затем загружать неопубликованные приложения на этих устройствах.
