...
Если вы планируете распространять ваше приложение будет распространяться на устройства под управлением Windows 10 S, ваше приложение должно быть подписано Microsoft Store, поэтому вам необходимо пройти процесс отправки в магазин перед распространением приложения на этих устройствах.
...
* Переносит пользовательские данные, связанные с помощью классического приложения в соответствующие расположения папок упакованного приложения.
