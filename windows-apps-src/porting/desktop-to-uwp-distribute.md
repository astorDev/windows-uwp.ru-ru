...
Публикация приложения в это хранилище для более широкую аудиторию. Кроме того корпоративные клиенты могут приобрести ваше приложение, чтобы распространять его внутри своих организаций через [Магазин Майкрософт для бизнеса](https://www.microsoft.com/business-store).
