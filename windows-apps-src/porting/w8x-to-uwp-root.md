---
description: Если у вас есть универсальное приложение 8,1 &\#8212; Windows 8.1, Windows Phone 8,1 или оба &\#8212; вы обнаружите, что исходный код и навыки будут беспрепятственно переноситься в Windows 10.
...
ms.locfileid: "74259101"
---
# <a name="move-from-windows-runtime-8x-to-uwp"></a>Переход со среды выполнения Windows 8.x на UWP


Если у вас есть универсальное приложение 8,1, будь то Windows 8.1, Windows Phone 8,1 или и то и другое, вы обнаружите, что исходный код и навыки будут беспрепятственно переноситься в Windows 10. В Windows 10 можно создать приложение универсальная платформа Windows (UWP), которое является одним пакетом приложения, который клиенты могут устанавливать на каждом устройстве. Дополнительные сведения о Windows 10, приложениях UWP и концепциях адаптивного кода и адаптивного пользовательского интерфейса, которые мы будем упомянуть в этом руководством по переносу, см. в разделе [Guide to UWP Apps](https://docs.microsoft.com/windows/uwp/get-started/universal-application-platform-guide).

При переносе вы обнаружите, что Windows 10 использует большинство API-интерфейсов с предыдущими платформами, а также разметку XAML, платформу пользовательского интерфейса и инструментарий, и вы найдете все, что вам известно. Как и ранее, вы можете выбрать язык программирования (C++, C# и Visual Basic), который будет использоваться с инфраструктурой пользовательского интерфейса XAML. Первые этапы планирования того, что следует делать с текущим приложением или приложениями, будут зависеть от того, какие типы приложений и проектов у вас имеются. Это объясняется в следующих разделах.
...
-   AppName\_81. Windows. Это проект, который строит пакет приложения для Windows 8.1.
...
Часто в 8,1 универсальных приложениях Windows предусмотрены те же возможности, что и при использовании одного и того же кода и разметки — как в его Windows 8.1, так Windows Phone 8,1. Такое приложение является идеальным кандидатом для переноса в одно приложение Windows 10, предназначенное для универсального семейства устройств (и которое можно установить на самых широком диапазоне устройств). По сути, вы переносите содержимое общего проекта. Двумя другими проектами вам пользоваться практически не придется, потому что они практически ничего не содержат.

В других случаях Windows 8.1 и (или) Windows Phone 8,1 приложения содержат уникальные функции. Или же они содержат те же самые функции, но реализуют их при помощи разных методов и технологий. В случае таких приложений при переносе вы можете создать одно приложение, которое будет ориентировано на все семейства устройств (в этом случае вам потребуется, чтобы приложение адаптировалось к различным устройствам) или же создать несколько приложений. Например, одно будет предназначено для семейства настольных, а второе — для семейства мобильных устройств. Характер универсального приложения для версии 8.1 определит, какой из этих вариантов подходит вам больше.
...
* [Разработка UX для приложений](https://docs.microsoft.com/previous-versions/windows/hh767284(v=win.10))
