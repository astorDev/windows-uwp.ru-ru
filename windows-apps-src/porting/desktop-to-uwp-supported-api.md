...
| Пользовательский интерфейс XAML | Windows 10, новые версии 1809 и более ранних версий не поддерживают размещения содержимого XAML UWP в упакованных приложений рабочего стола. Начиная с Windows 10, версия 1903, можно использовать [XAML о-ва](../xaml-platform/xaml-host-controls.md) для размещения содержимого XAML UWP.  |
...
Ниже приведен полный список API UWP, поддерживаемых в упакованных приложениях. Можно просмотреть [API-интерфейсы поддерживаются только в упакованных приложений](#new) или [API-интерфейсы, поддерживаемые в упакованных приложений и настольных приложений](#both).
