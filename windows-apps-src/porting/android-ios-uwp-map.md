...
title: Сопоставление концепции приложений для Windows для разработчиков iOS и Android
ms.date: 02/08/2017
ms.topic: article
...
<thead>
<tr class="header">
<th align="left"><strong>Общий принцип</strong></th>
...
<td align="left"><strong>Языке проектирования.</strong><br><br>Набор соглашений, описывающих вид и работу приложений на платформе.</td>
...
<td align="left"><a href="https://developer.microsoft.com/en-us/windows/apps/design"><strong>Проектирование приложений Windows UWP</strong> </a> показано, как создать приложение, которое ищет фантастические на всех устройствах Windows 10. Здесь описаны основы проектирования пользовательского интерфейса, методы создания отзывчивого дизайна и представлен полный список подробных руководств.<br/></td>
</tr>
<tr class="even">
...
<tr class="even">
<td align="left"><strong>Управлять обработки событий.</strong> <br><br>Описание логики, которая выполняется после активации событий в элементах управления пользовательского интерфейса.</td>
...
<td align="left">В UWP вы получаете программный доступ к встроенным элементам интерфейса с помощью <strong><a href="https://msdn.microsoft.com/library/windows/apps/ee684076.aspx">модели автоматизации пользовательского интерфейса</a></strong>.<br/><strong><a href="https://msdn.microsoft.com/library/windows/apps/mt297667.aspx">Пользовательские одноранговые классы автоматизации</a></strong>  позволяют предоставить Поддержка модели автоматизации для собственных пользовательских классов пользовательского интерфейса.  <strong><a href="https://msdn.microsoft.com/library/dd286726.aspx#VerifyingCodeUsingCUITCreate">Проект закодированного тестом пользовательского интерфейса</a></strong> в Visual Studio позволяет автоматически протестировать все приложение через пользовательский интерфейс или провести изолированное тестирование пользовательского интерфейса.</td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<tr class="even">
<td align="left"><strong>Повторно используемые стили оформления.</strong> <br><br>Применение многократно используемых визуальных изменений к нескольким элементам управления.</td>
...
<tr class="even">
<td align="left"><strong>Встроенные сенсорных жестов.</strong> <br><br>Предоставление настраиваемой поддержки сенсорного ввода путем обработки высокоуровневых абстрагированных событий жестов, таких как касание и двойное касание, в представлениях и элементах управления.</td>
<td align="left">Класс <strong>GestureDetector</strong> определяет основные сенсорные жесты, включая прокрутку, долгое нажатие, касание, двойное касание и смахивание.</td>
...
<td align="left">С помощью <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997788.aspx">вкладок и сводок</a></strong> можно отобразить постоянный список ссылок или вкладок над содержимым. The <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997787.aspx">Панель навигации и комбинированный режим</a></strong> позволяют отображать список ссылок рядом с содержимым.<br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigation-basics">Навигация</a><br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigate-between-two-pages">Переход между двумя страницами</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<td align="left"><strong><a href="https://msdn.microsoft.com/library/windows/apps/dn449149.aspx">Концентраторы</a></strong>  позволяют показать пользователю Предварительный просмотр содержимого, который можно выбрать для перехода по страницам дочерних. <strong><a href="https://msdn.microsoft.com/library/windows/apps/dn997765.aspx">Основной/подробности</a></strong>  разрешить пользователям выбор из списка сводки элементов которых отображаются рядом с соответствующей области данных.<br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigation-basics">Навигация</a><br/><br/><a href="https://msdn.microsoft.com/windows/uwp/layout/navigate-between-two-pages">Переход между двумя страницами</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Обратно кнопки навигации.</strong> <br><br>Переход назад в приложении.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Голоса.</strong> <br><br>Распознавание речи для голосового ввода и дополнительные голосовые возможности.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Данные в локальное приложение.</strong> <br><br>Локальное хранение связанных с приложением параметров и файлов.</td>
...
<tr class="even">
<td align="left"><strong>Локальная база данных хранилища.</strong> <br><br>Сохранение данных в реляционной базе данных с объектно-реляционными модулями сопоставления (ORM) (если применимо).</td>
...
<td align="left">Данные можно хранить с помощью <strong>SQLite</strong>. <strong><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592863.aspx">Платформа Entity Framework</a></strong>  является встроенной ORM, который избавляет от необходимости писать много кода доступа к данным и позволяет легко запрашивать базу данных без написания SQL. Запросы SQL выполняются непосредственно в <a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592864.aspx">библиотеке SQLite</a>.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/xaml/mt592862.aspx">Доступ к данным</a></td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Загрузка файлов HTTP.</strong> <br><br>Скачивание больших и маленьких файлов по HTTP.</td>
...
<td align="left">Класс <strong>Socket</strong> class предоставляет сокеты TCP, а класс <strong>DatagramSocket</strong> — сокет UDP.</td>
...
<td align="left"><strong><a href="https://www.visualstudio.com/features/universal-windows-platform-vs.aspx">Visual Studio</a></strong>  и <strong><a href="https://msdn.microsoft.com/library/jj171012.aspx">Blend для Visual Studio</a></strong> имеет все средства, необходимые для кода, проектирования, подключения, отладка, анализ, оптимизировать и тестирование приложений универсальной платформы Windows. Visual Studio также предоставляет <strong><a href="https://msdn.microsoft.com/library/windows/apps/mt188754.aspx">эмуляторы</a></strong> устройств под управлением Windows 10, чтобы вы могли протестировать приложение на разнообразных эмулированных устройствах.<br/><br/><a href="https://dev.windows.com/downloads">Скачиваемые файлы и инструменты для UWP</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Код организации.</strong> <br><br>Базовая структура папок приложения, часто создаваемая из начального шаблона.</td>
<td align="left">Файл <strong>AndroidManifest</strong> file, папка <strong>java</strong> с исходными файлами, папка <strong>res</strong> с ресурсами, включая макеты и значения, сценарии сборки <strong>Gradle</strong> в Android Studio и сценарии сборки <strong>Ant</strong> в Eclipse.</td>
...
<td align="left">Каждая активность имеет собственный <strong>жизненный цикл активности</strong> с такими состояниями как <strong>возобновлено</strong>. <strong>Обратные вызовы жизненного цикла</strong> например <strong>onResume</strong> реализованы в вашей <strong>классы действий</strong>.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Рекомендации по производительности.</strong> <br><br>Руководство по созданию быстрых и гибких приложений с ускоренным запуском и учетом уровня заряда батареи.</td>
...
<tr class="even">
<td align="left"><strong>Просмотр оптимизации для адаптивного пользовательского интерфейса.</strong> <br><br>Повышение производительности путем оптимизации представлений.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Работа с потоками.</strong> <br><br>Использование потоков для обеспечения <strong>скорости отклика интерфейса пользователя</strong> и <strong>параллельного выполнения нескольких задач</strong>.</td>
...
<td align="left">Вы можете тестировать внутренние покупки приложения, просто используя класс <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.currentappsimulator.aspx">CurrentAppSimulator</a></strong> вместо класса CurrentApp.<br/><br/></td>
</tr>
<tr class="even">
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Адаптивного пользовательского интерфейса: гибкие макеты.</strong> <br><br>Поддержка нескольких размеров экрана различной высоты и ширины.</td>
...
<tr class="even">
<td align="left"><strong>Адаптивного пользовательского интерфейса: специально макетов.</strong> <br><br>Поддержка нескольких размеров экрана с использованием отдельных целевых макетов.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Адаптивного пользовательского интерфейса: быстрые макеты.</strong> <br><br>Обработка изменений размера экрана, таких как поворот и изменение размеров окна.</td>
...
<tr class="even">
<td align="left"><strong>Поддержка возможности другое устройство.</strong> <br><br>Использование расширенных аппаратных функций при сохранении поддержки не обладающих ими устройств.</td>
...
<tr class="even">
<td align="left"><strong>Отображать уведомления.</strong> <br><br>Типы отображаемых уведомлений.</td>
...
<tbody>
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Запись мультимедиа.</strong> <br><br>Запись звука и визуального содержимого.</td>
...
<td align="left"><strong>Расположение Core</strong> <strong>CLLocationManager</strong> класс позволяет отслеживать расположение устройства с <strong>startUpdatingLocation</strong> стандартное расположение службы и <strong>startMonitoringSignificantLocationChanges</strong> для <strong>значительное изменение</strong> расположение службы.</td>
...
<td align="left">Карты встраиваются в приложения iOS с помощью класса <strong>MKMapView</strong><strong>платформы MapKit</strong>. К приложениям можно добавлять <strong>аннотации</strong> для отображения объектов на карте с помощью классов объектов, таких как <strong>MKPointAnnotation</strong>, и классов представлений, таких как <strong>MKPinAnnotationView</strong>.</td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Географическое зонирование.</strong> <br><br>Отслеживание входа и выхода из определенного географического региона.</td>
...
<td align="left">Вы можете создавать геозоны с помощью класса <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.devices.geolocation.geofencing.geofence.aspx">Geofence</a></strong> и определять <strong>отслеживаемые состояния</strong>, такие как вход и выход из региона. Обработка геозон на переднем плане осуществляется с помощью класса <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.devices.geolocation.geofencing.geofencemonitor.aspx">GeofenceMonitor</a></strong>, а в фоновом режиме — с помощью <strong><a href="https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.background.locationtrigger.aspx">фонового класса LocationTrigger background class</a></strong>.<br/><br/><a href="https://msdn.microsoft.com/library/windows/apps/mt219702.aspx">Настройка геозоны</a></td>
</tr>
<tr class="even">
<td align="left"><strong>Геокодирование и обратного геокодирования.</strong> <br><br>Преобразование адресов в географические расположения (геокодирование) и географических расположений в адреса (обратное геокодирование).<br/></td>
...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Маршруты и направлениях.</strong> <br><br>Предоставление маршрутов, расстояний и направлений между двумя географическими расположениями.</td>
...
<td align="left">Для предоставления доступа к данным приложения другому приложению можно использовать <strong>расширения приложений</strong>. <strong>Схемы URL-адресов</strong> позволяют передавать URL-адреса в другое приложение.</td>
...
<tr class="even">
<td align="left"><strong>Разрешение приложения для вызова.</strong> <br><br>Возможность ответа вашего приложения на запрос из другого приложения.</td>
...
<tr class="even">
<td align="left"><strong>Путем перетаскивания.</strong> <br><br>Перетаскивание содержимого между приложениями.</td>
...
<td align="left"><strong>Model-View-Controller (MVC)</strong> — распространенный шаблон, используемые в iOS и интегрированный в платформу.</td>
