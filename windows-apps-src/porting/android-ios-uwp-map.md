...
<td align="left">В UWP вы получаете программный доступ к встроенным элементам интерфейса с помощью <strong><a href="https://docs.microsoft.com/windows/desktop/WinAuto/uiauto-uiautomationoverview">модели автоматизации пользовательского интерфейса</a></strong>.<br/><strong><a href="https://docs.microsoft.com/windows/uwp/accessibility/custom-automation-peers">Пользовательские одноранговые классы автоматизации</a></strong>  позволяют предоставить Поддержка модели автоматизации для собственных пользовательских классов пользовательского интерфейса.  <strong><a href="https://docs.microsoft.com/visualstudio/test/use-ui-automation-to-test-your-code?view=vs-2015">Проект закодированного тестом пользовательского интерфейса</a></strong> в Visual Studio позволяет автоматически протестировать все приложение через пользовательский интерфейс или провести изолированное тестирование пользовательского интерфейса.</td>
</tr>
<tr class="odd" style="background-color: #f2f2f2">
...
<td align="left"><strong><a href="https://www.visualstudio.com/features/universal-windows-platform-vs.aspx">Visual Studio</a></strong>  и <strong><a href="https://docs.microsoft.com/visualstudio/designers/creating-a-ui-by-using-blend-for-visual-studio?view=vs-2015">Blend для Visual Studio</a></strong> имеет все средства, необходимые для кода, проектирования, подключения, отладка, анализ, оптимизировать и тестирование приложений универсальной платформы Windows. Visual Studio также предоставляет <strong><a href="https://docs.microsoft.com/windows/uwp/debug-test-perf/test-with-the-emulator">эмуляторы</a></strong> устройств под управлением Windows 10, чтобы вы могли протестировать приложение на разнообразных эмулированных устройствах.<br/><br/><a href="https://dev.windows.com/downloads">Скачиваемые файлы и инструменты для UWP</a></td>
</tr>
<tr class="even">
...
<td align="left">Вы можете тестировать внутренние покупки приложения, просто используя класс <strong><a href="https://docs.microsoft.com/uwp/api/windows.applicationmodel.store.currentappsimulator">CurrentAppSimulator</a></strong> вместо класса CurrentApp.<br/><br/></td>
</tr>
<tr class="even">
...
<td align="left">Локальные уведомления создаются с помощью <strong>UILocalNotification</strong>и можно запланировать с <b> UILocalNotification.scheduleLocalNotification:<strong>. | Вы можете запланировать всплывающие уведомления при помощи</strong>  <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Notifications.ScheduledToastNotification">ScheduledToastNotification</a><strong>. Можно отправить уведомление плитки из приложения с помощью</strong> <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Notifications.TileNotification">класса TileNotification</a><strong> или создать расписание уведомления плитки с помощью класса <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Notifications.ScheduledTileNotification">ScheduledTileNotification</a>.<br/><br/><a href="https://docs.microsoft.com/windows/uwp/controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts">Адаптивные и интерактивные всплывающие уведомления</a><br/><br/><a href="https://docs.microsoft.com/windows/uwp/controls-and-patterns/tiles-and-notifications-sending-a-local-tile-notification">Отправить уведомление с плиткой локального</a> || </strong>Отправка Push-уведомлений.</b> Уведомление, отправленное с сервера push-уведомлений и при необходимости обрабатываемое в приложении.</td>
