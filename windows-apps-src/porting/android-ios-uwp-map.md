...
<tr class="odd" style="background-color: #f2f2f2">
<td align="left"><strong>Тестирование покупок в приложении.</strong>  <br><br>Возможность протестировать код внутренней покупки приложения без отправки приложения в Магазин.</td>
...
<td align="left">Локальные уведомления создаются с помощью <strong>уилокалнотификатион</strong>, и их можно запланировать с <b> Уилокалнотификатион. счедулелокалнотификатион:<strong>. | Вы можете запланировать всплывающее уведомление с помощью</strong>  <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Notifications.ScheduledToastNotification">счедуледтоастнотификатион</a><strong>. Можно отправить уведомление плитки из приложения с помощью</strong> <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Notifications.TileNotification">класса TileNotification</a><strong> или создать расписание уведомления плитки с помощью класса <a href="https://docs.microsoft.com/uwp/api/Windows.UI.Notifications.ScheduledTileNotification">ScheduledTileNotification</a>.<br/><br/><a href="https://docs.microsoft.com/windows/uwp/controls-and-patterns/tiles-and-notifications-adaptive-interactive-toasts">Адаптивные и интерактивные всплывающие уведомления</a><br/><br/><a href="https://docs.microsoft.com/windows/uwp/controls-and-patterns/tiles-and-notifications-sending-a-local-tile-notification">Отправить уведомление о локальном плитке</a> | | @no__t 1Sending push-уведомлений. </b> Уведомление, отправленное с сервера push-уведомлений и при необходимости обрабатываемое в приложении.</td>
...
<td align="left">Класс <strong>базового расположения</strong> <strong>кллокатионманажер</strong> используется для наблюдения за расположением устройства, с <strong>стартупдатинглокатион</strong> для службы Standard Location и <strong>стартмониторингсигнификантлокатиончанжес</strong> для  <strong>Служба обнаружения существенных изменений</strong> .</td>
