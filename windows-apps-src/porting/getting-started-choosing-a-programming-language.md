...
-   [Создание первого приложения универсальной платформы Windows на C++](../get-started/create-a-basic-windows-10-app-in-cpp.md)
-   [Создание вашего первого UWP приложения с помощью C# или Visual Basic](../get-started/create-a-hello-world-app-xaml-universal.md)
-   [Создание первого приложения универсальной платформы Windows, с помощью JavaScript](../get-started/create-a-hello-world-app-js-uwp.md)
...
-   [угол](https://bugs.chromium.org/p/angleproject/)
...
-   [Создание вашего первого UWP приложения с помощью C# или Visual Basic](../get-started/create-a-hello-world-app-xaml-universal.md)
-   [Примеры приложений универсальной платформы Windows, использующиеC#](https://go.microsoft.com/fwlink/p/?LinkId=263453)
...
[Приступая к работе: Начало работы с Visual Studio](getting-started-getting-around-in-visual-studio.md)
