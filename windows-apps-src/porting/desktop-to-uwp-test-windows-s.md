...
ms.locfileid: "1662714"
---
# <a name="test-your-windows-app-for-windows-10-s"></a>Тестирование приложения для Windows на Windows10S.

Можно протестировать приложение для Windows, чтобы убедиться, что оно сможет корректно работать на устройствах под управлением Windows 10 S. На самом деле, если вы планируете опубликовать приложение в Microsoft Store, это надо сделать обязательно, поскольку таковы требования Store. Чтобы протестировать приложение, можно применить политику целостности кода Device Guard на устройстве под управлением Windows 10 Pro.
...
|--|--|--|--|
|Политика режима аудита |Ведет журнал ошибок / не блокирует |Store |SiPolicy_Audit.p7b |
|Политика режима производства |Да |Store |SiPolicy_Enforced.p7b |
