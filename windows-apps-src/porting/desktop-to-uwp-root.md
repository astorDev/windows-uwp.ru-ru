...
title: "Перенос классического приложения на универсальную платформу Windows (UWP) с помощью Desktop Bridge"
...
# Перенос классического приложения на универсальную платформу Windows (UWP) с помощью Desktop Bridge
...
Преобразование классических приложений в пакеты UWP состоит из двух этапов. Первый— это процесс преобразования, в ходе которого имеющиеся двоичные файлы повторно упаковываются в качестве пакета UWP. Ваш код остается прежним, он просто по-другому упаковывается. На втором этапе используются технологии среды выполнения, содержащиеся в юбилейном обновлении Windows10, которые позволяют исполняемым файлам пакета UWP выполняться в качестве файлов с полным доверием, а не в контейнере приложения. Этот механизм также присваивает преобразованному приложению идентифицирующие признаки пакета, что необходимо для использования некоторых API-интерфейсов UWP.
...
**Сторонний установщик**. Три распространенных сторонних установщика— [InstallShield от Flexera](http://www.flexerasoftware.com/producer/products/software-installation/installshield-software-installer), [WiX от FireGiant](https://www.firegiant.com/r/appx) и [Advanced Installer от Caphyon](http://www.advancedinstaller.com/uwp-app-package)— теперь поддерживают Desktop Bridge, и для создания с их помощью установщика MSI и пакета преобразованного приложения достаточно несколько щелчков мышью. Дополнительные сведения см. на соответствующих веб-сайтах для каждого установщика. 
...
| [Отладка приложений, преобразованных с помощью Desktop Bridge](desktop-to-uwp-debug.md) | Возможные варианты отладки преобразованного приложения. | 
