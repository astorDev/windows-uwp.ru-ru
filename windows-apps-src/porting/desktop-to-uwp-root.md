...
ms.locfileid: "7298140"
---
# <a name="package-desktop-applications-desktop-bridge"></a>Упаковка классических приложений (моста для классических приложений)

Выполнить существующего классического приложения и добавлять современные взаимодействия для пользователей Windows 10. После этого вы сможете охватить международные рынки путем распространения приложения через Microsoft Store. Монетизировать приложение можно гораздо более простыми способами с помощью возможностей, встроенные в магазине. Конечно, использовать Store не обязательно. Вы можете использовать существующие каналы.
...
: heavy_check_mark: проверяет приложения от упакованного классического приложения и требования к Microsoft Store.
...
Если для упаковки приложения используется DAC, вы можете использовать новый ``-Verify`` флаг, чтобы проверить ваш пакет на соответствие упакованного классического приложения и требования магазина. См. раздел [Упаковка, подписание и подготовка приложения для отправки в Store](desktop-to-uwp-run-desktop-app-converter.md#optional-parameters).
