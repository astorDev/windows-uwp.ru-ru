...
| Сводка | Эквивалентом UWP для элемента управления Windows Phone Silverlight Pivot является [Windows.UI.Xaml.Controls.Pivot](https://msdn.microsoft.com/library/windows/apps/dn608241). Эта функция доступна для всех семейств устройств. |
              ...
              **Примечание.**   Визуальное состояние PointerOver уместно в пользовательских шаблонах и стилях в приложениях для Windows10, но не в приложениях Windows Phone Silverlight. Есть и другие причины, по которым существующие пользовательские стили или шаблоны могут не подходить для приложений Windows10, включая используемые ключи ресурсов системы, изменения наборов визуальных состояний и улучшения производительности, внесенные в стили или шаблоны по умолчанию в Windows10. Мы рекомендуем изменить новую копию шаблона элемента управления по умолчанию для Windows10, а затем заново применить свой стиль и шаблон.
