...
#### [Используйте OpenCV с MediaFrameReader](../audio-video-camera/process-audio-frames-with-mediaframereader.md)
...
### [Введение в C++/WinRT](../cpp-and-winrt-apis/intro-to-using-cpp-with-winrt.md)
### [Начало работы с C++/WinRT](../cpp-and-winrt-apis/get-started.md)
### [Вопросы и ответы](../cpp-and-winrt-apis/faq.md)
### [Поиск и устранение неисправностей](../cpp-and-winrt-apis/troubleshooting.md)
### [Пример приложения на C++/WinRT — редактор фотографий](../cpp-and-winrt-apis/photo-editor-sample.md)
### [Обработка строк](../cpp-and-winrt-apis/strings.md)
### [Стандартные типы данных C++ и C++/WinRT](../cpp-and-winrt-apis/std-cpp-data-types.md)
### [Упаковка-преобразование и распаковка-преобразование скалярных значений в IInspectable](../cpp-and-winrt-apis/boxing.md)
### [Использование API-интерфейсов с помощью C++/WinRT](../cpp-and-winrt-apis/consume-apis.md)
### [Создание API-интерфейсов с помощью C++/WinRT](../cpp-and-winrt-apis/author-apis.md)
### [Обработка ошибок в C++/WinRT](../cpp-and-winrt-apis/error-handling.md)
...
### [Создание коллекций с помощью C++/WinRT](../cpp-and-winrt-apis/collections.md)
### [Параллельная обработка и асинхронные операции](../cpp-and-winrt-apis/concurrency.md)
### [Элементы управления XAML; привязка к свойству C++/WinRT](../cpp-and-winrt-apis/binding-property.md)
### [Элементы управления XAML; привязка к коллекции C++/WinRT](../cpp-and-winrt-apis/binding-collection.md)
### [Создание пользовательских (на основе шаблона) элементов управления XAML с помощью C++/WinRT](../cpp-and-winrt-apis/xaml-cust-ctrl.md)
### [Использование COM-компонентов с помощью C++/WinRT](../cpp-and-winrt-apis/consume-com.md)
### [Создание COM-компонентов с помощью C++/WinRT](../cpp-and-winrt-apis/author-coclasses.md)
### [Взаимодействие между C++/WinRT и C++/CX](../cpp-and-winrt-apis/interop-winrt-cx.md)
### [Переход на C++/WinRT из C++/CX](../cpp-and-winrt-apis/move-to-winrt-from-cx.md)
### [Взаимодействие между C++/WinRT и интерфейсом ABI](../cpp-and-winrt-apis/interop-winrt-abi.md)
### [Переход на C++/WinRT с WRL](../cpp-and-winrt-apis/move-to-winrt-from-wrl.md)
### [Слабые ссылки](../cpp-and-winrt-apis/weak-references.md)
...
### [Элементы управления UWP в приложениях WPF и Windows Forms](../xaml-platform/xaml-host-controls.md)
