...
-   [Сравнение OpenGL ES 2.0 с Direct3D 11](#comparing-opengl-es-20-with-direct3d-11)
-   [Перенос GLSL переменных HLSL](#porting-glsl-variables-to-hlsl)
-   [Перенос GLSL типы для HLSL](#porting-glsl-types-to-hlsl)
-   [Перенос GLSL предопределенные глобальные переменные, HLSL](#porting-glsl-pre-defined-global-variables-to-hlsl)
-   [Примеры перенос GLSL переменных HLSL](#examples-of-porting-glsl-variables-to-hlsl)
    -   [Равномерное распределение атрибута и изменения в GLSL](#uniform-attribute-and-varying-in-glsl)
    -   [Константа буферов и передачи данных в HLSL](#constant-buffers-and-data-transfers-in-hlsl)
-   [Примеры перенос кода OpenGL отрисовки в Direct3D](#examples-of-porting-opengl-rendering-code-to-direct3d)
-   [Связанные разделы](#related-topics)

## <a name="comparing-opengl-es-20-with-direct3d-11"></a>Сравнение OpenGL ES 2.0 и Direct3D 11
...
> **Примечание**  HLSL имеет текстуры и пробы как две отдельные объекты. В GLSL, как в Direct3D 9, привязка текстуры является частью состояния дискретизатора.
...
<tbody>
<tr class="odd">
<td align="left"><p><strong>Универсальный код</strong></p>
...
<ul>
<li>mat2: матрица 2 x 2 число с плавающей запятой</li>
<li>mat3: Матрица 3 x 3 число с плавающей запятой</li>
<li>mat4: Матрица 4 x 4 с плавающей запятой</li>
</ul></td>
<td align="left"><p>тип матрицы</p>
<ul>
<li>float2x2</li>
...
<p>Положение вершины</p>
<p>Пример: vPosition float4: SV_Position;</p></td>
</tr>
<tr class="even">
...
<p>Значение отсутствует, если вы не используете Direct3D 9</p>
...
<p>COLOR в Direct3D 9</p>
<p>Эта семантика относится к типу <strong>float4</strong>.</p>
<p>Выходные данные построителя текстуры</p>
<p>Цвет пикселя</p>
<p>Пример: float4 цвет [4]: SV_Target;</p></td>
</tr>
<tr class="even">
...
<p>Пример: float4 позиция: SV_Position</p></td>
</tr>
<tr class="even">
