...
-   [Сравнение OpenGL ES 2.0 и Direct3D 11](#comparing-opengl-es-20-with-direct3d-11)
...
<tr class="odd">
<td align="left">Модификаторы хранилищ [переменных](#porting-glsl-variables-to-hlsl)</td>
<td align="left">Буферы констант и передачи данных через объявления входных макетов</td>
</tr>
<tr class="even">
<td align="left"><p>[Типы](#porting-glsl-types-to-hlsl)</p>
