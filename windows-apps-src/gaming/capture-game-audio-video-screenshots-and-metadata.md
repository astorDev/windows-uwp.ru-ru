...
Вы можете зарегистрировать получать уведомления о начале очистки метаданных для вашего приложения с регистрации обработчика для события **[MetadataPurged](https://docs.microsoft.com/uwp/api/windows.media.capture.appcapturemetadatawriter.MetadataPurged)** системы.
