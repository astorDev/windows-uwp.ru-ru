...
# <span id="dev_gaming.multisampling__multi-sample_anti_aliasing__in_windows_store_apps"></span> Использование множественной выборки сглаживания в приложениях универсальной платформы Windows (UWP)
