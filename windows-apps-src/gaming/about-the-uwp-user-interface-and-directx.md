...
В разделе [глоссария графики Direct3D](../graphics-concepts/index.md) сведения о незнакомы графики термины и понятия, которые могут возникнуть во время чтения.
