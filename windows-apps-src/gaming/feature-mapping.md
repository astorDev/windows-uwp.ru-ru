...
-   Сообщество [DirectX Tool Kit](https://go.microsoft.com/fwlink/p/?LinkID=248929) (Набор инструментов DirectX) предлагает вспомогательные классы для использования с Direct3D11 и приложениями UWP.
