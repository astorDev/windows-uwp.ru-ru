...
description: В документе описаны основные параметры проекта Marble Maze (использование Visual C++ в среде выполнения Windows, создание проекта, структурирование, сборка).
ms.assetid: 73329b29-62e3-1b36-01db-b7744ee5b4c3
---

# Основные характеристики примера Marble Maze
