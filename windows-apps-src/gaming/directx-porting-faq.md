...
## Для чего нужен новый контекст устройства? Нужно ли заменить устройство Direct3D 9 устройством Direct3D 11, заменить контекст устройства или и то, и другое?
...
## Есть ли способ обновить код для рабочего стола до DirectX 11 перед прекращением использования эффектов?
...
##  Существует ли путь переноса игры с DirectX 8 в UWP?
...
##  Можно ли портировать игру с DirectX 10 или 11 на UWP?
...
## При прорисовке моей игры используется многопоточность и (или) отложенная прорисовка. Что мне нужно знать, чтобы использовать Direct3D 11?
...
## Где можно найти дополнительную информацию о программируемом конвейере начиная с Direct3D 9?
...
##  Какая функция в Direct3D 11 эквивалентна функции *x*?
