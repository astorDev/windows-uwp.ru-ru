...
> **Примечание**наш код работает также с помощью мыши сдвига элементами управления. API среды выполнения Windows абстрагируют события указателя, поэтому могут обрабатывать события как сенсорного ввода, так и указателя мыши.
