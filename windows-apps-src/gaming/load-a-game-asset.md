...
-   После этого последующие биты (Нумвертицес \* sizeof (**басиквертекс**)) содержат данные вершин.
-   Последние (Нуминдицес \* 16) биты данных содержат индексные данные, представленные в виде последовательности значений UInt16.
