...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415762">Приступая к работе с XAudio2</a></p></td>
<td align="left"><p>В разделе представлены сведения по ключевым понятиям XAudio2, версиям XAudio2 и формату аудио RIFF.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415692">Общие аудио основные понятия программирования</a></p></td>
<td align="left"><p>В разделе представлен обзор общих понятий аудио, с которыми должен быть знаком разработчик аудио.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415825">Голоса XAudio2</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415745">Обратные вызовы XAudio2</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415739">Графы аудио XAudio2</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415756">Звуковые эффекты XAudio2</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415821">Потоковая передача аудио данных с помощью XAudio2</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415899">Справочник по программированию XAudio2</a></p></td>
...
<tbody>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415779">Инструкции: Инициализировать XAudio2</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415781">Инструкции: Загрузка файлов звуковые данные в XAudio2</a></p></td>
<td align="left"><p>Узнайте, как заполнять структуры, необходимые для воспроизведения звуковых данных в XAudio2.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415787">Инструкции: Воспроизведение звука с XAudio2</a></p></td>
<td align="left"><p>Узнайте, как воспроизвести предварительно загруженные звуковые данные в XAudio2.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415794">Инструкции: Использовать Submix голоса</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415769">Инструкции: Использовать обратные вызовы голосовой источника</a></p></td>
<td align="left"><p>Узнайте, как использовать обратные вызовы речевых источников в XAudio2.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415774">Инструкции: Использовать обратные вызовы ядра</a></p></td>
<td align="left"><p>Узнайте, как использовать обратные вызовы модуля в XAudio2.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415767">Инструкции: Построить график базовую обработку аудио</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415772">Инструкции: Динамически добавить или удалить голоса из графа аудио</a></p></td>
<td align="left"><p>Узнайте, как добавить или удалить голоса submix из графа, который был создан, описанные в <a href="https://msdn.microsoft.com/library/windows/desktop/ee415767">как: Построить график базовую обработку аудио</a>.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415789">Инструкции: Создать цепочку эффект</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415730">Инструкции: Создание XAPO</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415728">Инструкции: Добавлена поддержка параметров времени выполнения в XAPO</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415733">Инструкции: Использовать XAPO в XAudio2</a></p></td>
<td align="left"><p>Узнайте, как применять эффект, реализованный как XAPO, в цепи эффектов XAudio2.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415723">Инструкции: Использовать XAPOFX в XAudio2</a></p></td>
<td align="left"><p>Узнайте, как применять один из эффектов в составе XAPOFX в цепи эффектов XAudio2.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415791">Инструкции: Stream звука с диска</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415798">Инструкции: Интеграция X3DAudio с XAudio2</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415783">Инструкции: Группа аудио методы, как набор операции</a></p></td>
<td align="left"><p>Узнайте, как применять наборы операций XAudio2 для одновременного действия группы вызовов методов.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ee415765">Отладка ошибки при воспроизведении звука в XAudio2</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/dd317910">Записи аудио/видео</a></p></td>
<td align="left"><p>В разделе описано применение Microsoft Media Foundation для записи звука и видео.</p></td>
</tr>
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/dd317914">Воспроизведение аудио/видео</a></p></td>
<td align="left"><p>В разделе описана реализация воспроизведения звука/видео в вашем приложении.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/dd757927">Поддерживаемые форматы файлов мультимедиа в Media Foundation</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/dd318778">Создание файла и кодировки</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/ms704847">Справочник по программированию Media Foundation</a></p></td>
<td align="left"><p>Этот раздел содержит справочную информацию по API Media Foundation.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/desktop/aa371827">Примеры в пакете SDK Media Foundation</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="https://msdn.microsoft.com/library/windows/apps/mt282143">Приведение мультимедиа</a></p></td>
...
-   [Общие сведения о XAudio2](https://msdn.microsoft.com/library/windows/desktop/ee415813)
-   [Руководство по программированию в XAudio2](https://msdn.microsoft.com/library/windows/desktop/ee415737)
