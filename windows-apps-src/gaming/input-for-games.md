...
### <a name="flight-sticks"></a>Накопители полетов

Накопители полетов, игровые устройства ввода, воспроизвести удобство использования полетов устройства, которые можно найти в самолете или космическим кораблем на панели. Эти устройства ввода идеально подходят для быстрого и точного управления летательным аппаратом.

Дополнительные сведения по использованию полетов фиксируется в игру UWP можно [упрощенный полетов](flight-stick.md).

### <a name="raw-game-controllers"></a>Необработанные игровые устройства
...
Дополнительные сведения о том, как использовать необработанные игровые устройства в игру UWP можно [необработанные устройства](raw-game-controller.md).

### <a name="ui-navigation-controllers"></a>Пользовательский Интерфейс навигации контроллеров
