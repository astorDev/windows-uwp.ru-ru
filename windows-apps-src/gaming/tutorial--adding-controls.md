...
- Если нажимаются какие-либо входные клавиши перемещения, в соответствующий компонент **m_moveCommand** Vector &mdash; добавляются значения `1.0f` или `-1.0f`, а `1.0f` — в обратном направлении.
