...
ms.locfileid: "57608539"
---
# <a name="graphics-diagnostics-tools"></a>Средства диагностики графики



С Windows 10 средств диагностики графики теперь доступен в Windows как дополнительный компонент. Для использования функций диагностики графики в среде выполнения и в Visual Studio в целях разработки приложений или игр DirectX установите дополнительный компонент "Средства для работы с графикой".

1.  Перейдите к **параметры**выберите **приложений**, а затем нажмите кнопку **управление дополнительными компонентами**.
...
[Общие сведения о диагностике графики в Visual Studio](https://go.microsoft.com/fwlink/p/?LinkID=526382)
