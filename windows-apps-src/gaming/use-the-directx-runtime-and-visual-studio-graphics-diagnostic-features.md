...
Начиная с Windows10, средства диагностики графики доступны непосредственно в Windows в виде дополнительного компонента. Для использования функций диагностики графики в среде выполнения и в Visual Studio в целях разработки приложений или игр DirectX установите дополнительный компонент "Средства для работы с графикой".

1.  Откройте раздел **Параметры**, выберите пункт **Система**, затем **Приложения и компоненты** и **Управление дополнительными компонентами**.
