...
> **Примечание**пиксельные шейдеры уровня 9\_x не могут прочесть системного значения SV\_POSITION. Пиксельные шейдеры модели 4.0 (и выше) могут использовать SV\_POSITION для получения координат пикселя на экране, где x находится в диапазоне от 0 до ширины однобуферной прорисовки, а y находится в диапазоне от 0 до высоты однобуферной прорисовки (со смещением каждой координаты на 0,5).
