...
> **Важные**  здесь примере кода используются типы (такие как DirectX::XMFLOAT3 и DirectX::XMFLOAT4X4) и линейные методы, объявленные в DirectXMath.h. Если вы вырезаете и вставляете этот код, добавьте в свой проект объявление: \#include &lt;DirectXMath.h&gt;.
