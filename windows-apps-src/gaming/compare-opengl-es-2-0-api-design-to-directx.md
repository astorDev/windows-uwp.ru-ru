...
# Планирование переноса из OpenGL ES 2.0 в Direct3D
...
## Знакомство с уровнями компонентов Direct3D
...
## Обзор графических средств DirectX и API
...
## Обзор API среды выполнения Windows и библиотеки шаблонов
...
## Перенос OpenGL ES2.0 в Direct3D11. Вопросы и ответы
