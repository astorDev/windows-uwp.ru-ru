...
| Разработка, распространение и бета-тестирование мобильных приложений | Тестирование и распространение мобильных приложений. Управление производительностью приложений и взаимодействием с пользователем. | [HockeyApp](https://azure.microsoft.com/services/hockeyapp/)| Интеграция отчетов об аварийных завершениях и метрик пользователей с платформой для распространения приложений и сбора отзывов пользователей. Поддерживает приложения для Android, Cordova, iOS, OS X, Unity, Windows и Xamarin. Кроме того, стоит [Visual Studio Mobile Center](https://www.visualstudio.com/vs/mobile-center/) &mdash; пакет управления для приложений, которые совмещают подробную аналитику, отчеты, о сбоях Push-уведомления, распространение приложений и многое другое. |
...
* [Облачное нагрузочное тестирование в средство](https://www.visualstudio.com/team-services/cloud-load-testing/)
