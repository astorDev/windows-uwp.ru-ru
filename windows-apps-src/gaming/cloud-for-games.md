...
### <a name="step-by-step-learning-guides"></a>Пошаговые обучающие руководства
...
* [ID@Xbox](http://www.xbox.com/Developers/id)
    ...
    Если вы хотите добавить в свою игру для Windows10 возможности Xbox Live, такие как многопользовательский режим, создание игровых матчей на разных платформах, счет игрока, достижения и списки лидеров, зарегистрируйтесь в программе ID@Xbox, чтобы получить инструменты и поддержку, необходимые для успешного воплощения своих творческих идей. Перед подачей заявки на участие в программе ID@Xbox зарегистрируйте учетную запись разработчика в [Центре разработки для Windows](https://developer.microsoft.com/windows/programs/join).
