...
<table>
    ...
    <tr>
        <td><a href="https://www.tencent.com">Тенцент игры</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://customers.microsoft.com/story/tencent-telecommunications-azure-service-fabric-windows-server-en">Тенцент игры и корпорация Майкрософт выстроили решение для игр в облаке</a>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=38m33s">Создание игр с помощью Service Fabric: сведения о реализации тенцент (видео)</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://www.halowaypoint.com/">343. отрасли</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-halo-5-guardians-implemented-social-gameplay-using-azure-documentdb/">Социальные игрового процесса, реализованные с помощью Azure Cosmos DB (через API DocumentDB)</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://web.ageofascent.com/">Illyriad игры</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Shows/Cloud+Cover/Episode-228-Building-Games-with-Service-Fabric#time=06m52s">Создание игр с помощью Service Fabric: возраст жанре ММО игр (видео)</a>
                <li><a href="https://channel9.msdn.com/Events/Build/2016/KEY02#time=57m20s">Управление компонентами игр как микрослужбами с помощью Azure Service Fabric (видео)</a> 
                <li><a href="/Blogs/Azure/Age-of-Ascent-from-Illyriad-Powered-by-Azure-Service-Fabric-and-ASPNET">Собеседование с возрастными разработчиками (видео)</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="https://www.nextgames.com/">Следующие игры</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://azure.microsoft.com/blog/how-we-built-it-next-games-global-online-gaming-platform-on-azure/">Как мы создали ИТ: следующие игры — Глобальная платформа Интернет-игр в Azure (блог с видео)</a>
                <li><a href="https://azure.microsoft.com/blog/the-walking-dead-no-mans-land-game-soars-to-1-with-azure-documentdb/">Прохождение недоставленных приложений использует Azure Cosmos DB (через API DocumentDB) для ускорения цикла разработки и более привлекательных игрового процесса</a>
            </ul>
        </td>
    </tr>
    <tr>
        <td><a href="http://www.crimecoast.com/">Пиксель группа</a></td>
        ...
        <td>
            <ul>
                <li><a href="https://channel9.msdn.com/Blogs/The-Game-Blog/BizSpark-Interview-with-Pixel-Squad-How-the-used-Azure-Cloud-Services-to-make-an-MMO-with-a-3-man-te">Как преступно жанре ММО Game использует облачные службы Azure</a>
            </ul>
        </td>
    </tr> 
</table>
...
* [Hitman и Azure: создавайте такие функции игры, как целевой объект сомнительны, которые можно использовать только в облаке](https://channel9.msdn.com/Series/Hitman)
* [Azure как секретный ключ для Хитцентс, игр Труперс и Инноспарк](https://news.microsoft.com/features/game-developers-use-microsoft-azure-as-secret-sauce-for-scale-and-growth-2/)
* [Запуски игр в программе BizSpark с помощью Azure](https://blogs.technet.microsoft.com/bizspark_featured_startups/2015/09/25/azure-open-for-gaming-startups/)
...
| Возможность сбора миллионов событий в секунду с миллионов устройств                         | Обработка миллиона потоков событий в секунду, поступающих с подключенных устройств | [Центры событий Azure](https://azure.microsoft.com/services/event-hubs/) | Сбор телеметрии из игр, веб-сайтов, приложений и устройств в масштабе облака  |
...
| Разработка, распространение и бета-тестирование мобильных приложений | Тестирование и распространение мобильных приложений. Управление производительностью приложений и взаимодействием с пользователем. | [HockeyApp](https://azure.microsoft.com/services/hockeyapp/)| Интеграция отчетов об аварийных завершениях и метрик пользователей с платформой для распространения приложений и сбора отзывов пользователей. Поддерживает приложения для Android, Cordova, iOS, OS X, Unity, Windows и Xamarin. Кроме того, рассмотрим [Visual Studio Mobile Center](https://visualstudio.microsoft.com/app-center/) &mdash; элемент управления для приложений, сочетающий широкие возможности анализа, отчеты о сбоях, Push-уведомления, распространение приложений и многое другое. |
...
* Сборка 2017. [предоставление компьютерных возможностей для игр мирового класса с помощью Microsoft Azure: уроки, полученные из таких заголовков, как Halo, Hitman и прохождение (видео)](https://channel9.msdn.com/Events/Build/2017/P4062)
...
* [Игровые службы в Azure (видео)](https://channel9.msdn.com/Series/Gaming-Services-on-Azure)
...
* [Средство нагрузочного тестирования на основе облака](https://visualstudio.microsoft.com/team-services/cloud-load-testing/)
