...
##  Преимущества Windows10 для разработки игр


С появлением UWP в Windows10 ваши продукты для Windows10 можно будет использовать на всех платформах Майкрософт. Благодаря возможности бесплатного перехода с предыдущих версий Windows количество пользователей Windows10 стабильно растет. Сочетание этих двух факторов означает, что с помощью Магазина Windows ваши продукты для Windows10 увидит огромное количество клиентов.
...
Чтобы создавать игры для UWP, необходимо настроить среду разработки, установив VisualStudio2015. VisualStudio2015 позволяет создавать приложения UWP и предоставляет указанные ниже средства для разработки игр.
...
Скоро в Windows10 появится набор компонентов XboxLive, позволяющий играть в игры Xbox на различных платформах, используя при этом достижения, счет игрока и многое другое. Скоро вы сможете работать с ID@Xbox и включать Live в ваши игры UWP. Кроме того, в будущем мы будем помогать вам поставлять игры для универсальной платформы Windows на XboxOne. Дополнительные сведения см. на странице [ID@Xbox](http://www.xbox.com/developers/id).
...
Как только вы будете готовы опубликовать свою игру, вам потребуется создать учетную запись разработчика и отправить игру в МагазинWindows.

Сведения о том, как отправить игру в МагазинWindows, см. по ссылке <https://dev.windows.com/publish>.
