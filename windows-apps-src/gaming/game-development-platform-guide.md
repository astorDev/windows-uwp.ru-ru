...
##  <a name="benefits-of-windows-10-for-game-development"></a>Преимущества Windows10 для разработки игр
...
Чтобы создавать игры для UWP, необходимо настроить среду разработки, установив VisualStudio2015 или более позднюю версию. VisualStudio2015 позволяет создавать приложения UWP и предоставляет указанные ниже средства для разработки игр.
...
## <a name="windows-10-apis"></a>API Windows10
...
Сведения о том, как отправить игру в МагазинWindows, см. по ссылке [Отправка и публикация игры](e2e.md#submitting-and-publishing-your-game).
