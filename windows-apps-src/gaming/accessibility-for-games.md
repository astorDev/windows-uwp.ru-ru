...
* Мигающего света с частотой от 5 до 30вспышек в секунду (герц), потому что вспышки света с частотой в этом диапазоне с наибольшей вероятностью вызывают припадки.
* Любых последовательностей мерцающих изображений, длительность которых составляет более 5секунд.
