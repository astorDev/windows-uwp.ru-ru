...
-   Файлы ресурсов хранятся в папках с произвольными именами, но имена файлов задаются с общей меткой, которая добавляется к строкам, зарезервированным системой, для обозначения языка или других квалификаторов. В частности, строки квалификаторов добавляются в начало обобщенного имени файла после символа подчеркивания («\_»). Например, \\assets\\menu\_option1\_lang-en-us.png, \\assets\\menu\_option1\_scale-140.png, \\assets\\coolsign\_dxfl-dx11.dds. Вы также можете объединять эти строки. Например, \\assets\\menu\_option1\_scale-140\_lang-en-us.png.
    > 
            **Примечание.** Если квалификатор языка используется в имени файла, а не как отдельный элемент в имени каталога, он должен иметь вид "lang-<tag>", например "lang-en-us", как описано в статье [Именование ресурсов с помощью квалификаторов](https://msdn.microsoft.com/library/windows/apps/xaml/hh965324).
...
-   Убедитесь, что каждый ресурс или файл строкового ресурса (RESW-файл) одинаково называется в каждом каталоге. Например, файл menu\_option1.png должен иметь одно и то же имя в каталоге \\en-us и каталоге \\jp-jp даже в том случае, если содержимое этого файла относится к разным языкам. В этом случае имена будут выглядеть так: \\en-us\\menu\_option1.png и \\jp-jp\\menu\_option1.png.
    > 
            **Примечание.** При желании вы можете добавить к имени файла языковой стандарт и сохранить файлы в одном каталоге, например \\assets\\menu\_option1\_lang-en-us.png, \\assets\\menu\_option1\_lang-jp-jp.png.
...
-   Убедитесь, что каждый ресурс одинаково называется в каждом каталоге. Например, файл menu\_option1.png должен носить одно и то же имя в каталоге \\scale-100 и каталоге \\scale-180 даже в том случае, если содержимое этого файла отличается. В этом случае имена будут выглядеть так: \\scale-100\\menu\_option1.png и \\scale-140\\menu\_option1.png.
    > 
            **Примечание.** При желании вы можете дополнить имя файла суффиксом коэффициента масштабирования и сохранить файлы в одном каталоге, например, \\assets\\menu\_option1\_scale-100.png, \\assets\\menu\_option1\_scale-140.png.
...
-   Убедитесь, что каждый ресурс (если он доступен для нескольких уровней компонентов) имеет одно и то же имя в каждом каталоге. Например, файл coolsign.dds должен иметь одно и то же имя в каталоге \\dxfl-dx9 и каталоге \\dxfl-dx11 даже в том случае, если содержимое этого файла отличается. В этом случае имена будут выглядеть так: \\dxfl-dx9\\coolsign.dds и \\dxfl-dx11\\coolsign.dds.
    > 
            **Примечание.** При желании вы можете дополнить имя файла суффиксом уровня компонентов и сохранить файлы в одном каталоге, например, \\textures\\coolsign\_dxfl-dx9.dds, \\textures\\coolsign\_dxfl-dx11.dds.
