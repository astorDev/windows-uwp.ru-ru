...
-   Файлы ресурсов хранятся в папках с произвольными именами, но имена файлов задаются с общей меткой, которая добавляется к строкам, зарезервированным системой, для обозначения языка или других квалификаторов. В частности, строки квалификаторов добавляются в начало обобщенного имени файла после символа подчеркивания («\_»). Например, \\assets\\menu\_option1\_lang-en-us.png, \\assets\\menu\_option1\_scale-140.png, \\assets\\coolsign\_dxfl-dx11.dds. Вы также можете объединять эти строки. Например, \\assets\\menu\_option1\_scale-140\_lang-en-us.png.
    > **Примечание**  при использовании в имени файла, а не только в имени каталога, квалификатор языка должны иметь форму «lang -<tag>«, например «lang-en-us» как описано в [адаптация ресурсов с учетом языка, масштаба и других квалификаторов](../app-resources/tailor-resources-lang-scale-contrast.md).
...
-   Убедитесь, что каждый ресурс одинаково называется в каждом каталоге. Например, файл menu\_option1.png должен носить одно и то же имя в каталоге \\scale-100 и каталоге \\scale-180 даже в том случае, если содержимое этого файла отличается. В этом случае имена будут выглядеть так: \\scale-100\\menu\_option1.png и \\scale-140\\menu\_option1.png.
    > **Примечание**  еще раз, вы можете при необходимости суффиксом масштабирования коэффициент к имени файла и сохранять их в том же каталоге; Например \\assets\\menu\_option1\_scale-100.png, \\assets\\menu\_option1\_scale-140.png.
