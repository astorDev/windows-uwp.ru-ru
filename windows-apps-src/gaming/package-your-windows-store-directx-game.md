...
Помимо модели пакета приложения Windows10 поддерживает пакеты приложений, которые включают два типа пакетов:
...
-   Убедитесь, что каждый ресурс или файл строкового ресурса (RESW-файл) одинаково называется в каждом каталоге. Например, файл menu\_option1.png должен иметь одно и то же имя в каталоге \\en-us и каталоге \\jp-jp даже в том случае, если содержимое этого файла относится к разным языкам. В этом случае имена будут выглядеть так: \\en-us\\menu\_option1.png и \\jp-jp\\menu\_option1.png.
    > **Примечание**  при необходимости можно добавить к имени файла языковой стандарт и сохранить файлы в одном каталоге; Например \\assets\\menu\_option1\_lang-en-us.png, \\assets\\menu\_option1\_lang-jp-jp.png.
...
-   Убедитесь, что каждый ресурс одинаково называется в каждом каталоге. Например, файл menu\_option1.png должен носить одно и то же имя в каталоге \\scale-100 и каталоге \\scale-180 даже в том случае, если содержимое этого файла отличается. В этом случае имена будут выглядеть так: \\scale-100\\menu\_option1.png и \\scale-140\\menu\_option1.png.
    > **Примечание**  еще раз, вы можете при необходимости суффиксом масштабирования коэффициент имя файла и сохранять их в том же каталоге; Например \\assets\\menu\_option1\_scale-100.png, \\assets\\menu\_option1\_scale-140.png.
