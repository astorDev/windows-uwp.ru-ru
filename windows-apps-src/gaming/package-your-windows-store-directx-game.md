...
description: Размер тех игр для UWP, которые поддерживают несколько языков или включают дополнительные ресурсы, может с легкостью вырасти до больших значений.
...
-   Файлы ресурсов хранятся в папках с произвольными именами, но имена файлов задаются с общей меткой, которая добавляется к строкам, зарезервированным системой, для обозначения языка или других квалификаторов. В частности, строки квалификаторов добавляются в начало обобщенного имени файла после символа подчеркивания («\_»). Например, \\assets\\menu\_option1\_lang-en-us.png, \\assets\\menu\_option1\_scale-140.png, \\assets\\coolsign\_dxfl-dx11.dds. Вы также можете объединять эти строки. Например, \\assets\\menu\_option1\_scale-140\_lang-en-us.png.
    > **Примечание.** Если квалификатор языка используется в имени файла, а не как отдельный элемент в имени каталога, он должен иметь вид «lang-<tag>», например «lang-en-us», как описано в статье [Как присваивать имена ресурсам с помощью квалификаторов](https://msdn.microsoft.com/library/windows/apps/xaml/hh965324).
...
|------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|
| Локализованные ресурсы             | Все возможные языки или сочетания языков и языковых стандартов для Windows 10. (Префикс квалификатора «lang-» в имени папки не обязателен.) | Символ «\_», за которым указывается язык, языковой стандарт или описатель пары «язык — языковой стандарт». Например, «\_en», «\_us» или «\_en-us» соответственно. |
...
-   В Microsoft Visual Studio 2015 выберите **ПРОЕКТ -> Магазин -> Создать пакет приложения...** и создайте пакет.
