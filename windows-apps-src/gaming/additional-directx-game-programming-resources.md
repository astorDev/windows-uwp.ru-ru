...
-   [Блог Шона Харгривза (Shawn Hargreaves)]( http://go.microsoft.com/fwlink/p/?LinkID=288872), сведения об играх на платформе XNA.
...
-   [Win2D](https://github.com/Microsoft/Win2D) — это простой в использовании API среды выполнения Windows для отрисовки двумерной графики в непосредственном режиме с ускорением GPU.
