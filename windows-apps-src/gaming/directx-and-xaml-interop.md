...
> **Примечание**  прикладные интерфейсы DirectX API не определены как типы среды выполнения Windows, поэтому обычно используется Visual C++ расширения компонентов (C++/CX) для разработки XAML UWP компоненты, которые взаимодействуют с DirectX. Кроме того, вы можете создавать приложения UWP, использующие DirectX, на C# и XAML, если инкорпорируете вызовы DirectX в отдельный файл метаданных среды выполнения Windows.
...
-   Необходимо задать высоту и ширину цепочки буферов DirectX (в [DXGI\_ЗАМЕНЫ\_ЦЕПОЧКИ\_DESC1](https://docs.microsoft.com/windows/desktop/api/dxgi1_2/ns-dxgi1_2-dxgi_swap_chain_desc1)) для текущего измерения элемента цепочке замены. Если этого не сделать, отображаемое содержимое будет масштабироваться (с помощью **DXGI\_МАСШТАБИРОВАНИЕ\_STRETCH**) в соответствии с.
-   Необходимо установить режим масштабирования цепочки буферов DirectX (в [DXGI\_ЗАМЕНЫ\_ЦЕПОЧКИ\_DESC1](https://docs.microsoft.com/windows/desktop/api/dxgi1_2/ns-dxgi1_2-dxgi_swap_chain_desc1)) для **DXGI\_МАСШТАБИРОВАНИЕ\_STRETCH**.
-   Невозможно задать режим альфа-цепочки буферов DirectX (в [DXGI\_ЗАМЕНЫ\_ЦЕПОЧКИ\_DESC1](https://docs.microsoft.com/windows/desktop/api/dxgi1_2/ns-dxgi1_2-dxgi_swap_chain_desc1)) для **DXGI\_альфа-канал\_режим\_ Заранее УМНОЖЕННЫЕ**.
...
* [Руководство по программированию для Direct3D 11](https://docs.microsoft.com/windows/desktop/direct3d11/dx-graphics-overviews)
