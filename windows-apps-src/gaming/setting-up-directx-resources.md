...
description: Мы покажем, как создать устройство Direct3D, цепочку буферов и представление объекта обработки и как представить обработанное изображение для отображения.
