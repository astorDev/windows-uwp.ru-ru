...
Если вы объявите [**ID3D11RenderTargetView**](https://msdn.microsoft.com/library/windows/desktop/ff476582) с помощью ComPtr, то сможете затем использовать метод **GetAddressOf** шаблона ComPtr, чтобы передать адрес указателя на **ID3D11RenderTargetView** (**ID3D11RenderTargetView) методу [**ID3D11DeviceContext::OMSetRenderTargets**](https://msdn.microsoft.com/library/windows/desktop/ff476464). Метод **OMSetRenderTargets** привязывает однобуферную прорисовку к [стадии слияния вывода](https://msdn.microsoft.com/library/windows/desktop/bb205120), чтобы указать однобуферную прорисовку в качестве цели вывода.
