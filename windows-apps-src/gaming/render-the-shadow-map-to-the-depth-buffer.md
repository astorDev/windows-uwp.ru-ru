...
**Оптимизируйте усеченная:**  Убедитесь, что реализация вычисляет тесной усеченная таким образом, вы сможете получить максимальную точность ваш буфер глубины. Другие советы по работе с тенями см. в разделе о [распространенных методиках улучшения карт глубин теней](https://msdn.microsoft.com/library/windows/desktop/ee416324).
