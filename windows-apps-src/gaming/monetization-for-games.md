...
Кампании-распродажи можно планировать заранее, указывая начальную и конечную дату распродажи. Подробнее см. в статье [Выставление приложений и надстроек на продажу](https://docs.microsoft.com/windows/uwp/publish/put-apps-and-add-ons-on-sale).
...
Если вы связали решение с опубликованной игрой, активной и доступной в Магазине, у вашего решения будет активная лицензия; это значит, что вы на один шаг ближе к созданию надстроек для своей игры. Подробнее см. в статье [Создание пакетов приложений](https://docs.microsoft.com/windows/uwp/packaging/index).
