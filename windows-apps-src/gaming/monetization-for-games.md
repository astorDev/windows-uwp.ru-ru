...
По умолчанию приложение будет отображать рекламу из сети платной рекламы корпорации Майкрософт. Чтобы максимально увеличить доход от рекламы, можно использовать рекламный посредник для группы объявлений в целях показа рекламы из дополнительных платных рекламных сетей. Подробнее о предложениях, имеющихся на данный момент, см. руководстве по использованию [рекламных посредников](../publish/monetize-with-ads.md#ad-mediation).

### <a name="which-markets-allow-ads-to-be-displayed"></a>На каких рынках разрешено показывать рекламу?

Полный список стран и регионов, которые поддерживают рекламу, см. в статье [Поддерживаемые рынки для рекламных сетей](../publish/monetize-with-ads.md#network-markets).
