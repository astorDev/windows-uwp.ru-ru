...
* Помещение игры в Microsoft Store, это предложение защищенной, Интернет-магазине [распространения по всему миру](#worldwide-distribution-channel). Пользователи по всему миру смогут купить вашу игру в Интернете по [установленной вами цене](#set-a-price-for-your-game).
...
В Microsoft Store можно сделать игры доступными для скачивания в более чем 200 странах и регионах по всему миру, с поддержкой различных видов оплаты, включая такие как Visa, Mastercard и PayPal. Полный список стран и регионов см. в разделе [Выбор определенных стран](https://msdn.microsoft.com/windows/uwp/publish/define-pricing-and-market-selection).
...
Также оно предусматривает совместимость с будущими продуктами и компонентами, которые поддерживаются в центр партнеров и магазином. При разработке игр для предыдущих версий Windows 10 используйте вместо него пространство имен [Windows.ApplicationModel.Store](https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.store.aspx).
...
3. Для __требуется сборку пакетов для отправки в Microsoft Store?__ параметр, выберите __Да__.
...
4. Настройте эту новую отправку. На странице отправки:
    * Щелкните __Цены и доступность__. В разделе " __видимость__ " выберите «__Скрыть это приложение и запретить его покупку …__» убедитесь, что только вашей команды разработчиков имеет доступ к игре. Подробнее см. в статье [Распространение и видимость](https://msdn.microsoft.com/windows/uwp/publish/set-app-pricing-and-availability#distribution-and-visibility).
...
2. Войдите в свою учетную запись разработчика центр партнеров и выберите имя приложения, чтобы связать это решение.
