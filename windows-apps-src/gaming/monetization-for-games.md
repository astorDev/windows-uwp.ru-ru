...
Он также предназначен для обеспечения совместимости с типами будущих продуктов и функций, поддерживаемых в центре партнеров и Store. При разработке игр для предыдущих версий Windows 10 используйте вместо него пространство имен [Windows.ApplicationModel.Store](https://docs.microsoft.com/uwp/api/windows.applicationmodel.store).
...
4. Настройте эту новую отправку. На странице отправки:
    * Щелкните __Цены и доступность__. В __видимость__ выберите "__скрыть это приложение и предотвратить получение...__ "для обеспечения только разработки команда имеет доступ к игре. Подробнее см. в статье [Распространение и видимость](https://docs.microsoft.com/windows/uwp/publish/set-app-pricing-and-availability).
...
* [Листинг Store](https://docs.microsoft.com/windows/uwp/publish/create-add-on-store-listings)

Если игры есть надстройки, вы их можно создать программным способом с помощью __API отправки Microsoft Store__. Дополнительные сведения см. в разделе [Создание и управление отправкой, с помощью служб Microsoft Store](https://docs.microsoft.com/windows/uwp/monetize/create-and-manage-submissions-using-windows-store-services).
...
* [Создать рекламные объявления в XAML и .NET](https://docs.microsoft.com/windows/uwp/monetize/adcontrol-in-xaml-and--net)
* [Создать рекламные объявления в HTML5 и JavaScript](https://docs.microsoft.com/windows/uwp/monetize/adcontrol-in-html-5-and-javascript)
* [Создание вставки рекламы](https://docs.microsoft.com/windows/uwp/monetize/interstitial-ads)
* [Создание собственного рекламы](https://docs.microsoft.com/windows/uwp/monetize/native-ads)
...
* [Рекомендации по рекламные объявления](https://docs.microsoft.com/windows/uwp/monetize/ui-and-user-experience-guidelines)
...
* [Типы учетных записей, расположений и оплате](https://docs.microsoft.com/windows/uwp/publish/account-types-locations-and-fees)
...
* [Реализуйте пробную версию приложения](https://docs.microsoft.com/windows/uwp/monetize/implement-a-trial-version-of-your-app)
* [Запустите приложение экспериментов с A / B-тестирование](https://docs.microsoft.com/windows/uwp/monetize/run-app-experiments-with-a-b-testing)
