...
Теперь вы знаете, с чего начать. Остается добавить к этому знания и навыки разработки игр для Магазина Windows.

Сведения о портировании существующей игры см. в следующих разделах.

-   [Перенос из OpenGL ES 2.0 в Direct3D 11.1](port-from-opengl-es-2-0-to-directx-11-1.md)
-   [Перенос из DirectX 9 на универсальную платформу Windows](porting-your-directx-9-game-to-windows-store.md)
