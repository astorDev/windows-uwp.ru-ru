...
-   [Загрузите Microsoft Visual Studio 2015](https://visualstudio.microsoft.com/vs/). Visual Studio 2015 содержит средства для программирования графики, такие как средства отладки. Обзор графических и игровых компонентов и инструментов DirectX можно просмотреть в разделе об [инструментах Visual Studio для разработки игр DirectX](set-up-visual-studio-for-game-development.md).
...
-   [Порт с OpenGL ES 2,0 до Direct3D 11,1](port-from-opengl-es-2-0-to-directx-11-1.md)
-   [Порт с DirectX 9 на универсальная платформа Windows](porting-your-directx-9-game-to-windows-store.md)
