...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/winrt-components/creating-windows-runtime-components-in-cpp">Создание компонентов среда выполнения Windows</a></td>
    </tr>
</table>
