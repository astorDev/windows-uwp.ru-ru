...
Надстройки (продукта из приложения) — это дополнительный который игроки могут приобрести в игре. Надстройки может быть разными уровнями игры, элементы или все остальное, что может понравиться игрокам. Использовать соответствующим образом, надстроек могут приносить прибыль, при этом улучшая игровой процесс. Определение и публиковать игры надстройки через Центр партнеров и покупок из приложения в коде вашей игры.
...
<table>
    ...
    <tr>
        <td>Центр партнеров расширенная публикация (GDN)</td>
    ...
    <tr>
        <td>Использовать Azure Active Directory (AAD) для добавления пользователей в вашей учетной записи центра партнеров</td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/Build/2017/B8093">Распространение приложений UWP следующего поколения: создание расширяемый, поток может componentizedapps</a></td>
    </tr>
    <tr>
