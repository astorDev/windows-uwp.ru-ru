...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.microsoft.com/windows/apps">Инструкции к приложениям для Windows 10</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/desktop/directx">Графика и игры DirectX</a></td>
    </tr>
    <tr>
        <td>Azure для игр</td>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/xbox-apps/index">Создание приложений UWP для Xbox One</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/">Руководство по Xbox Live для разработчиков</a></td>
    </tr>
    <tr>
...
#### <a name="xbox-live-creators-program"></a>Программа Xbox Live Creators
...
Если вы хотите получить доступ к еще более возможностям Xbox Live, специальной поддержке по маркетингу и разработке, а также в основном магазине Xbox One, примените к [ID@Xbox](https://www.xbox.com/Developers/id) программе.
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://www.xbox.com/Developers/id">Программа независимых разработчиков для Xbox One</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="../get-started/get-started-tutorial-game-js3d.md">Создание трехмерной игры на языке JavaScript с использованием библиотеки three.js</a></td>
    </tr>
    <tr>
        <td>Пример 2D-игры UWP на MonoGame</td>
        <td><a href="../get-started/get-started-tutorial-game-mg2d.md">Создание игры UWP на двухмерной платформе MonoGame</a></td>
    </tr>      
</table>

### <a name="developer-forums"></a>Форумы разработчиков

Форумы для разработчиков — это отличное место для запроса и ответа на вопросы о разработке игр и связи с сообществом разработчиков игр. Форумы также могут стать отличнейшим источником уже готовых ответов на сложные вопросы, с которыми разработчики сталкивались ранее и успешно решали.
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=windowsstore%2Cwpsubmit%2Caiaads%2Caiasdk%2Caiamgr">Публикация и реклама в приложениях</a></td>
    </tr>
    <tr>
        <td>Форум разработчиков приложений UWP</td>
        <td><a href="https://docs.microsoft.com/answers/topics/uwp.html">Разработка приложений универсальной платформы Windows</a></td>
    </tr>
    <tr>
        <td>Форумы разработчиков классических приложений</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=windowsgeneraldevelopmentissues">Форумы, посвященные классическим приложениям для Windows</a></td>
    </tr>
    <tr>
        <td>Игры Microsoft Store на базе DirectX (архив записей форума)</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=wingameswithdirectx">Создание игр Microsoft Store на базе DirectX (архив)</a></td>
    </tr>
    <tr>
        <td>Форум разработчиков для управляемых партнеров Windows 10</td>
        <td><a href="https://forums.xboxlive.com/users/login.html">Форумы разработчиков для XBOX: Windows 10</a></td>
    </tr>
    <tr>
        <td>Форум Xbox Live</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en/home?forum=xboxlivedev">Форум по разработке для Xbox Live</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://devblogs.microsoft.com/visualstudio/">Блог о средствах для разработчиков</a></td>
    </tr>
    <tr>
        <td>Блог о средствах разработчика Somasegar</td>
        <td><a href="https://devblogs.microsoft.com/somasegar/">Блог Somasegar</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://devblogs.microsoft.com/pix/">Оптимизация производительности и отладка игр на основе DirectX 12 для Windows и Xbox</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/gaming/monetization-for-games">Монетизация для игр</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="directx-programming.md">Программирование для DirectX</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.mozilla.org/docs/Web">Справочник по HTML и модели DOM</a></td>
    </tr>
    <tr>
...
 
####Объединение технологий представления
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx">Справочник по языку C++ (C++/CX)</a></td>
    </tr>
    <tr>
        <td>Справочник и руководство по программированию на Visual C++</td>
        <td><a href="https://docs.microsoft.com/cpp/visual-cpp-in-visual-studio">Visual C++ в Visual Studio 2019</a></td>
    </tr>
</table>
 
#### C#
...
При использовании DirectX для игры необходимо выбрать версию, которая будет использоваться: Microsoft Direct3D 12 или Microsoft Direct3D 11.
...
<table>
    ...
    <tr>
        <td>Мосты UWP</td>
        <td><a href="https://developer.microsoft.com/windows/bridges">Используйте свой код при разработке для Windows</a></td>
    </tr>
    <tr>
        <td>Мост Windows для iOS</td>
        <td><a href="https://developer.microsoft.com/windows/bridges/ios">Перенос приложений для iOS в Windows</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://unity.com/">Unity — игровой движок</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/gaming/missing-dot-net-apis-in-unity-and-uwp">Отсутствуют интерфейсы API .NET в Unity и UWP</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/porting/w8x-to-uwp-root">Переход со среды выполнения Windows 8.x на UWP</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://developer.xboxlive.com/platform/development/education/Documents/Porting%20from%20Xbox%20One%20to%20Windows%2010.aspx">Перенос из Xbox One в UWP для Windows 10</a></td>
    </tr>
    <tr>
        <td>Перенос из DirectX 9 в DirectX 11</td>
        <td><a href="porting-your-directx-9-game-to-windows-store.md">Перенос из DirectX 9 на универсальную платформу Windows (UWP)</a></td>
    </tr>
    <tr>
        <td>Перенос из Direct3D 11 в Direct3D 12</td>
        <td><a href="https://docs.microsoft.com/windows/desktop/direct3d12/porting-from-direct3d-11-to-direct3d-12">Перенос из Direct3D 11 в Direct3D 12</a></td>
    </tr>
    <tr>
        <td>Перенос из OpenGL ES в Direct3D 11</td>
        <td><a href="port-from-opengl-es-2-0-to-directx-11-1.md">Перенос из OpenGL ES 2.0 в Direct3D 11</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/uwp/win32-and-com/win32-and-com-for-uwp-apps">Альтернативы Windows API в приложениях универсальной платформы Windows (UWP)</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/get-started/whats-a-uwp">Что такое приложение универсальной платформы Windows?</a></td>
    </tr>
    <tr>
        <td>Обзор UWP</td>
...
 
###Начало работы с разработке UWP
...
### <a name="windows-desktop-apisto-uwp"></a>API для переноса классических приложений для Windows на UWP
...
<table>
    ...
    <tr>
        <td>среда выполнения Windows API для Win32 и COM API</td>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/cpp/cppcx/crt-functions-not-supported-in-universal-windows-platform-apps">Функции CRT, которые не поддерживаются в приложениях универсальной платформы Windows</a></td>
    </tr>
    <tr>
        <td>Альтернативы API Windows</td>
        <td><a href="https://docs.microsoft.com/uwp/win32-and-com/alternatives-to-windows-apis-uwp">Альтернативы Windows API в приложениях универсальной платформы Windows (UWP)</a></td>
    </tr>
</table>
 
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/visualstudio/debugger/how-to-trigger-suspend-resume-and-background-events-for-windows-store-apps-in-visual-studio?view=vs-2015">Активация событий приостановки, возобновления и перевода в фоновый режим для приложений UWP в Visual Studio</a></td>
    </tr>
</table>
 
###Проектирование UX для игр
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/launch-resume/index">Руководство по взаимодействию с пользователем — запуск, приостановка и возобновление работы приложения</a></td>
    </tr>
    <tr>
...
 
####Цветовая рекомендация и палитра
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://cmsresources.windowsphone.com/devcenter/common/resources/content/101_BestPractices_Typography.pdf">Рекомендации: оформление текста</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://cmsresources.windowsphone.com/devcenter/common/resources/content/101_BestPractices_UI_Map.pdf">Рекомендации: карта пользовательского интерфейса</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/desktop/xaudio2/xapo-overview">Обзор протокола XAPO</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-002">Новые возможности пространственного звука для Xbox и Windows</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/desktop/direct3d12/directx-12-programming-environment-set-up">Настройка среды для программирования с помощью Direct3D 12</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/desktop/direct3d12/important-changes-from-directx-11-to-directx-12">Важные изменения при переходе с Direct3D 11 на Direct3D 12</a></td>
    </tr>
    <tr>
        <td>Перенос из Direct3D 11 в Direct3D 12</td>
        <td><a href="https://docs.microsoft.com/windows/desktop/direct3d12/porting-from-direct3d-11-to-direct3d-12">Перенос из Direct3D 11 в Direct3D 12</a></td>
...
 
####Комплект инструментов и библиотеки DirectX
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://blogs.msdn.microsoft.com/tiles_and_toasts/2015/06/30/adaptive-tile-templates-schema-and-documentation/">Шаблоны адаптивных плиток: схема и документация</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://marketplace.visualstudio.com/items?itemName=shenchauhan.UWPTileGenerator">Средство для создания всех необходимых плиток с использованием одного изображения</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/monetize/enable-in-app-product-purchases">Поддержка покупки продуктов из приложения</a></td>
    </tr>
    <tr>
        <td>Использующиеся надстройки</td>
        <td><a href="https://docs.microsoft.com/windows/uwp/monetize/enable-consumable-in-app-product-purchases">Поддержка покупки продуктов из приложения</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://azure.microsoft.com/services/devops/test-plans/">Нагрузочное тестирование в облаке</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://developer.microsoft.com/windows/downloads/windows-10-sdk">Пакет средств разработки Windows 10</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>PIX в Windows</td>
        <td><a href="https://devblogs.microsoft.com/pix/introducing-pix-on-windows-beta/">Средство оптимизации производительности и отладки для DirectX 12 в Windows</a></td>
    </tr>
    <tr>
        <td>Средства отладки и проверки для разработки на базе D3D12 (видео)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2017/GDC2017-003">Настройка производительности и отладка D3D12 с помощью PIX и проверки графического процессора</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/desktop/direct3d12/direct3d-12-graphics">Руководство по программированию для Direct3D 12</a></td>
    </tr>
    <tr>
        <td>Сочетание DirectX и XAML</td>
        <td><a href="directx-and-xaml-interop.md">Взаимодействие DirectX и XAML</a></td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/globalizing/globalizing-portal">Руководство по разработке для глобальной аудитории</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/Build/2017/B8093">Распространение приложений UWP следующего поколения: создание расширяемых приложений с поддержкой потоков на основе компонентов</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/msix/package/create-app-package-with-makeappx-tool">Создание пакетов с помощью упаковщика MakeAppx.exe</a></td>
    </tr>
    <tr>
        <td>Цифровая подпись файлов с помощью SignTool</td>
        <td><a href="https://docs.microsoft.com/windows/desktop/SecCrypto/signtool">Подпись файлов и проверка подписи с помощью SignTool</a></td>
    </tr>    
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/legal/windows/agreements/app-developer-agreement">Соглашение с разработчиком приложения</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/publish/avoid-common-certification-failures">Недопущение распространенных ошибок при сертификации</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/uwp/schemas/storemanifest/storemanifestschema2015/schema-root">Схема манифеста Магазина (Windows 10)</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="../publish/xbox-analytics-report.md">Аналитический отчет для Xbox</a></td>
    </tr>
    <tr>
        <td>Ответ на отзывы клиентов</td>
        <td><a href="https://docs.microsoft.com/windows/uwp/publish/respond-to-customer-reviews">Реакция на отзывы пользователей</a></td>
    </tr>
    <tr>
...
Статистика Visual Studio Application Insights позволяет получать аналитические сведения о производительности, телеметрии и использовании опубликованной игры. Статистика Application Insights помогает обнаруживать и устранять проблемы после выхода игры, постоянно контролировать и совершенствовать игровой процесс, понимать характер взаимодействия игроков с игрой. Для работы Application Insights в приложение необходимо добавить пакет SDK, который отправляет данные телеметрии на [портал Azure](https://portal.azure.com/).
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/publish/package-version-numbering">Руководство по управлению пакетами приложения</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/index.md">Руководство по Xbox Live для разработчиков</a></td>
    </tr>
    <tr>
        <td>Описание функций, доступных в разных программах</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/developer-program-overview.md#feature-table">Обзор программ для разработчиков: таблица функций</a></td>
    </tr>
    <tr>
        <td>Ссылки на полезные ресурсы для разработки игр для Xbox Live</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/xbox-live-resources.md">Ресурсы по Xbox Live</a></td>
    </tr>
    <tr>
        <td>Получение данных от служб Xbox Live</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/introduction-to-xbox-live-apis.md">Введение в API-интерфейсы Xbox Live</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>Обзор</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-creators/get-started-with-xbox-live-creators.md">Начало работы с программой Xbox Live Creators Program</a></td>
    </tr>
    <tr>
        <td>Добавление Xbox Live в игру</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-creators/creators-step-by-step-guide.md">Пошаговое руководство по интеграции с программой Xbox Live Creators Program</a></td>
    </tr>
    <tr>
        <td>Добавление Xbox Live в игру UWP, созданную с помощью Unity</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-creators/develop-creators-title-with-unity.md">Начало разработки игры в рамках программы Xbox Live Creators Program с помощью игрового движка Unity</a></td>
    </tr>
    <tr>
        <td>Создание песочницы для разработки</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-creators/xbox-live-sandboxes-creators.md">Основные сведения о песочницах Xbox Live</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>Обзор</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-partner/get-started-with-xbox-live-partner.md">Начало работы с Xbox Live в качестве управляемого партнера или разработчика ID</a></td>
    </tr>
    <tr>
        <td>Добавление Xbox Live в игру</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-partner/partners-step-by-step-guide.md">Пошаговое руководство по интеграции Xbox Live для управляемых партнеров и членов ID</a></td>
    </tr>
    <tr>
        <td>Добавление Xbox Live в игру UWP, созданную с помощью Unity</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-partner/partner-unity-uwp-il2cpp.md">Добавление поддержки Xbox Live в Unity для UWP с использованием сервера сценариев IL2CPP для участников с ID и управляемых партнеров</a></td>
    </tr>
    <tr>
        <td>Создание песочницы для разработки</td>
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/get-started-with-partner/advanced-xbox-live-sandboxes.md">Расширенные сведения о песочницах Xbox Live</a></td>
    </tr>
    <tr>
        <td>Требования к играм, использующим Xbox Live (GDN)</td>
        <td><a href="https://edadfs.partners.extranet.microsoft.com/adfs/ls/?wa=wsignin1.0&wtrealm=https%3a%2f%2fdeveloper.xboxlive.com&wctx=rm%3d0%26id%3dpassive%26ru%3d%252fen-us%252flive%252fcertification%252frequirements%252fPages%252fTCR.aspx&wct=2019-11-20T19%3a55%3a26Z">Требования к Xbox для Xbox Live в Windows 10</a></td>
    </tr>
    <tr>
        <td>Примеры</td>
