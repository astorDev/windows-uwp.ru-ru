...
<table>
    ...
    <tr>
        ...
        <td>[Реализация явного многоадаптерного приложения с помощью DirectX 12](https://software.intel.com/en-us/articles/multi-adapter-support-in-directx-12)</td>
    </tr>
    <tr>
        <td>Intel: учебник по DirectX 12</td>
        <td>[Совместный технический документ Intel, Suzhou Snail и Майкрософт](https://software.intel.com/en-us/articles/tutorial-migrating-your-apps-to-directx-12-part-1)</td>
    </tr>
</table>
