...
<table>
    ...
    <tr>
        ...
        <td><a href="https://go.microsoft.com/fwlink/p/?LinkID=526271">Независимая программа для разработчиков Xbox One</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://social.msdn.microsoft.com/Forums/en-us/home?category=windowsapps">Публикация и реклама в приложениях</a></td>
    </tr>
    <tr>
        <td>Форум разработчиков приложений UWP</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en-us/home?forum=wpdevelop">Разработка приложений универсальная платформа Windows</a></td>
    </tr>
    <tr>
        <td>Форумы разработчиков классических приложений</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/en-us/home?category=windowsdesktopdev">Форумы для классических приложений Windows</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>Учебник. Создание игры DirectX UWP</td>
        <td><a href="tutorial--create-your-first-uwp-directx-game.md">Создание простой игры UWP c использованием DirectX</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/winrt-components/creating-windows-runtime-components-in-cpp">Среда выполнения Windows компонентов с C++помощью/CX</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.xboxlive.com/en-us/platform/development/education/Documents/Porting%20from%20Xbox%20One%20to%20Windows%2010.aspx">Перенос из Xbox One в Windows 10 UWP</a></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><a href="https://go.microsoft.com/fwlink/p/?linkid=618387">ПОД</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/cpp/porting/how-to-use-existing-cpp-code-in-a-universal-windows-platform-app">Практическое руководство. Использование существующего C++ кода в приложении UWP</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://go.microsoft.com/fwlink/?LinkId=535007">Рекомендации: Typography</a></td>
    </tr>
</table>
 
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://go.microsoft.com/fwlink/?LinkId=535008">Рекомендации: Схема пользовательского интерфейса</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Better-Power-Better-Performance-Your-Game-on-DirectX12">Улучшенная мощность, лучшая производительность: Ваша игра на DirectX 12</a></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://go.microsoft.com/fwlink/?LinkId=248929">директкстк</a></td>
    </tr>
    <tr>
        <td>Получить набор инструментов DirectX для DirectX 12</td>
        <td><a href="https://go.microsoft.com/fwlink/?LinkID=615561">Директкстк 12</a></td>
    </tr>
    <tr>
        <td>Получить библиотеку обработки текстур DirectX</td>
        <td><a href="https://go.microsoft.com/fwlink/?LinkId=248926">директкстекс</a></td>
    </tr>
    <tr>
        <td>Получить библиотеку обработки геометрии DirectXMesh</td>
        <td><a href="https://go.microsoft.com/fwlink/?LinkID=324981">директксмеш</a></td>
    </tr>
    <tr>
        <td>Получить библиотеку UVAtlas для создания и упаковывания атласа текстуры isochart.</td>
        <td><a href="https://go.microsoft.com/fwlink/?LinkID=512686">уватлас</a></td>
    </tr>
    <tr>
        <td>Получить библиотеку DirectXMath</td>
        <td><a href="https://go.microsoft.com/fwlink/?LinkID=615560">директксмас</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        <td>Сервер Поддержка нескольких адаптеров в DirectX 12</td>
    ...
    <tr>
        <td>Сервер Руководство по DirectX 12</td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.xboxlive.com/en-us/windows/documentation/Pages/home.aspx">Расширенное руководством по публикации в центре партнеров</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/Build/2017/B8093">Распространение приложений UWP NextGen Firewall: Создание расширяемых, поддерживающих поток, компонентных приложений</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/gaming/xbox-live/developer-program-overview.md#feature-table">Обзор программы для разработчиков: Таблица функций</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://go.microsoft.com/fwlink/?LinkId=533217">Требования к Xbox Live в Windows 10</a></td>
    </tr>
    <tr>
        <td>Примеры</td>
    ...
    <tr>
        ...
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Xbox-Live-Multiplayer-Introducing-services-for-cross-platform-matchmaking-and-gameplay">Многопользовательский режим Xbox LIVE: Знакомство со службами для кросс-платформенных координирующему и игрового процесса</a></td>
    </tr>
    <tr>
        <td>Многопользовательские игры на разных устройствах в Fable Legends (видео)</td>
        <td><a href="https://channel9.msdn.com/Events/GDC/GDC-2015/Fable-Legends-Cross-device-Gameplay-with-Xbox-Live">Условные обозначения фабле: Игрового процесса между устройствами с помощью Xbox Live</a></td>
    </tr>
    <tr>
