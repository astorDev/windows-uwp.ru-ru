...
<table>
    ...
    <tr>
        ...
        <td><a href="https://social.msdn.microsoft.com/Forums/home?forum=wpdevelop">Разработка приложений универсальной платформы Windows</a></td>
    </tr>
    <tr>
        <td>Форумы разработчиков классических приложений</td>
        <td><a href="https://social.msdn.microsoft.com/Forums/home?category=windowsdesktopdev">Форумы, посвященные классическим приложениям для Windows</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://developer.mozilla.org/en-US/docs/Web">Справочник по HTML и модели DOM</a></td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://docs.microsoft.com/windows/uwp/networking/index">Сеть и веб-службы</a></td>
    </tr>
    <tr>
