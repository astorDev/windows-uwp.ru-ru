...
<table>
    ...
    <tr>
        <td>ID@Xbox — программа для разработчиков</td>
        <td>[Программа независимых разработчиков для Xbox One](http://go.microsoft.com/fwlink/p/?LinkID=526271)</td>
    </tr>
    <tr>
        <td>ID@Xbox — сайт для потребителей</td>
        <td>[ID@Xbox](http://www.idatxbox.com/)</td>
    </tr>
</table>

#### <a name="xbox-live-creators-program"></a>Программа создателей Xbox Live

На данный момент доступна ознакомительная версия программы создателей Xbox Live. Эта программа позволяет любому интегрировать Xbox Live в свой заголовок и опубликовать в Xbox One и Windows 10. Чтобы приступить к разработке по программе создателей Xbox Live, зарегистрируйтесь в ознакомительной версии. В настоящее время регистрация в предварительной версии программы ограничена, однако периодически будут предоставляться дополнительные места.

Если вы хотите иметь доступ к еще большим возможностям Xbox Live, находиться в основном магазине Xbox One или получать специальную маркетинговую поддержку и поддержку при разработке, примите участие в программе [ID@Xbox](http://www.xbox.com/Developers/id).
...
<table>
    ...
    <tr>
        <td>Ознакомительная версия программы создателей Xbox Live</td>
        <td>[Интегрировать Xbox Live в ваш заголовок](https://developer.microsoft.com/games/xbox/xboxlive/creator)</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>ID@Xbox Блог разработчиков</td>
        <td>[ID@XBOX Блог разработчиков](http://www.idatxbox.com/category/developer-blog/)</td>
    </tr>
</table>
