...
# Руководство по разработке игр для Windows 10
...
<table>
    ...
    <tr>
        ...
        <td>[Разработка игр для Windows 10](http://channel9.msdn.com/Events/GDC/GDC-2015/Developing-Games-for-Windows-10)</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Игры в экосистеме Майкрософт (видео)</td>
        <td>[Будущее игр в экосистеме Майкрософт](http://channel9.msdn.com/Events/GDC/GDC-2015/The-Future-of-Gaming-Across-the-Microsoft-Ecosystem)</td>
    </tr>
</table>
...
Direct3D 11.3 — низкоуровневый графический API, использующий знакомую модель программирования Direct3D. Direct3D 11 по-прежнему используется в универсальных приложениях для Windows, и вы получите доступ к новым функциям рендеринга и оптимизации, добавленным в Direct3D 11.3.

Direct3D 12 — новинка в Windows 10, представляющая новую модель конвейерного программирования. Direct3D 12 ближе к оборудованию, менее абстрактен, позволяет лучше управлять использованием ресурсов игры. Direct3D 12 повышает эффективность ЦП, GPU и питания.

Если у вас уже есть игровой движок, написанный в Direct3D 11, и вы пока не готовы переходить на Direct3D 12, можно использовать Direct3D 11 на 12 для некоторого повышения производительности и подготовки к переходу на Direct3D 12.
...
<table>
    ...
    <tr>
        ...
        <td>[Что такое Direct3D 12?](https://msdn.microsoft.com/library/windows/desktop/dn899228)</td>
    </tr>
    <tr>
...
Unity 5 — это следующее поколение удостоенной наград платформы для разработки двух- и трехмерных игр и интерактивных элементов. Unity 5 предлагает новые художественные инструменты, расширенные графические возможности и повышенную эффективность.
...
Unreal Engine 4 — это полный набор средств разработки любых игр любыми разработчиками. Unreal Engine используется разработчиками игр по всему миру для наиболее требовательных игр для консолей и компьютеров. Участники [программы раннего доступа к DirectX 12](#dxeap), подписавшиеся на Unreal Engine 4, получат доступ к проекту разработки Unreal Engine 4.4, который поддерживает DirectX 12.
...
<table>
    ...
    <tr>
        ...
        <td>[Переход с Windows Phone Silverlight на UWP](https://msdn.microsoft.com/library/windows/apps/mt238323)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Перенос из DirectX 9 на универсальную платформу Windows (UWP)](porting-your-directx-9-game-to-windows-store.md)</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>[Перенос из OpenGL ES 2.0 в Direct3D 11](port-from-opengl-es-2-0-to-directx-11-1.md)</td>
    </tr>
    <tr>
...
Набор инструментов DirectX, библиотека обработки текстур DirectX и библиотека обработки геометрии DirectXMesh содержат текстуры, сетки, спрайты и другие служебные функции и вспомогательные классы для разработки DirectX. Эти библиотеки могут сэкономить много времени и сил, которые вы потратили бы, реализуя данные функции самостоятельно. Хотя эти библиотеки создавались в основном для Direct3D 11, часть этих библиотек также работает в Direct3D 12.
...
<table>
    ...
    <tr>
        <td>Скачать DirectX Tool Kit (DirectX 11)</td>
        <td>[DirectXTK](http://go.microsoft.com/fwlink/?LinkId=248929)</td>
    </tr>
    <tr>
        <td>Получить библиотеку обработки текстур DirectX (DirectX 11)</td>
...
<table>
    ...
    <tr>
        ...
        <td>[Руководство по программированию для Direct3D 12](https://msdn.microsoft.com/library/windows/desktop/dn903821)</td>
    </tr>
    <tr>
        <td>Сочетание DirectX и XAML</td>
        <td>[Межпрограммное взаимодействие DirectX и XAML](directx-and-xaml-interop.md)</td>
...
Рабочая группа по Microsoft DirectX выпустила серию детальных видео о разработке DirectX 12. В них приводятся сведения о привязке ресурсов, режимах презентации, отладке, преградах для ресурсов и многих других концепциях DirectX 12. В этой серии видео иногда выступают приглашенные гости.
...
<table>
    ...
    <tr>
        <td>Управление ресурсами и кучей в Direct3D 12 (видео)</td>
        <td>[Кучи и ресурсы в DirectX 12](https://www.youtube.com/channel/UCiaX2B8XiXR70jaN7NK-FpA)</td>
    </tr>
</table>
...
Создавайте игры для всего мира на платформе Windows и узнайте о возможностях интернационализации, встроенных в основные продукты Майкрософт.
...
Завершив создание игры и отправив ее, не считайте, что вы все сделали. Возможно, вы завершили разработку первой версии, однако путешествие вашей игры на рынке только начинается. Вы захотите следить за пользованием и получать отчеты об ошибках, реагировать на отзывы пользователей и публиковать обновления игры.

### Аналитика и продвижение Центра разработки для Windows
...
<table>
    ...
    <tr>
        <td>Реакция на отзывы пользователей</td>
...
Статистика Visual Studio Application Insights позволяет получать аналитические сведения о производительности, телеметрии и использовании опубликованной игры. Статистика Application Insights помогает обнаруживать и устранять проблемы после выхода игры, постоянно контролировать и совершенствовать игровой процесс, понимать характер взаимодействия игроков с игрой. Application Insights работает путем добавления SDK в приложение, которое отправляет телеметрию на [портал Azure](http://portal.azure.com/).
