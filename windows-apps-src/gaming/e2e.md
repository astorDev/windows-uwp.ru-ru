...
Карта пользовательского интерфейса — это макет навигации и меню игры в виде блок-схемы. Карта пользовательского интерфейса позволяет всем задействованным заинтересованным лицам понять интерфейс и пути навигации игры, а также выявлять потенциальные трудности и проблемы на ранней стадии цикла разработки.
