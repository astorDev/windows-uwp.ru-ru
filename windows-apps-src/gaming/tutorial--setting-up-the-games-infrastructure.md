...
## 2. Обзор и обновление файла package.appxmanifest.
...
## 3. Обзор включенных библиотек и заголовков.
...
На этом этапе вы можете создать проект игры UWP на базе DirectX и определить компоненты и файлы, предоставленные в шаблоне "Приложение DirectX 11 (универсальные приложения для Windows)".
