...
description: Здесь мы загрузим необработанные данные текстур и применим эти данные к трехмерному примитиву с помощью куба, который мы создали в разделе "Применение глубины и эффектов к примитивам".
