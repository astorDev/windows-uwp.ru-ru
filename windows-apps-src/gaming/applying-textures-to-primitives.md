...
Применим к кубу не данные о цвете, а данные о текстуре, как описано в предыдущем курсе [Применение глубины и эффектов к примитивам](using-depth-and-effects-on-primitives.md).
