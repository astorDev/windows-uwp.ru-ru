---
title: Создание шейдеров и рисование примитивов
description: В этом разделе мы покажем, как использовать исходные HLSL-файлы для компиляции и создания шейдеров, позволяющих отрисовывать на экране примитивы.
