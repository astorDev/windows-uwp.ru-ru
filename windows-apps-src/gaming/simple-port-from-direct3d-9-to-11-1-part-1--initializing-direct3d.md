...
Чтобы убедиться, мы не чаще, чем экрана фактически может отображать визуализации, мы устанавливаем задержкой кадров 1 и используйте [ **DXGI\_ЗАМЕНЫ\_эффект\_ПЕРЕВЕРНУТЬ\_SEQUENTIAL** ](https://msdn.microsoft.com/library/windows/desktop/bb173077). Тем самым экономится энергия, а кроме того это требуется для сертификации. Подробнее о представлении на экране вы узнаете из части 2 этой пошаговой инструкции.

> **Примечание**    можно использовать многопоточность (например, [ **ThreadPool** ](https://msdn.microsoft.com/library/windows/apps/br229642) рабочие элементы) для продолжения другую работу, пока поток отрисовки заблокирован.
