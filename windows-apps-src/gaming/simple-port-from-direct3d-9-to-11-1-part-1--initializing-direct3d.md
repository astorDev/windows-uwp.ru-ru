...
> **Примечание.** Для параметра *SDKVersion* в приложениях UWP всегда следует устанавливать значение D3D11\_SDK\_VERSION.
...
## Настройка заднего буфера в качестве цели отрисовки
