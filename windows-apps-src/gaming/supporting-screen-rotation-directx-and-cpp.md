...
-   Альбомная — по умолчанию ориентация для Windows10 и считается базового или тождественного угла для поворота (на 0 градусов).
