...
description: В этом учебном руководстве описывается добавление традиционных элементов управления перемещением и обзором, т. е. мыши и клавиатуры, в игру DirectX.
ms.assetid: 4b4d967c-3de9-8a97-ae68-0327f00cc933
---

# <span id="dev_gaming.tutorial__adding_move-look_controls_to_your_directx_game"></span>Элементы управления перемещением и обзором для игр
...
## Замечание по реализации элементов управления касанием
...
## Настройка инфраструктуры основных событий ввода
...
## Создание простейших событий ввода
...
## Инициализация элементов управления касанием и состояния устройства управления
...
## Обновление сведений о состоянии устройства управления
...
## Обновление матрицы обзора с учетом нового расположения камеры
