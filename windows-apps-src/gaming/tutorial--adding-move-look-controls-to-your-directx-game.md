...
description: В этом учебном руководстве описывается добавление традиционных элементов управления перемещением и обзором с помощью мыши и клавиатуры, в игру DirectX.
