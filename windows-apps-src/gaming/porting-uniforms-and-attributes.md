...
## Изменение однородных элементов и объектов буфера однородных элементов на буферы констант Direct3D
...
## Перенос атрибутов вершин в макеты входных данных Direct3D и семантика HLSL
