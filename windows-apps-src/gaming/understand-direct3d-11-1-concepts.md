...
> 
            **Примечание.**   Большинство приложений Direct3D9 широко использовали шейдеры, но иногда в комбинации с традиционной моделью на основе фиксированной функции. Обратите внимание, что Direct3D11 использует только программируемую модель шейдеров. Устаревшие компоненты Direct3D9 с фиксированными функциями использовать не рекомендуется.
