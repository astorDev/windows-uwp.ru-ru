...
Команды направления предназначены для базовой [навигации по осям XY](..\input-and-devices\designing-for-tv.md#xy-focus-navigation-and-interaction) между отдельными элементами пользовательского интерфейса. Команды просмотра и меню предназначены для отображения информации об игре (часто кратковременной и иногда модальной) и для переключения между игрой и контекстами меню соответственно. Команды принятия и отмены предназначены для утвердительных (да) и отрицательных (нет) ответов соответственно.
...
[Пример InputInterfacingUWP_ (github)_](https://github.com/Microsoft/Xbox-ATG-Samples/tree/master/Samples/System/InputInterfacingUWP) показывает, как разные устройства ввода ведут себя в качестве контроллеров навигации по пользовательскому интерфейсу.
