---
author: QuinnRadich
Description: "Информация о создании обучающего пользовательского интерфейса, который помогает пользователям начать работать с вашим приложением Магазина Windows."
