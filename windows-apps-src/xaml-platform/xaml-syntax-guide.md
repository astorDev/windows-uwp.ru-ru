...
### Объявление объекта с помощью синтаксиса объектного элемента
...
### Объявление объекта с помощью синтаксиса атрибута
...
### Задание свойства с помощью синтаксиса атрибутов
...
### Определение свойства с помощью синтаксиса элементов свойств
...
### Свойства содержимого в языке XAML
...
### Механизм синтаксиса коллекций языка XAML
...
## Когда стоит использовать синтаксис атрибутов, а когда— элементов свойств
...
## Логика и правила синтаксического анализа языка XAML
...
## Соглашения о заполнителях XAML в справке среды выполнения Windows
...
## Советы и рекомендации, замечания по стилю
