...
**Примечание**конструкторы XAML зачастую устанавливают соглашения о при использовании рабочих областей конструирования, отличных от редактора XML, но более поздней версии, такой XAML можно свободно редактировать целью переупорядочения атрибутов или введения новых.
