...
**\[** _fillRule_ **\]** _мовекомманд_ _дравкомманд_ **\[** _дравкомманд_ **\*\]** **\[** _closeCommand_ **\]**

Многие команды рисования используют точки, при этом вы предоставляете значение _x,y_. Каждый раз, когда отображается заполнитель \*_точек_ , можно предположить, что для значения _x, y_ точки задано два десятичных значения.
...
**Обратите внимание** ,  допустимо указать несколько точек после команды Move. К этим точкам проводится линия, как если бы вы указали команду линии. Однако такой стиль не рекомендуется; используйте вместо этого команду выделенной линии.
...
| Синтаксис |
|--------|
| _Конечная точка_ `L` <br/>- или -<br/>_Конечная точка_ `l` |
...
| Синтаксис |
|--------|
| *Конечная точка* *ControlPoint2* `C ` *ControlPoint1* <br/> - или - <br/> *Конечная точка* *ControlPoint2* `c ` *ControlPoint1* |
...
| Синтаксис |
|--------|
| `Q ` *конечную точку контролпоинт* <br/> - или - <br/> `q ` *конечную точку контролпоинт* |
...
| Синтаксис |
|--------|
| `S` *конечную точку* ControlPoint2 <br/> - или - <br/>`s` *конечную точку ControlPoint2* |
...
| Синтаксис |
|--------|
| `T` *конечную точку* контролпоинт <br/> - или - <br/> `t` *конечную точку* контролпоинт |
...
| Синтаксис |
|--------|
| `A ` *Размер* *ротатионангле* *исларжеаркфлаг* *свипдиректионфлаг* *Конечная точка* <br/> - или - <br/>`a ` *сизеротатионанглеисларжеаркфлагсвипдиректионфлажендпоинт* |
...
-   **\-бесконечности**: представляет **NegativeInfinity**.
