...
**Перо** и другие инструменты рисования в Blend для Microsoft Visual Studio2015 обычно создают объект [**Path**](/uwp/api/Windows.UI.Xaml.Shapes.Path) с использованием команд перемещения и рисования.
