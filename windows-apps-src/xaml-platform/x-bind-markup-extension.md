...
-   [Пример базовых характеристик пользовательского интерфейса XAML](https://go.microsoft.com/fwlink/p/?linkid=619992)
...
При использовании **{x: Bind}** с шаблонами данных, необходимо указать тип, к которому будет, задав значение **x: DataType** , как показано в разделе " [Примеры](#examples) ". Вы также можете задавать тип для интерфейса или базового класса, а затем использовать приведения, если понадобится сформулировать полное выражение.
