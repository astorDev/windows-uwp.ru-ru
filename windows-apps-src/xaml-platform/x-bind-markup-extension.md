...
При использовании **x:Bind** вам не нужно применять **ElementName=xxx** как часть выражения привязки. Вместо можно использовать имя элемента в первой части пути для привязки, поскольку именованные элементы становятся полями страницы или пользовательского элемента управления, представляющий собой источник привязки корня. 
