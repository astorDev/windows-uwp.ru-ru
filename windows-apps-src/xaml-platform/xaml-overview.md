...
Дополнительные сведения о сопоставлении пространств имен XAML для настраиваемых типов, в том числе особые вопросы работы с расширениями компонентов VisualC ++ (C + +/ CX), см. в разделе [пространства имен XAML и сопоставление пространств имен](xaml-namespaces-and-namespace-mapping.md).
...
**Примечание**c + +/ CX существует два файла кода программной части, один является заголовком (. xaml.h) и второй — реализацией (. xaml.cpp). Реализация ссылается на заголовок, и технически именно заголовок представляет точку входа для подключения кода программной части.
