...
> [!NOTE]
> Дополнительные сведения о работе панелей см. в разделе [Обзор пользовательских панелей XAML](https://msdn.microsoft.com/library/windows/apps/mt228351).
