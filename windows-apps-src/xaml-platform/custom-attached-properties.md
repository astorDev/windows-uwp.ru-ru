...
> [!NOTE]
> При написании пользовательского интерфейса XAML с кодом C++/CX необходимо включить заголовок для пользовательского типа, определяющего присоединенное свойство, каждый раз, когда XAML-страница использует этот тип. Каждая страница XAML имеет связанный заголовок кода программной части (. XAML. h). Здесь следует включить заголовок (с помощью  **\#include**) для определения типа владельца присоединенного свойства.
