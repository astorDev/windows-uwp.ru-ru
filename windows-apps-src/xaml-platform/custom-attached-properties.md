---
description: Здесь показано, как реализовать присоединенное свойство XAML как свойство зависимостей и определить соглашение о методе доступа для его использования в XAML.
