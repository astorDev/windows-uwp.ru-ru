...
Ниже приведен список пространств имен кода, которые в настоящее время, сопоставляются с пространством имен XAML по умолчанию.
...
-   **d: DataContext атрибут:** Этот атрибут можно задать на корневой страницы или элемента управления, чтобы переопределить любые явному или наследуемому [ **DataContext** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.datacontext) имеет этот объект в противном случае.
-   **атрибут d:DesignSource:** Задает источник данных времени разработки для [ **CollectionViewSource**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Data.CollectionViewSource), переопределяющего [ **источника**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.data.collectionviewsource.source).
...
* [Создание компонентов среды выполнения Windows в C# и Visual Basic](https://docs.microsoft.com/previous-versions/windows/apps/hh441572(v=vs.140))
* [C#, Шаблоны проектов VB и C++ для приложений среды выполнения Windows](https://docs.microsoft.com/previous-versions/windows/apps/hh768232(v=win.10))
* [Миграция Silverlight или WPF XAML или кода в приложении среды выполнения Windows](https://docs.microsoft.com/previous-versions/windows/apps/br229571(v=win.10))
 
