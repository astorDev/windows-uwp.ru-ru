...
**Примечание**Если вы преобразование разметки координат **{x: Bind}** **{Binding}**, а затем следует учитывать различия значения по умолчанию для свойства **режим** .
