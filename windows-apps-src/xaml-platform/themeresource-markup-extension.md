...
Пакет Microsoft Visual Studio 2013 может содержать возможные значения ключей в раскрывающихся меню Microsoft IntelliSense при использовании расширения разметки **{ThemeResource}** на XAML-странице. Например, при вводе "{ThemeResource", отображаются ключи ресурсов из [ресурсов тем XAML](https://msdn.microsoft.com/library/windows/apps/mt187274).
