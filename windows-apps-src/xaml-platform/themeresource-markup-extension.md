...
### Когда и как следует использовать {ThemeResource} вместо {StaticResource}
...
Свойства принимают значение [**Brush**](https://msdn.microsoft.com/library/windows/apps/br228076), а ссылка на ресурсы [**SolidColorBrush**](https://msdn.microsoft.com/library/windows/apps/br242962) с именами `ButtonBackgroundThemeBrush` и `ButtonForegroundThemeBrush` создается с помощью **ThemeResource**.
