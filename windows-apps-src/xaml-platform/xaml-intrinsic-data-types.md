---
description: Сведения о поддержке среды выполнения Windows для некоторых типов данных на уровне языка в XAML в среде CLR и других языках программирования, например C++.
