...
**Примечание**.   By, Языковые примитивы для XAML и все остальные языковые элементы XAML отображаются с префиксом "x:". Так элементы языка XAML обычно используются на практике для создания разметки. Это соглашение соблюдается в документации по языку XAML и в спецификации XAML.
