---
author: jwmsft
description: "Описывается имеющаяся в XAML для среды выполнения Windows поддержка на уровне языка для определенных типов данных в среде CLR и в других языках программирования, таких как C++."
