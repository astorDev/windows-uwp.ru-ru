---
description: Мы опишем понятие программирования событий в приложении среды выполнения Windows, при использовании C#, расширения компонентов Visual Basic или Visual C++ (C + +/ CX) как языка программирования и XAML для определения пользовательского интерфейса.
...
- Значение свойства элемента **Background** или **Fill** не равно **null**. Объект **null** [ **кисть** ](/uwp/api/Windows.UI.Xaml.Media.Brush) значение прозрачности результатов и нажмите кнопку невидимости теста. (Чтобы сделать элемент прозрачным, но доступным для проверки нажатия, используйте значение свойства кисти [**Transparent**](https://msdn.microsoft.com/library/windows/apps/hh748061), а не **null**.)

**Примечание.**  **Background** и **Fill** не определены элементом [**UIElement**](https://msdn.microsoft.com/library/windows/apps/br208911), а определены различными производными классами, например [**Control**](https://msdn.microsoft.com/library/windows/apps/br209390) и [**Shape**](/uwp/api/Windows.UI.Xaml.Shapes.Shape). Но применения кистей, которые вы используете для свойств переднего и заднего планов, одинаковы для проверки нажатия и событий ввода, независимо от того, какой подкласс реализует свойства.
...
Некоторые элементы управления имеют особые правила для проверки нажатия. Например, [**TextBlock**](https://msdn.microsoft.com/library/windows/apps/br209652) не обладает свойством **Background**, но доступен для проверки нажатия в пределах границ его площади. [**Изображение** ](https://msdn.microsoft.com/library/windows/apps/br242752) и [ **MediaElement** ](https://msdn.microsoft.com/library/windows/apps/br242926) элементы управления являются тестируемым на нажатие через их измерения прямоугольника, определенного, независимо от того, прозрачное содержимое, такие как альфа-канала в файле мультимедиа Источник файла. [**Веб-представления** ](https://msdn.microsoft.com/library/windows/apps/br227702) элементы управления имеют специальные поведение проверки, так как входные данные могут быть обработаны размещенной события сценария HTML и fire нажатия.
...
* [Краткое руководство. Реакция на сенсорный ввод](https://msdn.microsoft.com/library/windows/apps/xaml/hh465387)
* [Взаимодействия пользователей с клавиатурой](https://msdn.microsoft.com/library/windows/apps/mt185607)
