...
Инструкции см. в разделе [в этой статье](../porting/desktop-to-uwp-enhance.md#first-set-up-your-project).
...
Установите Windows 10, версия 1903 пакета SDK (или более поздней версии). Затем пакет приложения в пакете MSIX путем добавления [проект упаковки приложений Windows](https://docs.microsoft.com/windows/uwp/porting/desktop-to-uwp-packaging-dot-net) решение и добавить ссылку на проект WPF или Windows Forms.
...
Если вы не хотите упаковать приложение в пакете MSIX, можно добавить [манифест сборки side-by-side](https://docs.microsoft.com/windows/desktop/SbsCs/application-manifests) в проект и добавьте **maxversiontested укажите** значение в манифест, чтобы указать, что ваш приложение совместимо с Windows 10, 1903 или более поздней версии.

1. Если у вас еще нет сборки манифеста в проекте, добавьте новый XML-файл в проект и назовите его **app.manifest**. Для приложений WPF и Windows Forms, убедитесь, что также назначить **манифеста** свойства **. app.manifest** в **приложения** странице вашего [проекта свойства](https://docs.microsoft.com/en-us/visualstudio/ide/reference/application-page-project-designer-csharp?view=vs-2019#resources).
2. В манифесте сборки, включают **совместимости** и дочерних элементов, показано в следующем примере. Замените **идентификатор** атрибут **maxversiontested укажите** элемент с номером версии, вы используете Windows 10 (это должен быть Windows 10, версия 1903 года или более поздней версии). 
...
* [О-ва XAML лаборатории](https://github.com/Microsoft/Windows-AppConsult-XAMLIslandsLab/tree/microsoftlearn). Это комплексное лабораторное занятие включает пошаговые инструкции по использованию оболочку элементы управления и элементы управления ведущего приложения в наборе средств сообщества Windows для добавления элементов управления универсальной платформы Windows для существующего бизнес-приложения WPF. Это лабораторное занятие включает [полный код для приложения WPF](https://github.com/Microsoft/Windows-AppConsult-XAMLIslandsLab/tree/microsoftlearn/Lab) производительны [подробные инструкции](https://github.com/Microsoft/Windows-AppConsult-XAMLIslandsLab/blob/microsoftlearn/Manual/README.md) для каждого шага в процессе.
