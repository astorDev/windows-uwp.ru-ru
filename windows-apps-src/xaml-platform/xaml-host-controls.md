...
WPF и Windows Forms можно использовать выбора оболочку элементы управления UWP в наборе [Средств сообщества Windows](https://docs.microsoft.com/windows/uwpcommunitytoolkit/). Упоминаться эти элементы управления как *элементы управления в оболочку* , так как они оболочку интерфейс и функциональные возможности конкретного элемента управления UWP. Можно добавить эти элементы управления в область проектирования вашего проекта WPF или Windows Forms и затем использовать их как любой другой Windows Forms или WPF элемент управления в конструкторе.
...
| [MediaPlayerElement](https://docs.microsoft.com/windows/communitytoolkit/controls/wpf-winforms/mediaplayerelement) | Windows 10 Insider Preview SDK сборки 17709 | Внедряет представление, которое выполняет и отрисовывает мультимедийного содержимого, например видео в свое классическое приложение Windows Forms или WPF. |
