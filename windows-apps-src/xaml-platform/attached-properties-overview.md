...
В языке XAML присоединенные свойства задаются с помощью синтаксиса _AttachedPropertyProvider.PropertyName_. Приведем пример установки свойства [**Canvas.Left**](https://docs.microsoft.com/dotnet/api/system.windows.controls.canvas.left) в языке XAML.
...
- Чтобы указать присоединенное свойство в качестве целевого свойства для ссылки на ресурс из файла ресурсов в **x:UID**, используйте специальный синтаксис, который внедряет выражение с полным именем **с использованием:** объявление в квадратных скобках ("\[\]"), чтобы создать намеренную разрыв области. Например, если существует элемент `<TextBlock x:Uid="Title" />`, ключ ресурса в файле ресурсов, предназначенном для **Canvas. Top** , на этом экземпляре имеет значение Title.\[с помощью: Windows. UI. XAML. Controls\]Canvas. Top ". Подробнее о файле ресурсов и языке XAML см. в разделе [Краткое руководство: перевод ресурсов пользовательского интерфейса](https://docs.microsoft.com/previous-versions/windows/apps/hh965329(v=win.10)).
...
- [Краткое руководство. Преобразование ресурсов пользовательского интерфейса](https://docs.microsoft.com/previous-versions/windows/apps/hh943060(v=win.10))
- [ **»** ](https://docs.microsoft.com/uwp/api/windows.ui.xaml.dependencyobject.setvalue)
