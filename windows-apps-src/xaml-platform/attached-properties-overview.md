...
- Чтобы указать присоединенное свойство в качестве целевого свойства для ссылки на ресурс из файла ресурсов в **x:UID**, используйте специальный синтаксис, который внедряет в стиль кода полное имя **с помощью:** объявление в квадратных скобках ("\[ @ no__t-3") для Создание намеренного разрыва области действия. Например, если существует элемент `<TextBlock x:Uid="Title" />`, ключ ресурса в файле ресурсов, предназначенном для значения **Canvas. Top** в этом экземпляре, — Title. \[using: Windows.UI.XAML.Controls\]Canvas.Top. Дополнительные сведения о файлах ресурсов и XAML см. в разделе [Quickstart: Преобразование ресурсов пользовательского интерфейса @ no__t-0.
...
- [Краткое руководство. Преобразование ресурсов пользовательского интерфейса @ no__t-0
