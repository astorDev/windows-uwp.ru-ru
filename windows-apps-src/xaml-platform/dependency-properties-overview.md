...
> [!NOTE]
> Источники данных Microsoft .NET поддержки перечисленные здесь типы. Источники данных C++/CX используют различные интерфейсы для уведомлений об изменениях или наблюдаемого поведения. См. [Подробно о привязке данных](https://msdn.microsoft.com/library/windows/apps/mt210946).
