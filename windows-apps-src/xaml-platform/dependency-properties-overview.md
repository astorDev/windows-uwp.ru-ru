---
description: Здесь показана система свойств зависимостей, доступная в приложениях для Windows, написанных на C++, C# и Visual Basic с XAML-определениями интерфейса.
