# [Начало работы с универсальной платформой Windows](https://developer.microsoft.com/windows/getstarted)
...
### [Что нового в предварительной сборке пакета Anniversary SDK для Windows 10](whats-new/windows-10-sdk-preview.md)
### [Что нового в Windows 10 (версия 1511)](whats-new/windows-10-version-1511.md)
### [Что нового в Windows 10 (версия RTM)](whats-new/windows-10-rtm.md)
# [Оформление и пользовательский интерфейс](https://developer.microsoft.com/windows/design)
...
## [Ввод и устройства](input-and-devices/index.md)
...
# [Разработка приложений для Windows](https://developer.microsoft.com/windows/develop)
...
#### [Элементы, плей-листы и звуковые дорожки мультимедиа](audio-video-camera/media-playback-with-mediasource.md)
...
### [Создание и редактирование композиций мультимедиа](audio-video-camera/media-compositions-and-editing.md)
...
### [Импорт мультимедиа из устройства](audio-video-camera/import-media-from-a-device.md)
...
### [Реализация социальных веб-каналов в приложении "Люди"](contacts-and-calendar/integrating-social-feeds-into-contact-cards.md)
...
### [Адаптивный код версии](debug-test-perf/version-adaptive-code.md)
...
### [Подключенные приложения и устройства](launch-resume/connected-apps-and-devices.md)
#### [Обнаружение удаленных устройств](launch-resume/discover-connected-devices.md)
...
### [Обработка привязки приложений к Интернету с помощью обработчиков URI приложения](launch-resume/web-to-app-linking.md)
...
#### [Создание и регистрация фоновой задачи, которая запускается в отдельном процессе](launch-resume/create-and-register-a-background-task.md)
#### [Создание и регистрация фоновой задачи, которая запускается в одном процессе](launch-resume/create-and-register-a-singleprocess-background-task.md)
#### [Преобразование фоновой многопроцессорной задачи в однопроцессорную](launch-resume/convert-multiple-process-background-task.md)
...
### [Обмен данными с удаленной службой приложения](launch-resume/communicate-with-a-remote-app-service.md)
### [Преобразование службы приложения для ее запуска в одном процессе с приложением узла](launch-resume/convert-app-service-single-process.md)
...
#### [Показ рекламы с помощью библиотек Microsoft advertising](monetize/display-ads-using-the-microsoft-advertising-libraries.md)
...
###### [В чем различие: AdMediatorControl или AdControl](monetize/what-is-the-difference-admediatorcontrol-or-adcontrol.md)
...
####### [Пошаговое руководство по обработке ошибок в XAML и C#](monetize/error-handling-in-xamlc-walkthrough.md)
...
#### [Создание проекта и определение удаленных переменных на панели мониторинга Центра разработки](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
#### [Кодирование приложения для экспериментов](monetize/code-your-experiment-in-your-app.md)
#### [Определение эксперимента в информационной панели Центра разработки](monetize/define-your-experiment-in-the-dev-center-dashboard.md)
#### [Управление экспериментом в информационной панели Центра разработки](monetize/manage-your-experiment.md)
...
#### [Обзор преобразователя классических приложений (Project Centennial)](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Ручное преобразование классического приложения для Windows в приложение UWP](porting/desktop-to-uwp-manual-conversion.md)
#### [Расширения преобразованных классических приложений](porting/desktop-to-uwp-extensions.md)
#### [Поддерживаемые API платформы UWP для преобразованных классических приложений](porting/desktop-to-uwp-supported-api.md)
#### [Подписывание преобразованного классического приложения](porting/desktop-to-uwp-signing.md)
#### [Развертывание и отладка преобразованного приложения UWP](porting/desktop-to-uwp-deploy-and-debug.md)
...
#### [Функции доступа](porting/hwa-access-features.md)
...
### [Рекомендации](xbox-apps/tailoring-for-xbox.md)
...
### [Пакетное управление IAP](publish/manage-iaps-in-bulk.md)
## [Монетизация с использованием объявлений](publish/monetize-with-ads.md)
