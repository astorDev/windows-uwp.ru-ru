...
#### [Поддерживаемые API UWP для приложений, преобразованных с помощью Desktop Bridge](porting/desktop-to-uwp-supported-api.md)
#### [Отладка приложений, преобразованных с помощью Desktop Bridge](porting/desktop-to-uwp-debug.md)
#### [Подписывание приложения, преобразованного с помощью Desktop Bridge](porting/desktop-to-uwp-signing.md)
...
## [Что нового в Windows для разработчиков](whats-new/windows-10-version-1607.md)
...
### [Отчет о получении надстроек](publish/add-on-acquisitions-report.md)
