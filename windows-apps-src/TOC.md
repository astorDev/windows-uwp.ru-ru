# [Начало работы с универсальной платформой Windows](https://developer.microsoft.com/windows/apps/getstarted)
...
### [Создание приложения "Hello, world" (JS)](get-started/create-a-hello-world-app-js-universal.md)
...
# [Оформление и пользовательский интерфейс](https://developer.microsoft.com/windows/apps/design)
...
#### [Навигация между двумя страницами](layout/navigate-between-two-pages.md)
...
#### [Активный холст](layout/active-canvas.md)
...
## [Язык дизайна Майкрософт](https://developer.microsoft.com/windows/design/microsoft-design-language)
## [Загрузки](design-downloads/index.md)
# [Разработка приложений для Windows](https://developer.microsoft.com/windows/apps/develop)
...
##### [Ручное управление системными элементами управления воспроизведением мультимедиа](audio-video-camera/system-media-transport-controls.md)
#### [Создание, планирование и управление перерывами при воспроизведении мультимедиа](audio-video-camera/create-schedule-and-manage-media-breaks.md)
...
### [Entity Framework 7 с SQLite для приложений на C#](data-access/entity-framework-7-with-sqlite-for-csharp-apps.md)
...
### [POS-терминал](devices-sensors/point-of-service.md)
...
#### [Объявления о низком энергопотреблении (LE) Bluetooth](devices-sensors/ble-beacon.md)
...
#### [Гоночный руль и принудительная обратная связь](gaming/racing-wheel-and-force-feedback.md)
#### [Гарнитура](gaming/headset.md)
#### [Контроллер навигации по пользовательскому интерфейсу](gaming/ui-navigation-controller.md)
#### [Способы ввода данных в играх](gaming/input-practices-for-games.md)
...
##### [Переход с DirectX 9 на DirectX 11.1 и универсальную платформу Windows](gaming/porting-considerations.md)
...
###### [Сравнение конвейера шейдеров OpenGL ES 2.0 с Direct3D](gaming/change-your-shader-loading-code.md)
##### [Инструкции: перенос простого обработчика OpenGL ES 2.0 в Direct3D 11.1](gaming/port-a-simple-opengl-es-2-0-renderer-to-directx-11-1.md)
...
##### [Справочник по переходу с OpenGL ES 2.0 на Direct3D 11.1](gaming/opengl-es-2-0-to-directx-11-1-reference.md)
###### [Справочные материалы по переходу с GLSL на HLSL](gaming/glsl-to-hlsl-reference.md)
...
#### [Использование библиотеки XAML](graphics/using-the-visual-layer-with-xaml.md)
...
#### [Преобразование службы приложений для ее запуска в одном процессе с ведущим приложением](launch-resume/convert-app-service-in-process.md)
...
#### [Создание и регистрация внепроцессной фоновой задачи](launch-resume/create-and-register-a-background-task.md)
...
### [Подключенные приложения и устройства (проект "Рим")](launch-resume/connected-apps-and-devices.md)
...
## [Монетизация, взаимодействие с пользователем и службы Магазина](monetize/index.md)
...
#### [Поддержка покупок приложений и расширений внутри приложения](monetize/enable-in-app-purchases-of-apps-and-add-ons.md)
#### [Поддержка покупок потребляемых расширений внутри приложения](monetize/enable-consumable-add-on-purchases.md)
#### [Реализация пробной версии приложения](monetize/implement-a-trial-version-of-your-app.md)
#### [Внутренние покупки приложения и пробные версии, использующие пространство имен Windows.ApplicationModel.Store](monetize/in-app-purchases-and-trials-using-the-windows-applicationmodel-store-namespace.md)
...
#### [Создание проекта и определение удаленных переменных на информационной панели](monetize/create-a-project-and-define-remote-variables-in-the-dev-center-dashboard.md)
...
### [Настройка приложения для получения push-уведомлений Центра разработки](monetize/configure-your-app-to-receive-dev-center-notifications.md)
...
#### [Начало работы с библиотеками Microsoft advertising](monetize/get-started-with-microsoft-advertising-libraries.md)
##### [Установка библиотек Microsoft Advertising](monetize/install-the-microsoft-advertising-libraries.md)
##### [Процессы создания приложений с рекламой](monetize/workflows-for-creating-apps-with-ads.md)
##### [Обновление приложения для использования последних библиотек Microsoft Advertising](monetize/update-your-app-to-the-latest-advertising-libraries.md)
##### [Переход с AdMediatorControl на AdControl для приложений UWP](monetize/migrate-from-admediatorcontrol-to-adcontrol.md)
...
##### [Дополнительная справка](monetize/additional-help.md)
##### [Важное примечание — EULA](monetize/important-notice-eula.md)
...
##### [Отправка приложения с рекламой в Магазин Windows](monetize/submit-an-app-with-ads-to-the-windows-store.md)
##### [Поддерживаемые размеры рекламных баннеров](monetize/supported-ad-sizes-for-banner-ads.md)
##### [Поддерживаемые рынки для Microsoft Advertising](monetize/supported-markets-for-microsoft-advertising.md)
#### [Пошаговые руководства для разработчиков](monetize/developer-walkthroughs.md)
##### [Промежуточная видеореклама](monetize/interstitial-ads.md)
...
##### [Добавление рекламы в видеосодержимое в HTML 5 и JavaScript](monetize/add-advertisements-to-video-content.md)
...
##### [Получение сведений о приобретениях приложения](monetize/get-app-acquisitions.md)
...
##### [Получение сведений об ответах на отзывы о приложении](monetize/get-response-info-for-app-reviews.md)
##### [Отправка ответов на отзывы о приложении](monetize/submit-responses-to-app-reviews.md)
#### [Запуск рекламных кампаний](monetize/run-ad-campaigns-using-windows-store-services.md)
##### [Управление рекламными кампаниями](monetize/manage-ad-campaigns.md)
##### [Управление строками поставки для рекламных кампаний](monetize/manage-delivery-lines-for-ad-campaigns.md)
##### [Управление профилями таргетинга рекламных кампаний](monetize/manage-targeting-profiles-for-ad-campaigns.md)
##### [Управление рекламными средствами для рекламных кампаний](monetize/manage-creatives-for-ad-campaigns.md)
...
###### [Получение сведений о выпуске пакета для отправки приложения](monetize/get-package-rollout-info-for-an-app-submission.md)
###### [Обновление процента выпуска пакета для отправки приложения](monetize/update-the-package-rollout-percentage-for-an-app-submission.md)
###### [Остановка выпуска пакета для отправки приложения](monetize/halt-the-package-rollout-for-an-app-submission.md)
###### [Завершение выпуска пакета для отправки приложения](monetize/finalize-the-package-rollout-for-an-app-submission.md)
...
###### [Получение сведений о выпуске пакета для отправки тестового пакета](monetize/get-package-rollout-info-for-a-flight-submission.md)
###### [Обновление процента выпуска пакета для отправки тестового пакета](monetize/update-the-package-rollout-percentage-for-a-flight-submission.md)
###### [Остановка выпуска пакета для отправки тестового пакета](monetize/halt-the-package-rollout-for-a-flight-submission.md)
###### [Завершение выпуска пакета для отправки тестового пакета](monetize/finalize-the-package-rollout-for-a-flight-submission.md)
##### [Примеры кода для API отправки Магазина Windows](monetize/code-examples-for-the-windows-store-submission-api.md)
###### [Примеры кода на C#](monetize/csharp-code-examples-for-the-windows-store-submission-api.md)
###### [Примеры кода на Java](monetize/java-code-examples-for-the-windows-store-submission-api.md)
###### [Примеры кода на Python](monetize/python-code-examples-for-the-windows-store-submission-api.md)
...
### [Создание приложения для демонстрации в розничных магазинах (RDX-приложения)](monetize/retail-demo-experience.md)
...
### [Формирование пакетов приложений UWP](packaging/packaging-uwp-apps.md)
### [Создание пакета приложений с помощью средства MakeAppx.exe](packaging/create-app-package-with-makeappx-tool.md)
### [Создание сертификата для подписи пакета](packaging/create-certificate-package-signing.md)
...
### [Переход от классических приложений к UWP](porting/desktop-to-uwp-root.md)
#### [Подготовка приложения к преобразованию с помощью Desktop Bridge](porting/desktop-to-uwp-prepare.md)
#### [Desktop App Converter](porting/desktop-to-uwp-run-desktop-app-converter.md)
#### [Ручное преобразование приложения в приложение UWP с помощью Desktop Bridge](porting/desktop-to-uwp-manual-conversion.md)
#### [Расширение возможностей приложений, преобразованных с помощью Desktop Bridge](porting/desktop-to-uwp-extensions.md)
#### [Поддерживаемые API UWP для приложений, преобразованных с помощью моста для классических приложений](porting/desktop-to-uwp-supported-api.md)
#### [Руководство по упаковке классических приложений .NET с использованием моста для классических приложений с помощью Visual Studio](porting/desktop-to-uwp-packaging-dot-net.md)
#### [Отладка приложений, преобразованных с помощью моста для классических приложений](porting/desktop-to-uwp-debug.md)
#### [Подписывание приложения, преобразованного с помощью моста для классических приложений](porting/desktop-to-uwp-signing.md)
#### [Распространение приложений, преобразованных с помощью Desktop Bridge](porting/desktop-to-uwp-distribute.md)
#### [Как работает Desktop Bridge](porting/desktop-to-uwp-behind-the-scenes.md)
#### [Известные проблемы с Desktop Bridge](porting/desktop-to-uwp-known-issues.md)
...
#### [Брокер веб-аутентификации](security/web-authentication-broker.md)
...
### [Создание компонентов среды выполнения Windows на языках C# и Visual Basic](winrt-components/creating-windows-runtime-components-in-csharp-and-visual-basic.md)
...
## [Справочник по API](https://msdn.microsoft.com/library/windows/apps/bg124285.aspx)
...
## [Новые возможности для разработчиков в Windows 10](whats-new/windows-10-creators-preview.md)
### [Что нового в Windows 10 (версия 1607)](whats-new/windows-10-version-1607.md)
#### [Добавления API в Windows 10 версии 1607](whats-new/windows-10-version-1607-api-diff.md)
...
### [Что нового в Windows 10 (версия 1507)](whats-new/windows-10-version-1507.md)
...
# [Публикация приложений для Windows](publish/index.md)
...
### [Настройка пользовательских разрешений для пользователей учетных записей](publish/set-custom-permissions-for-account-users.md)
...
#### [Создание описание в Магазине для определенной платформы](publish/create-platform-specific-store-listings.md)
...
### [Создание описание надстройки в Магазине](publish/create-add-on-store-listings.md)
### [Массовое управление надстройками](publish/manage-add-ons-in-bulk.md)
## [Монетизация с использованием рекламы](publish/monetize-with-ads.md)
...
### [Отчет о приобретениях надстроек](publish/add-on-acquisitions-report.md)
...
### [Отчет "Рекламный посредник"](publish/ad-mediation-report.md)
...
### [Отчет о продвижении приложения](publish/promote-your-app-report.md)
...
### [Создание рекламной кампании для своего приложения](publish/create-an-ad-campaign-for-your-app.md)
...
### [Отправка целевых push-уведомлений пользователям вашего приложения](publish/send-push-notifications-to-your-apps-customers.md)
...
### [Реакция на оценки пользователей](publish/respond-to-customer-reviews.md)
