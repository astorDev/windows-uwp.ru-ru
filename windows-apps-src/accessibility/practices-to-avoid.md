...
В данной статье рассказывается о методиках, которые не следует использовать при создании приложений универсальной платформы Windows (UWP), поддерживающих специальные возможности.
