...
<span id="accessible_name"></span><span id="ACCESSIBLE_NAME"></span>Специальное имя
-----------------------------------------------------------------------------------
...
<span id="role_value"></span><span id="ROLE_VALUE"></span>Роль и значение
------------------------------------------------------------------------
...
<span id="name_from_inner_text"></span><span id="NAME_FROM_INNER_TEXT"></span>Имя на основе внутреннего текста
--------------------------------------------------------------------------------------------------
...
**Note**   В модели автоматизации пользовательского интерфейса требуется, чтобы длина специального имени не превышала 2048 символов. Если строка, используемая для автоматического определения специального имени, превышает этот предел, специальное имя усекается в этой точке.

 

<span id="images"></span><span id="IMAGES"></span>Специальные имена изображений
-----------------------------------------------------------------------------
...
<span id="labels"></span><span id="LABELS"></span>Метки и LabeledBy
----------------------------------------------------------------------
...
<span id="accessible_description"></span><span id="ACCESSIBLE_DESCRIPTION"></span>Специальное описание (необязательно)
-------------------------------------------------------------------------------------------------------------------
...
<span id="Testing_accessibility_early_and_often"></span><span id="testing_accessibility_early_and_often"></span><span id="TESTING_ACCESSIBILITY_EARLY_AND_OFTEN"></span>Раннее и частое тестирование специальных возможностей
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_names_from_dynamic_data"></span><span id="accessible_names_from_dynamic_data"></span><span id="ACCESSIBLE_NAMES_FROM_DYNAMIC_DATA"></span>Специальные имена на основе динамических данных
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Accessible_names_and_localization"></span><span id="accessible_names_and_localization"></span><span id="ACCESSIBLE_NAMES_AND_LOCALIZATION"></span>Специальные имена и локализация
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
