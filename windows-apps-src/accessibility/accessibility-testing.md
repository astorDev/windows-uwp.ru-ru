...
Процедуры проверки работоспособности специальных возможностей приложения универсальной платформы Windows (UWP).

<span id="run_accessibility_testing_tools"></span><span id="RUN_ACCESSIBILITY_TESTING_TOOLS"></span>Запуск средств проверки специальных возможностей
-----------------------------------------------------------------------------------------------------------------------------------
...
### <span id="ui_accessibility_checker"></span><span id="UI_ACCESSIBILITY_CHECKER"></span>**Средство проверки специальных возможностей пользовательского интерфейса**
...
### <span id="ui_automation_verify"></span><span id="UI_AUTOMATION_VERIFY"></span>**Проверка модели автоматизации пользовательского интерфейса**
...
### <span id="accessible_event_watcher"></span><span id="ACCESSIBLE_EVENT_WATCHER"></span>**Средство отслеживания доступных событий**

[**Средство отслеживания доступных событий (AccEvent)**](https://msdn.microsoft.com/library/windows/desktop/Dd317979) проверяет, запускают ли элементы пользовательского интерфейса приложения соответствующие события модели автоматизации пользовательского интерфейса и Microsoft Active Accessibility при изменении элементов интерфейса. Изменения в пользовательском интерфейсе могут произойти при изменении фокуса или при вызове элемента интерфейса, выборе этого элемента или изменении его состояния или свойств.

**Примечание** Большинство упомянутых в документации средств тестирования специальных возможностей работает на ПК, а не на телефоне. Вы можете запускать некоторые из этих средств во время разработки и использования эмулятора, но большинство из них не предоставляют дерево автоматизации пользовательского интерфейса в эмуляторе.

 

<span id="test_keyboard_accessibility"></span><span id="TEST_KEYBOARD_ACCESSIBILITY"></span>Проверка специальных возможностей клавиатуры
-----------------------------------------------------------------------------------------------------------------------
...
<span id="verify_your_app_with_make_everything_on_your_screen_bigger"></span><span id="VERIFY_YOUR_APP_WITH_MAKE_EVERYTHING_ON_YOUR_SCREEN_BIGGER"></span>Проверка приложения с параметрами экрана
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="verify_main_app_scenarios_by_using_narrator"></span><span id="VERIFY_MAIN_APP_SCENARIOS_BY_USING_NARRATOR"></span>Проверка основных сценариев приложения с помощью экранного диктора
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
<span id="Examine_the_UI_Automation_representation_for_your_app"></span><span id="examine_the_ui_automation_representation_for_your_app"></span><span id="EXAMINE_THE_UI_AUTOMATION_REPRESENTATION_FOR_YOUR_APP"></span>Изучение представления модели автоматизации пользовательского интерфейса для вашего приложения
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
