...
### <a name="step-1-request-access-to-the-users-location"></a>Шаг1. Запрос доступа к данным о расположении пользователя
...
### <a name="step-2-register-for-changes-in-geofence-state-and-location-permissions"></a>Шаг2. Регистрация изменений состояния геозоны и разрешений на доступ к данным о расположении
...
### <a name="step-3-create-the-geofence"></a>Шаг3. Создание геозоны
...
-   [**MonitoredStates**](https://msdn.microsoft.com/library/windows/apps/dn263728) указывает, уведомления о каких событиях геозоны вы хотите получать: появление в заданной области, уход из заданной области или удаление геозоны;
-   [**SingleUse**](https://msdn.microsoft.com/library/windows/apps/dn263732) удаляет геозону, как только она достигнет всех отслеживаемых состояний;
-   [**DwellTime**](https://msdn.microsoft.com/library/windows/apps/dn263703) указывает, сколько времени пользователь должен находиться внутри или вне заданной зоны до инициации событий входа-выхода;
-   [**StartTime**](https://msdn.microsoft.com/library/windows/apps/dn263735) указывает время начала слежения за геозоной;
-   [**Duration**](https://msdn.microsoft.com/library/windows/apps/dn263697) указывает период, в течение которого выполняется слежение за геозоной.
...
### <a name="step-4-handle-changes-in-location-permissions"></a>Шаг4. Обработка изменений в разрешениях, связанных с расположением
...
### <a name="step-1-register-for-geofence-state-change-events"></a>Шаг1. Регистрация событий при изменении состояния геозоны
...
### <a name="step-2-implement-the-geofence-event-handler"></a>Шаг2. Реализация обработчика событий геозоны
...
### <a name="step-2-register-the-background-task"></a>Шаг2. Регистрация фоновой задачи
