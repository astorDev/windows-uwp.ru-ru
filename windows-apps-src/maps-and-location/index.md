...
> [!TIP]
> Дополнительные сведения об использовании карт и расположения в приложении, скачайте следующие примеры из [репозитория Windows-universal-samples](https://go.microsoft.com/fwlink/p/?LinkId=619979) на GitHub:
