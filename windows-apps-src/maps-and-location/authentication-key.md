...
**Совет** Чтобы получить дополнительные сведения об использовании карт в приложении, скачайте следующий пример из [репозитория универсальных примеров для Windows](http://go.microsoft.com/fwlink/p/?LinkId=619979) на веб-сайте GitHub.
