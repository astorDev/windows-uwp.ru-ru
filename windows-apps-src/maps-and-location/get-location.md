...
### Шаг 1. Запрос доступа к данным о местоположении пользователя
...
### Шаг 3. Обработка изменений в разрешениях, связанных с местоположением
...
### Шаг 1. Задание интервала отчетов и регистрация для обновления данных о местоположении
...
### Шаг 2. Обработка обновлений данных о местоположении
