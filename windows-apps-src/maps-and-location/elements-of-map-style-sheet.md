...
| >>>> business                | [PointStyle](#pointstyle) |  ✔   |  ✔   |  ✔   |  ✔   | Значки, которые представляют любое местоположение бизнеса. |
...
| >>>>> shoppingPoint          | [PointStyle](#pointstyle) |      |  ✔   |  ✔   |  ✔   | Значки, которые представляют отелей и других организаций проживание. |
...
| >>>> transitBuilding         | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Здания, используемый для пути, таких как аэропорт. |
...
| >>>>> highSpeedRamp          | [MapElement](#mapelement) |  ✔   |  ✔   |  ✔   |  ✔   | Линии, которые представляют съезды высокой скорости работы, которые обычно подключаются к управляемый въездом. |
...
| shadedReliefDarkColor        | Цвет   |  ✔   |  ✔   |  ✔   |  ✔   | Цвет темной части затененного рельефа.  Альфа-канал представляет максимальное значение альфа-канала. |
| shadedReliefLightColor       | Цвет   |  ✔   |  ✔   |  ✔   |  ✔   | Цвет светлой части затененного рельефа.  Альфа-канал представляет максимальное значение альфа-канала. |
| shadowColor                  | Цвет   |      |      |      |  ✔   | Цвет тени за значки, которые используют тени. |
...
| borderWidthScale             | Плавающий   |  ✔   |  ✔   |  ✔   |  ✔   | Сумма, по которым границ масштабируется. Например, используйте значение *1* для стандартного размера и значение *2* для вдвое большего размера. |
...
| Свойство                     | Тип    | 1703 | 1709 | 1803 | 1809 | Описание |
|------------------------------|---------|------|------|------|------|-------------|
| Фон формы             | Плавающий   |      |      |      |  ✔   | Форма для использования в качестве фона значок--заменить любой формы, которую существует. |
