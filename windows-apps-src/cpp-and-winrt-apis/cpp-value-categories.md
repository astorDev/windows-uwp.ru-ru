---
description: В этом разделе описываются различные категории значений, которые существуют в C++. Вы наверняка уже слышали об значения lvalue и rvalue, но существуют другие типы слишком.
