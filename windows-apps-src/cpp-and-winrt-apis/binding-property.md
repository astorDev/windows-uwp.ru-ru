...
Если вы опустите include из `BookstoreViewModel.idl` (см. список `MainPage.idl` выше), отобразится ошибка **ожидает \ < вблизи «MainViewModel»**. Еще один совет состоит в том, оставьте все типы в пространстве имен: пространство имен, которое отображается в описаниях кода.
