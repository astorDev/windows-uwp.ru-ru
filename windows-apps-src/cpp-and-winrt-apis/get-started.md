...
Переименуйте ваш `stdafx.h` и `stdafx.cpp` для `pch.h` и `pch.cpp`соответственно. Задайте свойству проекта **C/C++** > **Предварительно скомпилированные заголовки** > **Скомпилированный файл заголовка** *pch.h*.
...
Теперь можно скомпилировать и связать и добавьте C + +/ WinRT код в проект (например, код, показанный в [c + +/ WinRT краткое](#a-cwinrt-quick-start) выше, в разделе)
