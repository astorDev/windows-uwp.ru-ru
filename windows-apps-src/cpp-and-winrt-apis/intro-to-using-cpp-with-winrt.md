...
Список параметров настройки для средства `cppwinrt.exe`, настроенных с помощью свойств проекта, см. в [https://github.com/microsoft/xlang/tree/master/src/package/cppwinrt/nuget/readme.md#customizing ].
