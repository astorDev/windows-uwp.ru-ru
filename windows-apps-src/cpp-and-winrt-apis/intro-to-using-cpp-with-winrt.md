...
> [!IMPORTANT]
> Два наиболее важных аспектах C++/ WinRT, которые следует учитывать, описаны в разделах [Поддержка пакетов SDK для C++/WinRT](#sdk-support-for-cwinrt) и [Поддержка Visual Studio для C++/ WinRT и VSIX](#visual-studio-support-for-cwinrt-xaml-and-the-vsix).
...
## <a name="visual-studio-support-for-cwinrt-xaml-and-the-vsix"></a>Поддержка Visual Studio для C + +/ WinRT, XAML и VSIX
