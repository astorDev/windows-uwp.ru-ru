...
Поскольку C + +/ WinRT использует функции стандарта C ++ 17, проецировать свойство **C/C++** > **язык** > **Стандартный язык C++** > **ISO C ++ 17 Standard (/ std: c ++ 17)**. Вы также можете установить **Conformance mode: Yes (/permissive-)**, что дополнительно обеспечит соответствие стандартам вашего кода.
