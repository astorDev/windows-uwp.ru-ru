...
Обратите внимание на то, как добавить к событию столько мире делегаты по своему усмотрению. Однако есть некоторые издержки, связанные с событием. Если все, что необходимо простой обратного вызова с помощью только одной подписки делегата, то вы можете использовать [**winrt::delegate&lt;… T&gt; **](/uwp/cpp-ref-for-winrt/delegate) самостоятельно.
...
Обратите внимание, что эти правила не применяются обязательно, если вы разрабатываете внутренним API. Хотя API-интерфейсы внутренний часто станет общедоступным со временем.
