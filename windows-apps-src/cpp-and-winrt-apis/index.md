...
| [Сведения о деструкторах](details-about-destructors.md) | C++/WinRT 2.0 позволяет откладывать уничтожение типов реализации и безопасно выполнять запросы во время этой операции. В этом разделе описываются эти функции и объясняется, когда их использовать. |
