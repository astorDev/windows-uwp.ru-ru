...
Кроме того, добавьте следующие директиву для `MainPage.h` таким образом, учитывать тип пользовательского элемента управления **BgLabelControl** **MainPage** тип (сочетание компиляции разметки XAML и императивном коде).
