...
После их добавления ваш файл `BgLabelControl.h` будет выглядеть следующим образом. Вы можете скопировать и вставить этот листинг кода вместо содержимого `BgLabelControl.h`.
