...
*Переопределяемые* функции имитируют по-разному в различных языковые проекции. В C#, например, переопределяемые функции обычно отображаются в виде защищенные виртуальные функции. В C + +/ WinRT, они защищенных ни виртуальный, но по-прежнему можно переопределить их и предоставить свою собственную реализацию, как показано выше.
