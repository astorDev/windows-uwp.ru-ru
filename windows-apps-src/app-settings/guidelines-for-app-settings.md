...
Если пользователи вашего приложения могут выбирать его цветовой режим, представьте эти параметры с помощью [переключателей](../controls-and-patterns/radio-button.md) или [поля со списком](../controls-and-patterns/lists.md#drop-down-lists) с заголовком "Выбор режима". Параметры должны быть такими:
- Светлый
- Темный
- По умолчанию (Windows)

Мы также рекомендуем добавить гиперссылку на страницу "Цвета" приложения "Параметры" Windows, где пользователи могут проверить тему по умолчанию Windows. В качестве текста гиперссылки используйте строку "Параметры цвета Windows".

![Раздел "Выбор режима"](images/appsettings_mode.png)

<div class=”microsoft-internal-note”>
Подробные красные линии с предпочитаемыми текстовыми строками для раздела "Выбор режима" доступны в [UNI](http://uni/DesignDepot.FrontEnd/#/ProductNav/2543/0/dv/?t=Windows%7CControls%7CColorMode&f=RS2).
</div>

## <a name="about-section-and-give-feedback-button"></a>Раздел "О программе" и кнопка "Обратная связь"
