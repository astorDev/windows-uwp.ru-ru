...
## <a name="app-settings-page-content"></a>Содержимое страницы параметров приложения
...
##  <a name="add-settings-content-to-settings-flyouts"></a>Добавление параметров во всплывающие элементы "Параметры"
