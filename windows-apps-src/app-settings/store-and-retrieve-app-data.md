...
-   **Параметры**
    ...
    В качестве параметров приложения можно использовать перечисленные ниже типы данных.
...
### Предварительные требования по перемещению данных
...
* [Руководство по параметрам приложений](guidelines-for-app-settings.md)
