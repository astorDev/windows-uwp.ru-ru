---
description: Создавайте приложения UWP, которые поддерживают взаимодействие с помощью пера, в том числе рукописный ввод для естественного письма и рисования.
title: Взаимодействие с помощью пера
...
Кроме того, что перо служит как [**указатель**](https://msdn.microsoft.com/library/windows/apps/br225633) (аналогично мыши и касанию), оно обычно ассоциируется с письмом и рисованием непосредственно на экране с использованием цифровых чернил.

Платформа рукописного ввода для универсальной платформы Windows (UWP) в сочетании с пером обеспечивает естественный способ создания рукописных примечаний, рисунков и заметок с помощью цифровых чернил. Платформа поддерживает получение входных данных дигитайзера в виде рукописных данных, создание рукописных данных, управление этими данными, отображение их в виде росчерков и преобразование этих росчерков в текст с помощью функции распознавания рукописного ввода.
...
-   [**InkCanvas**](https://msdn.microsoft.com/library/windows/apps/dn858535) — элемент управления платформы пользовательского интерфейса XAML, который по умолчанию получает и отображает все входные данные от пера, будь то росчерк пера или росчерк стирания.

-   [**InkPresenter**](https://msdn.microsoft.com/library/windows/apps/dn922011) — объект кода программной части, созданный вместе с элементом управления [**InkCanvas**](https://msdn.microsoft.com/library/windows/apps/dn858535) (предоставляемый свойством [**InkCanvas.InkPresenter**](https://msdn.microsoft.com/library/windows/apps/dn899081)). Этот объект обеспечивает все возможности рукописного ввода по умолчанию, предоставляемые элементом **InkCanvas**, вместе с полным набором API для дополнительной настройки и персонализации.
...
<tr class="even">
<td align="left">Пустой элемент [<strong>InkCanvas</strong>](https://msdn.microsoft.com/library/windows/apps/dn858535) с фоновым изображением.</td>
<td align="left">[<strong>InkCanvas</strong>](https://msdn.microsoft.com/library/windows/apps/dn858535) с росчерками пера.</td>
<td align="left">[<strong>InkCanvas</strong>](https://msdn.microsoft.com/library/windows/apps/dn858535) с одним стертым росчерком.
<p>Обратите внимание, что стирание применяется ко всему росчерку, а не к его части.</p></td>
</tr>
</tbody>
</table>
