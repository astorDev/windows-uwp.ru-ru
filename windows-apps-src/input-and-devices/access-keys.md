...
Клавиши доступа могут повысить удобство использования и улучшить специальные возможности приложения для Windows, предоставляя пользователям интуитивно понятный способ навигации и взаимодействия с видимым пользовательским интерфейсом приложения с помощью клавиатуры вместо указывающего устройства (например, сенсорного ввода или мыши).
...
Некоторые элементы управления, например CommandBar, пока что не поддерживают встроенные области клавиш доступа, поэтому разработчику нужно внедрять их самостоятельно. В примере ниже показано, как поддерживать SecondaryCommands в CommandBar с клавишами доступа, доступными после вызова родительской команды (аналогично ленте в Microsoft Word).
...
## <a name="position-key-tips"></a>Положение подсказок клавиш
...
## <a name="style-key-tips"></a>Стиль подсказок клавиш
