...
Description: "Расширение основных возможностей Кортаны с помощью голосовых команд, активирующих приложение UWP и выполняющих одно действие."
...
Руководство по началу работы см. в разделе [Обзор возможностей расширения функций Кортаны](https://msdn.microsoft.com/cortana/getstarted).
...
**Проектировщикам**
* [Рекомендации по проектированию голосовых функций](https://msdn.microsoft.com/windows/uwp/input-and-devices/speech-interactions)
* [Рекомендации по проектированию Кортаны для работы с голосовыми командами](https://msdn.microsoft.com/en-us/cortana/voicecommands/voicecommand-design-guidelines)
