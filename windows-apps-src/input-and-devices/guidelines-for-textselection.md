---
description: Раздел посвящен выделению текста, изображений и элементов управления и манипулированию ими. Он дает советы по их использованию в приложениях Магазина Windows.
title: Выделение текста и изображений
ms.assetid: d973ffd8-602e-47b5-ab0b-4b2a964ec53d
label: Выделение текста и изображений
template: detail.hbs
---
