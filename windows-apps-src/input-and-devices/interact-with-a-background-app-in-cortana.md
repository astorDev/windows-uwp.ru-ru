...
Вот пример экрана передачи для приложения **Adventure Works**. В этом примере пользователь запросил у **Кортаны** предстоящие поездки. Экран передачи включает настроенное сообщение с именем службы приложения, значком и строкой **Обратная связь**, объявленной в VCD-файле.
