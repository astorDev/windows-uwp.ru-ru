---
Description: Добавьте в Кортану использование функциональных возможностей вашего приложения с помощью голосовых команд.
title: Рекомендации по проектированию Кортаны
...
**Кортана** позволяет приложениям, работающим в фоновом режиме, запрашивать у пользователя подтверждение или уточнение и в ответ предоставлять ему отзыв о состоянии голосовой команды. Это легкий и быстрый процесс, который не вынуждает пользователя выходить из **Кортаны** или переключать контекст на приложение.
...
Вы также можете указать значок, который будет отображаться в области содержимого полотна Кортаны, для каждого из результатов запроса. Допустимые размеры изображения для значков результатов:
...
В этом примере демонстрируется сквозной поток задач для фонового приложения в **Кортане**. Мы используем приложение **Adventure Works** для отмены поездки в Лас-Вегас.
