...
## <span id="Cortana"></span><span id="cortana"></span><span id="CORTANA"></span>Кортана
...
## <span id="Speech"></span><span id="speech"></span><span id="SPEECH"></span>Голосовые функции
...
<span id="Natural_language"></span><span id="natural_language"></span><span id="NATURAL_LANGUAGE"></span>Естественный язык  
...
<span id="Command_and_control"></span><span id="command_and_control"></span><span id="COMMAND_AND_CONTROL"></span>Команды и управление  
...
<span id="Dictation"></span><span id="dictation"></span><span id="DICTATION"></span>Диктовка  
...
## <span id="Pen"></span><span id="pen"></span><span id="PEN"></span>Перо
...
## <span id="Touch"></span><span id="touch"></span><span id="TOUCH"></span>Сенсорный ввод
...
## <span id="Touchpad"></span><span id="touchpad"></span><span id="TOUCHPAD"></span>Сенсорная панель
...
Дополнительные сведения
[Рекомендации по проектированию взаимодействия с помощью сенсорной панели](https://msdn.microsoft.com/library/windows/apps/dn456353)
 

## <span id="Keyboard"></span><span id="keyboard"></span><span id="KEYBOARD"></span>Клавиатура
...
## <span id="Mouse"></span><span id="mouse"></span><span id="MOUSE"></span>Мышь
...
Дополнительные сведения
[Рекомендации по проектированию взаимодействия с помощью мыши](https://msdn.microsoft.com/library/windows/apps/dn456351)
 

## <span id="Gesture"></span><span id="gesture"></span><span id="GESTURE"></span>Жест
...
## <span id="Gamepad_Controller"></span><span id="gamepad_controller"></span><span id="GAMEPAD_CONTROLLER"></span>Игровой контроллер
...
## <span id="Multiple_inputs"></span><span id="multiple_inputs"></span><span id="MULTIPLE_INPUTS"></span>Несколько типов ввода
