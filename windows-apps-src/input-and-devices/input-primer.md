...
Расширение возможностей **Кортаны** в Windows10 позволяет вам обрабатывать голосовые команды пользователя и запускать приложение для выполнения одного действия.
