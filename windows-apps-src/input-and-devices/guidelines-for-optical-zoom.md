---
description: В этом разделе представлены элементы Windows для масштабирования и изменения размеров, а также рекомендации по использованию в приложениях этих механизмов.
title: Руководство по визуальному масштабированию и изменению размеров
ms.assetid: 51a0007c-8a5d-4c44-ac9f-bbbf092b8a00
label: Визуальное масштабирование и изменение размера
template: detail.hbs
---
