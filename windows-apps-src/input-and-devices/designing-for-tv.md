...
| [Открыть контекстное меню](#commandbar-and-contextflyout) | Щелкните правой кнопкой мыши | Кнопка меню | [ContextFlyout](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.UIElement#Windows_UI_Xaml_UIElement_ContextFlyout) | Контекстные меню |
