...
## <span id="Measurements_and_scaling"></span><span id="measurements_and_scaling"></span><span id="MEASUREMENTS_AND_SCALING"></span>Единицы измерения и масштабирование
...
## <span id="Thresholds"></span><span id="thresholds"></span><span id="THRESHOLDS"></span>Пороговые значения
...
## <span id="Target_sizes"></span><span id="target_sizes"></span><span id="TARGET_SIZES"></span>Размеры цели
...
<td align="left">< 60 % от истинного размера</td>
<td align="left">90–100 % от истинного размера
...
## <span id="Targeting_assistance"></span><span id="targeting_assistance"></span><span id="TARGETING_ASSISTANCE"></span>Вспомогательные средства для определения цели касания
...
## <span id="Tethering"></span><span id="tethering"></span><span id="TETHERING"></span>Пограничный контакт
...
## <span id="scrubbing"></span><span id="SCRUBBING"></span>Проведение
