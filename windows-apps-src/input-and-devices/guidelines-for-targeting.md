...
Description: "В этом разделе описано использование геометрии контакта для определения цели касания и приводятся рекомендации для определения целей касания в приложениях среды выполнения Windows."
