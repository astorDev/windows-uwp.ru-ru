---
description: Этот раздел описывает новый интерфейс Windows и реализацию поворота, а также дает рекомендации по использованию этого механизма в приложениях Магазина Windows.
title: Поворот
