...
keywords: взаимодействие приложений для приложения, связи между процессами, производственных Издержек, фон системы обмена сообщениями, связи, приложений для приложения, фон приложения-службы
ms.author: twhitney
ms.date: 09/18/2017
ms.topic: article
ms.prod: windows
