...
ms.prod: windows
ms.technology: uwp
keywords: Windows 10 uwp, подключенных устройств, удаленных систем, Рим, рим проекта, фоновая задача, службы приложений
...
Чтобы использовать элементы этого пространства имен **uap3** , необходимо добавить определение пространства имен в верхней части файла манифеста, если она еще не создана.
...
Затем построить проект поставщика службы приложения и развернуть его узел устройства.
