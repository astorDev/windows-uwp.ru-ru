...
ms.prod: windows
ms.technology: uwp
keywords: устройства Windows 10, uwp, подключенных, удаленных систем, Рим, рим проекта, фоновом, приложения-службы
...
Чтобы использовать элементы этого пространства имен **uap3** , необходимо добавить определения пространства имен в верхней части файла манифеста, если она еще не создана.
...
Выберите построить проект поставщика службы приложения и его развертывание на устройства узла.
