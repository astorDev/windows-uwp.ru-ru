...
| [Связаться со службой удаленного приложения](communicate-with-a-remote-app-service.md) | Узнайте, как взаимодействовать с приложением на удаленном устройстве. |
...
| [По-прежнему действий пользователя, даже на устройствах](useractivities.md)| Предоставьте пользователям возможность возобновить, что они делали в приложении, даже на разных устройствах.|
