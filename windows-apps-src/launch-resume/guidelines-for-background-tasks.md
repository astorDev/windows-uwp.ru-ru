...
**Используйте [BackgroundTaskDeferral](https://msdn.microsoft.com/library/windows/apps/hh700499):** Если ваш класс задач фоновой выполняется асинхронный код, обязательно используйте задержек. В противном случае ваши фоновой задачи может быть преждевременно при [запуска](https://msdn.microsoft.com/library/windows/apps/windows.applicationmodel.background.ibackgroundtask.run.aspx) возвращает метод (или [OnBackgroundActivated](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.application.onbackgroundactivated.aspx) метод в случае в работе фоновых задач). Дополнительные сведения см. в разделе [Создание и регистрация фоновой задачи вне процесса](create-and-register-a-background-task.md).
