...
> [!NOTE]
> Если вы создаете новое имя схемы URI для вашего приложения, обязательно следуйте рекомендациям в [RFC 4395](https://go.microsoft.com/fwlink/p/?LinkID=266550). Это гарантирует, что созданное вами имя будет соответствовать стандартам для схем URI.
