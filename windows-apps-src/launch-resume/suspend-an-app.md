...
* [Рекомендации UX по запуску, приостановке и возобновлению](https://docs.microsoft.com/windows/uwp/launch-resume/index)
