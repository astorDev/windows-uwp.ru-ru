...
5.  В **точка входа:** файла в текстовое поле введите пространство имен и имя вашего фонового класса в этом примере использовано Tasks.ExampleBackgroundTask.
