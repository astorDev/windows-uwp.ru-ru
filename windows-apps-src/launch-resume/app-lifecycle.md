...
Windows 10, версия 1607, предоставляет два дополнительных состояния модели приложений: **Выполняется на переднем плане** и **выполняется в фоновом режиме**. Мы также рассмотрим эти новые состояния в следующих разделах.
