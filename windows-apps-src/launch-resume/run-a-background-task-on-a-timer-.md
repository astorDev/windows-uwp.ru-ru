...
См. в разделе **Scenario4** в [пример фоновой активации](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/BackgroundActivation) , чтобы просмотреть пример реализации времени, подключение, инициируемое фоновой задачи, описанного в этой статье.
...
- Времени ЦП: фоновые задачи ограничены по секундами использования времени они получают в зависимости от типа триггера.
