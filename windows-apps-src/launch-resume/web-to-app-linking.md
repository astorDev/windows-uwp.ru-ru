...
- Файл JSON, определяющий связь между вашим приложением и веб-сайт. объявление манифеста с именем семейства пакета приложения в той же корневой, что и приложение.
- Обработка активации в приложении.

> [!Note]
> Начиная с Windows 10 Creators update, поддерживаемых выбранных ссылок в Microsoft Edge запустится соответствующим приложением. Поддерживаемые выбранных ссылок в других браузерах (например Internet Explorer, и т.д.), будет хранить в работу в Интернете.
...
[запуска связь пример](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/AssociationLaunching) демонстрирует использование LaunchUriAsync() API.
