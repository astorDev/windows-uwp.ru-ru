...
Узнайте, как ваше приложение распознает события выполнения и завершения, сообщаемые фоновой задачей, которая выполняется отдельным процессом. (Для фоновых задач, выполняемых в том же процессе, можно задать общие переменные для обозначения хода выполнения и завершения).

 Фоновые задачи не связаны с приложением и выполняются отдельно, но код приложения может наблюдать за выполнением и завершением фоновых задач. Для этого приложение подписывается на события фоновых задач, которые оно зарегистрировало в системе.
