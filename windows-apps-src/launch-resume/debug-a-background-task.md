...
description: Сведения о том, как отладить фоновую задачу, используя в том числе активацию фоновой задачи и данные по трассировке отладки в журнале событий Windows.
