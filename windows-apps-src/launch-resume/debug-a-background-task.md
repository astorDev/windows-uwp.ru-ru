...
3.  Только Windows. Чтобы увидеть точку входа, используемую Windows для активации фоновой задачи, включите трассировку отладки и используйте журнал событий Windows.
    ...
    2.  Перейдите к **приложению и журналы служб**  - &gt; **Microsoft**  - &gt; **Windows**  - &gt; **BackgroundTaskInfrastructure** в средстве просмотра событий.
    3.  В панели действий выберите **представление**  - &gt; **Отобразить аналитический и отладочный журналы** для включения ведения журнала диагностики.
