...
| [Запустите приложение UWP](launch-store-app.md) | В этом разделе описывается схема URI ms-windows-store. Ваше приложение может использовать эту схему URI для запуска приложения UWP на определенных страницах в Store. |
...
| [Включение приложений для веб-сайтов с помощью обработчиков URI приложения](web-to-app-linking.md) | Диск взаимодействия пользователей с вашего приложения за счет поддержки приложений для функции веб-сайтов. |
