...
description: Описывается, как создать фоновую задачу, которая выполняется при обновлении приложения магазина универсальной платформы Windows (UWP).
ms.date: 05/07/2018
ms.topic: article
...
ms.locfileid: "9116186"
---
# <a name="extend-your-app-with-services-extensions-and-packages"></a>Расширение приложения за счет служб, расширений и пакетов

Существует множество возможностей в Windows 10 для расширения и разделении компоненты вашего приложения. Эта таблица поможет определить, какую технологию следует использовать в зависимости от требований. Далее идет краткое описание сценариев и технологий.
...
|------------------------------------|:------------------:|:------------------:|:------------------:|:------------------:|:------------------:|:------------------:|:------------------:|
| Подключаемые модули кода сторонних поставщиков            |                    |                    |                    |                    | :heavy_check_mark: |                    |                    |
...
**Подключаемых модулей сторонних поставщиков**  
...
Код, что работает внутри процесса приложения. Поддерживается только в C++. Может также включать содержимое. Поскольку код выполняется в процессе, считается более высокий уровень доверия. Вы можете не для предоставления такого рода расширения для сторонних поставщиков.
...
**Оптимизация упаковки** Оптимизация процесса создания пакета приложения для крупномасштабных или сложных приложений.
