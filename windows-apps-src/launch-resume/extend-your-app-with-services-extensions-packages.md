...
Код, что работает внутри процесса приложения. Может также включать содержимое. Поскольку код выполняется в процессе, считается более высокий уровень доверия. Вы можете отказаться от предоставления такого рода расширяемости сторонним разработчикам.
