...
> **Примечание**. Если вы являетесь изготовителем устройства и хотите назначить свое [приложение Microsoft Store для устройства](http://go.microsoft.com/fwlink/p/?LinkID=301381) в качестве обработчика **автозапуска** для вашего устройства, вы можете задать это приложение в метаданных устройства. Подробнее см. в разделе об [автозапуске приложений Microsoft Store для устройства](http://go.microsoft.com/fwlink/p/?LinkId=306684).
