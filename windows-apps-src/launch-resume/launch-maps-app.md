...
<div class="alert">
**Примечание**Если опустить параметр **sty** дает те же результаты, как sty = r.
</div>
<div>
 
</div></td>
...
<div class="alert">
**Примечание**на уровне улиц доступно не во всех регионах.
</div>
<div>
 
</div></td>
...
<div class="alert">
**Примечание**для местоположения может использоваться заголовок, если оно указано значение параметра **pos** . Вместо широты и долготы будет отображаться заголовок.
</div>
<div>
 
</div></td>
