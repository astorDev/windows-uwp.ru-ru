...
**Совет.** Чтобы получить дополнительные сведения о запуске приложения «Карты Windows» из вашего приложения, скачайте документ [Пример карты универсальной платформы Windows (UWP)](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/MapControl) из [репозитория Windows-universal-samples](https://github.com/Microsoft/Windows-universal-samples) на веб-сайте GitHub.
...
Чтобы запустить приложение «Карты Windows» из вашего приложения, вызовите метод [**LaunchUriAsync**](https://docs.microsoft.com/uwp/api/windows.system.launcher.launchuriasync) с URI **bingmaps:** , **ms-drive-to:** или **ms-walk-to:** . Следующий пример запускает тот же URI из предыдущего примера. Подробнее о запуске приложений с помощью схем URI см. в разделе [Запуск приложения по умолчанию для универсального кода ресурса (URI)](launch-default-app.md).
...
| bingmaps:? Collection = Point. 40.726966\_-74,006076\_некоторые% 255FBusiness        | Отображает карту с точкой с названием\_Business (в Лас-деньги).                                                                                                                               |
...
| bingmaps:? Collection = Point. 40.726966\_-74,006076\_поддельный% 255FBusiness% 255Fwith% 255FUnderscore                                                                        | Отображает Нью-Йорк с канцелярской признаком подставной\_Business\_с\_подчеркиванием.                                                  |
...
<ul>
<li><b>a</b>: гибридный вид карты.</li>
<li><b>r</b>: дорожное представление карты.</li>
<li><b>3d</b>: трехмерное представление карты. Используйте в сочетании с параметром <b>cp</b> и, при необходимости, с параметром <b>rad</b>.</li>
</ul>
...
<div class="alert">
<b>Обратите внимание</b> ,  изображения на уровне улицы доступны не во всех регионах.
</div>
<div>
 
</div></td>
...
<div class="alert">
<b>Обратите внимание</b> ,  данные трафика доступны не во всех регионах.
</div>
<div>
 
</div></td>
...
<div class="alert">
<b>Примечание</b> .  заголовок можно использовать для расположения, если расположение указано значением параметра <b>POS</b> . Вместо широты и долготы будет отображаться заголовок.
</div>
<div>
 
</div></td>
...
<ul>
<li><b>d</b>: обзор маршрута на автомобиле</li>
<li><b>t</b>: обзор маршрута на общественном транспорте</li>
<li><b>w</b>: обзор пешеходного маршрута</li>
</ul>
