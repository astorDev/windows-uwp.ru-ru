...
| bingmaps:?bb=39.719\_-74.52~41.71\_-73.5&q=pizza              | Поиск пиццы в указанном ограничивающем прямоугольнике (то есть в Нью-Йорке).      |
...
<div class="alert">
<b>Note</b>  A title can be used for a location if the location is specified by the <b>pos</b> parameter value. Вместо широты и долготы будет отображаться заголовок.
</div>
<div>
 
</div></td>
