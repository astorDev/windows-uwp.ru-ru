...
Чтобы увидеть ее в действии, вот видео о создании консольного приложения UWP.
...
- Консольные приложения UWP не могут создавать окна. Они не могут использовать MessageBox(), или Location() или другие API, который может создать окно по любой причине, таких как предлагает согласия пользователя.
