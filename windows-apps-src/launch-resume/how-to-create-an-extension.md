...
|---------|-----------|:------:|
|**Название**|Это имя контракта расширения. Если оно соответствует элементу **Name**, объявленному в основном приложении, это приложение сможет найти данное расширение.| :heavy_check_mark: |
