...
* [Пространство имен UserActivity](https://docs.microsoft.com/uwp/api/windows.applicationmodel.useractivities)

## <a name="related-topics"></a>Статьи по теме

* [Адаптивные карты](https://docs.microsoft.com/en-us/adaptive-cards/)
...
* [Project Rome на Github](https://github.com/microsoft/project-rome)
* [Project Rome в Центре разработки для Windows](https://aka.ms/projectrome)