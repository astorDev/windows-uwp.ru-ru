...
Используйте следующие URI для открытия разных страниц приложения «Параметры». Обратите внимание, что в столбце «Поддерживаемые SKU» указано, существует ли данная страница параметров в классических выпусках Windows10 (Домашняя, Pro, Корпоративная и для образовательных учреждений), в Windows10 Mobile или в обоих вариантах.
