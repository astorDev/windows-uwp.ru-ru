...
Вне процесса фоновые задачи являются более устойчивыми, поскольку фоновый процесс не может прекратить работу приложения, если что-то пойдет не так. Но устойчивость порождает по цене управление взаимоотношениями между процессами между приложением и фоновой задачи.
