...
title: "Работа приложения в свернутом состоянии с помощью расширенного сеанса выполнения"
...
# <a name="run-while-minimized-with-extended-execution"></a>Работа приложения в свернутом состоянии с помощью расширенного сеанса выполнения
...
Для этого требуется создать класс [ExtendedExecutionSession](https://msdn.microsoft.com/en-us/library/windows/apps/windows.applicationmodel.extendedexecution.extendedexecutionsession.aspx), чтобы запросить больше времени на завершение работы приложения в фоновом режиме. Тип создаваемого класса **ExtendedExecutionSession** определяется перечислением [ExtendedExecutionReason](https://msdn.microsoft.com/en-us/library/windows/apps/windows.applicationmodel.extendedexecution.extendedexecutionreason.aspx), которое вы предоставляете при создании класса. У перечисления **ExtendedExecutionReason** есть три значения: **Unspecified, LocationTracking** и **SavingData**.
...
[Жизненный цикл приложения](https://msdn.microsoft.com/en-us/windows/uwp/launch-resume/app-lifecycle)  
[Управление памятью при переходе приложения в фоновый режим](https://msdn.microsoft.com/en-us/windows/uwp/launch-resume/reduce-memory-usage)  
[Фоновая передача данных](https://msdn.microsoft.com/en-us/windows/uwp/networking/background-transfers)  [Фоновые процессы и электропитание](https://blogs.windows.com/buildingapps/2016/08/01/battery-awareness-and-background-activity/#I2bkQ6861TRpbRjr.97)  
[Класс MemoryManager](https://msdn.microsoft.com/en-us/library/windows/apps/windows.system.memorymanager.aspx)  
