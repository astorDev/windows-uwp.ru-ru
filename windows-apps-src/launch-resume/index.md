...
| [Перенос вне процесса фоновую задачу в фоновую задачу в процессе](convert-out-of-process-background-task.md) | Узнайте, как перенести вне процесса фоновые задачи, выполняемой внутри процесса фоновую задачу, которая выполняется в том же процессе, что и приложение переднего плана.|
