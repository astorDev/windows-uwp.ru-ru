...
| [Работа приложения в свернутом состоянии с помощью расширенного сеанса выполнения](run-minimized-with-extended-execution.md) | Узнайте, как использовать расширенный сеанс выполнения для обеспечения работы приложения в свернутом состоянии |

## <a name="launch-apps"></a>Запуск приложений

В разделе [Запуск приложения с помощью URI](launch-app-with-uri.md) подробно описано, как использовать универсальный код ресурса (URI) для запуска одного приложения из другого.
...
В разделе [Службы приложений](app-services.md) описывается, как интегрировать службы приложений с приложением UWP, чтобы разрешить общий доступ к данным и функциям между приложениями.
...
| [Расширение приложения за счет его служб, расширений и пакетов](extend-your-app-with-services-extensions-packages.md) | Существуют различные технологии в Windows 10, которые помогут вам расширить и разбить на компоненты ваше приложение. Этот раздел поможет вам определить, какая технология вам подходит больше всего. В нем также представлен короткий обзор каждой технологии. |
