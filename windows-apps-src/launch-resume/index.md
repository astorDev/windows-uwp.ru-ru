...
| [Создание и регистрация фоновой задачи, выполняемой вне процесса](create-and-register-an-outofproc-background-task.md)                               | Создание и регистрация фоновой задачи, которая запускается в виде отдельного процесса из вашего приложения, и регистрация ее для выполнения, когда приложение находится не на переднем плане.                                                                                                 |
...
| [Преобразование службы приложения для ее запуска в одном процессе с приложением узла](convert-app-service-in-process.md)                                | Узнайте, как преобразовать код службы приложений, который выполняется в отдельном фоновом процессе, в код, который выполняется в том же процессе, что и приложение, в котором размещается ваша служба приложения.                                                                                  |
