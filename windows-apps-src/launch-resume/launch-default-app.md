...
|[ms-tonepicker:](#tone-uri-scheme) | Средство выбора звуковых сигналов |
...
### Вызов метода LaunchUriAsync для запуска URI
...
### Если приложение для обработки данного URI отсутствует, порекомендуйте приложение.
...
<br>
### Схема URI приложения «Сообщения»
...
<br>
### Схема URI средства выбора звуковых сигналов
...
### Схема URI приложения «Телефоны мест по соседству»
<br>
