...
-   [Отправка локального всплывающего уведомления](https://blogs.msdn.microsoft.com/tiles_and_toasts/2015/07/08/quickstart-sending-a-local-toast-notification-and-handling-activations-from-it-windows-10/)
...
* [Обзор периодических уведомлений](tiles-and-notifications-periodic-notification-overview.md)
* [Обзор служб push-уведомлений Windows (WNS)](tiles-and-notifications-windows-push-notification-services--wns--overview.md)
