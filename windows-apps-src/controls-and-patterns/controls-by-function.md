---
Description: Перечисляет сгруппированные по функциям типовые элементы управления, которые можно использовать в приложении.
title: Элементы управления по функциям
ms.assetid: 8DB4347B-91D6-4659-91F2-80ECF7BBB596
label: Элементы управления по функциям
template: detail.hbs
---
