...
<b>Важные API</b><br/>
<ul>
<li>[**Класс StartScreenManager**](https://docs.microsoft.com/en-us/uwp/api/windows.ui.startscreen.startscreenmanager)</li>
...
* [Документация по адаптивной плитке](tiles-and-notifications-create-adaptive-tiles.md)