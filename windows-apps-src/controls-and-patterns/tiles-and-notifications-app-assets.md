---
description: Ресурсы значков, присутствующие в различных формах во всевозможных разделах операционной системы Windows 10, являются картами вызова приложения UWP.
title: Ресурсы плиток и значков
ms.assetid: D6CE21E5-2CFA-404F-8679-36AA522206C7
label: Ресурсы плиток и значков
template: detail.hbs
---
...
## <span id="Adaptive_scaling"></span><span id="adaptive_scaling"></span><span id="ADAPTIVE_SCALING"></span>Адаптивное масштабирование
...
## <span id="Tile_elements"></span><span id="tile_elements"></span><span id="TILE_ELEMENTS"></span>Элементы плиток
...
## <span id="Tile_assets"></span><span id="tile_assets"></span><span id="TILE_ASSETS"></span>Ресурсы плиток
...
## <span id="Tile_assets_in_list_views"></span><span id="tile_assets_in_list_views"></span><span id="TILE_ASSETS_IN_LIST_VIEWS"></span>Ресурсы плиток в виде списка
...
## <span id="Splash_screen_assets"></span><span id="splash_screen_assets"></span><span id="SPLASH_SCREEN_ASSETS"></span>Ресурсы экрана-заставки
...
## <span id="High-contrast_assets"></span><span id="high-contrast_assets"></span><span id="HIGH-CONTRAST_ASSETS"></span>Высококонтрастные ресурсы
...
## <span id="Asset_size_tables"></span><span id="asset_size_tables"></span><span id="ASSET_SIZE_TABLES"></span>Таблицы размеров ресурсов
...
## <span id="Asset_types"></span><span id="asset_types"></span><span id="ASSET_TYPES"></span>Типы ресурсов
