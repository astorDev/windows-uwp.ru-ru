...
---
# Иерархический макет с TreeView
...
## Структура пользовательского интерфейса TreeView
...
#### Красные линии для отступа папок и не являющихся папками узлов
...
## Создание шаблона данных для TreeViewItem
