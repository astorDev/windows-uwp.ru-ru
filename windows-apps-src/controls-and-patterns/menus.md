...
Вы не обязаны предоставлять значки для каждого пункта меню, особенно если меню длинное или команда не имеет стандартных зрительных образов. Загадочные значки бесполезны, создают визуальные помехи и не позволяют пользователям сосредоточиться на важных меню.
