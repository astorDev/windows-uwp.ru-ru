---
description: С помощью стилей можно настраивать свойства элементов управления и использовать эти параметры, чтобы придать единообразный внешний вид нескольким элементам.
MS-HAID: 'dev\_ctrl\_layout\_txt.styling\_controls'
MSHAttr: 'PreferredLib:/library/windows/apps'
Search.Product: eADQiWindows 10XVcnh
title: Настройка стиля элементов управления
ms.assetid: AB469A46-FAF5-42D0-9340-948D0EDF4150
label: Настройка стиля элементов управления
template: detail.hbs
---
