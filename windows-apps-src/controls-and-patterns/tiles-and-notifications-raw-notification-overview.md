...
**Внимание**! Прежде чем использовать фоновые задачи необработанного уведомления, приложению необходимо п должно предоставить фоновый доступ посредством [**BackgroundExecutionManager.RequestAccessAsync**](https://msdn.microsoft.com/library/windows/apps/hh700485).
