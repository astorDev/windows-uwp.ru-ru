...
Если вы работаете с плитками, использовать эти глифы нельзя, так как вы не можете задать шрифт для плитки и к глифам области личных символов невозможно получить доступ путем перехода на резервный вариант шрифта.
...
Шрифт Segoe UI Symbol также использовал глифы «нулевой ширины» для наложения и колоризации, как в следующем примере, где черный контур (U+E006) можно нарисовать поверх красного сердца нулевой ширины (U+E00B).

![Использование глифов нулевой ширины](images/segoe-ui-symbol-layering.png)

Все глифы в **Segoe MDL2 Assets** имеют одинаковую фиксированную ширину с соответствующей высотой и левой исходной точкой, поэтому эффектов наложения и колоризации можно добиваться, рисуя глифы непосредственно друг над другом.
...
При разработке приложения на C#, VB, C++ и XAML вы можете использовать [**Перечисление Symbol**](https://msdn.microsoft.com/library/windows/apps/dn252842) вместо идентификатора Юникода, чтобы указать глифы из шрифта Segoe MDL2 Assets. При разработке приложения на JavaScript и HTML вы можете использовать [**Перечисление AppBarIcon**](https://msdn.microsoft.com/library/windows/apps/hh770557) вместо идентификатора, представленного в Юникоде, чтобы указать глифы из шрифта **Segoe MDL2 Assets**.

Также помните, что шрифт **Segoe MDL2 Assets** содержит намного больше значков, чем мы можем показать здесь. Многие из них предназначены для специализированных целей и обычно не используются в других областях.

## <span id="Hearts"></span><span id="hearts"></span><span id="HEARTS"></span>Сердца
...
<td align="left"><p>Контур сердца</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Сердце со сплошной заливкой</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>Разбитое сердце</p></td>
</tr>
<tr class="even">
...
<td align="left"><p>Сердце со сплошной заливкой (нулевой ширины)</p></td>
</tr>
<tr class="odd">
...
<td align="left"><p>Разбитое сердце (нулевой ширины)</p></td>
</tr>
</tbody>
</table>
...
## <span id="Rating_stars"></span><span id="rating_stars"></span><span id="RATING_STARS"></span>Звезды
...
<td align="left">Контур звезды</td>
</tr>
<tr class="even">
...
<td align="left">Звезда со сплошной заливкой</td>
</tr>
<tr class="odd">
...
<td align="left">Звезда со сплошной заливкой (нулевой ширины)</td>
</tr>
<tr class="even">
...
<td align="left">Звезда со сплошной заливкой (сокращенный отступ для использования в HTML)</td>
</tr>
<tr class="odd">
...
<td align="left">Правая половина звезды</td>
</tr>
</tbody>
</table>
...
## <span id="Checkbox_components"></span><span id="checkbox_components"></span><span id="CHECKBOX_COMPONENTS"></span>Компоненты флажков


|        |                                                                                |                                 |                         |
|--------|--------------------------------------------------------------------------------|---------------------------------|-------------------------|
| Код   | Символ                                                                         | Перечисление                            | Описание             |
| U+E001 | ![checkmarklegacy](images/checkmarklegacy.png)                                 | CheckMarkLegacy                 | Галочка              |
| U+E002 | ![checkboxfilllegacy](images/checkboxfilllegacy.png)                           | CheckboxFillLegacy              | Установленный флажок         |
| U+E003 | ![checkboxlegacy](images/checkboxlegacy.png)                                   | CheckboxLegacy                  | Флажок                |
| U+E004 | ![checkboxindeterminatelegacy](images/checkboxindeterminatelegacy.png)         | CheckboxIndeterminateLegacy     | Неопределенное состояние     |
| U+E005 | ![checkboxcompositereversedlegacy](images/checkboxcompositereversedlegacy.png) | CheckboxCompositeReversedLegacy | Белая галочка на черном фоне                |
| U+E008 | ![checkmarkzerowidthlegacy](images/checkmarkzerowidthlegacy.png)               | CheckMarkZeroWidthLegacy        | Галочка (нулевой ширины) |
| U+E009 | ![checkboxfillzerowidthlegacy](images/checkboxfillzerowidthlegacy.png)         | CheckboxFillZeroWidthLegacy     | Заливка (нулевой ширины)       |
| U+E0A2 | ![checkboxcompositelegacy](images/checkboxcompositelegacy.png)                 | CheckboxCompositeLegacy         | Объединение               |
| U+E739 | ![флажок](images/checkbox.png)                                               | Флажок                        | Флажок                |
| U+E73A | ![checkboxcomposite](images/checkboxcomposite.png)                             | CheckboxComposite               | Композитный флажок      |
| U+E73B | ![checkboxfill](images/checkboxfill.png)                                       | CheckboxFill                    | Установленный флажок         |
| U+E73C | ![checkboxindeterminate](images/checkboxindeterminate.png)                     | CheckboxIndeterminate           | Неопределенное состояние     |
| U+E73D | ![checkboxcompositereversed](images/checkboxcompositereversed.png)             | CheckboxCompositeReversed       | Композитный флажок (белая галочка на черном фоне)      |
| U+E73E | ![checkmark](images/checkmark.png)                                             | CheckMark                       | Галочка              |

 

## <span id="Miscellaneous"></span><span id="miscellaneous"></span><span id="MISCELLANEOUS"></span>Прочее
...
<td align="left">Контур избранного</td>
</tr>
<tr class="odd">
...
<td align="left">Избранное (с заливкой)</td>
</tr>
<tr class="odd">
...
<td align="left">Мобильный контакт</td>
</tr>
<tr class="odd">
...
<td align="left">Заблокированный контакт</td>
</tr>
<tr class="even">
...
<td align="left">Индикатор набора текста</td>
</tr>
<tr class="odd">
...
<td align="left">Значок присутствия видео</td>
</tr>
<tr class="even">
...
<td align="left">Значок присутствия</td>
</tr>
</tbody>
</table>
...
## <span id="Scroll_bar_arrows"></span><span id="scroll_bar_arrows"></span><span id="SCROLL_BAR_ARROWS"></span>Стрелки полос прокрутки


| Код   | Символ                                                                   | Перечисление                         |
|--------|--------------------------------------------------------------------------|------------------------------|
...
| Код   | Символ                                                                     | Перечисление                          | Описание                               |
|--------|----------------------------------------------------------------------------|-------------------------------|-------------------------------------------|
| U+E0C4 | ![backbttnarrow20legacy](images/backbttnarrow20legacy.png)                 | BackBttnArrow20Legacy         | Стрелка кнопки перехода назад, 20 pt                   |
| U+E0A6 | ![backbttnarrow42legacy](images/backbttnarrow42legacy.png)                 | BackBttnArrow42Legacy         | Стрелка кнопки перехода назад, 42 pt                   |
| U+E0AD | ![backbttnmirroredarrow20legacy](images/backbttnmirroredarrow20legacy.png) | BackBttnMirroredArrow20Legacy | Перевернутая стрелка кнопки перехода назад в зеркальном отображении, 20 pt |
| U+E0AB | ![backbttnmirroredarrow42legacy](images/backbttnmirroredarrow42legacy.png) | BackBttnMirroredArrow42Legacy | Перевернутая стрелка кнопки перехода назад в зеркальном отображении, 42 pt |
| U+E830 | ![chromeback](images/chromeback.png)                                       | ChromeBack                    | Хромированная кнопка перехода назад                        |
| U+EA47 | ![chromebackmirrored](images/chromebackmirrored.png)                       | ChromeBackMirrored            | Хромированная кнопка перехода назад в зеркальном представлении               |

 

## <span id="Back_arrows_for_HTML"></span><span id="back_arrows_for_html"></span><span id="BACK_ARROWS_FOR_HTML"></span>Стрелки перехода назад для HTML


Добавьте дополнительный код для создания окружностей вокруг этих глифов.

| Код   | Символ                                                         | Перечисление                    | Описание                |
|--------|----------------------------------------------------------------|-------------------------|----------------------------|
| U+E0D5 | ![arrowhtmllegacy](images/arrowhtmllegacy.png)                 | ArrowHTMLLegacy         | Стрелка для HTML         |
| U+E0AE | ![arrowhtmlmirroredlegacy](images/arrowhtmlmirroredlegacy.png) | ArrowHTMLMirroredLegacy | Зеркальная версия U+E0D5 |

 

## <span id="AppBar_glyphs"></span><span id="appbar_glyphs"></span><span id="APPBAR_GLYPHS"></span>Глифы панели приложения AppBar


Используйте глифы из следующего списка для панели [**AppBar**](https://msdn.microsoft.com/library/windows/apps/br229670). По соглашению они указываются по имени перечисления. Они разработаны как значки 20 × 20 пикселей без круга.
...
## <span id="Battery_icons"></span><span id="battery_icons"></span><span id="BATTERY_ICONS"></span>Значки батареи


| Код | Символ                                             | Перечисление              | Код | Символ                                                  | Перечисление                |
|------|----------------------------------------------------|-------------------|------|---------------------------------------------------------|---------------------|
