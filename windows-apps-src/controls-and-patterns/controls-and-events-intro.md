---
Description: Пользовательский интерфейс приложения, используемый для отображения и ввода данных пользователем, создается с помощью таких элементов управления, как кнопки, текстовые поля и поля со списком. Ниже показано, как добавлять элементы управления в приложение.
