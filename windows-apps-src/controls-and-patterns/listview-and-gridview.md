---
author: Jwmsft
Description: "Используйте элементы управления представлением списка или сетки, чтобы отображать наборы данных, например галерею изображений или набор сообщений электронной почты, и выполнять с ними различные действия."
title: "Представление списка и сетки"
...
<li><a href="https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.itemscontrol.itemssource.aspx"><strong>Свойство ItemsSource</strong></a></li>
<li><a href="https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.controls.itemscontrol.items.aspx"><strong>Свойство Items</strong></a></li>
</ul>
...
В этом примере элемент данных является простой строкой. DataTemplate используется для добавления изображения слева от строки и отображения строки синим.  
...
-------------|------------
Нет | <ul><li>Пользователь может выбрать один элемент с помощью клавиши пробела, щелчка мыши или касания.</li></ul>
Ctrl | <ul><li>Пользователь может отменить выбор одного элемента с помощью клавиши пробела, щелчка мыши или касания.</li><li>С помощью клавиш со стрелками пользователь может перемещать фокус независимо от выделения.</li></ul>
...
Клавиша-модификатор | Тип взаимодействия
-------------|------------
Нет | <ul><li>Пользователь может выбрать несколько элементов с помощью клавиши пробела, щелчка мыши или касания сенсорной панели, чтобы выбрать элемент в фокусе или отменить его выбор.</li><li>С помощью клавиш со стрелками пользователь может перемещать фокус независимо от выделения.</li></ul>
Shift | <ul><li>Пользователь может выбрать несколько смежных элементов, щелкнув первый элемент выделения (или коснувшись его), а затем— последний.</li><li>С помощью клавиш со стрелками пользователь может создать непрерывное выделение, начиная с выбранного с нажатой клавишей Shift элемента.</li></ul>
...
Клавиша-модификатор | Тип взаимодействия
-------------|------------
Нет | <ul><li>Поведение схоже с выделением **Single**.</li></ul>
Ctrl | <ul><li>Пользователь может выбрать несколько элементов с помощью клавиши пробела, щелчка мыши или касания сенсорной панели, чтобы выбрать элемент в фокусе или отменить его выбор.</li><li>С помощью клавиш со стрелками пользователь может перемещать фокус независимо от выделения.</li></ul>
Shift | <ul><li>Пользователь может выбрать несколько смежных элементов, щелкнув первый элемент выделения (или коснувшись его), а затем— последний.</li><li>С помощью клавиш со стрелками пользователь может создать непрерывное выделение, начиная с выбранного с нажатой клавишей Shift элемента.</li></ul>
...
Сведения о порядке изменения внешнего вида выбранных элементов см. в разделе [Шаблоны элементов представления списка](listview-item-templates.md).

### Перетаскивание

Элементы управления ListView и GridView поддерживают перетаскивание элементов внутри данного элемента управления, а также между данным и другими элементами управления ListView и GridView. Подробнее о реализации шаблона перетаскивания см. в разделе [Перетаскивание](https://msdn.microsoft.com/windows/uwp/app-to-app/drag-and-drop). 

## Получение примеров

*   [Пример ListView и GridView на языке XAML](http://go.microsoft.com/fwlink/p/?LinkId=619900)<br/>
    В этом примере показано использование элементов управления ListView и GridView.
