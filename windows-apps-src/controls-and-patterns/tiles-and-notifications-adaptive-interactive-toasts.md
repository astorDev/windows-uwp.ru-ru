---
description: Данная функция позволяет создавать удобные уведомления с большим объемом содержимого, встроенными изображениями и дополнительными возможностями.
title: Адаптивные и интерактивные всплывающие уведомления
ms.assetid: 1FCE66AF-34B4-436A-9FC9-D0CF4BDA5A01
label: Адаптивные и интерактивные всплывающие уведомления
template: detail.hbs
---
...
## <span id="toast_structure"></span><span id="TOAST_STRUCTURE"></span>Структура всплывающего уведомления
...
### <span id="Visual"></span><span id="visual"></span><span id="VISUAL"></span>Визуальные элементы
...
### <span id="Audio"></span><span id="audio"></span><span id="AUDIO"></span>Звук
...
## <span id="Alarms__reminders__and_incoming_calls"></span><span id="alarms__reminders__and_incoming_calls"></span><span id="ALARMS__REMINDERS__AND_INCOMING_CALLS"></span>Будильники, напоминания и входящие вызовы
...
-   Уведомления о входящих вызовах на устройствах Windows Mobile открываются во весь экран. Для этого задается атрибут сценария внутри корневого элемента всплывающего уведомления — &lt;toast&gt;:
    &lt;toast scenario=" { default | alarm | reminder | incomingCall } " &gt;

## <span id="xml_examples"></span><span id="XML_EXAMPLES"></span>Примеры XML
...
## <span id="Activation_samples"></span><span id="activation_samples"></span><span id="ACTIVATION_SAMPLES"></span>Примеры активации
...
## <span id="Schemas___visual__and__audio_"></span><span id="schemas___visual__and__audio_"></span><span id="SCHEMAS___VISUAL__AND__AUDIO_"></span>Схемы: &lt;visual&gt; и &lt;audio&gt;
...
## <span id="Schemas___action_"></span><span id="schemas___action_"></span><span id="SCHEMAS___ACTION_"></span>Схемы: &lt;action&gt;
...
## <span id="Attributes_for_system-handled_actions"></span><span id="attributes_for_system-handled_actions"></span><span id="ATTRIBUTES_FOR_SYSTEM-HANDLED_ACTIONS"></span>Атрибуты для обрабатываемых системой действий
