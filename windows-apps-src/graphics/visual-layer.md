...
-   [**LayerVisual**](https://msdn.microsoft.com/library/windows/apps/windows.ui.composition.layervisual.aspx) — ContainerVisual, потомки которого преобразованы в один уровень.  
