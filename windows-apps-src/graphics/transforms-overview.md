...
**Примечание о миграции.** Windows Presentation Foundation (WPF) содержит свойство **LayoutTransform**, применяющее преобразования перед этапом разметки. Однако XAML среды выполнения Windows не поддерживает свойство **LayoutTransform**. (В Microsoft Silverlight нет этого свойства.)
