...
## <span id="3-D_transforms"></span><span id="3-d_transforms"></span><span id="3-D_TRANSFORMS"></span>Трехмерные преобразования

Трехмерные эффекты можно применять к любому [**UIElement**](https://msdn.microsoft.com/library/windows/apps/BR208911) с помощью *преобразований перспективы*. Например, вы можете создать иллюзию того, что объект поворачивается к вам или отворачивается от вас на плоскости перспективы. Для этого присвойте свойству [**Projection**](https://msdn.microsoft.com/library/windows/apps/xaml/windows.ui.xaml.uielement.projection.aspx) объекта **UIElement** значение [**PlaneProjection**](https://msdn.microsoft.com/library/windows/apps/BR210192). Класс **PlaneProjection** определяет способ отрисовки преобразования в смоделированном трехмерном пространстве. Этот тип преобразования подробно описан в разделе [Объемные эффекты перспективы для пользовательского интерфейса на XAML](3-d-perspective-effects.md).

**Примечание.**   Технически возможно получить похожие результаты с помощью сочетания классов [**Transform**](https://msdn.microsoft.com/library/windows/apps/BR243006), но метод [**PlaneProjection**](https://msdn.microsoft.com/library/windows/apps/BR210192) с изображениями в виде кистей обычно выглядит лучше, и задать правильные значения свойства гораздо проще.

 

## <span id="related_topics"></span>Связанные разделы

* [Рисование фигур](drawing-shapes.md)
