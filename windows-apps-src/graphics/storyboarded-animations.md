...
**Совет.** Если вы создаете визуальные состояния для элемента управления с Visual Studio, то конструктор будет отображать предупреждения при каждой попытке применить зависимую анимацию к свойству визуального состояния.
