...
translationtype: HT
---
# <a name="windows-store-app-marketing-guidelines"></a>Рекомендации по продвижению приложений Магазина Windows
...
[![Кнопка скачивания](images/downloadbutton.png)](https://go.microsoft.com/fwlink/p/?LinkId=533057) Изображения устройств с Windows
