...
ms.locfileid: "2866108"
---
# <a name="create-customer-groups"></a>Создание групп пользователей

Можно создать *группы клиентов* , включают сокращенный набор вашего приложения. Эти группы можно использовать клиентам рекламных акций, тестирования и других целей.

Для просмотра и создания групп клиентов, разверните узел **Владейте** в левого меню переходов центра [разработчиков Windows](https://partner.microsoft.com/dashboard), а затем выберите **группы клиентов**.
