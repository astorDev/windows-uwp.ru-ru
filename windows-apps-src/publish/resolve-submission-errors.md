...
Если вы отправляете приложение UWP, вы можете увидеть ошибку во время предварительной обработки, если файл пакета не файл .msixupload или .appxupload, созданным Visual Studio для магазина. Убедитесь, что при создании файла пакета приложения, выполните действия, описанные в [пакет приложения UWP с помощью Visual Studio](../packaging/packaging-uwp-apps.md) и только отправить файл .msixupload или .appxupload на странице " [пакеты](upload-app-packages.md) " отправки, .msix или appx или .msixbundle/appxbundle .
...
## <a name="desktop-application"></a>Классические приложения
...
> [!IMPORTANT]
>  Если имя, которое вы хотите использовать недоступен, приложение может оно уже зарезервировано для этого. Если ваше приложение уже опубликовано под этим именем, или если вы считаете, что вы имеете право использовать его, [обратитесь в службу поддержки](https://go.microsoft.com/fwlink/p/?LinkId=331509).  
