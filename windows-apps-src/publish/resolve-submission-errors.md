...
Если вы отправляете приложение UWP, вы можете увидеть ошибку во время предварительной обработки, если файл пакета не является файлом .msixupload или .appxupload, созданным Visual Studio для магазина. Убедитесь, что при создании файла пакета приложения, выполните действия, описанные в [пакет приложения UWP с помощью Visual Studio](../packaging/packaging-uwp-apps.md) и только отправить файл .appxupload или .msixupload на странице " [пакеты](upload-app-packages.md) " отправки, не является .msix/appx или .msixbundle/appxbundle .
