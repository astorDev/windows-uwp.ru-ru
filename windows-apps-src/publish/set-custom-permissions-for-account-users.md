...
-   (В том числе группы и приложения Azure AD) пользователи не смогут доступ ко всей учетной записи центра партнеров с разрешениями, связанными с их ограниченного роли, если только вы [настроить разрешения](#custom) и назначьте [разрешения уровня продукта](#product-level-permissions) Таким образом, чтобы они могли работать только с определенным приложениям или надстройкам.
...
По умолчанию набор стандартных ролей доступен, которые вы можете назначать при добавлении пользователя, группу или приложение Azure AD в учетную запись центра партнеров. Каждая роль имеет определенный набор разрешений для выполнения определенных функций в учетной записи. 
...
| Роль                 | Описание              |
|----------------------|--------------------------|
| Менеджер              | Имеет полный доступ к учетной записи, за исключением права на изменение параметров налогов и выплат. Это относится и управление пользователями в центре партнеров, но Обратите внимание, что право на создание и удаление пользователей в клиенте Azure AD зависит от разрешений в Azure AD. То есть если пользователю назначена роль, но не имеет разрешения глобального администратора в организации Azure AD, они не смогут создавать или удалять пользователей из каталога (но сможет изменять их роли в центре партнеров). <p> Обратите внимание, что если учетная запись центра партнеров связана с более чем одним клиентом Azure AD, менеджер не сможет увидеть полные сведения для пользователя (имя, фамилию, электронную почту для восстановления пароля, в том числе и укажите, являются ли они глобальным администратором Azure AD) если они не находятся вход для того же клиента, что и пользователь с учетной записью с разрешениями глобального администратора для этого клиента. Тем не менее они могут добавлять и удалять пользователей из любого клиента, связанного с учетной записью центра партнеров. |
...
<table>
    ...
    <tr><td align="left">    <b>Связаться с клиентом</b>  </td><td>    Можно просматривать <a href="respond-to-customer-feedback.md">ответы на отзывы клиентов</a> и <a href="respond-to-customer-reviews.md">ответы на рецензии клиентов</a>, если также предоставлено разрешение <b>Отзывы клиентов</b>. Можно также просматривать <a href="send-push-notifications-to-your-apps-customers.md">целевые уведомления</a>, созданные для этого продукта.    </td><td>    Можно <a href="respond-to-customer-feedback.md">отвечать на отзывы клиентов</a> и <a href="respond-to-customer-reviews.md">отвечать на отзывы клиентов</a>, до тех пор, пока также предоставлено разрешение <b>Отзыв</b> . Можно также <a href="send-push-notifications-to-your-apps-customers.md">создавать и отправлять целевые уведомления</a> для продукта.                   </td><td>    Н/Д         </td><td>    Н/Д                          </td></tr>
