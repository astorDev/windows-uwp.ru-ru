...
По умолчанию доступен набор стандартных ролей, которые вы можете назначать при добавлении пользователя, группу или приложение Azure AD в учетную запись центра партнеров. Каждая роль имеет определенный набор разрешений для выполнения определенных функций в учетной записи. 
