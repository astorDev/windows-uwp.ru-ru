...
| Разработчик            | Может отправлять пакеты, приложения и надстройки, а также просматривать сведения телеметрии в [отчете об использовании](usage-report.md). Можно получить доступ к функциональности [Взаимодействия между устройствами](https://go.microsoft.com/fwlink/?linkid=874042) . Не может просматривать финансовую информацию и параметры учетной записи.   |
...
<tr><td align="left">    <b>Группы пользователей</b>                     </td><td align="left">  Можно просмотреть <a href="create-customer-groups.md">группы клиентов</a> (сегменты и групп известных пользователей).      </td><td align="left">  Создание, изменение и просмотр <a href="create-customer-groups.md">групп клиентов</a> (сегменты и групп известных пользователей).       </td></tr>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    <b>Приобретения</b>     </td><td>    Можно просматривать отчеты <a href="acquisitions-report.md">Приобретения</a> и <a href="add-on-acquisitions-report.md">Приобретения надстроек</a> для продукта.        </td><td>    Н/Д    </td><td>    Н/д (отчет о **приобретениях дополнительный компонент** следующие параметры для родительского продукта)        </td><td>    Н/Д                         </td></tr>
    ...
    <tr><td align="left">    <b>Аналитика Xbox</b> </td><td>    Можно просмотреть [Xbox аналитических отчетов](xbox-analytics-report.md) для продукта.    </td><td>    Н/Д   </td><td>    Н/Д       </td><td>    Н/Д          </td></tr>
...
<table>
    ...
    <tr><td align="left">    <b>Связаться с клиентом</b>  </td><td>    Можно просматривать <a href="respond-to-customer-feedback.md">ответы на отзывы клиентов</a> и <a href="respond-to-customer-reviews.md">ответы на рецензии клиентов</a>, если также предоставлено разрешение <b>Отзывы клиентов</b>. Можно также просматривать <a href="send-push-notifications-to-your-apps-customers.md">целевые уведомления</a>, созданные для этого продукта.    </td><td>    Можно <a href="respond-to-customer-feedback.md">ответить на отзывов клиентов</a> и <a href="respond-to-customer-reviews.md">реагировать на отзывы клиентов</a>, до тех пор, пока также предоставлены разрешения на <b>связи с отзывами клиентов</b> . Можно также <a href="send-push-notifications-to-your-apps-customers.md">создавать и отправлять целевые уведомления</a> для продукта.                   </td><td>    Н/Д         </td><td>    Н/Д                          </td></tr>
