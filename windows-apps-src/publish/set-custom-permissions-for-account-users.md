...
title: "Настройка пользовательских разрешений для пользователей учетных записей"
ms.assetid: 
...
# Настройка пользовательских разрешений для пользователей учетных записей

При добавлении пользователей в свою учетную запись можно присвоить им [стандартную роль](manage-account-users.md#roles-and-permissions) или настроить разрешения и предоставить соответствующий уровень доступа. Некоторые из этих разрешений применяются ко всей учетной записи, а некоторые могут предоставляться всем продуктам или лишь некоторым из них. 

Чтобы использовать пользовательские разрешения, а не стандартные роли, щелкните **Настройка разрешений доступа** в разделе **Роли** при добавлении или изменении учетной записи пользователя. 

> **Примечание**. Те же разрешения могут применяться независимо от того, добавляется ли пользователь, группа или приложение Azure AD.
...
<tr><td align="left">    **Отчет об эффективности рекламы на уровне учетной записи** </td><td align="left">  Можно просматривать [отчет об эффективности рекламы](advertising-performance-report.md#account-level-advertising-performance-report) на уровне учетной записи. (Невозможно просматривать отчеты об эффективности рекламы по отдельным продуктам, если такое разрешение не предоставляется отдельно.)       </td><td align="left">  Н/Д   </td></tr>
...
<tr><td align="left">    **Отчеты об эффективности рекламы**              </td><td align="left">  Можно просматривать [отчеты об эффективности рекламы](advertising-performance-report.md) для всех продуктов в учетной записи. (Невозможно просматривать [отчет об эффективности рекламы](advertising-performance-report.md#account-level-advertising-performance-report) на уровне учетной записи, если такое разрешение не предоставляется отдельно.)       </td><td align="left">  Можно просматривать [отчеты об эффективности рекламы](advertising-performance-report.md) для всех продуктов в учетной записи. (Невозможно просматривать [отчет об эффективности рекламы](advertising-performance-report.md#account-level-advertising-performance-report) на уровне учетной записи, если такое разрешение не предоставляется отдельно.)         </td></tr>
<tr><td align="left">    **Рекламные блоки**                            </td><td align="left">  Можно просматривать [рекламные блоки](monetize-with-ads.md), созданные для учетной записи.    </td><td align="left">  Можно создавать, просматривать [рекламные блоки](monetize-with-ads.md) для этой учетной записи и управлять ими.             </td></tr>
...
<tr><td align="left">    **Отчеты о рекламных объявлениях, которые привели к установке приложений**             </td><td align="left">  Можно просматривать [отчет о рекламных объявлениях, которые привели к установке приложений](app-install-ads-reports.md) для всех продуктов в учетной записи.           </td><td align="left">  Н/Д   </td></tr>
...
## Разрешения уровня продукта

Разрешения в этом разделе могут предоставляться для всех продуктов в учетной записи или настраиваться так, чтобы предоставить разрешения только для одного или нескольких конкретных продуктов. Эти разрешения сгруппированы в четыре категории: **Аналитика**, **Монетизация**, **Публикации** и **Xbox Live**. Можно развернуть каждую из этих категорий, чтобы просмотреть отдельные разрешения в каждой категории. 

Чтобы предоставить разрешение для всех продуктов в этой учетной записи, выберите соответствующие параметры для этого разрешения (установите переключатель в положение **Только чтение**, **Чтение и запись** или **Нет доступа**) в строке, помеченной **Все продукты**. 
 
> **Совет**. Выбранные в поле **Все продукты** параметры будут применяться для каждого продукта, который в настоящее время используется в учетной записи, а также для всех будущих продуктов, созданных в этой учетной записи.
...
<table>
    ...
    <tr><td align="left">    **Отзывы пользователей**    </td><td>    Можно просматривать отчеты [Оценки](ratings-report.md), [Рецензии](reviews-report.md) и [Отзывы](feedback-report.md) для продукта.       </td><td>    Н/Д (для ответа на отзывы или рецензии должно быть предоставлено разрешение **Связаться с клиентом**)   </td><td>    Н/Д     </td><td>    Н/Д         </td></tr>
    ...
    <tr><td align="left">    **В режиме реального времени**   </td><td>    Можно просматривать отчет по продукту в режиме реального времени.       </td><td>    Н/Д   </td><td>    Н/Д     </td><td>    Н/Д                 </td></tr>
    </tbody>
    </table>
...
<table>
    ...
    <tbody>
    <tr><td align="left">    **Конфигурация службы Xbox**&nbsp;\*    </td><td>    Можно просматривать параметры, связанные с достижениями, многопользовательским режимом, списками лидеров и другими настройками Xbox Live для продукта.  </td><td>    Можно просматривать и изменять параметры, связанные с достижениями, многопользовательским режимом, списками лидеров и другими настройками Xbox Live для продукта.  </td><td>    Н/Д     </td><td>    Н/Д                      </td></tr>
    <tr><td align="left">    **Каналы приложений**&nbsp;\*</td><td>    Н/Д  </td><td>    Можно публиковать рекламные видеоканалы на консоли Xbox для просмотра через OneGuide.  </td><td>  Н/Д </td><td> Н/Д </td></tr>
</tbody>
</table>
