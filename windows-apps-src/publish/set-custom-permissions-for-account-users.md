...
<table>
    ...
    <tr><td align="left"><b>устройств Xbox</b>&nbsp; @ no__t-3</td><td>    Может просматривать страницу консолей разработки Xbox One для учетной записи.  </td><td>    Может просматривать и редактировать страницу консолей разработки Xbox One для учетной записи.    </td><td>    Н/Д    </td><td>    Н/Д                      </td></tr>
