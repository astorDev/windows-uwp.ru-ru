---
author: jnHs
Description: "Настройка собственных разрешений для пользователей учетных записей."
...
# <a name="set-custom-permissions-for-account-users"></a>Настройка собственных разрешений для пользователей учетных записей
