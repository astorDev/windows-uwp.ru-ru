...
При просмотре **пользователей**, **устройств**или **длительность** вкладок при **30 D** выбранного периода времени, может появиться круглыми маркерами. Они представляют значительного увеличения или уменьшения заданное значение, мы думаем, что необходимо знать о. Дата, на котором отображается круг представляет конец недели, в которой обнаружено значительное увеличение или уменьшение по сравнению с на прошлой неделе. Для получения дополнительных сведений об изменениях, наведите указатель мыши на элемент управления circle.  

> [!TIP]
> Можно просмотреть дополнительные идеи, относящиеся к значительные изменения за последние 30 дней в [представление отчета](insights-report.md).
