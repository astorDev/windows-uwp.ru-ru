...
Выбрав **30 D** периода времени, при просмотре вкладок **пользователей**, **устройств**и **продолжительность** могут отображаться круг маркеры. Эти представления значительное увеличение или уменьшение в заданное значение, мы считаем, что необходимо знать о. Дата, на котором отображается круг представляет конец недели, в котором обнаружено значительное увеличение или уменьшение по сравнению с недели до этого. Для получения дополнительных сведений об изменениях, наведите указатель мыши на элемент управления circle.  
