...
2.  В таблице существующие уведомления выберите **в ходе выполнения** или **Completed**и посмотрите в столбцах **скорость доставки** и **скорость запуска приложения** , чтобы оценить общую эффективность каждого уведомления.
