...
[Центр партнеров](https://partner.microsoft.com/dashboard) предоставляет управляемую данными платформу для привлечения клиентов вы можно отправлять уведомления всем клиентам вашего приложения, или только подмножеству пользователей Windows 10 вашего приложения, которые соответствуют критериям, которые вы определили в [клиента Сегмент](create-customer-segments.md). Вы также можете создать уведомление было отправлено клиентам более одного из своих приложений.
...
1. В [Центре партнеров](https://partner.microsoft.com/dashboard)разверните раздел **привлечение** , а затем выберите **уведомления**.
