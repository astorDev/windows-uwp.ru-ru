...
ms.locfileid: "2816737"
---
# <a name="add-on-acquisitions-report"></a>Отчет о приобретении надстроек


Отчет о **приобретениях дополнительный компонент** на панели мониторинга Центр разработчиков Windows позволяет видеть надстройки продается, а также личных и сведения о платформе и отображает сведения о преобразования для клиентов на 10 Windows (в том числе Xbox). Можно также просмотреть рядом с данными в режиме реального времени приобретения для последнего периода или семьдесят двух часов.
...
В верхней части страницы можно выбрать период времени, для которого требуется отобразить данные. Значением по умолчанию является **30D** (30дней), однако вы можете отобразить данные за 3, 6 или 12 месяцев, либо для заданного вручную диапазона дат. Также можно выбрать **1 H** или **72 H** для отображения данных приобретения практически в реальном времени для один час или семьдесят 2 часа; Эти периоды времени применяются только на вкладку **ежедневно дополнительный компонент** диаграммы **дополнительный компонент приобретения** и перейдите на вкладку **поглощений** **рынков** диаграммы. 
