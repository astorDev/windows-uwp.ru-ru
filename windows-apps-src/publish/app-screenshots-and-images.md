...
### <a name="23-poster-art-720-x-1080-or-1440-x-2160-pixels"></a>2:3 плакаты (720 x 1080 или 1440 x 2160 пикселей)
...
- Разрешение видео должно быть 1920 x 1080 пикселей.
- Эскиз должен быть в формате PNG с разрешением 1920 x 1080 пикселей.
...
Предоставление изображения для приложения не гарантирует, что оно будет включено в рекламный блок. Дополнительные сведения см. в статье упрощение [продвижения приложения](make-your-app-easier-to-promote.md) .
