...
Вы также можете настроить запрет на использование Store изображений логотипа в ваших пакетах приложения при показе страницы приложения клиентам, использующим Windows 10 (включая Xbox), чтобы Store использовал только загружаемые изображения. Так вы сможете эффективнее настроить внешний вид вашего приложения в Store для клиентов, использующих Windows 10 (включая Xbox).

Чтобы в Store на Windows 10 (включая Xbox) использовались только выложенные изображения, установите флажок **Для клиентов, использующих ОС Windows10 (отображать выложенные изображения логотипа вместо изображений из моих пакетов)**. (Если не установить этот флажок, будут использоваться изображения из ваших пакетов приложения.)

После установки этого флажка появится новый раздел под названием **Выложенные логотипы Store**. Здесь вы можете выложить три изображения, включая изображение размером 300 x 300 (значок плитки приложения). Если указанный флажок установлен, поле для предоставления этого изображения переместится в данный раздел. Если вы используете этот вариант, рекомендуем предоставить изображения всех трехразмеров: 300 x 300, 150 x 150 и 71 x 71пиксель. Однако в обязательном порядке требуется только изображение размером 300 x 300.
...
> [!TIP]
> Если вы создали описания в Магазине на нескольких языках, вы можете **Выбрать из существующих трейлеров** для повторного использования трейлеров, которые вы уже выложили. Не нужно выкладывать их по отдельности для каждого языка.

Чтобы удалить трейлер из описания, щелкните значок **X** рядом с именем соответствующего файла. Вы можете на выбор удалить его из текущего описания в Магазине, в котором вы сейчас работаете, или изо всех описаний вашего продукта в Магазине (на всех языках).
...
Как и остальные материалы на странице описания в Store, трейлеры должны пройти сертификацию перед их публикацией в Microsoft Store. Убедитесь, что ваши трейлеры отвечают [политикам Microsoft Store](https://msdn.microsoft.com/library/windows/apps/dn764944.aspx).
