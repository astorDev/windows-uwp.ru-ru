...
Если вашей отправки *только* содержит пакеты UWP, вам не нужно предоставить это изображение (Если вы установили флажок для **для пользователей Windows 10 и Xbox, отображать выложенные изображения логотипа вместо изображений из моих пакетов**, как описано в следующем раздел).
...
Чтобы удалить трейлер из описания, щелкните значок **X** рядом с именем соответствующего файла. Вы можете выбрать, следует ли удалить его из текущего описания в магазине в котором вы работаете, или удалить его из всех описаний вашего продукта в магазине (на всех языках).
...
В разделе **Windows 10 и Xbox изображение** изображения **альбома главное изображение формата 16:9 (1920 x 1080 или 3840 x 2160 пикселей)** используется в различных макетов в Microsoft Store на всех типах устройств Windows 10 (включая Xbox). Рекомендуем предоставить это изображение независимо от того, для какой операционной системы или типа устройств предназначено приложение.
