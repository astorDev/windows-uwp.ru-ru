...
Вы можете запретить Store использовать изображения логотипа в ваших пакетах приложения при показе страницы приложения клиентам, использующим Windows 10 (включая Xbox), и вместо этого магазин использовал только загружаемые изображения. Так вы сможете эффективнее настроить внешний вид вашего приложения в Store для клиентов, использующих Windows 10 (включая Xbox). (Если ранее опубликованное приложение поддерживает более ранние версии ОС, эти пользователи могут по-прежнему см. в разделе изображения из пакетов.)

У хранилище использовать только выложенные (для пользователей Windows 10, включая Xbox), изображения и не используйте изображения, любой из пакетов, установите флажок заблокированном **для клиентов с Windows 10 и Xbox, отображать выложенные изображения логотипа вместо изображений из моих пакетов **.
...
> [!TIP]
> Изображение [обложки главное изображение формата 16:9](#windows-10-and-xbox-image-169-super-hero-art) особенно рекомендуется, если вы планируете добавить [видеоанонсы](#trailers) в магазине описания; Если его не добавить, трейлеры не будут отображаться в верхней части описания.
