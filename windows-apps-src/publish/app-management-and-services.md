---
author: jnHs
Description: "Вы можете просматривать сведения о приложениях и управлять ими, а также настраивать такие службы, как уведомления, служба A/B-тестирования и \"Карты\", на информационной панели в Центре разработки для Windows."
...
В разделе **Push-уведомления** вы можете создавать и отправлять уведомления пользователям вашего приложения. Их можно отправлять всем пользователям приложения или подмножеству пользователей Windows 10, которые соответствуют критериям, заданным в [сегменте заказчиков](create-customer-segments.md). Дополнительные сведения см. в разделе [Отправка push-уведомлений пользователям вашего приложения](send-push-notifications-to-your-apps-customers.md).

В зависимости от типа пакета приложения и его требований вы также можете воспользоваться одним из следующих вариантов для push-уведомлений, щелкнув **WNS и MPNS** в левом меню навигации: 
