...
| **Базовая цена**                | Обязательный                                    | [Настройка и планирование цен приложений](set-and-schedule-app-pricing.md)              |
...
| Имя поля                    | Заметки                                       | Дополнительные сведения                          |
|-------------------------------|---------------------------------------------|----------------------------------------|
| **Возрастная категория**               | Обязательный                                    | [Возрастная категория](age-ratings.md)          |
...
| Имя поля                    | Заметки                                       | Дополнительные сведения                                                     |
|-------------------------------|---------------------------------------------|-------------------------------------------------------------------|
| **Описание**               | Обязательный                                    | [Напишите отличное описание приложения](write-a-great-app-description.md) |
