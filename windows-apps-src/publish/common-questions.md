...
Последовательно выберите пункты <http://commerce.microsoft.com>, выполнить вход с помощью учетные данные учетной записи Майкрософт и внесите необходимые изменения.
