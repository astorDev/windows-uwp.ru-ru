...
- Все отзывы, оставленные пользователями в вашей закрытой аудитории, будут доступны вам для просмотра. Тем не менее эти отзывы не будут опубликованы в описании вашего приложения в Store даже после перемещения вашей отправки в раздел **Общедоступная аудитория**. Вы можете прочитать отзывы, оставленные пользователями в вашей частной аудитории, просмотра, [отчет об отзывах](reviews-report.md), но не удается скачать эти данные или использовать [API аналитики для Microsoft Store](../monetize/access-analytics-data-using-windows-store-services.md) для программного доступа к этим отзывам.
...
Это параметр по умолчанию. Оставьте этот параметр включенным, которое приложение должно быть зарегистрировано в магазине для клиентов, для поиска приложения по прямой ссылке и другими способами, включая поиск, просмотр и включения в списках каталога. 
