...
Это параметр по умолчанию. Оставьте этот параметр включенным, если ваше приложение в магазине для пользователей для поиска приложения по прямой ссылке и другими способами, включая поиск, просмотр и включения в списках каталога. 
