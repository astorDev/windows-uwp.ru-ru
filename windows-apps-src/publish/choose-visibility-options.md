---
Description: Установите ограничения на то, как приложение может быть обнаружено и получено, в том числе от того, могут ли пользователи найти ваше приложение в магазине, или просмотреть его список магазинов.
...
- Все отзывы, оставленные пользователями в вашей закрытой аудитории, будут доступны вам для просмотра. Тем не менее эти отзывы не будут опубликованы в описании вашего приложения в Store даже после перемещения вашей отправки в раздел **Общедоступная аудитория**. Вы можете читать рецензии, написанные вашей частной аудиторией, просмотрев [отчет о проверках](reviews-report.md), но вы не можете скачать эти данные или использовать [API Microsoft Store Analytics](../monetize/access-analytics-data-using-windows-store-services.md) для программного доступа к этим проверкам.
...
Это параметр по умолчанию. Оставьте этот параметр выбранным, если вы хотите, чтобы приложение было указано в магазине, чтобы клиенты могли найти его через прямую ссылку на приложение и (или) другие методы, включая поиск, просмотр и включение в проверенные списки. 
...
- **Только прямая ссылка: любой клиент с прямой ссылкой на список продукта может скачать его, за исключением Windows 8. x.** Любой пользователь, который открывает описание приложения по прямой ссылке, может скачать его на устройствах с Windows 10 или Windows Phone 8.1 и более ранних версий (но не на устройствах с Windows 8.x).
- **Прекращение приобретения. любой клиент с прямой ссылкой может просматривать список магазинов продукта, но он может скачать его только в том случае, если он владеет продуктом, или иметь рекламный код и использовать устройство Windows 10.** Даже если у пользователя есть прямая ссылка, он не сможет скачать приложение, если у него нет [промокода](generate-promotional-codes.md) и устройства с Windows 10. Если у пользователя есть рекламный код, он может использовать его, чтобы бесплатно получить ваше приложение (только в Windows 10), даже если вы не предлагаете его другим пользователям. Получить приложение можно только с помощью промокода.
