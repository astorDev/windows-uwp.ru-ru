...
ms.locfileid: "3986635"
---
# <a name="add-on-submissions"></a>Отправка надстроек

Надстройки (или продукты в приложении) — это дополнительный элементы для приложения, которые пользователи могут приобретать. Надстройка может быть весело, появилась новая игра уровня или что-либо еще, вы думаете, будет хранить пользователей занят. Надстройки — это не только хороший способ для получения доходов, но и для взаимодействие с клиентами.
...
Вы в любое время можете внести изменения в опубликованную надстройку. Надстройка изменения отправлены и публикуются независимо от приложения, поэтому обычно не требуется для обновления всего приложения для внесения изменений в надстройку как обновление его цены или описание.
...
Чтобы отправить обновления, перейдите на страницу надстройки на информационной панели и щелкните **Обновить**. Это создаст новый отправки для надстройки, используя сведения из предыдущей отправки в качестве отправной точки. Внесите необходимые изменения будут такие, как и нажмите кнопку **Отправить в хранилище**.
