...
Чтобы отправить обновления, перейдите на страницу надстройки на информационной панели и щелкните **Обновить**. Это создаст новую отправку для надстройки, используя в качестве отправной точки сведений из предыдущей отправки. Внесите необходимые изменения, вам необходимо и нажмите кнопку **Отправить в магазин**.
