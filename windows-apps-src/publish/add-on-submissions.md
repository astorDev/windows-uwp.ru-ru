...
Надстройки публикуются через [Центр партнеров](https://partner.microsoft.com/dashboard)и требуется иметь активные [учетные записи разработчика](https://go.microsoft.com/fwlink/p/?LinkId=615100). Вам также необходимо [включить надстройки](../monetize/in-app-purchases-and-trials.md) в коде приложения.

Для создания надстройки в центре партнеров, [указав тип продукта и кода продукта](set-your-add-on-product-id.md)— это первый шаг в процессе отправки надстройки. После этого вы создадите отправки, чтобы надстройку можно было приобрести в Microsoft Store. Вы можете отправить надстройку одновременно с [самим приложением](app-submissions.md) или работать над ней независимо. Вы также можете выпускать [обновления](#updating-an-add-on-after-publication) надстройки после публикации приложения в Магазине. В этом случае приложение не надо будет отправлять повторно.
...
Чтобы отправить обновления, перейдите на его страницу в центре партнеров и щелкнуть « **Обновить»**. Это создаст новую отправку для надстройки, используя данные из предыдущей отправки в качестве отправной точки. Внесите необходимые изменения, вы бы и нажмите кнопку **Отправить в магазин**.
