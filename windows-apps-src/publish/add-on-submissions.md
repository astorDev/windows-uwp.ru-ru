...
ms.locfileid: "2842336"
---
# <a name="add-on-submissions"></a>Отправка надстроек

Надстройки (или продукты в приложении) — это дополнительный элементы для приложения, которые пользователи могут приобретать. Дополнительный компонент может быть вслух, новая функция новую игру уровня или что-либо еще, вы думаете будет сохранена в пользователи мероприятиям. Надстройки — это не только хороший способ для получения доходов, но и для взаимодействие с клиентами.
...
Вы в любое время можете внести изменения в опубликованную надстройку. Дополнительный компонент изменения отправленных и опубликовано независимо от вашего приложения, поэтому обычно не требуется обновлять всего приложения для изменения дополнительного компонента, такие как обновление ее цены или описание.
...
Чтобы отправить обновления, перейдите на страницу надстройки на информационной панели и щелкните **Обновить**. Будет создан новый отправки для надстройки, используя сведения из предыдущей отправки в качестве отправной точки. Внесите необходимые изменения, необходимо будет, и нажмите кнопку **Отправить в хранилище**.
