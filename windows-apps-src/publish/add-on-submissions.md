...
Надстройки публикуются через [Центр партнеров](https://partner.microsoft.com/dashboard)и требуется иметь активные [учетные записи разработчика](http://go.microsoft.com/fwlink/p/?LinkId=615100). Вам также необходимо [включить надстройки](../monetize/in-app-purchases-and-trials.md) в коде приложения.
