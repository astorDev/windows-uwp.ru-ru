...
ms.locfileid: "67495700"
---
# <a name="payment-thresholds-methods-and-timeframes"></a>Пороговые значения, методы и сроки оплаты

Предполагаемое время передачи платежей и магазины Майкрософт, из которых вы можете получать платежи зависит от страны или региона и о выплатах типа учетной записи. В этом разделе описаны методы оплаты, поддерживаемые в каждой страны или региона.
...
## <a name="payment-methods-in-countriesregions"></a>Способы оплаты в странах и регионах

> [!NOTE]
> Пороговые значения оплаты во всех регионах составляет 50 ДОЛЛ.

| Country                          | Azure Marketplace | Store, рекламы, Mixer и Minecraft | Office | Функциями PayPal |
|----------------------------------|-------------------|------------------------------------------|--------|-----------------|
...
| Объединенные Арабские Эмираты             | Да               | Да                                      | Да    | Да             |
