...
Чтобы изменить описание, нажмите его имя на странице общих сведений об отправке. Разделы страницы **Описание** описаны ниже.
...
Ключевые слова — это отдельные слова или их сочетания, которые не отображаются для пользователей, но помогут вашему приложению появляться в результатах поиска по ключевым словам. Вы можете включить до 8 ключевых слов, каждое из которых не должно превышать 45 символов.
