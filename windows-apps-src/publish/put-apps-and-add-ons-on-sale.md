...
> [!IMPORTANT]
> Цена распродажи отображается только для пользователей с Windows10 устройств, включая Xbox One. Распродажи, предлагаемые владельцам одного из ваших других продуктов, отображаются только для пользователей Windows 10 версии 1607 или выше.
> 
