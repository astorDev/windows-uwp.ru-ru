...
> [!IMPORTANT]
> Цена распродажи отображается только для пользователей с Windows10 устройств, включая Xbox One. Продажи, которые вы предлагаете только владельцам одного из ваших других продуктов отображаются только для клиентов, использующих ОС Windows 10 версии 1607 или более поздней версии.
> 
