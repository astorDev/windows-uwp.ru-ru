...
> [!TIP]
> Помимо использования центра партнеров, чтобы отвечать на отзывы, вы можете реагировать на отзывы [программными средствами](../monetize/submit-responses-to-app-reviews.md).
