...
ms.locfileid: "2913727"
---
# <a name="view-app-identity-details"></a>Просмотр сведений об идентификации приложений


При работе с приложением на информационной панели центра разработки для Windows, вы можете просмотреть сведения, связанные с уникальным идентификатором, назначенным приложению в магазине Майкрософт. Вы также можете получить ссылку на страницу с описанием приложения в Магазине.
