...
ms.locfileid: "2816416"
---
# <a name="view-app-identity-details"></a>Просмотр сведений об идентификации приложений


При работе с app в центр разработчиков Windows панели мониторинга, можно просмотреть сведения, относящиеся к уникальный идентификатор, присвоенный приложением Microsoft Store. Вы также можете получить ссылку на страницу с описанием приложения в Магазине.
