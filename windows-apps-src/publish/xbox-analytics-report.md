---
author: jnHs
Description: "Аналитический отчет Xbox на информационной панели Центра разработки для Windows показывает статистику взаимодействия пользователей с возможностями вашего продукта, предназначенными для Xbox."
