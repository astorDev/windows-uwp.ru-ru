...
-   Для каждого приложения или IAP каждые 6 месяцев можно создавать до 500 рекламных кодов. Шестимесячный период начинается при отправке первого заказа на рекламные коды.
