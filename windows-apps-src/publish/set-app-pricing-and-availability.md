...
> [!NOTE]
> Задержки во время сертификации или публикации могут вызвать перенос фактического выпуска на более позднюю дату. Microsoft Store не гарантирует, что ваше приложение (или обновление) будет доступно в конкретный день.  
