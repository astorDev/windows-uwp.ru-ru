...
> [!NOTE]
> пробы с ограниченным временем не отображаются для клиентов в Windows 10 Build 10.0.10586 или более ранней версии или для клиентов на Windows Phone 8,1 и более ранних версий.
