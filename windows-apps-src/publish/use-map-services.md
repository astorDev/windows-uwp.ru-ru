---
Description: Чтобы использовать службы карт в приложениях для Windows Phone 8.1 и более ранних версий, необходимо иметь идентификатор и маркер приложения службы карт, которые можно включить в код приложения. Вы можете получить этот маркер на странице "Карты" панели мониторинга Центра разработки в разделе "Службы".
