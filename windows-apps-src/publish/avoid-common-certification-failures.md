---
description: Список поможет избежать проблем, не позволяющих пройти сертификацию, и проблем, которые могут быть выявлены при выборочной проверке после публикации приложения.
