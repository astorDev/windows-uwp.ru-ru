...
> [!NOTE]
> Кроме того, необходимо ознакомиться с [Политиками Магазина Windows](https://msdn.microsoft.com/library/windows/apps/dn764944), чтобы убедиться в соответствии вашего приложения всем изложенным здесь требованиям.
