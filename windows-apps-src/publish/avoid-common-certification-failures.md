...
> [!NOTE]
> Убедитесь, что для просмотра [Политик хранения Microsoft](https://docs.microsoft.com/legal/windows/agreements/store-policies) , убедитесь, что ваше приложение соответствует всем требованиям, перечисленным существует.
...
-   Добавьте [политику конфиденциальности](create-app-store-listings.md#privacy-policy), если она необходима для приложения. Например, если ваше приложение любым образом получает доступ к любым личным сведениям или если это предусмотрено законом. Чтобы определить, требуется ли ваше приложение политику конфиденциальности, просмотрите [Соглашение для разработчиков приложений](https://docs.microsoft.com/legal/windows/agreements/app-developer-agreement) и [Политик хранения Microsoft](https://docs.microsoft.com/legal/windows/agreements/store-policies).
