...
> [!NOTE]
> Если для группы объявлений отсутствуют действия за последние полгода, мы пометить как **неактивное**и в конечном итоге удалить его из центра партнеров. С помощью фильтров можно показать только **Активные** или **Неактивные** группы объявлений. Если вы увидите, что какая-либо группа объявлений помечена как **Неактивная** по ошибке, [обратитесь в службу поддержки](http://aka.ms/storesupport).
...
Когда [Создайте группу объявлений](#create-ad-unit) или [выберите существующую группу объявлений](#available-ad-units), если выбранное для рекламных блоков приложение имеет по крайней мере одну отправку и достигло разделе **соответствие требованиям COPPA** появится в нижней части страницы [в магазине](../publish/the-app-certification-process.md#in-the-store) шаге в приложении процесс сертификации.
