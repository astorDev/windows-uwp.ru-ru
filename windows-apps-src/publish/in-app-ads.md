...
> [!NOTE]
> Если для группы объявлений отсутствуют действия за последние полгода, мы будет помечать как **неактивный**и в конечном итоге удалим с информационной панели. С помощью фильтров можно показать только **Активные** или **Неактивные** группы объявлений. Если вы увидите, что какая-либо группа объявлений помечена как **Неактивная** по ошибке, [обратитесь в службу поддержки](http://aka.ms/storesupport).
