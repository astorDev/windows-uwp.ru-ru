...
4.  В раскрывающемся меню **Тип группы объявлений** выберите тип рекламы.
    ...
    * Если в вашем приложении отображаются баннера, установите флажок **заголовка**.
    * Если в вашем приложении отображаются межстраничная видеореклама или баннер, выберите **видеореклама** или **баннер** (не забудьте выбрать параметр, соответствующий типу межстраничного объявления, которые вы хотите показать).
    * Если собственная реклама отображаются в вашем приложении, выберите **Native**.
...
> [!NOTE]
> Если объявлений отсутствуют действия за последние полгода, мы его метку как **неактивное**и в конечном итоге удалим с информационной панели. С помощью фильтров можно показать только **Активные** или **Неактивные** группы объявлений. Если вы увидите, что какая-либо группа объявлений помечена как **Неактивная** по ошибке, [обратитесь в службу поддержки](http://aka.ms/storesupport).
...
| Undertone | Выберите этот вариант, чтобы показывать объявления от [Undertone](https://www.undertone.com/). | Баннер |
