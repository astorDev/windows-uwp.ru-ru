---
author: jnHs
Description: "Если приложение показывает рекламу с помощью Microsoft Advertising SDK, используйте страницу \"Реклама в приложении\" на информационной панели Центра разработки для управления использованием рекламных объявлений."
