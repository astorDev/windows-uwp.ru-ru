...
* Публиковалась Windows 8.x и Windows Phone 8.x приложения, использующие [Microsoft Advertising SDK для Windows и Windows Phone 8.x](http://aka.ms/store-8-sdk).
