...
| пайментмесод            | Метод, используемый для оплаты партнера, например для перевода электронного банка, кредит-ноты                                                             |
...
| куантититипе                   | Указывает тип количества, например количество счетов, MAU                                                                                     | Все                                                            |
