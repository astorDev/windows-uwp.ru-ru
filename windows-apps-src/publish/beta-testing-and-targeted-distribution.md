---
Description: Центр партнеров несколько вариантов для инженеров-испытателей опробовать приложение, прежде чем предлагать его общедоступным.
...
Центр партнеров несколько вариантов для инженеров-испытателей опробовать приложение, прежде чем предлагать его общедоступным.
...
**Закрытый аудитории** параметр может использоваться, только когда приложения уже не опубликована для открытого аудитории. Этот параметр можно использовать с приложения, предназначенные для любой версии операционной системы, но тест-инженерам, должен работать под управлением Windows 10 версии 1607 или более поздней версии (включая Xbox One) и необходимо выполнить вход с помощью учетной записи Майкрософт, связанную с адресом электронной почты, введенного.
...
Этот параметр предлагает еще один способ ограничить распределение приложения, чтобы только определенные группы инженеров-испытателей, позволять кто-то еще обнаружение приложения в Store (или его приобретения без рекламный код). Тем не менее в отличие от параметра частной аудитории любой пользователь, у которого есть прямая ссылка на приложение, сможет просмотреть его описание. Если сохранение конфиденциальности является важным аспектом для вашей отправки, мы рекомендуем публиковать приложения для частной аудитории.
...
- В разделе **Видимость** на странице **Цены и доступность** под пунктом [Возможность обнаружения](choose-visibility-options.md#discoverability) выберите пункт **Отправить продукт в Store, но запретить его поиск там**. Выберите вариант для **остановить приобретения: Любой клиент с прямой ссылкой можно увидеть список Store продукта, но их можно только загрузить его, если они принадлежит продукт до, или код акции и вы используете устройство Windows 10**. 
...
В отличие от параметров, описанных выше, этот параметр работает с Windows Phone 8.1, а также Windows 10 (однако не работает с Windows 8 .x). Пользователи не смогут найти приложение при поиске или просмотре позиций в Store, но каждый, у кого есть прямая ссылка на описание приложения в Store, сможет скачать его на устройство под управлением Windows Phone 8.1 (или более ранних версий) либо Windows 10. Следует помнить, что для цены приложения должно быть выбрано значение **Бесплатно**, чтобы тестировщики могли свободно скачать его.

Использование этого параметра.
- В разделе **Видимость** на странице **Цены и доступность** под пунктом [Возможность обнаружения](choose-visibility-options.md#discoverability) выберите пункт **Отправить продукт в Store, но запретить его поиск там**. Выберите вариант для **только прямую ссылку: Любой клиент с прямую ссылку на список продуктов можно загрузить, за исключением на Windows 8.x.**.
