...
Параметр **закрытый аудитории** можно только используется при ваше приложение еще не опубликованы для общедоступных аудитории. Этот параметр можно использовать с приложениями, предназначенные для любой версии операционной системы, но ваше инженеры-испытатели должен работать под управлением Windows 10, версия 1607 или более поздней версии (в том числе Xbox один из них) и должен быть выполнил вход с помощью учетной записи Майкрософт, связанный с адресом электронной почты, при.
...
Этот параметр предлагает другой способ ограничьте рассылки приложения к определенной группой только инженеров-испытателей, при предотвращения кому-либо обнаружение приложения в магазине (или приобретение без рекламное кода). Тем не менее в отличие от параметра частной аудитории любой пользователь, у которого есть прямая ссылка на приложение, сможет просмотреть его описание. Если сохранение конфиденциальности является важным аспектом для вашей отправки, мы рекомендуем публиковать приложения для частной аудитории.
