...
Параметр **Частная аудитория** можно использовать с приложениями, предназначенными для любой версии ОС, но тест-инженеры должны работать с Windows 10 версии 1607 или выше (включая Xbox One) и должны войти в систему с учетной записью Майкрософт, связанную с адресом электронной почты, который вы предоставите.
