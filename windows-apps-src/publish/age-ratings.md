---
description: Страница «Возрастные категории» процесса «Отправка приложения» позволяет указать данные для присвоения приложению возрастной категории согласно правилам IARC.
