...
[Центр партнеров](https://partner.microsoft.com/dashboard) поддерживает три варианта для ответа клиентам оставлять отзывы о приложении. Независимо от выбранного варианта помните, что для каждого ответа действует ограничение: 1000 символов.
...
- **Исследование**: Вы знаете о проблеме, и вам нужна в него.
- **Работать с ними**: Вы Устранение неполадок или добавить запрошенную функцию.
- **Завершено**: Вы опубликовали обновление для устранения проблемы или добавить компонент запрошенного.
