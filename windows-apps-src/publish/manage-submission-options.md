...
В этом выпуске даты после отправки продукта, можно изменить до тех пор, пока еще не введены действие опубликовать. 
