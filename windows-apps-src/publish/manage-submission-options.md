---
Description: Управление параметрами отправки, такими как параметры удержания публикации, примечания для сертификации и многое другое.
...
Эту дату выпуска можно изменить после отправки продукта, если он еще не входил в шаг публикации. 
