---
Description: Управление параметрами отправки, например параметры публикации удержание, заметки о сертификации и др.
...
Можно изменить эту дату выпуска после отправки ваш продукт до тех пор, пока он еще не введен еще на этапе публикации. 
