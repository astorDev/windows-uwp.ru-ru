...
Если выбран тип продукта **Подписка**, здесь отображается **Период подписки**. Выберите параметр, чтобы указать, как часто взимается плата за подписку. Значение по умолчанию — **ежемесячные**, но можно также выбрать **3 месяцев**, **6 месяцев**, **ежегодно**, или **24 месяцев**.
...
> [!NOTE]
> Ключевые слова не доступны для использования в пакеты, предназначенные для Windows 8 и Windows 8.1.
...
> [!NOTE]
> **Пользовательские данные разработчика** поле недоступно для использования в пакеты, предназначенные для Windows 8 и Windows 8.1.
