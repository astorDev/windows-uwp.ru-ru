...
Если выбран тип продукта **Подписка**, здесь отображается **Период подписки**. Необходимо выбрать один из доступных параметров (**Ежемесячно**, **3 месяца**, **6 месяцев**, **Ежегодно** или **24 месяца**), чтобы указать, как часто с клиента будет взимается плата за подписку. Обратите внимание, что после публикации надстройки **Период подписки** изменить будет невозможно.
...
Также здесь представлена **Бесплатная пробная версия** для надстроек подписки. Необходимо решить, смогут ли клиенты использовать надстройку бесплатно в течение определенного периода времени (в течение **1 недели** или **1 месяца**), или выбрать параметр **Бесплатная пробная версия отсутствует**. Обратите внимание, что после публикации надстройки условия предоставления **Бесплатной пробной версии** изменить будет невозможно.
