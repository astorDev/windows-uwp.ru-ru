...
> [!IMPORTANT]
> Нельзя использовать [API отправки в Microsoft Store](../monetize/create-and-manage-submissions-using-windows-store-services.md) для публикации бизнес-приложений непосредственно для предприятий. Все отправки бизнес-приложений необходимо опубликовать через Центр партнеров.
...
В некоторых случаях компании может не хотят свои бизнес-приложения для отправки через Центр партнеров (например, для обеспечения соответствия или приложений необходимы дополнительные возможности). В этом случае предприятие может развертывать приложения непосредственно на своих компьютерах, скачивая неопубликованные приложения без использования МагазинаМайкрософт для бизнеса или Магазина Майкрософт для образовательных учреждений.
