...
> **Важно!** На данный момент через Магазин Windows для бизнеса можно распространять только бесплатные приложения для предприятий. Если вы отправите платное бизнес-приложение, то оно станет доступно предприятию позже, когда будет добавлена поддержка приобретения в больших объемах платных приложений. 
...
> **Важно!** Этот процесс должен быть инициирован предприятием. Дополнительные сведения см. в статье [Работа с бизнес-приложениями](http://go.microsoft.com/fwlink/p/?LinkId=698846).
