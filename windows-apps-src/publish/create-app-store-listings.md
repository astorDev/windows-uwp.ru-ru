...
Если вы отправили пакеты, в том же языке описания в магазине, вы работаете над, имя, используемое в эти пакеты будут выбраны. Если вам нужно [Переименовать приложение](manage-app-names.md#rename-an-app-that-has-already-been-published) после его уже были опубликованы, когда вы создаете новую отправку с пакетами, которые используют новое имя можно выбрать здесь различных зарезервированное имя.
...
> [!NOTE]
> Можно выбрать только **Название продукта** относится к описания в магазине на языке работе. Он не влияет на имя, отображаемое, когда пользователь устанавливает приложение; Это имя берется из манифеста пакета, который получает установки. Чтобы избежать путаницы, мы рекомендуем использовать то же имя каждого языка пакеты и описание в магазине.
