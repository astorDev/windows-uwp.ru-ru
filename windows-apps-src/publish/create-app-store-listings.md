...
Для получения наилучших результатов сохраняются на краткое описание в разделе 270 знаков. Поле имеет ограничение в 500 символов, но в некоторых представлениях, будут показаны только первые 270 символы (с помощью ссылки, доступные для просмотра до конца краткое описание).
