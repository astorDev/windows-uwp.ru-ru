...
Если вы отправили отображалось на этом языке описания в магазине, над которыми вы работаете, имя, используемое в эти пакеты будут выбраны. Если вам нужно [Переименовать приложение](manage-app-names.md#rename-an-app-that-has-already-been-published) после его уже были опубликованы, можно выбрать разные зарезервированное имя, при создании новой отправки с помощью пакетов, которые используют новое имя.
