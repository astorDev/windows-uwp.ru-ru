...
translationtype: HT
---
# <a name="how-your-app-appears-in-the-store-for-windows-10-customers"></a>Как пользователи Windows10 видят ваше приложение в Магазине
...
## <a name="apps-that-shared-identity-in-the-windows-store-and-windows-phone-store"></a>Приложения с общим удостоверением в Магазине Windows и Магазине Windows Phone
...
**Примечание.** Если вы установили цены для рынков в Магазине Windows Phone, для ваших пользователей Windows 10 будут отображаться эти рассчитываемые цены.
...
Если ваше приложение отображается в разных категориях в двух Магазинах, мы используем категорию из Магазина Windows, чтобы определить новую категорию приложения. Обратите внимание, что некоторые категории в Магазине отличаются для пользователей Windows10, поэтому обязательно просмотрите [таблицу](#category-changes) ниже.
