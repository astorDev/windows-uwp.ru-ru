...
На странице " **сведения об ошибке** " вы также увидите диаграммы **преобладание стека** , который показывает верхней стеков привели к сбоя, упорядоченные по процент и диаграмма **конфигурацию устройства (30 D)** , в которой представлены подробные сведения о том, Настройка устройства, для которых произошел сбой. 


## <a name="crash-free-sessions-and-devices-30d"></a>Сеансы бесперебойной и устройств (30D)

На диаграмме **бесперебойной сеансов и устройства** приводится процентов от устройства или сеансов пользователей, которые не возникает сбой за последние 30 дней. Эти сведения помогает понять, масштабов вашего сбоев влияют на пользователей. Например приложение может иметь 10 000 сбоев в один день. Если затронуты 90% устройств, затем будет, вероятно, классификации, как критические и действовать сразу же исправить ее. Тем не менее если только для представления 5% от устройств с помощью вашего приложения, приоритет может быть более низкой.

Эта диаграмма содержит две вкладки:
- **Бесперебойной устройств**: показан процент уникальных устройства, которые не возникает сбой каждый день (за последние 30 дней).
- **Сеансы бесперебойной**: показан процент уникальные пользовательские сеансы, которые не возникает сбой каждый день (за последние 30 дней).
