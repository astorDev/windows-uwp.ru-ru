...
На странице " **сведения об ошибке** ", вы также увидите диаграммы **преобладание стека** , который показывает верхней стеков привели к сбоя, упорядоченные по процент и диаграммы **конфигурацию устройства (30 D)** , который предоставляет сведения о том, Настройка устройства, для которых произошел сбой. 
