...
Дополнительные сведения об использовании протокола Microsoft Store см. [Запуск приложения Microsoft](../launch-resume/launch-store-app.md).
