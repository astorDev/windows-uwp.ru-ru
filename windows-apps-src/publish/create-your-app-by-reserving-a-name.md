---
Description: При создании нового приложения в информационной панели Центра разработки для Windows имя приложения должно быть уникальным для всего Магазина Windows. В этом разделе объясняется, как зарезервировать имена, а также предоставляются некоторые рекомендации по выбору подходящих имен приложений.
...
При создании нового приложения на информационной панели Центра разработки для Windows имя приложения должно быть уникально для всего Магазина Windows. В этом разделе объясняется, как зарезервировать имена, а также предоставляются некоторые рекомендации по [выбору подходящих имен приложений](#choosing-your-app-s-name).
