...
Ниже перечислены языки, которые поддерживаются в Microsoft Store. Ваше приложение должно поддерживать хотя бы один из этих языков и не должно содержать любых кодов языков, которые здесь отсутствуют.
