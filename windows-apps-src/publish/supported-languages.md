...
Ниже перечислены языки, поддерживаемые Microsoft Store. Ваше приложение должно поддерживать хотя бы один из этих языков и не должно содержать любых кодов языков, которые здесь отсутствуют.
