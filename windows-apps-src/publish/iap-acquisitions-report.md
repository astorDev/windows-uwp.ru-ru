...
> **Важно** Отчет **Приобретения внутренних продуктов приложения** не включает данные о возвратах денежных средств, реверсировании, обратных платежах и пр. Чтобы оценить доходы от приложения, просмотрите [сводку о выплатах](payout-summary.md). В разделе **Зарезервировано** перейдите по ссылке **Скачать зарезервированные транзакции**.
