---
description: Отчет «Получения IAP» на информационной панели позволяет узнать, сколько IAP вы продали и просмотреть демографические сведения и данные о платформе.
