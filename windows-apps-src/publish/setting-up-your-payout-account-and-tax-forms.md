...
-   **Какие настройки PayPal требуются для получения платежей?** Нужно убедиться, что счет PayPal не блокирует платежи eCheck. Управлять этой настройкой можно на странице предпочтений получения платежей PayPal. Дополнительные сведения см. на [странице настройки учетной записи PayPal](https://go.microsoft.com/fwlink/p/?linkid=513139).
...
-   Банковские сведения, введенный в центре партнеров в символы латиницы преобразовывается кириллица символов.
...
Можно выполнить и Отправить налоговые формы электронном виде в центре партнеров; в большинстве случаев не нужно распечатывать и почтой формы.
