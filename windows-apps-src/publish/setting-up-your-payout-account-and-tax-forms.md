---
Description: Для получения денег от продажи приложения в Microsoft Store, необходимо настроить учетную запись о выплатах и заполните необходимые налоговых форм.
...
ms.locfileid: "57641009"
---
# <a name="set-up-your-payout-account-and-tax-forms"></a>Настройка счета для выплат и налоговых форм


Для получения денег от продажи приложения в Microsoft Store, необходимо настроить учетную запись о выплатах и заполнения налоговых форм в [центра партнеров](https://partner.microsoft.com/dashboard).

Если вы планируете размещать только бесплатные приложения (и не планируете предлагать покупки из приложения или использовать Microsoft Advertising), то вам не нужно настраивать счет для выплат и заполнять налоговые формы. Если в будущем и решить, что вы хотите продавать приложения (или надстройки), можно настроить учетную запись о выплатах и заполнения налоговых форм в это время. Вы не сможете отправлять любые оплаченные приложения или надстройки, пока не будут указаны ваш счет для выплат и налоговый профиль.
...
После получения [вашей учетной записи разработчика](opening-a-developer-account.md), есть две вещи, которые необходимо выполнить, прежде чем вы сможете продавать приложения (или надстройки) в Microsoft Store:

-   [Настройка учетной записи о выплатах](#payout-account)
-   [Заполните формы налога](#tax-forms)

> [!NOTE]
> Для сведения о том, как и когда вы оплачивается за денег свои приложения, см. в разделе [начало платных](getting-paid-apps.md).
 
...
 
**Чтобы настроить учетную запись о выплатах**

1.  В [центра партнеров](https://partner.microsoft.com/dashboard)выберите **параметры** шестеренки значок в правом верхнем углу, а затем выберите **параметров разработчика**.
2.  В меню навигации слева на странице параметров выберите **выплат**.
...
-   **Какие параметры PayPal требуется использовать для получения платежей?** Нужно убедиться, что счет PayPal не блокирует платежи eCheck. Управлять этой настройкой можно на странице предпочтений получения платежей PayPal. Дополнительные сведения см. на [странице настройки учетной записи PayPal](https://go.microsoft.com/fwlink/p/?linkid=513139).
-   **Поддерживается ли моей страны/региона?** См. раздел [Типы, доступность и стоимость учетных записей](account-types-locations-and-fees.md), чтобы узнать, является ли PayPal поддерживаемым способом оплаты.
-   **Моей учетной записи PayPal должны быть зарегистрированы в одной страны или региона в моей учетной записи центра партнеров?** Нет. При настройке учетной записи PayPal можно принять конфигурацию по умолчанию. У вас не должно быть никаких проблем с другими странами или регионами и валютами, если вы не заблокировали оплату в некоторых валютах. Управлять этой настройкой можно на странице предпочтений получения платежей PayPal.
-   **У для приема платежей PayPal вручную?** Нет. По умолчанию счета PayPal настроены таким образом, чтобы пользователи принимали платежи вручную. Это значит, что платеж, не принятый в течение 30 дней, будет возвращен. Изменить эту настройку можно, выключив параметр «Спрашивать меня» на странице дополнительных настроек PayPal.
...
-   **Имя держателя счета** введены для учетной записи о выплатах в центре партнеров должны быть точно тем же имя, связанное с вашего банковского счета. Например, если имя владельца банковского счета содержит отчество, укажите его в поле **Имя владельца счета**.
-   Выплаты перечисляются напрямую корпорацией Майкрософт на ваш банковский счет в рублях.
-   Банковские сведения, введенные в центре партнеров в латинские символы переводятся в символы кириллицы.
...
После получения [зарегистрировать учетную запись разработчика](opening-a-developer-account.md) и настройки вашего [выплат](#payout-account), можно создать вашей *налоговый профиль* для Microsoft Store, выполнив следующие шаги:
...
Далее вам будут предоставлены электронные версии налоговых форм, которые необходимо заполнить. Независимо от страны проживания или гражданство необходимо заполнить США налоговых форм для продажи всех приложений и надстроек через Microsoft Store. Разработчики, удовлетворяющие требованиям ценза оседлости в США, должны заполнить форму IRS W-9. Разработчики, проживающие за пределами США, должны заполнить форму IRS W-8. Вы можете заполнить эти формы в Интернете после заполнения налогового профиля.
...
Если вы находитесь за пределами США, то можете воспользоваться льготами по межгосударственному договору об исключении двойного налогообложения. Эти преимущества зависят от страны и позволяет уменьшить объем налогов, которые удерживает Microsoft Store. Вы можете претендовать на эти льготы, заполнив часть II формы W-8BEN. Мы рекомендуем связаться с соответствующими органами в вашей стране или регионе, чтобы определить применимость данных льгот.
