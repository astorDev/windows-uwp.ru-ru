...
Также можно воспользоваться полем поиска для поиска конкретных слов или фраз в отзывы о вашем приложении. Обратите внимание, что осуществляется только исходный отзыв текст по клиенту, даже если отзыв написанных на другом языке. Текст переведенные отзыв не выполняется.
