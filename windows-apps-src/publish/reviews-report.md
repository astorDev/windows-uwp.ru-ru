...
-   Дата отзыва.
-   Имя пользователя, оставившего отзыв как оно отображается в Microsoft Store.
...
Как упоминалось выше, при поиске отзывы, осуществляется только исходный текст слева от клиента (и не все перевод текста), даже если у вас есть **Перевод отзывов** флажком.
