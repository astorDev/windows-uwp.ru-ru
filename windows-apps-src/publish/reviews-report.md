...
- **Содержимое отзыва**: значение по умолчанию — **оценки с отзывами**, это означает, что будут показаны только оценки с содержимым отзыв. Вы можете выбрать **все** для отображения всех оценок, даже те, которые не включают любой отзыв рукописный текст. Обратите внимание, что в диаграмме **оценок** всегда будет отображаться все отзывы, независимо от того, выбор.
...
Диаграмма **оценок** отображается в верхней части этот отчет таким образом, вы можете получить взглянуть на следующее: 
...
Также можно воспользоваться полем поиска для поиска конкретных слов или фраз в отзывы о вашем приложении. Обратите внимание, что осуществляется только исходный отзыв текст, написанный пользователем, даже если отзыв, написанных на другом языке. Переведенные отзыв текст не выполняется.
...
Как упоминалось выше, при поиске отзывы, оставленные клиента только исходный текст осуществляется (и не все перевод текста), даже если у вас есть **Перевод отзывов** флажком.
