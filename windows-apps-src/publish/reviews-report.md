...
- **Содержимое отзыва**: значение по умолчанию — **оценки с отзывами**, это означает, что будут отображаться только оценки с содержимым, просмотр. Вы можете выбрать **все** для отображения всех оценок, даже те, которые не включают любой текст, написанный отзыв. Обратите внимание, что на схеме **оценок** всегда будет отображаться все отзывы, независимо от того, выбор.
...
Вы можете сортировать отзывы на странице по дате и(или) по оценке как по возрастанию, так и по убыванию. Щелкните ссылку **Сортировка** , чтобы просмотреть параметры сортировки по **дате** и/или **оценке**.

Также можно воспользоваться полем поиска для поиска определенного слова или фразы в отзывы о вашем приложении. Обратите внимание, что осуществляется только исходный отзыв текст по клиенту, даже если отзыв, написанный на другом языке. Текст переведенные отзыв не выполняется.
...
Как упоминалось выше, при поиске отзывы, осуществляется только исходный текст, оставленные клиента (и не все перевод текста), даже если у вас установлен флажок **Перевод отзывов** .
