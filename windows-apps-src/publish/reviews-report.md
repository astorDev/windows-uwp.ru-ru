...
- **Содержимое отзыва**: значение по умолчанию — **оценки с отзывами**, это означает, что будут показаны только оценки с содержимым, просмотр. Вы можете выбрать **все** для отображения всех оценок, даже те, которые не включают любой отзыв рукописный текст. Обратите внимание, что в диаграмме **оценок** всегда будут отображаться все отзывов независимо от вашего выбора.
...
Также можно воспользоваться полем поиска для поиска определенного слова или фразы в отзывы о вашем приложении. Обратите внимание, что осуществляется только исходный отзыв текст по клиенту, даже если отзыв, написанных на другом языке. Текст переведенные отзыв не выполняется.
...
Как упоминалось выше, при поиске отзывы, выполняется поиск исходный текст слева от клиента (и не все преобразованного текста), даже если у вас установлен флажок **Перевод отзывов** .
