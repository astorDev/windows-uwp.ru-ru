...
Вы также можете отвечать клиента отзывы [непосредственно на этой странице](respond-to-customer-reviews.md), программно [через API отзывов Microsoft Store](../monetize/submit-responses-to-app-reviews.md), или с помощью [приложения центра разработки](https://www.microsoft.com/store/apps/dev-center/9nblggh4r5ws).
...
- **Просмотрите содержимое**: значение по умолчанию — **оценки с отзывами**, это означает, что будут показаны только оценки с содержимым отзыв. Вы можете выбрать **все** для отображения всех оценок, даже те, которые не включают любой отзыв рукописный текст. Обратите внимание, что **Система оценок** диаграммы всегда будут отображаться все отзывы, независимо от вашего выбора.
...
Диаграмма **Система оценок** отображается в верхней части этого отчета таким образом, вы можете получить взглянуть на следующее: 
...
На этой диаграмме также может отображаться в [отчете об оценках](ratings-report.md), а также дополнительные сведения о оценок вашего приложения.
...
-   Дата отзыва.
-   Имя пользователя, оставившего отзыв каким оно отображается в Microsoft Store.
...
Вы можете сортировать отзывы на странице по дате и(или) по оценке как по возрастанию, так и по убыванию. Щелкните ссылку **Сортировка по** , чтобы просмотреть параметры сортировки по **дате** и/или **оценке**.

Можно также использовать поле поиска для поиска конкретных слов или фраз в отзывы о вашем приложении. Обратите внимание, что выполняется поиск только исходный отзыв текст, написанный пользователем, даже если отзыв, написанных на другом языке. Поиск текста переведенные отзывов не выполняется.
...
Как упоминалось выше, при поиске отзывы, оставленные клиента только исходный текст выполняется поиск (и не все перевод текста), даже если у вас установлен флажок **Перевод отзывов** .
