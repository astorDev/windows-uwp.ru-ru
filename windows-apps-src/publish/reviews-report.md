...
- **Содержимое отзыва**: значение по умолчанию — **оценки с отзывами**, это означает, что будут показаны только оценки с содержимым отзыв. Вы можете выбрать **все** для отображения всех оценок, даже те, которые не включают любой отзыв рукописный текст. Обратите внимание, что в диаграмме **оценок** всегда будут отображаться все отзывы, независимо от вашего выбора.
...
Как упоминалось выше, при поиск, отзывы, оставленные клиента только исходный текст осуществляется (и не все преобразованного текста), даже если у вас есть **Перевод отзывов** флажком.
