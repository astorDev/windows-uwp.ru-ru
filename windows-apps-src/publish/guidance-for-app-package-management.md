...
> **Примечание.** Номер версии пакетов Windows 10 должен быть больше, чем номер версии публикуемых пакетов Windows 8, Windows 8.1 и Windows Phone 8.1 (или ранее опубликованных вами пакетов для этих версий ОС) для одного и того же приложения. Дополнительные сведения о нумерации версий в Windows10 см. в разделе [Нумерация версий пакетов](package-version-numbering.md).
