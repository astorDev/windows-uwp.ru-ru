...
> **Примечание.** Номер версии пакетов Windows 10 должен быть больше, чем номер версии публикуемых пакетов Windows 8, Windows 8.1 и Windows Phone 8.1 (или ранее опубликованных вами пакетов для этих версий ОС) для одного и того же приложения. Дополнительные сведения см. в разделе [Нумерация версий пакета](package-version-numbering.md).
...
> **Важно!** Помните, что если предоставить пакеты, предназначенные для семейства универсальных устройств, каждый пользователь, который использовал ваше приложение в любых более ранних версиях операционных систем (Windows Phone 8, Windows 8.1 и т. д.) и перешел на Windows 10, получит обновление до пакета Windows 10.
> 
...
> 
> Подробнее о семействах устройств: [Руководство по работе с приложениями универсальной платформы Windows (UWP)](../get-started/universal-application-platform-guide.md).
