...
Сведения о том, как сделать приложение пригодным для клиентов по всему миру, см. в разделе [рекомендации по глобализации](../design/globalizing/guidelines-and-checklist-for-globalizing-your-app.md) и [обеспечению возможности локализации приложения](../design/globalizing/prepare-your-app-for-localization.md).
...
> [!NOTE]
> Для ранее опубликованных приложений, включающих пакеты, предназначенные для Windows 8 или Windows 8.1, некоторые отдельные рынки рассматриваются как один рынок "остальной части мира". Дополнительные сведения см. в разделе [Страны категории "Остальной мир" для ОС Windows 8.x](#rest-of-world-markets-for-windows-8x).
...
## <a name="microsoft-store-consumer-markets"></a>Microsoft Store рынков потребительского рынка

Вы можете сделать свое приложение или надстройку доступными в одной или нескольких указанных ниже странах. Рынки со звездочкой поддерживают Microsoft Store на Xbox One; рядом с именами в всплывающем окне **Выбор рынка** появится **кнопка Xbox** .
...
<table>
  ...
  <tr>
    ...
    <td>Виргинские о-ва (Великобритания)</td>
...
| Страна       | Способ оплаты  | Рекламная поправка | Дата вступления в силу |
|----------------------|-----------------|-------------------------------|----------------|
...
| ЮАР         | Карта оплаты       | 2,24 %                         | март 2016 г.     |
...
| ОАЭ | Карта оплаты       | 2,24 %                         | март 2016 г.     |
| United Kingdom       | Карта оплаты       | 2,24 %                         | март 2016 г.     |
...
Если ранее опубликованное приложение включает в себя пакеты, предназначенные для Windows 8. x, важно помнить, что ряд рынков рассматривается как один рынок "остальной мир" для клиентов, использующих магазин в Windows 8. x, даже если они отображаются как отдельные рынки в центре партнеров.

Если вы оставляете выбор рынка по умолчанию при отправке приложения, вам не придется беспокоиться об этом, и ваше приложение будет доступно всем возможным рынкам. Тем не менее, если вы хотите исключить определенные рынки, помните, что за исключением одного из этих рынков, это означает, что ваше приложение не будет доступно *ни* на одном из рынков «остальной мир» для клиентов Windows 8 или Windows 8.1.
...
> [!NOTE]
> Список стран и регионов, в которых можно зарегистрироваться для использования учетной записи разработчика, см. в разделе [типы учетных записей, местоположения и сборы](account-types-locations-and-fees.md).
