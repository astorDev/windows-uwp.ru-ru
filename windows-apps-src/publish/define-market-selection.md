...
Если ранее опубликованное приложение включает в себя пакеты, предназначенные для Windows 8. x, важно учитывать, что ряд рынков рассматривается как один рынок "остальной мир" для клиентов, использующих магазин в Windows 8. x, даже если они отображаются как отдельные рынки. в центре партнеров.
