...
Если ранее опубликованное приложение включает пакеты, предназначенные для Windows 8.x, важно помнить, что некоторые рынки обрабатываются как на рынке один «остальной мир» для клиентов, использующих хранилище в Windows 8.x, даже если они отображаются как отдельные страны в центре партнеров.

Если вы оставите выбор определенных стран по умолчанию при отправке приложения, не нужно беспокоиться об этом, и ваше приложение будет доступно для всех возможных рынках. Тем не менее если вы хотите исключить некоторые рынки, имейте в виду, что исключение даже одного из этих рынков «Остальной мир» означает, что ваше приложение не будет доступно в *любой* части рынки «Остальной мир» для пользователей Windows8 или Windows8.1.
