...
> [!NOTE]
> Для ранее опубликованных приложений, включающих пакеты, предназначенные для Windows 8 или Windows 8.1, некоторые отдельные рынки рассматриваются как один рынок "остальной части мира". Подробнее: [Рынки «Остальной мир» для Windows 8.x](#rest-of-world-markets-for-windows-8x).
...
Вы можете сделать свое приложение (или надстройку) доступным на одном или нескольких из следующих рынков. Рынки со звездочкой поддерживают Microsoft Store на Xbox One; рядом с именами в всплывающем окне **Выбор рынка** появится **кнопка Xbox** .
...
<table>
  ...
  <tr>
    <td>Республика Северная Македония</td>
    <td>Мадагаскар</td>
    <td>Малави</td>
    <td>Малайзия</td>
  </tr>
  ...
  <tr>
    ...
    <td>Южная Георгия и Южные Сандвичевы о-ва</td>
    <td>Испания*</td>
  </tr>
  <tr>
    <td>Шри-Ланка</td>
...
| кзечиа              | Карта оплаты       | 2,24%                         | Март 2016 г.     |
| Дания              | Карта оплаты       | 2,24%                         | Март 2016 г.     |
| Финляндия              | Карта оплаты       | 2,24%                         | Март 2016 г.     |
| France               | Карта оплаты       | 2,24%                         | Март 2016 г.     |
| Germany              | Карта оплаты       | 2,24%                         | Март 2016 г.     |
...
| Соединенные Штаты        | Карта оплаты       | 2,24%                         | Март 2016 г.     |
...
> [!NOTE]
> список стран и регионов, в которых можно зарегистрироваться для использования учетной записи разработчика, см. статью [типы учетных записей, местоположения и сборы](account-types-locations-and-fees.md).
