...
> [!IMPORTANT]
> Это вы несете ответственность за любые нормативных требований, даже если эти требования не указаны здесь или в центре партнеров.
...
> [!NOTE]
> Для ранее опубликованных приложений, которые включают пакеты, предназначенные для Windows8 или Windows8.1 некоторые отдельные рынки обрабатываются как единый рынок «Остальной мир». Дополнительные сведения см. в разделе [Страны категории "Остальной мир" для ОС Windows8.x](#rest-of-world-markets-for-windows-8x).
...
Вы можете сделать свое приложение или надстройку доступными в одной или нескольких указанных ниже странах. Рынки, помеченные звездочкой поддерживают Microsoft Store на Xbox One; Вы увидите **Xbox** рядом с их имена во всплывающем окне **Выбор определенных стран** .
...
| Taiwan               | Карта оплаты       | 2,24%                         | Март 2016 г.     |
...
Если ранее опубликованное приложение включает пакеты, предназначенные для Windows 8.x, важно помнить, что некоторые рынки обрабатываются как рынок один «остальной мир» для клиентов, использующих хранилище в Windows 8.x, даже если они отображаются как отдельные рынки в центре партнеров.

Если вы оставите Выбор рынка по умолчанию, при отправке приложения, вам не нужно беспокоиться об этом, и ваше приложение будет доступно на всех возможных рынках. Тем не менее если вы хотите исключить некоторые рынки, имейте в виду, что исключение даже одного из этих рынков «Остальной мир» означает, что ваше приложение не будет доступно в *любой* части рынки «Остальной мир» для пользователей Windows8 или Windows8.1.
