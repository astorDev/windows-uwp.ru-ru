...
> [!NOTE]
> Ранее опубликованных приложений, которые включают пакеты, предназначенные для Windows8 или Windows8.1 некоторые отдельные рынки обрабатываются как единый рынок «Остальной мир». Дополнительные сведения см. в разделе [Страны категории "Остальной мир" для ОС Windows8.x](#rest-of-world-markets-for-windows-8x).
...
Если ранее опубликованное приложение включает пакеты, предназначенные для Windows 8.x, важно помнить, что некоторые рынки обрабатываются как рынок одного «остальной мир» для клиентов, использующих хранилище в Windows 8.x, даже если они отображаются как отдельные страны в центре партнеров.
