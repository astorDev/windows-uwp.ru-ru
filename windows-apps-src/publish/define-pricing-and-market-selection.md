...
Вы можете сделать свое приложение или надстройку доступными в одной или нескольких указанных ниже странах. Страны, помеченные звездочкой поддержки Microsoft Store для Xbox One; Вы увидите **Xbox** рядом с их имена во всплывающем окне **Выбор определенных стран** .
