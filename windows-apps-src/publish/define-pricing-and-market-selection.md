...
Сведения, чтобы помочь сделать свои приложения для клиентов по всему миру в разделе [правила для глобализации](../design/globalizing/guidelines-and-checklist-for-globalizing-your-app.md) и [сделать свои приложения локализуемых](../design/globalizing/prepare-your-app-for-localization.md).
...
## <a name="microsoft-store-consumer-markets"></a>Потребитель рынков хранилища Майкрософт

Вы можете сделать свое приложение или надстройку доступными в одной или нескольких указанных ниже странах. Рынков звездочкой поддержки Microsoft хранилища на один Xbox; Вы увидите **Xbox** рядом с их имена во всплывающем окне **выбора рынка** .
...
Если ваше приложение включает пакеты, предназначенные для Windows 8.x, важно знать, что число рынков считаются рынка одного «Rest из, мир» для клиентов, использующих хранилище на Windows 8.x, даже если они отображаются в виде отдельных рынков в центр разработчиков Windows панели мониторинга (в отличие от более ранних панели мониторинга хранилища, где возникла один вариант рынка «Rest мир» для группирования всех этих рынков).
