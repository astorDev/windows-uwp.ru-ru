...
> [!NOTE]
> Для приложений, предназначенных для Windows8 или Windows8.1 некоторые отдельные рынки обрабатываются как единый рынок «Остальной мир». Дополнительные сведения см. в разделе [Страны категории "Остальной мир" для ОС Windows8.x](#rest-of-world-markets-for-windows-8x).
...
Если вы оставите выбор по умолчанию при отправке приложения, то вам не о чем беспокоиться, ваше приложение будет доступно на всех возможных рынках. Тем не менее если вы хотите исключить некоторые рынки, имейте в виду, что исключение даже одного из этих рынков «Остальной мир» означает, что ваше приложение не будет доступно на всех рынках «Остальной мир» для пользователей Windows8 или Windows8.1.
