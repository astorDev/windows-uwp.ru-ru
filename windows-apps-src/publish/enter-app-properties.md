---
author: jnHs
Description: "Страница &quot;Свойства приложения&quot; процесса отправки приложения позволяет указать категорию приложения, а также предпочтения оборудования или другие объявления."
...
Страница **Свойства приложения** [процесса отправки приложения](app-submissions.md) позволяет указать категорию приложения, а также предпочтения оборудования или другие объявления. Здесь мы рассмотрим варианты, отображаемые на этой странице, и обсудим факторы, которые следует учитывать при указании соответствующих данных.
