...
Этот раздел будет доступен, только если в качестве категории продукта был выбран вариант **Игры**. Здесь можно указать, какие функции поддерживает ваша игра. Сведения, предоставленные в этом разделе, будут отображаться в списке магазина продукта.
...
В этом разделе можно указать, предназначен ли продукт для использования в иммерсивном представлении (не 2D) [Windows Mixed Reality](https://developer.microsoft.com/mixed-reality) на ПК и (или) устройствах HoloLens. Если вы укажете, что продукт предназначен, вам также потребуется:
...
- **Для клиентов под управлением Windows 10 версии 1607 или более поздней:**
...
- **Для клиентов в Windows 8. x и более ранних версий или Windows Phone 8. x и более ранних версий:**
