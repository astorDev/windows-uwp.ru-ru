...
Этот раздел будет доступен, только если в качестве категории продукта был выбран вариант **Игры**. Здесь можно указать, какие функции поддерживает ваша игра. Сведения, представленные в этом разделе отображается на продукта в магазине описания.
