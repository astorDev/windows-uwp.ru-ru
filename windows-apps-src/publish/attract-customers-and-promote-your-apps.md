...
ms.locfileid: "2830786"
---
# <a name="attract-customers-and-promote-your-apps"></a>Привлечение клиентов и продвижение приложений

После вашего приложения в магазине Майкрософт, настало время для его перед числа пользователей по мере возможности. Мы предлагаем множество функций, которые помогут вам продвигать ваши продукты и расширить клиентскую базу, включая рекламные кампании, промокоды, распродажи и многое другое.
...
-   [Хранилище Microsoft маркетинговых рекомендации к приложениям](app-marketing-guidelines.md)
