...
ms.prod: windows
ms.technology: uwp
keywords: Windows 10, uwp, аналитика, отчеты, панели мониторинга, приложения, данные, показатели
...
-   [Полезные сведения о отчета](insights-report.md)
