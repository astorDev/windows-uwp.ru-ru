---
author: JnHs
Description: "Получение подробной аналитики по вашим приложениям для Windows на информационной панели или другими способами."
...
Для просмотра основных данных аналитики о чаще всего скачиваемых приложениях разверните раздел **Анализ** и выберите пункт **Обзор**. По умолчанию на странице **Обзор аналитики** отображаются сведения о пяти приложениях с наибольшим количеством скачиваний. Чтобы отобразить другие опубликованные приложения, нажмите кнопку **Фильтры**.
...
В дополнение к аналитическим отчетам на информационной панели существует ряд других способов доступа к аналитическим данным.
