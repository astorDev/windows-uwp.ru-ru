---
author: jnHs
Description: "Вы можете создавать описания в Магазине для ваших приложений без использования информационной панели Центра разработки путем экспорта ваших описаний в виде CSV-файла, ввода ваших сведений и ресурсов с последующим импортом обновленного файла."
...
Вы можете создавать [описания в Магазине](create-app-store-listings.md) для ваших приложений без использования информационной панели Центра разработки путем экспорта ваших описаний в виде CSV-файла, ввода ваших сведений и ресурсов с последующим импортом обновленного файла. Этот способ можно использовать для создания описаний с нуля или для обновления уже созданных описаний. 

Обратите внимание, что этот способ нельзя использовать для создания и обновления [описаний в Магазине для определенной платформы](create-platform-specific-store-listings.md) вашего приложения.
