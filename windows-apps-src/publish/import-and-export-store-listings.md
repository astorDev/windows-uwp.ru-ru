...
Если вы хотите использовать новый ресурс, который не был добавлен ранее в центр партнеров, можно сделать путем импорта ваших описаний в качестве папки, а не как одного CSV-файла. Необходимо создать папку, содержащую CSV-файл. Затем добавьте изображения из этой же папки в корневую папку или во вложенную папку. В поле вам потребуется ввести полный путь, включая имя корневой папки.
...
Никакие данные из CSV-файла будут сохранены в центре партнеров, пока все ошибки в вашем файле будут устранены, даже для полей без ошибок. После импорта CSV-файл, который не содержит ошибки, предоставленные вами сведения описания будут сохранены в центре партнеров и будет использоваться для этой отправки.
