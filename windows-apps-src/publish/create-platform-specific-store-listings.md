...
Пользователи Windows10 (включая Xbox) всегда будут видеть [Описание хранилища](create-app-store-listings.md)по умолчанию. Вы не увидите возможность создания описания в магазине для определенной платформы, если вы уже опубликовали свое приложение с помощью пакетов, которые поддерживают один или несколько более ранних версий ОС. 
...
Описания в магазине для определенной платформы может пригодиться, если вы хотите рассказать о функциональных возможностях, которые отображаются только в одной версии ОС, или необходимо предоставить снимки экрана, которые относятся к определенной ОС (независимо от типа устройства).
