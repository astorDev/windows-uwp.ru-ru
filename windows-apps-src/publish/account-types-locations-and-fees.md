...
\*  PayPal может использоваться в качестве метода оплаты для учетных записей о выплатах на этом рынке, но не может использоваться для оплаты регистрационном взносе учетной записи разработчика.
