...
Учетные записи компании стоят немного дороже— в основном потому, что нам нужно провести ряд дополнительных проверок, подтверждающих, что вы уполномочены создать учетную запись от имени вашей компании. Каждой [Политики хранения](https://docs.microsoft.com/legal/windows/agreements/store-policies#1014-account-type), приложений с помощью некоторых возможностей например на доступ к учетной записи финансовые сведения или требуют проверки подлинности для доступа к основные функциональные возможности (без использования поставщика проверки подлинности безопасных выделенного сторонних производителей), можно опубликовать только по учетным записям компаний.

## <a name="account-verification"></a>Проверка учетной записи

После регистрации мы проверим вашу учетную запись. Мы проверяем индивидуальные учетные записи, чтобы убедиться, что другая компания уже не использует ваше отображаемое имя издателя. Наш партнер по проверке учетных записей Dun & Bradstreet поверяет, уполномочены ли вы создать учетную запись для компании, которую представляете. Этот процесс может занимать от нескольких дней до пары недель. Часто для завершения проверки требуется телефонный звонок в вашу компанию, поэтому при заполнении формы регистрации указывайте все актуальные контактные данные. Не удается отправлять приложения из учетной записи компании, пока оно проверяется, но во время ожидания может [зарезервировать имени приложения](create-your-app-by-reserving-a-name.md) продолжить созданию и тестированию приложений и совместной работы над Подготовка к отправке.
