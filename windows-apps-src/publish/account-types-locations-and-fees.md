...
Учетные записи компании стоят немного дороже— в основном потому, что нам нужно провести ряд дополнительных проверок, подтверждающих, что вы уполномочены создать учетную запись от имени вашей компании. В соответствии с политиками [Store](https://docs.microsoft.com/legal/windows/agreements/store-policies#1014-account-type) для публикации приложений с определенной функциональностью, например приложений, осуществляющих доступ к сведениям о финансовых счетах или требующих аутентификации для доступа к основной функциональности (без привлечения защищенного выделенного стороннего поставщика аутентификации), требуется учетная запись компании.
