...
В [начале процесса регистрации](http://go.microsoft.com/fwlink/p/?LinkId=615100) нужно выбрать тип учетной записи: индивидуальную или компании. Оба типа учетной записи позволяют отправлять приложения, надстройки и службы. Индивидуальные учетные записи используются отдельными разработчиками, работающими самостоятельно. Учетные записи компании предназначены для организаций и предприятий и разрешают доступ к некоторым дополнительным возможностям приложений. Учетные записи компании проходят более строгую [проверку](#account-verification), чтобы мы могли подтвердить ваши полномочия на ее создание от имени компании. 
...
После регистрации мы проверим вашу учетную запись. Мы проверяем индивидуальные учетные записи, чтобы убедиться, что другая компания уже не использует ваше отображаемое имя издателя. С помощью Symantec или Dun & Bradstreet мы проверяем, уполномочены ли вы создать учетную запись для компании, которую представляете. Этот процесс может занимать от нескольких дней до пары недель. Часто для завершения проверки требуется телефонный звонок в вашу компанию, поэтому при заполнении формы регистрации указывайте все актуальные контактные данные. Вы не можете отправлять приложения из непроверенной учетной записи компании, но во время ожидания проверки вы можете [резервировать имя приложения](create-your-app-by-reserving-a-name.md), получать доступ к информационной панели Центра разработки для Windows и продолжать создавать и тестировать приложение.
