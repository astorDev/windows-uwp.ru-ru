...
В [начале процесса регистрации](http://go.microsoft.com/fwlink/p/?LinkId=615100) нужно выбрать индивидуальную или корпоративную учетную запись разработчика.

> **Важно!** Выбранный тип учетной записи нельзя изменить, поэтому внимательно выбирайте тип.
...
> **Важно!** Если принято решение о создании корпоративной учетной записи, обязательно изучите наши [рекомендации для корпоративных учетных записей](opening-a-developer-account.md#additional-guidelines-for-company-accounts).
...
|  Гватемала | 19 USD | 99 USD | Платежи в гватемальских кетсалях (GTQ) через банк | Нет | 
...
|  Кения | 19 USD | 99 USD | Платежи в кенийских шиллингах (KES) через банк | Нет | 
|  Кирибати | 19 USD | 99 USD | Нет выплаты | Нет | 
|  Южная Корея | 21 216 KRW | 108 000 KRW | Платежи в долларах США (USD) через банк | Нет | 
...
|  Нигерия | 19 USD | 99 USD | Платежи в нигерийских найрах (NGN) через банк | Нет | 
...
|  Румыния | 63 RON | 360 RON | Платежи в долларах США (USD) через банк | Нет | 
