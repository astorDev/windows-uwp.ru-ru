...
ms.locfileid: "9045713"
---
# <a name="account-types-locations-and-fees"></a>Типы, доступность и стоимость учетных записей

Windows программ в [Центре партнеров](https://partner.microsoft.com/dashboard) предложения как отдельные учетные записи и во многих [странах и регионах](#developer-account-and-app-submission-markets). Все типы учетных записей дают вам получить доступ к для публикации приложений в магазине и участвовать в дополнительных программах Майкрософт.

> [!NOTE]
> При открытии вашей учетной записи разработчика, убедитесь, что вход в [Центр партнеров](https://partner.microsoft.com/dashboard) с учетной записью Майкрософт, который вы хотите использовать учетную запись разработчика. Вы получите возможность [добавить дополнительных пользователей в учетную запись](manage-account-users.md) позже.

В [начале процесса регистрации](https://go.microsoft.com/fwlink/p/?LinkId=615100) нужно выбрать тип учетной записи: индивидуальную или компании. Оба типа учетной записи позволяют отправлять приложения, игры, надстройки и службы.
...
Учетные записи компании стоят немного дороже— в основном потому, что нам нужно провести ряд дополнительных проверок, подтверждающих, что вы уполномочены создать учетную запись от имени вашей компании. На [Политикам](https://docs.microsoft.com/legal/windows/agreements/store-policies#1014-account-type), приложения с ограниченными возможностями, например доступ к учетной записи финансовые сведения или требующих аутентификации для доступа к основной функциональности (без привлечения защищенного выделенного стороннего поставщика аутентификации), его можно опубликовать только учетными записями компании.
