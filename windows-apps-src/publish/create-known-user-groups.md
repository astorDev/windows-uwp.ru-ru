...
Не удается удалить группу известных пользователей из центра партнеров (или измените ее имя) после он создан, но можно изменить его членство в любое время.
...
Для внесения более масштабных изменений выберите **Экспорт CSV**, чтобы сохранить членство вашей группы в CSV-файле. Внесите изменения в файл, а затем щелкните **Import .csv**, чтобы использовать новую версию файла для обновления состава группы.
