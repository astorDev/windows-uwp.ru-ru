...
> [!IMPORTANT]
> Прежде чем вы можете получать деньги от продажи приложения в Microsoft Store, необходимо [вашей учетной записи о выплатах и заполните необходимые налоговых форм](setting-up-your-payout-account-and-tax-forms.md).
...
Можно использовать сведения о платежные данные и скачивать отчеты **Сводка о выплатах** из [центра партнеров](https://partner.microsoft.com/dashboard). Дополнительные сведения об отображаемой здесь информации и о категоризации зарабатываемых вами денег см. в разделе [Сводка о выплатах](payout-summary.md).
...
> [!NOTE]
> Ваш **о выплатах хранения состояния** Выбор распространяется на **все** источников дохода, которые оплачиваются по программе разработчика Windows в центре партнеров (Microsoft Store, рассылает объявления, Azure Marketplace и т. д.). Невозможно выбрать различные состояния удержания для всех источников выручки.
