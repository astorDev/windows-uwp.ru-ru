...
| Зависит | Процент просмотров ad, которые могут просматриваться в вашем приложении. Для получения дополнительных сведений о том, как это значение рассчитывается видеть [оптимизировать зависит единиц ad](../monetize/optimize-ad-unit-viewability.md). |
