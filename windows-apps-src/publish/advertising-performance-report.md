...
| Зависит | Доля показов рекламы, доступные для просмотра в вашем приложении. Для получения дополнительных сведений о том, как это значение рассчитывается см. [Оптимизация зависит ad единиц](../monetize/optimize-ad-unit-viewability.md). |
