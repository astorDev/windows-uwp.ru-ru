...
> [!NOTE]
> Если у вас больше одного тестового пакета, необходимо присвоить каждому из них приоритет. Подробнее см. ниже в разделе [Добавление дополнительных тестовых пакетов и назначение им приоритета].
...
> [!IMPORTANT]
> При постепенном выпуске пакетов в составе тестового пакета пользователи, не включенные в ту часть, которая получает ваши новые пакеты, будут получать пакеты из предыдущей отправки тестового пакета (если им не доступна тестируемая возможность более высокого ранга).
