...
> [!IMPORTANT]
> При постепенном выпуске пакетов в составе тестового, пользователи, не включенные в ту часть, которая получает ваши новые пакеты будут получать пакеты из предыдущей отправки тестового пакета (если нет тестируемой возможности с более высоким приоритетом, доступный для них).
