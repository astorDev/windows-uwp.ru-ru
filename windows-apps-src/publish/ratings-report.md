---
description: Отчет «Оценки» на информационной панели Центра разработки позволяет просматривать распределение оценок вашего приложения пользователями в Магазине Windows.
title: Отчет «Оценки»
...
-   **Новые оценки** — это оценки, которые пользователи отправили, но не изменили.
