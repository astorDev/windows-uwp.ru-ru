...
После реализации предложений, вы можете вернуться на страницу **целевые предложения** в центре партнеров, чтобы просмотреть общее количество конверсий для каждого предложения.
