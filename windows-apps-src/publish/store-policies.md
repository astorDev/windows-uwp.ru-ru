...
ms.locfileid: "66826481"
---
# <a name="microsoft-store-policies"></a>Политики для Microsoft Store


**Версия документа: 7.11**

**Дата документа: 5 марта 2019 г.**
...
В игровых продуктах, предназначенных для Xbox One, должны использоваться службы Xbox Live в рамках программы [Xbox Live Creators](https://go.microsoft.com/fwlink/?linkid=844722) или [ID@Xbox](http://go.microsoft.com/fwlink/?LinkId=821742).
...
Начиная с 17 апреля 2018 г. новые опубликованные продукты, требующие проверки подлинности для доступа к основным функциям, должны использовать сторонний безопасный выделенный поставщик проверки подлинности или должны быть опубликованы из учетной записи организации. Обратите внимание, что все приложения должны использовать учетную запись организации, если им требуется доступ к финансовым данным учетной записи, как описано в разделе 10.8.3.
