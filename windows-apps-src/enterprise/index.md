...
ms.locfileid: "7426331"
---
# <a name="enterprise"></a>Корпоративная

В следующей схеме представлен обзор основных функций корпоративного уровня для приложений Windows10Universal платформы Windows (UWP).
...
Есть ли версия этого приложения, которые показаны некоторые улучшения, которые были, о которых рассказывалось в сборки во время этой презентации [Быстро создать бизнес-приложений с помощью Visual Studio и UWP](https://channel9.msdn.com/Events/Build/2018/BRK3502)
...
[DataGridView](https://docs.microsoft.com/en-us/windows/communitytoolkit/controls/datagrid) предоставляет удобный способ отображения коллекции данных в строках и столбцах.
...
Библиотека пользовательского интерфейса Windows — это набор пакетов NuGet, которые предоставляют элементы управления и другие элементы пользовательского интерфейса для приложений UWP. Оно также позволяет нижнего уровня совместимости с предыдущими версиями Windows 10, чтобы ваше приложение работает, даже если пользователи не имеют последних операционной системы.

![Библиотека пользовательского интерфейса Windows](images/win-ui.png)

См. в разделе [Библиотека пользовательского интерфейса Windows (предварительной версии)](https://docs.microsoft.com/en-us/uwp/toolkits/winui/).

<a id="xaml-islands" />

### <a name="uwp-controls-in-desktop-applications"></a>Элементы управления UWP в классических приложениях

Windows 10 теперь позволяет использовать элементы управления UWP в классических приложениях WPF, Windows Forms и C++ Win32. Это означает, что можно улучшить внешний вид и функциональные возможности своих существующих классических приложений с помощью новейшие возможности пользовательского интерфейса Windows 10, которые доступны только через элементы управления UWP, например Windows Ink и элементов управления, которые поддерживают системы проектирования Fluent Design. Эта возможность называется острова XAML.
...
MSIX — это формат упаковки, созданный для быть безопасный и надежный, на основе сочетания MSI-файл, .appx, технологии установки App-V и ClickOnce.
...
Распространять приложение среди пользователей организации можно несколькими способами. Можно использовать магазин Майкрософт для бизнеса, существующие системы управления мобильными устройствами или загружать неопубликованные приложения на устройствах. Вы можете также сделать приложения доступным для общей открытых, опубликовав в Microsoft Store.

| Статья | Описание |
|-------|-------------|
| [Распространение бизнес-приложений для предприятий](https://msdn.microsoft.com/library/windows/apps/mt608995) | Вы можете опубликовать бизнес-приложений непосредственно для предприятий, для массового приобретения предприятиями в магазине Майкрософт для бизнеса, но при этом широко доступным для всех. |
...
Действие - поговорим Джош и (или) Карл для получения более ориентированным предприятия примеры друг с другом.

| Статья |  Описание |
|------ |--------------|
| [Пример VanArsdel инвентаризации](https://github.com/Microsoft/InventorySample) | Пример приложения Windows 10 (с помощью универсальной платформы Windows) фокус в сценариях, бизнес, показывающий, как использовать новейших возможностей Windows в классических приложениях. Пример основана на создание и управление ими клиента, заказов и продукты для вымышленная компания VanArsdel.
Выделяет MVVM, базы данных SQL, Entity Framework. Список других пользователей.|
