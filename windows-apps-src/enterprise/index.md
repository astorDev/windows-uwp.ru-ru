...
| Раздел | Описание |
|-------|-------------|
| [Основы работы в сети](https://msdn.microsoft.com/library/windows/apps/mt280233) | В этом пошаговом руководстве объясняются основные концепции сетевого подключения, используемые во всех приложениях UWP, независимо от применяемого протокола связи.  |
...
| Раздел | Описание |
|-------|-------------|
| [Распространение бизнес-приложений для предприятий](https://msdn.microsoft.com/library/windows/apps/mt608995) | В Microsoft Store для бизнеса можно публиковать бизнес-приложения, которые будут доступны только для приобретения предприятиями в больших объемах и недоступны остальным пользователям. |
