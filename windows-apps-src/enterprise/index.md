...
В этой статье представлен обзор основных функций корпоративного уровня предоставляются по универсальной платформы Windows (UWP) для приложений Windows 10. Видеоролик, демонстрирующий некоторые из них подробно см. в разделе [Быстро создать бизнес-приложений с помощью UWP и Visual Studio](https://channel9.msdn.com/Events/Build/2018/BRK3502).
