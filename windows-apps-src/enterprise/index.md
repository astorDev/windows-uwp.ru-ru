...
Есть ли версия этого приложения, которые показаны некоторые улучшения, которые были, о которых рассказывалось в сборки во время этой презентации [Быстро создавать бизнес-приложений с помощью UWP и Visual Studio](https://channel9.msdn.com/Events/Build/2018/BRK3502)
...
> * [MSIX развертывания](#MSIX)

<a id="template-studio" />

### <a name="windows-template-studio"></a>Windows Template Studio

Windows Template Studio — это расширение Visual Studio 2017, ускоряет создание нового приложения универсальной платформы Windows (UWP), с помощью на основе мастера работы. Созданный проект UWP является правильным форматом, для чтения код, который включает новые возможности Windows 10 при реализации проверенные шаблоны и рекомендации.
...
### <a name="msix-deployment"></a>MSIX развертывания
...
MSIX — это формат упаковки быть безопасный и надежный, созданных на основе сочетания .msi, .appx, App-V и ClickOnce технологий установки.

![Значок MSIX](images/WinUI_MSIX_2col_740x417.png)

См. в [документации MSIX](https://docs.microsoft.com/windows/msix/).
...
Распространять приложение среди пользователей организации можно несколькими способами. Можно использовать магазин Майкрософт для бизнеса, политиками управления мобильными устройствами или загружать неопубликованные приложения на устройствах. Вы также можете приложения доступны в главной открытых, опубликовав в Microsoft Store.
