...
- [Анимации, управляемые вводом](input-driven-animations.md)
- [Пользовательские возможности манипуляции с Интерактионтраккер](interaction-tracker-manipulations.md)
- [Анимация на основе связей](relation-animations.md)
