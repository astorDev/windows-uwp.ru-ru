...
- Возможность связать объект с подсветкой, поэтому они перемещаются вместе независимо от остальной части сцены для включения сценариев, таких как [Отображение](/design/style/reveal) Fluent команда.
...
**Преобразования** | Источники света должна располагаться в узел выше пользовательского интерфейса, который использует эффектов, например [преобразований перспективы](/design/layout/3-d-perspective-effects) в вашем визуальной структуры необходимо нарисовать надлежащим образом.
