...
Дополнительные сведения об использовании кистей с пользовательским интерфейсом на XAML см. в разделе [**Кисти**](../graphics/using-brushes.md#xamlcompositionbrushbase).
...
Дополнительную информацию об использовании источников света, включая элементы пользовательского интерфейса на XAML, см. в разделе [**Освещение**](lighting.md).
...
Этот код на языке [C++/ CX](https://docs.microsoft.com/cpp/cppcx/visual-c-language-reference-c-cx) равнозначен приведенному ранее коду на C&#35; с использованием такой же структуры XAML.
