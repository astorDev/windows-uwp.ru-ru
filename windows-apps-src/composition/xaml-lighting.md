...
Затем можно применить этот светлый UIElement для XAML или кисть для них. В этом примере показано использование различных потенциальных.
