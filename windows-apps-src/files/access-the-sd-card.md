...
description: Можно хранить не слишком важные данные на дополнительной карте microSD, в особенности на недорогих мобильных устройствах с ограниченным объемом внутренней памяти.
---
# Доступ к SD-карте
