...
> [!NOTE]
> [**FileSavePicker** ](https://msdn.microsoft.com/library/windows/apps/br207871) объектов отображения средства выбора файла с помощью [ **PickerViewMode.List** ](https://msdn.microsoft.com/library/windows/apps/br207891) режим просмотра.
