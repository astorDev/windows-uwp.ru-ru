---
Description: Как использовать эскизы, чтобы пользователи могли использовать предварительный просмотр файлов в приложениях UWP.
...
<th> Режимы эскизов </th>
<th> Характеристики получаемых эскизов </th>
</tr>
<tr>
...
<tr>
<td> Documents<br />Музыка </td>
<td> DocumentsView <br />MusicView <br /> ListView</td>
<td> <b>Размер</b>: небольшой, желательно не менее 40 x 40 пикселей. <br />
<b>Пропорции</b>:  равные, квадратные.  <br />
