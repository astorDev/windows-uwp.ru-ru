...
-   **Объявления capabilty приложения**
    ...
    > [!NOTE]
    > Материалы в библиотеке документов в домашнюю группу не будет видимым в приложении независимо от возможностей, объявленные в манифесте приложения и независимо от того, параметры общего доступа пользователя.     

-   **Общие сведения об использовании средства выбора файла**
...
-   **Понять, файлов и папок запросов**
...
2.  **Задайте параметры запроса и фильтра поиска.**
...
3.  **Выполнить запрос и обработки результатов.**
...
2.  **Найти целевой папки и затем создать файл запроса ограничена этой папки.**
...
2.  **Откройте средства выбора файлов в домашней группы и применить фильтр, который включает файлы видео в форматы, которые поддерживает приложение.**
