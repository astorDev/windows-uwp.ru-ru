...
-   **Воспроизведение на**позволяют пользователям воспроизведение звука, видео и изображений, передаются из вашего приложения на другие устройства их домашней сети.
...
**Сенсорные**Windows предоставляет возможности уникальных и разнообразных процедур сенсорного управления, должное функциональность мыши.
...
**Увлекательность и Новизна**убедитесь, что ваше приложение оригинальным и подключает пользователей с помощью этих стандартных возможностей:
...
-   **Пользовательские плитки**  сделать приложение более личные для пользователей, загружая изображение пользовательской плитки или дать пользователям возможность устанавливать содержимое из вашего приложения в качестве личной плитки в Windows.

**Возможности устройства**убедитесь, что ваше приложение использует все преимущества возможностей современных устройств.

-   **Жесты близкого взаимодействия**предоставьте пользователю возможность установить соединение с другим пользователям, которые находятся близко друг к другу, посредством физического соприкосновения устройств (многопользовательские игры). Узнайте подробнее о [бесконтактном и контактном взаимодействии](https://msdn.microsoft.com/library/windows/apps/hh465229).
-   **Камеры и внешние устройства хранения**могли своих встроенных или подключены к фотографии для конференц-связи, запись вести, участвовать видеоконференциях миром, общаться пользователей или независимо от действий ваше приложение замечательно. Подробнее о [получении доступа к содержимому съемного носителя](https://msdn.microsoft.com/library/windows/apps/hh465189).
...
**Выберите способ расположения вашего приложения в каждом представлении.** Windows поддерживает альбомную и книжную ориентации, а также подстройку размеров окна приложения под любую ширину в полноэкранном режиме до минимальной ширины. Нам нужно, чтобы приложение выглядело и работало превосходно на любом экране и в любой ориентации. Это значит, что необходимо планировать структуру элементов интерфейса для различных размеров и представлений. Тем самым вы обеспечите плавную адаптацию интерфейса к нуждам и предпочтениям пользователя.
