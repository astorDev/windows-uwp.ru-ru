...
Хорошая информационная архитектура не только помогает упростить пользовательские сценарии, но и позволяет вам визуализировать ключевые экраны, с которых следует начать. [Звуковые](http://go.microsoft.com/fwlink/p/?LinkID=268089) приложения, например, запускает непосредственно в это центр, который предоставляет доступ к библиотеке пользователя, магазина, новости и статистики. Взаимодействие сфокусировано, поэтому пользователи могут получить и аудиокнигам быстро. Более глубокие уровни приложения сфокусированы на более специфических задачах.
...
**Контракты**ваше приложение может участвовать в контракты действий пользователя — широкая группа, приложений, кросс компонентов.

-   **Совместное использование**Позвольте пользователям отправлять содержимое вашего приложения другим людям через другие приложения и получения общем доступе содержимого из других пользователей и приложений, слишком.
...
**Увлекательность и Новизна**убедитесь, что ваше приложение оригинальным и привлекает пользователям эти стандартные возможности:
...
-   **Всплывающие уведомления**пользователей о том, зависящих от времени или лично соответствующие содержимое с помощью всплывающих уведомлений, информировать их возвращается к приложению даже в том случае, если ваше приложение закрыто. Узнайте подробнее о [плитках, индикаторах событий и всплывающих уведомлениях](../design/shell/tiles-and-notifications/index.md).
...
**Возможности устройства**убедитесь, что полный все многообразие возможностей современных устройств.
...
-   **Камеры и внешние устройства хранения**подключения пользователей к своих встроенных или документальные камеры фотографии для конференц-связи, запись вести, участвовать видеоконференциях миром, или независимо от действий ваше приложение замечательно. Подробнее о [получении доступа к содержимому съемного носителя](https://msdn.microsoft.com/library/windows/apps/hh465189).
-   **Акселерометры и другие датчики**   Устройства поставляются с датчиков одними. Ваше приложение способно менять яркость в зависимости от освещения, адаптировать интерфейс при повороте дисплея и реагировать на любые движения. Узнайте подробнее о [датчиках](../devices-sensors/sensors.md).
-   **Определение географического расположения**используйте данные географического положения из стандартных веб-данных или от датчиков географического положения чтобы помочь пользователям сориентироваться, определить свое положение на карте или узнать о людей, действия и назначения. Дополнительные сведения о [географическом положении](https://msdn.microsoft.com/library/windows/apps/hh465139).
...
-   **Всегда Старайтесь использовать содержимое.** Возможности позволяют пользователям напрямую управлять содержимым на холсте приложения, а не добавлять команды, выполняющие на содержимое. Скажем, пусть путешественники из нашего примера, планируя маршрут, просто перетаскивают развлечения внутри списка на полотне приложения, а не нажимают всякий раз стрелки.
