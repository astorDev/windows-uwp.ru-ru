---
title: "Руководство по началу работы: игра UWP на JavaScript"
description: "Простая игра UWP для Магазина Windows, написанная на языках JavaScript и CreateJS"
author: jken
ms.author: jken
ms.date: 02/09/2017
ms.topic: article
...
---
# <a name="get-started-tutorial-a-uwp-game-in-javascript"></a>Руководство по началу работы: игра UWP на JavaScript

## <a name="a-simple-2d-uwp-game-for-the-windows-store-written-in-javascript-and-createjs"></a>Простая двухмерная игра UWP для Магазина Windows, написанная на языках JavaScript и CreateJS
...
**Примечание.** Этот пример не претендует на то, чтобы считаться завершенной (или хорошей) игрой. Его цель— продемонстрировать, как с помощью JavaScript и сторонней библиотеки создать приложение, готовое к публикации в Магазине Windows.
...
Теперь у вас есть приложение UWP, и его можно опубликовать в Магазине Windows (если, конечно, вы уверены, что все сделано качественно). 
