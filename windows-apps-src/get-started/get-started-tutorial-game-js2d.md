...
description: Простая игра UWP для Microsoft Store, написанная на JavaScript и CreateJS
...
Опубликовав приложение в Microsoft Store можно предоставить к ним (или продавать!) миллионам пользователей на различных устройствах.  
...
Если вы запустили игру с помощью клавиши F5, наверняка вы задаетесь вопросом, что же сейчас происходит. А происходит совсем «не много», немного как значительная часть кода — это сейчас закомментирована. Итак вы увидите всего лишь динозавра и предложение требования к созданию клавишу ПРОБЕЛ. 
