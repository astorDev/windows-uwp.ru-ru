...
Опубликовав приложение в Microsoft Store можно предоставить к ним (или продавать его!) миллионам пользователей разнообразных устройств.  
...
Если вы запустили игру с помощью клавиши F5, наверняка вы задаетесь вопросом, что же сейчас происходит. И ответ «не много», так как значительная часть кода — это сейчас закомментирована. Итак вы увидите всего лишь динозавра и предложение требования к созданию клавишу ПРОБЕЛ. 
