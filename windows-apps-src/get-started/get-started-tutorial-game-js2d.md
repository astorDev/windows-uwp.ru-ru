...
Можно также загрузить проект как ZIP-файл или использовать другие стандартные способы работы с [проектами GitHub](https://docs.microsoft.com/windows/uwp/get-started/get-uwp-app-samples).
