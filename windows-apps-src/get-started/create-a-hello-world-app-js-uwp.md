...
3.  В списке шаблонов слева откройте **Установленные > Шаблоны > JavaScript** и выберите **Универсальная платформа Windows**, чтобы просмотреть список шаблонов проектов UWP.

    Если универсальные шаблоны не отображаются, возможно, у вас нет компонентов для создания приложений UWP. Вы можете повторить процесс установки и добавить поддержку UWP. Для этого выберите **Открыть установщик Visual Studio** в диалоговом окне *Создание проекта*. Ознакомьтесь с разделом [Подготовка](get-set-up.md).
