---
title: "Руководство по началу работы: игра UWP в MonoGame 2D"
description: "Простая игра UWP для Магазина Windows, написанная на языках C# и MonoGame"
author: mukin
ms.author: mukin
ms.date: 03/06/2017
ms.topic: article
...
translationtype: HT
---
# <a name="get-started-tutorial-a-uwp-game-in-monogame-2d"></a>Руководство по началу работы: игра UWP в MonoGame 2D

## <a name="a-simple-2d-uwp-game-for-the-windows-store-written-in-c-and-monogame"></a>Простая двухмерная игра UWP для Магазина Windows, написанная на языках C# и MonoGame
...
+    Windows10 и Microsoft Visual Studio2015. [Щелкните здесь, чтобы узнать, как подготовиться к работе с Visual Studio.](https://docs.microsoft.com/en-us/windows/uwp/get-started/get-set-up)
...
Откройте проект в Visual Studio 2015 и нажмите клавишу **F5**, чтобы запустить пример. В первый раз это может занять некоторое время, так как Visual Studio необходимо получить пакеты NuGet, которых не хватает в вашей установке.
...
2. Запустите Visual Studio 2015.
...
В качестве игрового персонажа мы будем использовать нашего "фирменного" кота-ниндзя, оседлавшего своего верного динозавра. [Щелкните здесь, чтобы загрузить изображение.](https://github.com/muhsinking/VeggieJump/blob/master/MonoGame2D/Content/ninja-cat-dino.png)
...
7. Обработка ввода с клавиатуры Дальше нам понадобится новый метод для обработки ввода с клавиатуры. Добавьте этот метод в файл **Game1.cs**:
...
## <a name="publish-to-the-windows-store"></a>Публикация в Магазине Windows
Поскольку мы создали эту игру как приложение UWP, ее можно опубликовать в Магазине Windows. Для этого нужно выполнить несколько шагов.
...
Дополнительные сведения см. в разделе [Публикация приложения Магазина Windows](https://developer.microsoft.com/en-us/store/publish-apps).
