...
+ .NET framework рабочего стола разработки. Если у вас еще нет этого установлена, вы можете получить этого повторно запустите установщик Visual Studio и изменении установки Visual Studio 2017.
