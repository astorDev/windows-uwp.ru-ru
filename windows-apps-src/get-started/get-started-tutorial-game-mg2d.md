...
В MonoGame новые вызовы **spriteBatch.Draw** будут рисоваться поверх любых предыдущих вызовов. Это означает, что брокколи и спрайта динозавра будут нарисованы поверх существующего спрайта травы, поэтому они могут никогда не будут за ним независимо от своего положения.

Попробуйте запустить игру и передвигать динозавра с помощью клавиш со стрелками и клавиши ПРОБЕЛ. Если вы следовали инструкциям выше, вы сможете управлять движениями в окне игры персонажа и брокколи должны появляться с возрастающей скоростью.
