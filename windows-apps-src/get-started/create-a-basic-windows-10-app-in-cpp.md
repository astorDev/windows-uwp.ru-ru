...
-   Для работы с этим учебником необходимо использовать Visual StudioCommunity 2017 или одну из версий Кроме Community Visual Studio2017 на компьютере, на котором выполняется Windows10. Для скачивания перейдите на страницу [Получение инструментов](http://go.microsoft.com/fwlink/p/?LinkId=532666).
...
4.  Введите имя проекта. Он будет называться HelloWorld.
 ...
 ![C + +/ CX шаблоны проектов в диалоговом окне Новый проект ](images/vs2017-uwp-01.png)
