...
description: В Microsoft Visual Studio2017, вы можете использовать C + +/ CX для разработки приложения, которое выполняется в Windows10, в том числе на телефонах под управлением Windows10. Пользовательский интерфейс в этих приложениях определен на языке XAML.
ms.date: 06/11/2018
ms.topic: article
...
В Microsoft Visual Studio2017, вы можете использовать C + +/ CX для разработки приложения, которое выполняется в Windows10 с пользовательским Интерфейсом, определенного в разметке языка XAML (Extensible Application).
...
4.  Введите имя проекта. Он будет называться HelloWorld.
 ...
 ![C + +/ CX шаблоны проектов в диалоговом окне «Создание проекта» ](images/vs2017-uwp-01.png)
