...
description: В Microsoft Visual Studio 2017 вы можете использовать язык C++/CX для разработки приложения, которое работает в Windows 10, в том числе на телефонах под управлением Windows 10. Пользовательский интерфейс в этих приложениях определен на языке XAML.
ms.date: 06/11/2018
ms.topic: article
...
-   Для работы с этим руководством необходимо использовать Visual Studio Community (или более позднюю версию) либо одну из других версий Visual Studio на компьютере с Windows 10. Для скачивания перейдите на страницу [Получение инструментов](https://go.microsoft.com/fwlink/p/?LinkId=532666).
...
2.  В диалоговом окне **Создание проекта** разверните на левой панели узел **Установленные** > **Visual C++**  > **Универсальная платформа Windows** .

> [!NOTE]
> Вам может быть предложено установить инструменты универсальной платформы Windows для разработки на C++.
...
4.  Введите имя проекта. Он будет называться HelloWorld.
 ...
 ![Шаблоны проектов C++/CX в диалоговом окне "Создание проекта" ](images/vs2017-uwp-01.png)
