...
Объекты [**Promise**](https://msdn.microsoft.com/library/windows/apps/BR211867) имеют метод [**then**](https://msdn.microsoft.com/library/windows/apps/BR229728), который принимает «завершенную» функцию в качестве параметра. **Promise** вызывает эту функцию по ее завершении.
