...
-   Создавать новый проект **Visual Studio 2015**, предназначенный для **Windows 10** и платформы **UWP**.
...
## <a name="if-you-would-rather-watch-a-video"></a>Также можно ознакомиться с этим руководством, просмотрев видеозапись
...
1.  Рекомендуется протестировать приложение на устройстве с маленьким экраном и ограниченным объемом оперативной памяти, поэтому в меню целевого устройства (![Меню запуска отладки](images/startdebug-full.png)) на панели инструментов **Стандартные** выберите параметр **Эмулятор 10.0.14393.0 WVGA, 4 дюйма, 512 МБ**.
