...
3.  В списке шаблонов слева выберите **Установленные > Visual C# > Windows Universal** чтобы увидеть список шаблонов проектов UWP.
...
Убедитесь, что сигнатура метода теперь включает ключевое слово **async** или вы получите ошибку при попытке запустить приложение.
