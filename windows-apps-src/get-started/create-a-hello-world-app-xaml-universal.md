...
1.  Запустите Visual Studio 2015.
   ...
   Откроется начальный экран Visual Studio 2015. (Далее Visual Studio 2015 будет упоминаться просто как Visual Studio.)

2.  В меню **Файл** выберите команду **Создать** > **Проект**.

   Откроется диалоговое окно **Создание проекта**. В левой панели диалогового окна вы можете выбрать тип шаблонов, которые нужно отобразить.
