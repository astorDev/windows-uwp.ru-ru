...
| **Оформление и пользовательский интерфейс** | В этой области документация содержится вся информация о визуальном представлении и пользовательском интерфейсе приложения. Если вам интересны особенности языка разметки XAML или вы просто хотите придать уникальный вид своим документам, начните с этих разделов: </br>   [Основы проектирования приложений UWP](../design/basics/index.md) |
