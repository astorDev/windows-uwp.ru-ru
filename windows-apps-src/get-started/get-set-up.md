...
title: Подготовка
description: Подготовка на самом деле проще, чем может показаться. Выполните эти инструкции и начните создавать приложения универсальной платформы Windows (UWP) для Windows 10.
ms.date: 05/07/2018
ms.topic: article
...
ms.locfileid: "57658649"
---
# <a name="get-set-up"></a>Подготовка

![Подготовьтесь к работе с Visual Studio](images/VisualStudio2017Hero_ImageXL-LG.png)

Подготовка на самом деле проще, чем может показаться. Выполните эти инструкции и начните создавать приложения универсальной платформы Windows (UWP) для Windows 10.

## <a name="1-download-or-update-visual-studio"></a>1. Скачать или обновить Visual Studio

Microsoft Visual Studio 2017 помогает вам проектировать, кода, тестирования и отладки приложений.

Если у вас нет Visual Studio 2017, можно установить бесплатно Microsoft Visual Studio Community 2017. В этот загружаемый пакет входят симуляторы устройств для тестирования приложений:
...
- [Сценарии установки разработчика](https://github.com/Microsoft/windows-dev-box-setup-scripts)
