        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <ul>
                        <li><a href="//developer.microsoft.com/windows/downloads">Скачать инструменты и пакет SDK</a></li>
                        <li><a href="//docs.microsoft.com/windows/uwp/get-started/get-set-up">Нужна помощь?</a></li>
                    </ul>
                  </div>
                </div>
            </div>
