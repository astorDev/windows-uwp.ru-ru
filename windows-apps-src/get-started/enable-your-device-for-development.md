...
-   *Приложения Microsoft Store* является параметром по умолчанию. Если вы не разрабатываете приложения или не используете специальные внутренние приложения вашей компании, не отключайте этот параметр.
...
> [!NOTE]
> Если режим разработчика не устанавливается должным образом, мы рекомендуем вам файл запроса обратной связи. В app **Концентратор обратной связи** выберите **Добавить новые отзывы**и выберите **Платформа разработки** категории и подкатегории **В режим разработчика** . Отправка отзывов могут помочь корпорации Майкрософт устранить проблему, которыми вы столкнулись.
