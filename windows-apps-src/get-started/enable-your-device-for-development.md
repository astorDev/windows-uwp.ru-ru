...
Однако если вы создаете программное обеспечение в Visual Studio на компьютере впервые, вам *потребуется* включить Pежим разработчика на компьютере для разработки и на всех устройствах, которые будут использоваться для тестирования кода. Если открыть проект UWP при выключенном режиме разработчика, то либо откроется страница параметров **Для разработчиков**, либо в Visual Studio отобразится следующее диалоговое окно.
