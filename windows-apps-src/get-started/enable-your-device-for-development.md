---
author: martinekuan ms.assetid: 54973C62-9669-4988-934E-9273FB0425FD title: Подготовьте свое устройство к использованию в разработке description: Разработка для устройств под управлением Windows 10 осуществляется по несколько иным принципам.
keywords: Начало работы keywords: Лицензия разработчика keywords: Visual Studio, лицензия разработчика keywords: подготовка устройства
---
...
**Примечание**. Даже в случае загрузки неопубликованных приложений устанавливать приложения можно только из доверенных источников. При установке неопубликованного приложения, еще не сертифицированного Магазином Windows, вы соглашаетесь, что получили все необходимые права для загрузки этого приложения и несете всю ответственность за любые убытки, которые могут возникнуть в результате установки и запуска приложения. См. раздел "Windows &gt; Магазин Windows" данного [заявления о конфиденциальности](http://go.microsoft.com/fwlink/?LinkId=521839).
...
### <span id="device-discovery-and-pairing"></span>Обнаружение устройств и портал устройств
