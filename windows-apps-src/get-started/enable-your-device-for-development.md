...
-   *Приложения в магазине Майкрософт* — это значение по умолчанию. Если вы не разрабатываете приложения или не используете специальные внутренние приложения вашей компании, не отключайте этот параметр.
...
> [!NOTE]
> Если не установить режим разработчика, мы рекомендуем вам в файл свои отзывы и предложения запроса. В приложении **Сервера-концентратора свои отзывы и предложения** выберите **Добавить новый свои отзывы и предложения**и выберите категории **Платформы разработки** и подкатегории **Режим разработчика** . Отправка отзывов поможет устранить проблему, которую вы обнаружила Microsoft.
