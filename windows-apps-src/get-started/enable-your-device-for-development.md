...
-   *Приложения UWP* является параметром по умолчанию. Если вы не разрабатываете приложения или не используете специальные внутренние приложения вашей компании, не отключайте этот параметр.
