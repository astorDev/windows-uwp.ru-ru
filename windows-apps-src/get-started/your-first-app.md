...
description: Создание приложения для универсальной платформы Windows (UWP) для Windows 10 на вашем любимом языке программирования.
ms.date: 01/25/2017
ms.topic: article
...
* [Создание «Hello, world» приложение с помощью XAML с помощьюC#](create-a-hello-world-app-xaml-universal.md)

Если вы хотите узнать основы или освежить память, рекомендуем следующие материалы:

* [C#Основы программирования для начинающих](https://go.microsoft.com/fwlink/?linkid=850801)
...
* [XAML и связывания с данными в UWP](xaml-basics-intro.md)
* [Простой двухмерных игр для Microsoft Store, написанных на UWP C# и MonoGame](get-started-tutorial-game-mg2d.md)


## <a name="visualc-component-extensions-ccx-and-xaml"></a>Расширения компонентов Visual C++ (C + +/ CX) и XAML

Воспользоваться преимуществами иметь опыт программирования C++ для создания приложений с помощью расширения компонентов Visual C++ (C + +/ CX) с помощью XAML.

* [Создание «Hello, world» приложение с помощью XAML с использованием C + +/ CX](create-a-basic-windows-10-app-in-cpp.md)

Подробнее о C++ можно узнать здесь:

* [C++: Универсальный язык и библиотеки приступите к работе](https://www.microsoftvirtualacademy.com/training-courses/c-a-general-purpose-language-and-library-jump-start)
...
* [Создание «Hello, world» приложение с помощью HTML и JavaScript](create-a-hello-world-app-js-uwp.md)
...
* [Документация для разработчиков Microsoft Edge](https://docs.microsoft.com/microsoft-edge/)
* [Использование WebVR с помощью Microsoft Edge](https://docs.microsoft.com/en-us/microsoft-edge/webvr/)
...
* [Преобразование веб-приложение для приложения универсальной платформы Windows](../porting/hwa-create-windows.md)
...
* [HTML5 и CSS3 основы программирования для начинающих](https://www.microsoftvirtualacademy.com/training-courses/html5-css3-fundamentals-development-for-absolute-beginners)
* [Виртуальная академия Майкрософт](https://go.microsoft.com/fwlink/p/?LinkID=389916)
