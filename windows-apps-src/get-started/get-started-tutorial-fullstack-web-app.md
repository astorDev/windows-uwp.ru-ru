...
Убедитесь, что вы сохранили все изменения в VS Code, запустите свой сервер еще раз (F5 в VS Code или `npm start` из оболочки, а затем перейдите на страницу [http://localhost:8000](https://localhost:8000)) для тестирования API игры.
...
* [jQuery](https://jquery.com/) – это библиотека JavaScript
* [Express](https://expressjs.com/) для платформы веб-приложения
* [Pug](https://pugjs.org/) (ранее Jade) для модуля создания шаблонов
* [Bootstrap](https://getbootstrap.com/) для динамического макета
...
5. Просмотрите приложение, перейдя на страницу [http://localhost:3000/](https://localhost:3000/).
...
2. В браузере перейдите на страницу [http://localhost:3000/](https://localhost:3000/) и играйте в игру!

3. В случае возникновения ошибок можно использовать средства отладки Node.js Visual Studio Code, нажав F5 на клавиатуре и введя `Node.js`. Дополнительные сведения об отладке в Visual Studio Code см. в этой [статье](https://code.visualstudio.com/docs/editor/debugging#_launch-configurations). 
