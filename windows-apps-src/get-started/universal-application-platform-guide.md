---
title: Руководство по работе с приложениями универсальной платформы Windows
...
![Универсальные приложения для Windows работают на различных устройствах, поддерживающих адаптивный пользовательский интерфейс, естественный пользовательский ввод, один магазин, единый центр разработки и облачные службы ](images/universalapps-overview.png)
...
-   [**CoreIndependentInputSource**](https://msdn.microsoft.com/library/windows/apps/dn298460) — новый API-интерфейс, позволяющий использовать необработанные входные данные на основном или фоновом потоке.
-   [**PointerPoint**](https://msdn.microsoft.com/library/windows/apps/br242038) унифицирует необработанные входные данные от касаний, мыши и пера в единый и последовательный набор интерфейсов и событий, который может быть использован на основном или фоновом потоке с помощью **CoreInput.**
