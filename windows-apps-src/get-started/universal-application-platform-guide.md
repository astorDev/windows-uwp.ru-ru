...
Если вы разрабатываете приложение универсальной платформы Windows (UWP), вы можете получить много расстояния и удобство из рассмотрения термины «универсальной платформы Windows (UWP)» и «Среды выполнения Windows (WinRT)» в качестве более или менее синонимами. Но он *является* возможность выглядеть рассматривается технологии и определить только разницу между этими идеи. Если вам интересно, этого последнего раздела документ для вас.
