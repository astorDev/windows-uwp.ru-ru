...
## См. также ##
Дополнительные вводные сведения см. в разделе [Windows10— вводные сведения о создании приложений для Windows для устройств Windows10](https://msdn.microsoft.com/en-us/magazine/dn973012.aspx)
