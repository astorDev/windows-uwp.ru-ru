...
-   Устраните как можно большее количество факторов тестирования.
    -   Отключите фоновые приложения на тестируемом устройстве. Чтобы сделать это, в Windows, установите **параметры** из меню "Пуск" &gt; **персонализации** &gt; **экрана блокировки**. Выберите все активные приложения и установите значение **Нет**.
