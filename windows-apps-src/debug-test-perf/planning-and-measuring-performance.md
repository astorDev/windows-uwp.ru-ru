...
| Метка класса взаимодействия | Восприятие пользователя                 | Идеальное            | Максимум          | Примеры.                                                                     |
|-------------------------|---------------------------------|------------------|------------------|------------------------------------------------------------------------------|
| Ранний доступ                    | Минимально заметная задержка      | 100 миллисекунд | 200 миллисекунд | Вывод панели приложения; нажатие кнопки (первая реакция)                        |
...
-   Устраните как можно большее количество факторов тестирования.
    -   Отключите фоновые приложения на тестируемом устройстве. Для этого в Windows выберите **Параметры** в меню Пуск &gt; **Персонализация** &gt; **Блокировка экрана**. Выберите все активные приложения и установите значение **Нет**.
...
-   Перед отправкой приложения в магазин для сертификации не забудьте включить в план тестирования тестовые случаи, связанные с производительностью, как описано в разделе "тесты производительности" в статье [тесты набора сертификации приложений Windows](windows-app-certification-kit-tests.md) и в разделе "производительность и стабильность" [тестовых случаев приложений UWP](https://docs.microsoft.com/previous-versions/windows/apps/dn275879(v=win.10)).
