...
-   Перед отправкой своего приложения на сертификацию в Магазин убедитесь, что в ваши планы тестирования включены связанные с производительностью тестовые случаи, как описано в [тестах комплекта сертификации приложений для Windows](windows-app-certification-kit-tests.md) и разделе "Производительность и надежность" [тестовых случаев приложений Магазина Windows](https://msdn.microsoft.com/library/windows/apps/Dn275879).
