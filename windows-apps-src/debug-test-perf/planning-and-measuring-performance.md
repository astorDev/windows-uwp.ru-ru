...
-   Перед отправкой приложения в магазин для сертификации, не забудьте включить в ваши планы тестирования включены связанные с производительностью тестовые случаи, как описано в разделе «Тесты производительности» [тесты комплект сертификации приложений для Windows](windows-app-certification-kit-tests.md) и в «производительность и раздел стабильность» [тестовых случаев приложений UWP](https://msdn.microsoft.com/library/windows/apps/Dn275879).
