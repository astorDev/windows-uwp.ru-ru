...
title: Компоненты UWP и оптимизация взаимодействия
description: Создавайте приложения универсальной платформы Windows на основе компонентов UWP, интегрируя собственные и управляемые типы без проблем с производительностью.
---
...
**Примечание**  
Большинство компонентов UWP, которые поставляются с Windows 10, реализованы в C++, поэтому при их использовании из C# или Visual Basic нарушаются границы взаимодействия. Всегда проверяйте приложение, чтобы узнать, влияет использование компонентов UWP на его производительность или нет, прежде чем потратить средства на внесение изменений в код.
