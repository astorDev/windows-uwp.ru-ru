...
ms.locfileid: "74735009"
---
# <a name="uwp-components-and-optimizing-interop"></a>Компоненты и оптимизация взаимодействия UWP


Создавайте приложения на базе универсальной платформы Windows (UWP) с использованием компонент UWP и межпрограммного взаимодействия между собственными и управляемыми типами, избегая проблем производительности в связи с таким взаимодействием.
...
**Обратите внимание** ,   большинство компонентов UWP, поставляемых с Windows 10, C++ реализованы в, так что вы пересекаете границы C# взаимодействия при их использовании из или Visual Basic. Всегда проверяйте приложение, чтобы узнать, влияет использование компонентов UWP на его производительность или нет, прежде чем потратить средства на внесение изменений в код.
