...
**Примечание**  большинство компонентов UWP, которые поставляются с Windows10, реализованы в C++, поэтому границы взаимодействия при их использовании из C# или Visual Basic. Всегда проверяйте приложение, чтобы узнать, влияет использование компонентов UWP на его производительность или нет, прежде чем потратить средства на внесение изменений в код.
