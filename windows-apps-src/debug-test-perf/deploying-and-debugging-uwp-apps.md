...
На удаленном устройстве макет регистрируется в следующем расположении по умолчанию в зависимости от семейства устройства:   `Xbox: \\MY-DEVKIT\DevelopmentFiles\XrfsFiles` — это символьная ссылка на **путь регистрации пакета**
 ПК не использует символьную ссылку и вместо этого непосредственно регистрирует **путь регистрации пакета**
