...
Чтобы вернуться к этому диалоговому окну, можно открыть свойства проекта и перейдите на вкладку " **Отладка** ". После этого нажмите **Найти** рядом с пунктом **удаленный компьютер:**
...
Чтобы указать целевой удаленный компьютер для приложения на C++ или JavaScriptUWP:
...
- **Не запускать, а отлаживать мой код при открытии / Запустить приложение**
  ...
  -   На странице свойств C# и Visual Basic,**Отладка** установите флажок **не запускать, а отлаживать мой код при открытии** .
