...
- **Запущенные приложения**: список запущенных в настоящий момент приложений и возможность закрыть их.
