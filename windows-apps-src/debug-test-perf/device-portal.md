...
2.  В разделе Диспетчер приложений портала устройств нажмите кнопку **Добавить** и выберите **установлен пакет приложения из локального хранилища**.
