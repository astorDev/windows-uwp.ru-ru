...
На странице трассировки производительности можно для представления [записи производительности Windows (WPR)](https://msdn.microsoft.com/library/hh448205.aspx) трассировки с главным устройством.
