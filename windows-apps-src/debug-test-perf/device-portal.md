...
4.  Проверьте соответствующие флажки, если вы хотите установить дополнительные или пакеты платформы, а также установка приложения. При наличии нескольких зависимостей добавляйте каждую по отдельности.     
...
![Устройство под управлением портала обрабатывает страницы](images/device-portal/mob-device-portal-processes.png)
...
- **Память**: общая используется, доступно, зафиксированных, разбиением и невыгружаемый
...
- **Журнал поставщиков**: здесь поставщиков трассировки событий Windows, которые были включены во время текущего сеанса. Щелкните или нажмите **Включить**, чтобы активировать поставщика, который ранее был отключен. Щелкните или нажмите **Очистить**, чтобы очистить журнал.
...
Дополнительные сведения об использовании ведения журнала трассировки событий Windows см. в блоге [Портала устройств используется для просмотра журналов отладки](https://blogs.windows.com/buildingapps/2016/06/10/using-device-portal-to-view-debug-logs-for-uwp/) . 
...
Страница сети управление сетевыми подключениями на устройстве. Если вы не подключены к порталу устройства через USB, изменение этих параметров будет наверняка приводит к отключению от портала устройств.
- **Доступные сети**: отображается сети WiFi, доступные на устройстве. Щелкните или нажмите сеть, чтобы подключиться к ней, при необходимости предоставьте ключ доступа. Портал устройства еще не поддерживает Корпоративная проверка подлинности. Также можно использовать в раскрывающемся списке **профилей** пытаться подключиться к любому профили Wi-Fi, известные на устройстве.
- **Конфигурация IP-адрес**: отображается адресные сведения о каждом узле сетевые порты устройства.
