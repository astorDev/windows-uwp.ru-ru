...
Использование ограничено информацию о версии операционной системы для Microsoft Store. Эти сведения часто неправильно использовались приложениями для проверки версии ОС и включения функций, соответствующих этой версии.
...
Просмотрите сообщения об ошибках для идентификации API приложением, которые не [API для приложений UWP](https://msdn.microsoft.com/library/windows/apps/xaml/bg124285.aspx).
