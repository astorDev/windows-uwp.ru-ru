...
> **Примечание**приложений на C++, которые встроены в конфигурации отладки не пройдет этот тест, даже если в конфигурации используются только API из пакета Windows SDK для приложений UWP. См. в разделе, [альтернативы API Windows в приложениях UWP](https://go.microsoft.com/fwlink/p/?LinkID=244022) подробнее.
...
-   Выполните сборку приложения, выпуск перед отправкой в Microsoft Store.
...
Проверьте правильность прорисовки приложения на уровне компонентов9\-1 Direct3D, даже если вы планируете использовать его при более высоком уровне компонентов. Дополнительные сведения см. в статье [Разработка для различных уровней компонентов Direct3D](https://go.microsoft.com/fwlink/p/?LinkID=253575).
