...
2.  В комплекте сертификации приложений для Windows выберите категорию проверки, которую необходимо выполнить. Пример: При проверке приложения Windows выберите **проверить приложение Windows**.
...
1.  В командном окне перейдите в каталог, содержащий комплект сертификации приложений для Windows.
    ...
    **Обратите внимание**    , что путь по умолчанию\\— C\\:\\\\Program Files\\Windows Kits 10 App Certification Kit.
...
**Примечание. комплект**сертификации приложений для Windows можно запустить из службы, но служба должна инициировать процесс пакета в рамках активного сеанса пользователя и не может быть выполнена в Session0.  
