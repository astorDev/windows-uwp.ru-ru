...
**Примечание**Если вы используете Visual Studio, при создании пакета приложения можно запустить комплект сертификации приложений Windows. Подробнее об этом см. в разделе [Packaging UWP apps](https://msdn.microsoft.com/library/windows/apps/Mt627715) (Создание пакетов приложений UWP).
...
**Важные**комплект сертификации приложений для Windows должен выполняться в контексте активного сеанса пользователя.
...
**Примечание**  получить дополнительные сведения о Windows комплект сертификации приложений для командной строки, введите команду `appcert.exe /?`
