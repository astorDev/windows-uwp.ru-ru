...
### <a name="game-event-data"></a>Данные о событии игры

На странице **игры событий данных** можно просмотреть график в реальном времени, потоки в число события в игре трассировки событий для Windows (ETW) в настоящее время записываются на Xbox One. Если игры события, записанные в системе, можно также просмотреть сведения (имя события, вхождения события и название игры) описания каждого события в таблице под графиком данных данных. Таблица доступна только в том случае, если существует события, записанные.

![Данные о событии игры](images/device-portal-xbox-22.PNG)
