...
### <a name="game-event-data"></a>Данные игры события

На странице **данные игры события** можно просмотреть график в реальном времени, потоки в поле число в настоящее время записи на один вашей Xbox игры событий Windows (Трассировки событий). Если игры события, записанные в системе, можно также просмотреть подробные сведения (название события, экземпляров события и название игры) описание каждого события в таблице ниже графическое представление данных. Таблица доступна только в том случае, если записанные события.
