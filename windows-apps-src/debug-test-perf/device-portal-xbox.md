...
На странице **игры данные** можно просмотреть график в реальном времени, потоки в число события в игре трассировки событий для Windows (ETW) в настоящее время записи на Xbox One. Если игра события, записанные в системе, можно также просмотреть сведения (имя события, вхождения события и название игры) описания каждого события в таблице под графиком данных. Таблицы доступна только в том случае, если существуют события, записанные.
