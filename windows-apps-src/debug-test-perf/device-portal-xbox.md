...
На странице **игры данные** можно просмотреть график в реальном времени, потоки в число игры события трассировки событий для Windows (ETW), в настоящее время записанные на Xbox One. Если игры события, записанные в системе, можно также просмотреть сведения (имя события, вхождения события и название игры) описания каждого события в таблице под графиком данных. Таблица доступна только в том случае, если существуют события, записанные.
