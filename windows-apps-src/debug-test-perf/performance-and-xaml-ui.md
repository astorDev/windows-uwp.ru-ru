...
Если вы еще этого не сделали, шаг, мы увидели, результат значительное повышение производительности просто перенос приложения для целевой платформы Windows 10. Несколько операций оптимизации XAML (например, [{x: Bind}](https://msdn.microsoft.com/library/windows/apps/Mt204783)) доступны только в приложениях Windows 10. См. в разделе [перенос приложений для Windows 10](https://msdn.microsoft.com/library/windows/apps/Mt238321) и сеансом //build/ [перенос на универсальную платформу Windows](https://channel9.msdn.com/Events/Build/2015/3-741).
...
| [Оптимизация фоновое действие](optimize-background-activity.md) | Создавайте приложения UWP, которые взаимодействуют с системой с целью повышения эффективности энергопотребления фоновых задач. |
