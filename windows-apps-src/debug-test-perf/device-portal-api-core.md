...
Команда | Описание
:----- | :-----
включение *{level}* поставщика *{guid}* | Включите поставщик, отмеченный *{guid}*, (без кавычек) на указанном уровне. 
              *{level}* является значением типа **int** от 1 (наименьшее количество подробных данных) до 5 (подробные данные).
...
- Нет.  
              **Примечание.** Выполнение данной операции занимает значительное время.  Значение возвращается, после того как ETL завершит запись на диск.  
