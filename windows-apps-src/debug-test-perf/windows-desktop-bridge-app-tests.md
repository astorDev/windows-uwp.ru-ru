...
**Действия по исправлению**  
См. в разделе [рабочего стола для UWP Bridge: Расширения приложений](https://docs.microsoft.com/windows/apps/desktop/modernize/desktop-to-uwp-extensions) объяснения этих расширений и как использовать их соответствующим образом. 
