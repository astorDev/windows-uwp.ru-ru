...
**Корректирующие действия**  
Чтобы исправить это, используйте последнюю версию [Пакета SDK карт Bing](https://go.microsoft.com/fwlink/p/?linkid=614880) для приложений UWP.
