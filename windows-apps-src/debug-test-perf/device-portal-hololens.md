...
> [!IMPORTANT]
> Если компьютер не может найти устройство, попробуйте использовать реальной сети IP-адрес устройства, HoloLens, а не `http://127.0.0.1:10080`.
