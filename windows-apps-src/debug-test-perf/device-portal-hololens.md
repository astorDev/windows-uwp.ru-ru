...
3. Взгляните на плитку **Параметры** и выполните жест [касания](https://developer.microsoft.com/mixed-reality#Press_and_release) в hololens (1-й общий) или выберите его в hololens 2, [касаясь его или используя руки](https://docs.microsoft.com/hololens/hololens2-basic-usage). Приложение параметров будет запущено после его выбора.
