...
> [!IMPORTANT]
> Если компьютер не удалось найти устройство, попробуйте выполнить реальной сети IP-адрес устройства HoloLens, а не от `http://127.0.0.1:10080`.
