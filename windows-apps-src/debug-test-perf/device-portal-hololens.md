...
> [!IMPORTANT]
> Если компьютер не удается найти устройство, попробуйте использовать IP-адрес реальных сети HoloLens устройство, а не `http://127.0.0.1:10080`.
