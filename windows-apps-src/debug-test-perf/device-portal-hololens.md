...
2. Поиск IP-адрес вашего устройства. Найдите IP-адрес на устройстве в разделе **параметров > & Internet > Wi-Fi > оборудования свойства сети**. Можно также спросить: «Привет, Кортана! Какой у меня IP-адрес»?
