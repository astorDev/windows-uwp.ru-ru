...
description: Бета-тестирование дает возможность улучшить приложение на основе отзывов пользователей вне вашей рабочей группы разработки приложений, которые пользуются невыпущенными приложениями на своих устройствах.
---
# Бета-тестирование
