...
|---------|------------------------------|------------------|-------------|
| Ограничение скорости | Ограничение скорости маршрута | Не применимо   | Проход по маршруту на указанной предельной скорости. |
...
| Возможность            | Камера Windows Phone 8.0 | Камера Windows Phone 8.1  |
|--------------------|--------------------------|---------------------------|
