...
Сведения о требованиях к BIOS см. в разделе [Включение Hyper-V для эмулятора Windows Phone 8](https://msdn.microsoft.com/en-us/library/windows/apps/xaml/jj863509.aspx).
...
> **Примечание**. В пользовательский интерфейс внесено одно важное изменение. В этой версии эмулятора для отображения или скрытия аппаратной клавиатуры используется клавиша F4, работающая как переключатель, а не клавиши Page Up и Page Down, использовавшиеся в предыдущих версиях эмулятора.
...
> **Примечание**. Поскольку SD-карта, используемая телефоном, форматируется в файловой системе FAT32, ее максимальным размером является 32 ГБ.
...
### Не удается запустить эмуляторы
...
### Удаление образа Windows 10 Mobile
...
###Отключение графики с аппаратным ускорением
...
2. Создайте следующий подраздел реестра, если он еще не существует:
...
* [Выполнение приложений Windows Phone в эмуляторе](https://msdn.microsoft.com/en-us/library/windows/apps/xaml/dn632391.aspx)
