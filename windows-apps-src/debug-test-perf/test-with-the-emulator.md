...
| Компонент            | Камера Windows Phone 8.0 | Камера Windows Phone 8.1  |
|--------------------|--------------------------|---------------------------|
...
* [Запуск приложений Windows Phone в эмуляторе](https://docs.microsoft.com/visualstudio/debugger/run-windows-phone-apps-in-the-emulator?view=vs-2015)
