...
Эмулятор Microsoft для Windows 10 Mobile требуется Visual Studio 2015 или более поздней версии; Это не обратную совместимость с более ранними версиями Visual Studio.
...
Для запуска приложения в эмуляторе, просто выберите эмулированных устройства из раскрывающегося меню **выполнить** в Visual Studio.
...
> **Примечание**с момента SD-карты, используемых на телефоне отформатированный в файловой системе FAT32, 32 ГБ — максимальный размер.
...
В некоторых ситуациях, в том числе после обновления до новой тестируемой возможности Windows10 виртуальный сетевой коммутатор, связанный с эмулятором можно получить в состояние, в котором его невозможно удалить через пользовательский интерфейс.
...
> **Примечание**XDECleanup.exe удаляет все эмулятора определенных виртуальных машин Hyper-V, а также все контрольные точки виртуальной Машины и сохраненные состояния.
