...
Запуск приложения в эмуляторе, просто выберите эмулированных устройств из раскрывающегося меню **выполнить** в Visual Studio.
...
> **Примечание**с момента SD-карты, используемых на телефон отформатированный в файловой системе FAT32, 32 ГБ для максимального размера.
