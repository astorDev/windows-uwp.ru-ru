...
-   [**Двойные**](https://msdn.microsoft.com/library/windows/apps/xaml/system.double.aspx), могут быть анимированы с любым [ **DoubleAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243136)
-   [**Точка**](https://msdn.microsoft.com/library/windows/apps/BR225870), могут быть анимированы с любым [ **PointAnimation**](https://msdn.microsoft.com/library/windows/apps/BR210346)
-   [**Цвет**](https://msdn.microsoft.com/library/windows/apps/Hh673723), могут быть анимированы с любым [ **ColorAnimation**](https://msdn.microsoft.com/library/windows/apps/BR243066)
...
-   Значение вложенного свойства из этих целевым объектом для анимации [ **UIElement** ](https://msdn.microsoft.com/library/windows/apps/BR208911) свойства: [**Объект Transform3D**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.uielement.transform3d.aspx), [ **RenderTransform**](https://msdn.microsoft.com/library/windows/apps/BR208980), [ **проекции**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.uielement.projection.aspx), [ **Клипов**](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.uielement.clip)
...
* [Выполнена его раскадровка анимации для визуальных состояний](https://msdn.microsoft.com/library/windows/apps/xaml/JJ819808)
