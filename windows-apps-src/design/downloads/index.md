...
<a href="/windows/uwpcommunitytoolkit/getting-started">Инструкции по установке</a>
    :::column-end:::
    :::column:::
        ![Эскиз для Windows Template Studio](images/Windows-template-studio.png) <b>Windows Template Studio</b><br>
        Быстрое создание шаблонов приложения UWP с помощью пользовательского интерфейса на основе мастера.<br />
        <a href="https://aka.ms/wtsinstall">Скачать</a>
    :::column-end:::
:::row-end:::
