---
Description: Узнайте, как Win32 C# приложения могут отправить локальный всплывающие уведомления и обрабатывать действия, щелкнув всплывающее уведомление.
...
ms.date: 01/23/2018
ms.topic: article
keywords: Windows 10, универсальной платформы Windows, win32, рабочий стол, всплывающие уведомления, отправке всплывающего уведомления, отправьте локальный тоста, desktop bridge C#, c острые, всплывающее уведомление, wpf
...
## <a name="step-1-enable-the-windows-10-sdk"></a>Шаг 1. Включить Windows 10 SDK
...
## <a name="step-2-reference-the-apis"></a>Шаг 2. Справочник по API-интерфейсы
...
## <a name="step-3-copy-compat-library-code"></a>Шаг 3. Скопируйте код библиотеки совместимости
...
## <a name="step-4-implement-the-activator"></a>Шаг 4. Реализуйте активатор

Таким образом, когда пользователь выбирает вашей всплывающее уведомление, приложение можно сделать что-то необходимо реализовать обработчик для активации всплывающее уведомление. Это необходимо, чтобы всплывающее уведомление сохранялось в центре уведомлений (так как всплывающее уведомление можно щелкнуть после закрытия вашего приложения). Этот класс можно разместить в любом месте в проекте.
...
## <a name="step-5-register-with-notification-platform"></a>Шаг 5. Регистрация с помощью уведомлений платформы
...
#### <a name="step-52-register-aumid-and-com-server"></a>Шаг 5.2. Регистрация сервера AUMID и COM
...
## <a name="step-6-register-com-activator"></a>Шаг 6. Активатор регистрация COM
...
## <a name="step-7-send-a-notification"></a>Шаг 7. Отправить уведомление
...
## <a name="step-9-remove-and-manage-notifications"></a>Шаг 9. Удалите уведомления и управляйте ими
...
**ИСПРАВЛЕНО. Приложение не получения фокуса после нажатия кнопки всплывающих**: В сборках 15063 и более ранних версий права на переднем плане не были, передаваемых в приложение, активированное COM-сервера. Поэтому приложение просто мигало при попытке переместить его на передний план. В то время решения этой проблемы не существовало. Мы исправили это сборках 16299 и более поздних версиях.


## <a name="resources"></a>Ресурсы

* [Полный образец кода на GitHub](https://github.com/WindowsNotifications/desktop-toasts)
* [Всплывающие уведомления от настольных приложений](toast-desktop-apps.md)
