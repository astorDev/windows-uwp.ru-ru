...
title: Закрепление вспомогательных плиток меню "Пуск"
...
ms.locfileid: "8352488"
---
# <a name="pin-secondary-tiles-to-start"></a>Закрепление вспомогательных плиток меню "Пуск"
