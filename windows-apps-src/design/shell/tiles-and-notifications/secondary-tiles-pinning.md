---
Description: Узнайте, как закрепить вторичную плитку для запуска из приложения Windows.
title: Закрепите дополнительные плитки для запуска
...
ms.locfileid: "82971049"
---
# <a name="pin-secondary-tiles-to-start"></a>Закрепите дополнительные плитки для запуска


В этом разделе описано, как создать вспомогательную плитку для приложения Windows и закрепить ее в меню "Пуск".
