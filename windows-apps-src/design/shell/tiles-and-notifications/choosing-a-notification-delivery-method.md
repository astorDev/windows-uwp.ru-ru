---
Description: В этой статье описаны варианты четыре уведомлений &\#8212; local, запланировано, периодически и передать &\#8212; которые обеспечивают обновлений плиток и эмблем и всплывающие уведомления содержимого.
...
-   Всплывающее уведомление: Уведомление отображается, но удаления вашего образа
