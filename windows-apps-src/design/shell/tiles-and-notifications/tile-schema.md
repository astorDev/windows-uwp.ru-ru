...
|---|---|---|---|
| **Визуальный элемент** | [ToastVisual](#tilevisual) | true | Описывает визуальную часть уведомления на плитке. |
...
| Свойство | Тип | Обязательно |Описание |
|---|---|---|---|
| **Source** | строка | true | URL-адрес изображения. Поддерживаются ms-appx, ms-appdata и http(s). Изображения HTTP должны иметь размер 200 КБ или меньше. |
...
| **Text** | [TileBasicText](#tilebasictext) | false | Отображаемая строка текста. Не отображается на маленьких плитках. |
...
* [Библиотека уведомлений на сайте GitHub](https://github.com/windows-toolkit/WindowsCommunityToolkit/tree/dev/Notifications)