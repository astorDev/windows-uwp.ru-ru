...
**Совет**    Сведения о том, как получить справку при редактировании скриптов, см. в разделе [Включение IntelliSense для серверной части JavaScript](https://blogs.msdn.com/b/visualstudio/archive/2013/07/26/enabling-intellisense-for-mobile-services-javascript-in-visual-studio.aspx).
...
Push-уведомления следует использовать в соответствии с рекомендациями для приложений Windows, так как эти уведомления используют ресурсы пользователя и могут отвлекаться от использования. См. [Руководство и контрольный список для push-уведомлений](https://docs.microsoft.com/windows/uwp/controls-and-patterns/tiles-and-notifications-windows-push-notification-services--wns--overview).
...
* [Подключение к мобильным службам Windows Azure (C#/C++/VB)](https://docs.microsoft.com/previous-versions/windows/apps/dn263175(v=win.10))
* [Краткое руководство: добавление push-уведомлений в мобильную службу (JavaScript)](https://docs.microsoft.com/previous-versions/windows/apps/dn263163(v=win.10))
 
