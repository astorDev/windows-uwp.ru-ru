...
| **Визуальный элемент** | [ToastVisual](#toastvisual) | true | Описывает визуальную часть всплывающего уведомления. |
...
| Значение | Значение |
|---|---|
| **Default** | Обычное поведение всплывающего уведомления. |
...
| Свойство | Тип | Обязательно |Описание |
|---|---|---|---|
| **Text** | string или [BindableString](#bindablestring) | false | Отображаемый текст. Поддержка привязки данных добавлена в обновление Creators Update, но работает только для элементов текста верхнего уровня. |
...
| Свойство | Тип | Обязательно |Описание |
|---|---|---|---|
| **Source** | строка | true | URL-адрес изображения. Поддерживаются ms-appx, ms-appdata и http. Изображения HTTP должны иметь размер 200 КБ или меньше. |
...
* [Краткое руководство. Отправить Локальная активация всплывающее уведомление и дескриптора](https://blogs.msdn.microsoft.com/tiles_and_toasts/2015/07/08/quickstart-sending-a-local-toast-notification-and-handling-activations-from-it-windows-10/)
