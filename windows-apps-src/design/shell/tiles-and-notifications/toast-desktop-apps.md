...
| Параметр | Объекты класса Visual | Действия | Элементы ввода данных | Активация внутри процесса |
| -- | -- | -- | -- | -- |
...
| Объекты класса Visual | Действия | Элементы ввода данных | Активация внутри процесса |
| -- | -- | -- | -- |
| ✔️ | ✔️ | ✔️ | ✔️ |
...
Сведения об использовании этого параметра см. в статьях [Отправка локального всплывающего уведомления из C# классических приложений](send-local-toast-desktop.md) или [Отправка локального всплывающего уведомления C++ из приложений для настольных WRL](send-local-toast-desktop-cpp-wrl.md).
...
* [Отправка локального всплывающего уведомления из классических C# приложений](send-local-toast-desktop.md)
* [Отправка локального всплывающего уведомления из приложений C++ для настольных WRL](send-local-toast-desktop-cpp-wrl.md)
