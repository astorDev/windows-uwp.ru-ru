---
Description: Обнаружить различные параметры, которые имеют классических приложений Win32 для отправки уведомления извещения
...
| [Нет COM / Stub CLSID](#alternative-option---no-com--stub-clsid) | ✔️ | ✔️ | ❌ | ❌ |
...
* [Отправка локального всплывающего уведомления из рабочего стола C# приложений](send-local-toast-desktop.md)
* [Отправка локального всплывающего уведомления из рабочего стола C++ WRL приложений](send-local-toast-desktop-cpp-wrl.md)
