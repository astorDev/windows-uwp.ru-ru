...
| Параметр | Визуальные элементы | Действия | Ввод данных | Активация внутри процесса |
| -- | -- | -- | -- | -- |
...
| Визуальные элементы | Действия | Ввод данных | Активация внутри процесса |
| -- | -- | -- | -- |
| ✔️ | ✔️ | ✔️ | ✔️ |
