---
Description: Узнайте, как приложений Win32 C++ WRL можно отправить локальный всплывающие уведомления и обрабатывать действия, щелкнув всплывающее уведомление.
...
## <a name="step-2-copy-compat-library-code"></a>Шаг 2. Скопируйте код библиотеки совместимости
...
## <a name="step-3-include-the-header-files-and-namespaces"></a>Шаг 3. Включать файлы заголовков и пространств имен
