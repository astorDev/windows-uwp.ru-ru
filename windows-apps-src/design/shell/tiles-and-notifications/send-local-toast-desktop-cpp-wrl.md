---
Description: Узнайте, как C++ приложения Win32 WRL могут отправлять уведомления с помощью уведомлений и управлять пользовательским всплывающим уведомлением.
...
| Windows 8.1 и 8 | Нет данных | Нет данных | Поддерживается |
| Windows 7 и более ранние версии | Нет данных | Нет данных | Нет данных |
