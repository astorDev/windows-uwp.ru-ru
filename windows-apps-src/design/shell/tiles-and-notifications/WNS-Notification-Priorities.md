...
Установка приоритета на уведомления о запросах осуществляется с помощью дополнительных заголовка запроса POST, `X-WNS-PRIORITY`. Это целочисленное значение от 1 до 4 сопоставляющийся приоритет: 
