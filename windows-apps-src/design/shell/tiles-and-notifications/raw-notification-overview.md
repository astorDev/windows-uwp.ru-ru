...
Дополнительные сведения об отправке Push-уведомлений, см. в разделе [краткое руководство: Отправка Push-уведомления](https://msdn.microsoft.com/library/windows/apps/xaml/hh868252).
...
* [Рекомендации для уведомления raw](https://msdn.microsoft.com/library/windows/apps/hh761463)
* [Краткое руководство. Создание и регистрация в фоновом режиме необработанное уведомление](https://msdn.microsoft.com/library/windows/apps/jj676800)
* [Краткое руководство. Перехват Push-уведомлений для выполнения приложений](https://msdn.microsoft.com/library/windows/apps/jj709908)
