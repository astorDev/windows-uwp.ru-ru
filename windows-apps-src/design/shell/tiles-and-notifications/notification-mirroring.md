...
Зеркальное отображение уведомлений дает разработчикам два главных преимущества: зеркальные уведомления улучшают взаимодействие пользователей со службой и помогают пользователям найти ваше классическое приложение магазина Windows. Пользователи могут даже не знать, что у вас есть прекрасное приложение UWP, доступное для настольного компьютера с Windows 10. Когда пользователи получают зеркальные уведомления с телефона, они могут щелкнуть всплывающее уведомление, чтобы перейти в магазин Windows, где они могут установить классическое приложение UWP.
