---
Description: Визуализатор уведомлений — это новое приложение Windows в магазине, которое помогает разработчикам проектировать адаптивные динамические плитки для Windows 10.
...
Визуализатор уведомлений — это новое приложение Windows [в магазине](https://www.microsoft.com/store/apps/notifications-visualizer/9nblggh5xsl1) , которое помогает разработчикам проектировать адаптивные динамические плитки и интерактивные всплывающие уведомления для Windows 10.
...
**Примечание**    . Имитация визуализатора уведомлений меню "Пуск" Windows и всплывающие уведомления не всегда полностью точны и не поддерживает некоторые расширенные свойства полезных данных. Получив нужные визуальные параметры плитки или всплывающего уведомления, протестируйте их, закрепив плитку или вызвав всплывающее уведомление, чтобы убедиться, что она отображается, как требуется.
