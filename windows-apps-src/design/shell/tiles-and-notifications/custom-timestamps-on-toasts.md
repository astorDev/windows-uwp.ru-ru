---
Description: Узнайте, как использовать пользовательские метки времени на всплывающие уведомления.
...
> [!IMPORTANT]
> **Требует Creators Update и 1.4.0 библиотеки уведомлений**: Вы должны выполняться сборка 15063 или более поздней версии, чтобы просмотреть пользовательские отметки времени. Для назначения метки времени в содержимом всплывающего уведомления необходимо использовать [библиотеку уведомлений набора средств сообщества UWP из NuGet](https://www.nuget.org/packages/Microsoft.Toolkit.Uwp.Notifications/) версии 1.4.0 или более поздней.
