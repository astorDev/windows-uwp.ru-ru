---
Description: Шаблоны адаптивной плитку — это новая функция в Windows 10, что позволяет создавать собственные содержимое уведомлений плитки, на любом языке разметки простым и гибким, адаптирующий для экранов разной плотности.
...
**Примечание**  на мобильных устройствах Windows Mobile не поддерживает углу логотип, поэтому «логотип» и «nameAndLogo» по умолчанию, равное «name».
...
**Значение по умолчанию, фирменная символика результат:**
...
**Примечание**    это изменение из Windows 8.x, в котором фирменной символики по умолчанию был «эмблема».
...
**Примечание**  стиль по умолчанию для заголовка, если подсказка стиль не задан.
...
| header                         | 46 epx                    | Светлая       |

 

**Варианты стиль чисел текста**
...
**Слабая текст разновидностям стилей**
...
**Примечание**  только допустимые дочерние группы — это подгруппа.
...
**Примечание**  8 пикселей автоматически добавляется между столбцами.
...
Если дополнительные аспекты поведения не определены, изображения будут равномерно сжиматься или увеличиваться для заполнения доступной ширины. В этом примере показана плитка с двумя столбцами и встроенными изображениями. Встроенные изображения растягивается, заполняя всю ширину столбца.
...
**Обрезка круг для считывания и фоновые изображения**
...
**Использовать peek и фоновое изображение**
...
**Используйте подсказку overlay на фоновое изображение**
