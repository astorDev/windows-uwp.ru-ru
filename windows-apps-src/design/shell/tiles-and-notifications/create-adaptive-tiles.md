...
ms.locfileid: "83234575"
---
# <a name="create-adaptive-tiles"></a>Создание адаптивных плиток

Шаблоны адаптивных плиток — это новая возможность в Windows 10, которая позволяет создавать собственные уведомления плиток с помощью простого и гибкого языка разметки, который адаптируется к различной плотности экрана. В этой статье рассказывается, как создать адаптивные динамические плитки для приложения Windows. Полный список адаптивных элементов и атрибутов см. в разделе [Схема адаптивных плиток](../tiles-and-notifications/tile-schema.md).
...
**Примечание**    . Стиль по умолчанию имеет значение Caption, если не указан стиль подсказки.
...
| subheader                      | 34 epx                    | Легкий       |
| Верхний колонтитул                         | 46 epx                    | Легкий       |
...
**Примечание**    . Единственным допустимым дочерним элементом группы является подгруппа.
...
**Примечание**    . Между столбцами автоматически добавляется 8-пиксельное поле.
