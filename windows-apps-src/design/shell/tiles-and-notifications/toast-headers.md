---
Description: Узнайте, как использовать заголовки для визуальной группировки всплывающие уведомления в центре поддержки.
...
Далее приведены порядок уведомления в заголовки... Для заданного приложения последнего уведомления из приложения (и всему заголовку группы, если часть заголовка) будут отображаться первыми.
