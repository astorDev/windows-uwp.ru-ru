...
ms.locfileid: "66365962"
---
# <a name="special-tile-templates"></a>Специальные шаблоны плиток
 

Специальные шаблоны плиток — это уникальные шаблоны, которые могут быть анимированными или предоставлять возможности, не поддерживаемые адаптивными плитками. Каждый шаблон специальная Плитка был специально создан для Windows 10, за исключением шаблон преобразованного в значок плитки, классической специальный шаблон, который был обновлен после выпуска Windows 10. В этой статье рассматриваются три специальная Плитка шаблона: Значками, фотографии и людей.

## <a name="iconic-tile-template"></a>Пиктографический шаблон плитки


C помощью пиктографического шаблона (также известного как шаблон «IconWithBadge») можно отображать небольшое изображение в центре плитки. Windows 10 поддерживает шаблона на телефоне и планшете/desktop.
...
**Шаг 3. Отправить уведомление на плитку**
...
**Шаг 4. Отправить уведомление эмблемы на плитку**
...
На следующем рисунке представлены особенности связей различных API-интерфейсов и полезных данных с каждым аспектом пиктографического шаблона плитки. [Уведомление на плитке](https://docs.microsoft.com/previous-versions/windows/apps/hh779724(v=win.10)) (содержащее эти элементы &lt;binding&gt;) используется для задания пиктографического шаблона и ресурса изображения; [уведомление на индикаторе событий](https://docs.microsoft.com/previous-versions/windows/apps/hh779719(v=win.10)) задает числовое значение; свойства плитки используются для управления отображаемым именем плитки, цветом и т. д.
...
В приложении «Люди» для Windows 10 используется специальный шаблон плитки, который отображает коллекцию изображений по кругу, перемещающихся по горизонтали или по вертикали на плитке. Этот шаблон плитки доступно со времен 10572 сборки Windows 10 и любой пользователь, можно пользоваться в свои приложения.
...
* [Полный образец кода на GitHub](https://github.com/WindowsNotifications/quickstart-people-tile-template)
