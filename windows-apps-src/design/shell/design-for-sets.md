...
В манифесте приложения укажите альтернативный значок без основы в дополнение к обычному значку. Дополнительные сведения см. в разделе [значки и логотипы приложений](/windows/uwp/design/style/app-icons-and-logos). Значок, чтобы указать указывается в документации как «ресурсы списка целевых размеров без основы» в разделе [сведения о ресурсы значков приложения](/windows/uwp/design/style/app-icons-and-logos#more-about-app-icon-assets) этой статьи.
