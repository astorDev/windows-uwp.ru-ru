...
В манифесте приложения укажите альтернативный значок без основы в дополнение к обычному значку. Дополнительные сведения см. в разделе [Руководство по работе с ресурсами плиток и значков](./tiles-and-notifications/app-assets.md). Значок, который необходимо задать, указывается в документации как «Ресурсы списка целевых размеров без основы» в разделе [Типы ресурсов](./tiles-and-notifications/app-assets.md#asset-types) этой статьи.
