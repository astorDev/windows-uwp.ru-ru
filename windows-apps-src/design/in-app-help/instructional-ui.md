---
Description: Создайте пользовательский интерфейс с инструкциями, который научит пользователей работать с приложением Windows.
...
Хороший инструктивный пользовательский интерфейс актуален для пользователя, учит его полезному и повышает удобство работы. Значения должны быть следующими:
...
Старайтесь сделать так, чтобы ваш инструктивный пользовательский интерфейс не доставлял пользователю неудобств. Чего не следует делать:
