...
Приложения UWP могут работать на любом устройстве под управлением Windows 10, включая телефоны, планшеты, настольные компьютеры, телевизоры и т. д. Благодаря большому количеству целевых объектов и размеров экрана в экосистеме Windows 10 вместо оптимизации пользовательского интерфейса для каждого устройства рекомендуется разработать несколько категорий ключевых значений (также называемых «точками останова»): 
...
<tbody>
<tr class="even">
<td style="vertical-align:top;">Малый</td>
...
<tr class="even">
<td style="vertical-align:top;">Большая</td>
