...
На практике используется сочетание статических и гибких элементов для создания пользовательского интерфейса. Вы по-прежнему использовать статические элементы и значения в некоторых местах, но убедитесь, что общего пользовательского интерфейса быстро реагировать на различные способы их устранения, размеры экранов и представления.
...
Свойства макета управляют размером и положением элемента. Чтобы создать макет типа fluid, используют автоматическое или пропорциональное изменения размера для элементов и разрешение панелей макета для размещения своих дочерних элементов, при необходимости. 
