---
Description: В этом учебнике показано создание пользовательского интерфейса основного приложения. В ней поясняется и демонстрируется использование двух наиболее распространенных элементов XAML — Grid и StackPanel.
...
## <a name="step-2-define-a-grid"></a>Шаг 2. Определить, задав сетку
...
## <a name="step-3-color-the-grid"></a>Шаг 3. Цвет сетки
...
## <a name="step-4-organize-content-by-using-stackpanel-elements"></a>Шаг 4. Организации содержимого с помощью элементов StackPanel
...
## <a name="step-5-add-an-image-icon"></a>Шаг 5. Добавить значок изображения
...
В **обозревателе решений**, щелкните правой кнопкой мыши **активы** и выберите **добавить** -> **существующий элемент...** Поиск частично cloudy.png в открывшемся браузере, выберите его и нажмите кнопку **добавить**.
