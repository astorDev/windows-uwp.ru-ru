...
* [Языковые теги BCP-47](https://tools.ietf.org/html/bcp47)
...
* [Пример параметров глобализации](https://code.msdn.microsoft.com/windowsapps/Globalization-preferences-6654eb36)
