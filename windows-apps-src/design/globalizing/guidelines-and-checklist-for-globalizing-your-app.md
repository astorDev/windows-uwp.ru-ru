...
| Правила сравнения языковых тегов являются нестандартными. | [Языковые теги BCP-47](https://go.microsoft.com/fwlink/p/?linkid=227302) являются сложными. При сравнении языковых тегов возникает ряд проблем, например с информацией о соответствии сценариев, устаревшими тегами и несколькими региональными вариантами. Система управления ресурсами в Windows решает за вас проблему соответствия. Вы можете указать набор ресурсов на любом языке, система сама выберет подходящий для пользователя и приложения язык. См. разделы [Ресурсы приложения и Система управления ресурсами](../../app-resources/index.md) и [Как Система управления ресурсами сопоставляет языковые теги](../../app-resources/how-rms-matches-lang-tags.md). |
