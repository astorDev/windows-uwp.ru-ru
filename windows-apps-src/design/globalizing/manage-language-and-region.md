...
- Указано вложенный тег языка сценария в квалификатора не значение Suppress-Script, определенных для языка. Например, вместо zh-CN или zh-TW, используйте zh-Hant, zh-Hant-TW или zh-Hans (Дополнительные сведения см. в разделе [подтегов языков IANA](https://go.microsoft.com/fwlink/p/?linkid=227303)).
...
* [Пример ресурсов и локализации приложения](https://go.microsoft.com/fwlink/p/?linkid=231501)
