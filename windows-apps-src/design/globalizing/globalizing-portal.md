...
| [Используют кодовую страницу UTF-8](use-utf8-code-page.md) | UTF-8 является универсальной кодовую страницу для международного использования. |
