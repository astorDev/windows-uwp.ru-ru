...
| [Международные шрифты](loc-international-fonts.md) | В этом разделе перечислены шрифтов, доступных для приложений универсальной платформы Windows, на которые переведены на языки, отличные от США английский. |
