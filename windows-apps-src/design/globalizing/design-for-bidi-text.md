---
Description: Создавайте приложения, которые обеспечивают поддержку двунаправленный текст (BiDi) так, можно объединить скрипт из слева направо (LTR) и справа налево (RTL) систем письма, которые обычно содержат различные виды алфавиты.
...
![Меню "Пуск" BiDi](images/56283_BIDI_01_startscreen_resized.png)
![меню с помощью чудо-кнопки "Пуск" BiDi](images/56283_BIDI_02_startscreen_charm_resized.png)
...
![BiDi снимок экрана](images/56286_BIDI_06_print_flyout_resized.png)

![Снимок экрана BiDi](images/56286_BIDI_07_settings_flyout_resized.png)
![BiDi снимок экрана](images/56286_BIDI_08_app_bars_resized.png)
...
![Шрифт Segoe UI для языков с двунаправленным письмом](images/56290_BIDI_13_start_screen_segoe.png)
![шрифт Segoe UI для языков с двунаправленным письмом](images/56290_BIDI_13_start_screen_segoe_arabic.png)

## <a name="case-study-1-a-bidi-music-app"></a>Практический пример #1. Приложение music BiDi
...
| -------------- | ------------------- | ------------------- |
| **Выравнивания по левому краю** | Hello, World! | בוקר טוב! |
| **По правому краю** | !Hello, World | !בוקר טוב |
...
## <a name="case-study-2-a-bidi-mail-app"></a>Практический пример #2. Приложение "Почта" BiDi
