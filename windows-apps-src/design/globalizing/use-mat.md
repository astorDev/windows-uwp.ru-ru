---
Description: Набор многоязычных приложений (Toolkit) 4,0 интегрируется с Microsoft Visual Studio 2019 для предоставления приложений Windows с поддержкой перевода, управления файлами перевода и инструментами для редактора.
...
ms.locfileid: "82970969"
---
# <a name="use-the-multilingual-app-toolkit-40"></a>Использование набора средств для многоязычных приложений версии 4.0

Набор многоязычных приложений (Toolkit) 4,0 интегрируется с Microsoft Visual Studio 2019 для предоставления приложений Windows с поддержкой перевода, управления файлами перевода и инструментами для редактора. Вот некоторые преимущества этого набора средств.
...
Для преимущества&mdash;глобализации и локализации, а также определения терминов **глобализация**, **Локализация**и **Локализация**&mdash;см. в статье [Глобализация и локализация](globalizing-portal.md).
...
2. Щелкните **многоязычный набор средств** > для приложений**добавить языки перевода..**..
...
Для перевода ресурсов&mdash;приложения можно использовать установленные поставщики перевода, такие как [языковой портал Майкрософт](https://www.microsoft.com/Language/) и [Microsoft Translator](https://www.microsofttranslator.com/)&mdash;. Если поставщик поддерживает определенный язык, рядом с названием языка отображается значок поставщика в диалоговом окне "Языки перевода".
...
2. Щелкните правой кнопкой мыши `<project-name>.qps-ploc.xlf` файл в Обозреватель решений и выберите **набор средств многоязыкового набора** > приложений**создать переводы машин**.
3. В области **Параметры** > **время & язык** > **язык &** > **языки**нажмите кнопку **Добавить язык**.
...
Чтобы выполнить перевод и редактирование данных для локализаторов, выберите нужные кслф-файлы в Обозреватель решений, щелкните их правой кнопкой мыши и выберите пункт **многоязыковый набор средств App Toolkit** > **Экспорт переводов.**...
...
После того как локализаторы завершат перевод и вы получите переведенные XLF-файлы, вы можете импортировать эти файлы в свой проект. Выберите нужные файлы. кслф в Обозреватель решений, щелкните их правой кнопкой мыши и выберите пункт **многоязыковой набор средств App Toolkit** > **Импорт и перезапуска переводов...**. Нажмите кнопку **Добавить**, перейдите к файлу. кслф или. zip и нажмите кнопку **Импорт**.
...
- [ЦИКЛ](https://www.sdl.com/translate/get-started/instant-quote.html)
...
* [MSI-установщик набора средств для многоязычных приложений версии 4.0](https://developer.microsoft.com/windows/develop/multilingual-app-toolkit)
