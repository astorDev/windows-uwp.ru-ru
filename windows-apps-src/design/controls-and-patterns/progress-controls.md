...
*Сверху вниз - неопределенном ProgressBar и определенный элемент управления ProgressBar*

![Состояние ProgressRing](images/ProgressRing_SingleState.png)

*Неопределенное ProgressRing*
...
-   **Элемент управления имеет определенный срок или прогнозируемый окончания?**
...
-   **Можно ли пользователь продолжить без необходимости отслеживать ход выполнения операции?**
...
-   **Приведет ли пользователя подождать, чтобы продолжить операцию?**
...
-   **Ожидает ли приложение пользователю выполнить задачу?**
...
-   **Нужно знать, что что-то происходит пользователя?**
...
-   **— Это операция фоновой активности, который не блокирует действие пользователя и представляет интерес минимальным (но по-прежнему некоторые) для пользователя?**
...
-   **Важно ли это пользователь только о завершении операции?**
...
-   **— Это операция, в виртуализированных коллекции?**
...
**Изменение размера ProgressRing**
...
**Выделение цветом элементы управления хода выполнения**
