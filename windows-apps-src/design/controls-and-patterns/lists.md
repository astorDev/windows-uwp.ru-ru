...
<tbody>
<tr class="odd">
<td align="left"><p><a href="listview-and-gridview.md">Представление списка и представление сетки</a></p></td>
<td align="left"><p>Знакомство с основами использования представления списка или сетки в вашем приложении.</p></td>
</tr>
<tr class="even">
<td align="left"><p><a href="item-containers-templates.md">Контейнеры элементов и шаблонов</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="inverted-lists.md">Обращенный список</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="pull-to-refresh.md">Чтобы обновить по запросу</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="nested-ui.md">Вложенные пользовательского интерфейса</a></p></td>
...
-   Несколько: Пользователь может выбрать несколько элементов без использования модификатора.
-   Расширенная: Пользователь может выбрать несколько элементов с модификатором, например, удерживая нажатой клавишу SHIFT.
