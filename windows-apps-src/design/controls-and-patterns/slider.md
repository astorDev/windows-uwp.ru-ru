...
> **API платформы**: [класс Slider](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.slider), [свойство Value](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.primitives.rangebase.value), [событие ValueChanged](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.primitives.rangebase.valuechanged)
