...
* **В общем случае следует все команды для элемента доступен в окне элемента [контекстное меню](menus.md).** Контекстные меню доступны пользователям, независимо от типа ввода и должны содержать все контекстно-зависимые команды, которые пользователь может выполнить.

* **Для часто используемых команд рассмотрите возможность использования входных ускорители.** Ускорители ввода позволяют пользователю быстро выполнять действия на основе их устройства ввода. Ускорители ввода включают:
...
| Input    | Контекстное действие                          |
| -------- | --------------------------------------- |
| Мышь    | Щелчок правой кнопкой мыши                             |
| Клавиатура | SHIFT + F10, кнопка меню                  |
| Сенсорный ввод    | Длительное нажатие элемента                      |
| Перо      | Нажатие кнопки пера, длительное нажатие элемента |
| Геймпад  | Кнопка меню                             |

**Так как пользователь может открыть контекстное меню, независимо от типа входных данных, в контекстном меню должен содержать все команды контекстного меню, доступные для элемента списка.**
...
Чтобы интегрировать проведите по экрану в вашей коллекции, вам потребуется два компонента: SwipeItems, где размещается команды; и SwipeControl, который служит оболочкой для элемента и обеспечивает взаимодействие перетаскивания.
...
* [Проведите по экрану](swipe.md)
* [Потяните, чтобы обновить](pull-to-refresh.md)
* [Взаимодействие с помощью пера и пера](../input/pen-and-stylus-interactions.md)
* [Настройки приложения для игровой и Xbox](../devices/designing-for-tv.md)
