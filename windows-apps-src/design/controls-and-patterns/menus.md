...
Используйте те же элементы для создания меню в строке меню как всплывающее меню. Тем не менее вместо группирование объектов MenuFlyoutItem в MenuFlyout, можно сгруппировать необходимые процедуры в элементе MenuBarItem. Каждый MenuBarItem добавляется в строке как меню верхнего уровня.
