...
См. в разделе _Иерархическое представление, использование привязки данных_ в разделе "Примеры" Полный код.
...
Нужно ли использовать ItemsSource или RootNodes, фактические элементы, используемые для отображения каждого узла — под названием «контейнер» — — это объект [TreeViewItem](/uwp/api/windows.ui.xaml.controls.treeviewitem) . Задать стиль контейнер при использовании TreeView ItemContainerStyle или ItemContainerStyleSelector свойств.
