...
- При открытом раскрывающегося дескриптор вызова элементов в раскрывающемся списке вниз, чтобы оба изменить, что параметр выбран, а затем вызвать его. Очень важно для вызова элемента всплывающего элемента, так как событие не возникает при использовании сенсорного управления нажатия кнопки.
...
> [!NOTE]
> При вызове сенсорный ввод, кнопку с разделением ведет себя как раскрывающийся список кнопки. С помощью других методов ввода пользователь может вызывать любой половины кнопки отдельно. Сенсорный ввод оба частями кнопки вызова всплывающий элемент. Таким образом необходимо включить параметр в содержимом всплывающего элемента в выключатель или отключить.
