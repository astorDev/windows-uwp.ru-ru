...
Для состояний наподобие PointerOver (наведение мыши на кнопку), **PointerPressed** (кнопка вызвана), или Disabled (кнопка не активна). Эти окончания добавляются на исходные имена упрощенный стиль: **ButtonBackgroundPointerOver**, **ButtonForegroundPointerPressed**, **ButtonBorderBrushDisabled**и т. д. Изменения этих кисти, обеспечит согласованно цветных элементов управления тему приложения.
