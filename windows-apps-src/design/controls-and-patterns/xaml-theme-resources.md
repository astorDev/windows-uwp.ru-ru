...
Дополнительные сведения о том, как применять цвета в приложение Windows, см. в статье [Цвета в приложениях Windows](../style/color.md).
...
В дополнение к набору ресурсов, предоставляемых платформой XAML, существует набор значений цвета, полученных из палитры Windows. Эти цвета не привязаны к среде выполнения Windows или приложениям Windows. Однако многие из ресурсов [Brush](/uwp/api/Windows.UI.Xaml.Media.Brush) XAML используют эти цвета, когда система работает (и приложение выполняется) с темой HighContrast. Платформа XAML предоставляет эти системные цвета как ключевые ресурсы. Разделы должны иметь следующий формат имени: `SystemColor[name]Color`.
...
Руководство по использованию набора шрифтов Windows в приложении см. в статье [Шрифтовое оформление приложений Windows](../style/typography.md).
