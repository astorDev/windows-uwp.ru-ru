...
**Является наилучшим вариантом для ввода текста?**
...
-   Для строго числовых данных:
    ...
    -   **Значение ввода скорее всего для настройки после результат наблюдается, таких как и в том или экрана яркость?** Если да, используйте элемент управления [ползунок](slider.md).
...
**Область применения:** Текстовое поле, RichEditBox, AutoSuggestBox
...
Дополнительные сведения см. в разделе [ввода текста с представлением рукописного ввода](text-handwriting-view.md).

## <a name="choose-the-right-keyboard-for-your-text-control"></a>Выбор подходящей клавиатуры для элемента управления текстом

**Область применения:** Текстовое поле PasswordBox RichEditBox
...
**Область применения:** TextBlock, RichEditBox RichTextBlock, текстовом поле
...
**Область применения:** TextBlock, RichTextBlock, многострочного текстового поля, RichEditBox
...
**Область применения:** Текстовое поле RichEditBox
...
-   **Для автоматического исправления орфографических ошибок**
...
-   **Для отображения альтернативных вариантов**
