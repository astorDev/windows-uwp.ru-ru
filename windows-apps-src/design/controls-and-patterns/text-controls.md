...
**Относится к** TextBox, RichEditBox, AutoSuggestBox
...
Дополнительные сведения см. в статье о [поле рукописного ввода текста](text-handwriting-view.md).

## <a name="choose-the-right-keyboard-for-your-text-control"></a>Выбор подходящей клавиатуры для элемента управления текстом

**Относится к** TextBox, PasswordBox RichEditBox
...
**Относится к** TextBlock, RichTextBlock, TextBox, RichEditBox
...
**Относится к** TextBlock, RichTextBlock, многострочному TextBox, RichEditBox
...
**Относится к** TextBox, RichEditBox
