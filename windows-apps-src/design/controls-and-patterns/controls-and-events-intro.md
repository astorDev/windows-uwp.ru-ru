...
*Шаблон*— это макет для изменения элемента управления или объединения нескольких элементов управления, позволяющий получить что-то новое. Например шаблон [основной/подробности](master-details.md) является способом, использовать элемент управления [SplitView](split-view.md) для навигации приложения. Аналогично можно настроить шаблон элемента управления [NavigationView](navigationview.md) для реализации шаблона вкладку.
