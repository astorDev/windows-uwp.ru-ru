...
*Шаблон*— это макет для изменения элемента управления или объединения нескольких элементов управления, позволяющий получить что-то новое. Например, с помощью шаблона [панель навигации](navigationview.md) можно использовать элемент управления [SplitView](split-view.md) для навигации по приложению. Аналогичным образом, вы можете настроить шаблон элемента управления [Сводка](tabs-pivot.md), чтобы реализовать шаблон вкладки.
