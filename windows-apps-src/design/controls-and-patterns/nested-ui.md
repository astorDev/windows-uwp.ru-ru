...
При создании пользовательского интерфейса со списком сначала необходимо учесть все методы ввода, поддерживаемые Windows. Подробнее о различных типах ввода см. в разделе [Азбука методов ввода](../input/index.md).
