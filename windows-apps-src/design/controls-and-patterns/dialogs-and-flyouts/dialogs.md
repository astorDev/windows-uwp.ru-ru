...
Рекомендации о том, когда следует использовать диалоговое окно и когда следует использовать всплывающий элемент (аналогичного элемента управления), [диалоговые окна](index.md)и всплывающие элементы. 
