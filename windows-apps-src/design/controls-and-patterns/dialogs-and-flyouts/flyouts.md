...
Рекомендации о том, когда следует использовать всплывающий элемент и когда следует использовать диалоговое окно (аналогичного элемента управления), [диалоговые окна](index.md)и всплывающие элементы. 
