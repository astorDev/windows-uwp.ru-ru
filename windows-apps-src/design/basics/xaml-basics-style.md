...
3. Используйте элемент многоугольника, чтобы создать фоновую фигуру для ползунка экспозиции.
    ...
    В [пространстве имен Windows.XAML.Ui.Shapes](https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.Shapes) доступно на выбор семь фигур. Среди фигур есть эллипс, прямоугольник и элемент "Путь", с помощью которого можно создать любую фигуру — да, даже единорога! 
