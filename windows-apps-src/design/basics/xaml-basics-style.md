...
![Простой ползунок с оформлением по умолчанию.](../basics/images/xaml-basics/slider-start.png)

Эти ползунки выполняют все положенные им функции, но они не совсем обычные. Исправим ситуацию. 
...
3. Используйте элемент многоугольника, чтобы создать фоновую фигуру для ползунка экспозиции.
    ...
    В [пространстве имен Windows.XAML.Ui.Shapes](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Shapes) доступно на выбор семь фигур. Среди фигур есть эллипс, прямоугольник и элемент "Путь", с помощью которого можно создать любую фигуру — да, даже единорога! 
    ...
    * Сделайте для **Многоугольник** линейную градиентную заливку.     
    * На ползунке экспозиции установите для свойства **Foreground** значение "Transparent" (прозрачный), чтобы многоугольник было видно. 
...
4. Скомпилируйте и запустите приложение. Теперь ползунок должен выглядеть замечательно

    ![Необычный ползунок экспозиции](../basics/images/xaml-basics/style-exposure-slider-done.png)
...
6. Скомпилируйте и запустите приложение. Теперь у нас два необычных ползунка.

    ![Два необычных ползунка](../basics/images/xaml-basics/style-2sliders-done.png)

7. **Дополнительные сведения**

    Добавьте фоновую фигуру для ползунка оттенка с градиентом от зеленого к красному. 

    ![Три необычных ползунка](../basics/images/xaml-basics/style-3sliders-done.png)
...
## <a name="part-2-create-basic-styles"></a>Часть 2. Создание основных стилей
...
Добавим стиль в наше приложение. В файле DetailsPage.xaml обратите внимание на текстовые блоки, расположенные рядом с ползунками экспозиции, температуры и оттенка. Каждый из этих текстовых блоков отображает значение ползунка. Здесь текстовый блок ползунка экспозиции. Обратите внимание, что свойствам **Margin**, **VerticalAlignment** и **Padding** уже заданы значения.
...
6. Скомпилируйте и запустите приложение. Теперь оно выглядит... так же. Но вы должны чувствовать то прекрасное чувство удовлетворения и завершенности, которое приходит от написания эффективного и поддерживаемого кода.

<!-- TODO add new start/end points -->
Поздравляем, вы завершили часть 2.


## <a name="part-3-use-a-control-template-to-make-a-fancy-slider"></a>Часть 3. Использование шаблона элемента управления для создания необычного ползунка
