...
Обратите внимание, что, когда это возможно, необходимо дать пользователям управлять содержимым напрямую, а не использовать команды, которые работают с содержимым. Например, разрешите пользователям изменять расположение списков путем перетаскивания и удаления элементов списка, а не с помощью кнопок "вверх" и "вниз".
