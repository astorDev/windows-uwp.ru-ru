...
Наиболее важным аспектом командного интерфейса выполняется какой вашего попытка пользователь может выполнить. При планировании функций вашего приложения, рассмотрим действия, необходимые для выполнения этих задач и возможности пользователей, которые вы хотите включить. После выполнения начальной черновик эти возможности, а затем вы сможете принимать решения о средствах и взаимодействия для их реализации.
...
Изобретательность проектирование процессы команды. Выберите, какие входные устройства ваше приложение поддерживает и как приложение отвечает на каждом устройстве. С помощью поддержки широкого диапазона возможностей и параметров сделать ваше приложение удобным, переносимые и специальных возможностей максимально.
...
Использование подходящих элементов в интерфейсе командной позволяет сделать приложение интуитивно понятным, простой в использовании и очень сложным, запутанного приложением. Полный набор командных элементов, доступны в универсальной платформы Windows (UWP). Ниже приведен список некоторых наиболее распространенные командные элементы UWP.
...
Всегда старайтесь, чтобы пользователь мог управлять содержимым напрямую, а не через команды, выполняющие на содержимом, например перетаскивание для изменения порядка элементов списка, а не вверх и вниз кнопки команд. 

Тем не менее это может оказаться возможно с определенные устройства ввода, или когда Поддерживайте параметры и возможности конкретного пользователя. В этих случаях предоставляйте столько командных возможности как можно скорее и поместите эти командные элементы на поверхности команд в приложении.
