...
Изобретательность проектирование процессы команды. Выберите, какие входные устройства ваше приложение поддерживает и как приложение отвечает на каждом устройстве. Поддерживая широкий спектр возможностей и параметров сделать приложение удобным, переносимые и специальных возможностей максимально.
