...
Наиболее важным аспектом командного интерфейса — это то, что вы пытаетесь пользователь может выполнить. При планировании функциональные возможности приложения, рассмотрим действия, необходимые для выполнения этих задач и взаимодействия с пользователем, который вы хотите включить. После выполнения начальной черновик эти возможности, вы сможете принимать решения о средствах и взаимодействий для их реализации.

Ниже приведены некоторые распространенные команды возможности.
...
Изобретательность проектирование процессы команды. Выберите, какие входные устройства ваше приложение поддерживает и как приложение отвечает на каждом устройстве. Поддерживая широкий спектр возможностей и параметров внесения возможностях можно было использовать, портативность и специальных возможностей максимально (см. в разделе [командной поверхностью разработки приложений универсальной платформы Windows (UWP)](../controls-and-patterns/commanding.md) для получения дополнительных сведений).
...
Тем не менее это может не удастся определенные устройства ввода, или когда Поддерживайте параметры и возможности конкретного пользователя. В этих случаях предоставляйте столько командных возможности как можно скорее и поместите эти командные элементы на поверхности команд в приложении.
...
Команды обратной связи обменивается данными с пользователями обнаружен взаимодействия или команды, как команда интерпретировано и обработано, что ли команда выполнена успешно или нет. Это помогает пользователям понять, что они делают, и что они могут сделать потом. В идеальном случае раздел отзывов должен быть интегрирован естественным образом в пользовательский интерфейс, чтобы пользователям не приходилось прерывать работу с приложением или выполнять дополнительные действия, только если это совершенно необходимо

> [!NOTE]
> Отправка отзывов только в случае необходимости и только в том случае, если он недоступен в другом месте. Оставьте пользовательского интерфейса вашего приложения засоряйте, если вы добавляете значение.
...
:::row:::
    ...
    :::column span="2":::
       ...
       <a href="../controls-and-patterns/dialogs-and-flyouts/index.md">Всплывающие элементы</a> — это облегченная контекстно-зависимые всплывающих окон, которые можно закрыть нажатием или щелчком за его пределами.
:::row-end:::
...
Независимо от того, насколько правильно разработан пользовательский Интерфейс приложения — это, всем пользователям выполнять действие, которое что они не хотели бы выполнять. Ваше приложение может помочь в этой ситуации, требуя подтверждения действия, или предоставляя возможность отменить последние действия.
