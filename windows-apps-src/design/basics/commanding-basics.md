...
Проявите изобретательность при разработке командного взаимодействия. Выберите устройства ввода, которые поддерживает ваше приложение, и реакцию приложения на каждое устройство. Реализовав поддержку максимально широкого диапазона возможностей и параметров, вы делаете свое приложение максимально удобным, мобильным и доступным (дополнительные сведения см. в статье [Использование команд в приложениях Windows с помощью классов StandardUICommand, XamlUICommand и ICommand](../controls-and-patterns/commanding.md)).
