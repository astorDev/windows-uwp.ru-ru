...
ms.locfileid: "57640819"
---
# <a name="tutorial-create-a-user-interface"></a>Учебник. Создание пользовательского интерфейса
...
## <a name="part-1-add-a-textblock-using-xaml-designer"></a>Часть 1. Добавить блок текста, с помощью конструктора XAML
...
**Добавьте элемент управления с помощью конструктора XAML:**
...
2. Под элементом **TextBlock** добавьте **элемент управления GridView** с именем "ImageGridView". Задайте **RelativePanel** _присоединенных свойств_ поместить элемент управления под текстом заголовка и сделать его растягивается по ширине экрана.
...
## <a name="part-3-add-a-datatemplate-to-display-your-data"></a>Часть 3. Добавление шаблона данных DataTemplate для отображения данных
...
**Добавить шаблон данных в представление сетки**
...
3. На панели "Структура документа" щелкните правой кнопкой мыши **ImageGridView**. В контекстном меню выберите **Правка дополнительных шаблонов > Правка созданных элементов (ItemTemplate) > создать пустой...** . **Создание ресурса** откроется диалоговое окно.
...
## <a name="part-4-modify-the-item-container-style"></a>Часть 4. Изменение стиля элемента контейнера
...
1. На панели "Структура документа" щелкните правой кнопкой мыши **ImageGridView**. В контекстном меню выберите **Правка дополнительных шаблонов > Правка созданного контейнера элемента (ItemContainerStyle) > изменить копию...** . **Создание ресурса** откроется диалоговое окно.
...
## <a name="part-5-apply-some-final-adjustments-to-the-layout"></a>Часть 5. Применить некоторые окончательные настройки в макет
...
**Изменить выравнивание изображения**
...
4. На панели "Структура документа" щелкните правой кнопкой мыши **ImageGridView**. В контекстном меню выберите **Правка дополнительных шаблонов > Изменение макета из элементов (ItemsPanel) > изменить копию...** . **Создание ресурса** откроется диалоговое окно.
