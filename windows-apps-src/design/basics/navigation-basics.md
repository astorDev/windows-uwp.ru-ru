...
Навигация должна быть согласована с ожиданиями пользователей. С помощью [стандартных элементов управления](#use-the-right-controls) , пользователи, которые знакомы с и следующие стандартные соглашения для значков, расположение и оформление заставляет навигацию предсказуемой и интуитивно понятным для пользователей.
...
:::row:::
    ...
    :::column span="2":::
        ...
        - В группе есть менее 8 страниц. <br>
...
:::row:::
    ...
    :::column span="2":::
        ...
        - Предполагается, что пользователи могут переключаться между часто вкладки.
