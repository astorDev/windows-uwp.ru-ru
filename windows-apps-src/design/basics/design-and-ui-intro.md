---
Description: Функции универсальной разработки, включенных в каждый справки приложения универсальной платформы Windows можно создавать масштабируемые элегантно широким спектром устройств приложения.
...
Это не список нормативных правил — это постоянно обновляемый документ, изменения в который вносятся по мере развития нашей [системы проектирования Fluent Design](/windows/apps/fluent-design-system) и с учетом меняющихся потребностей нашего сообщества разработчиков приложений.
...
Приложения UWP выполняются на всех [устройств Windows 10](../devices/index.md), из Телевизоре на планшете или ПК. Итак, как спроектировать пользовательский Интерфейс, который хорошо выглядит на самых разнообразных устройствах и размеры экрана?

![одно приложение на различных устройствах](images/universal-image-1.jpg)

Используя автоматическую корректировку элементы пользовательского интерфейса, чтобы они были разборчивым и легко взаимодействовать с на всех устройствах и размеры экрана помогает универсальной платформы Windows.
...
Если вы хотите узнать о принципах проектирования с помощью Fluent Design (системы проектирования корпорации Майкрософт) и ознакомиться с дополнительными компонентами, которые можно встроить в приложение UWP, см. раздел [Система проектирования Fluent Design](/windows/apps/fluent-design-system).
