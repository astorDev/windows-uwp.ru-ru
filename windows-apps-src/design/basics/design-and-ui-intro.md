...
Приложения UWP работать на всех [устройствах с Windows 10](../devices/index.md), от Телевизора до планшета или настольного компьютера. Так как проектирование пользовательского интерфейса, которое хорошо выглядит на различных устройствах и экранах разного размера?

![одно приложение на различных устройствах](images/universal-image-1.jpg)

UWP обеспечивает изменяя автоматически элементы пользовательского интерфейса, чтобы они были разборчивыми и легко взаимодействовать на всех устройствах и экранах разного размера.
