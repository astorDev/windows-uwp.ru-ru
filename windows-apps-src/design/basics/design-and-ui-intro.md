...
Во-первых, приложения UWP запускаются на всех [устройствах Windows 10](../devices/index.md), от телевизора до планшета и компьютера. Как это влияет на пользовательский интерфейс приложения?

![одно приложение на различных устройствах](images/universal-image-1.jpg)

К счастью для вас, приложения UWP автоматически регулируют размер элементов пользовательского интерфейса, чтобы они были разборчивыми и с ними было легко взаимодействовать на всех устройствах с различным размером экрана.
