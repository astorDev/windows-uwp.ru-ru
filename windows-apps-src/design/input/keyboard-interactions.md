...
| **Клавиатура**  | **Gamepad**                         | **Удаленное управление**  |
|---------------|-------------------------------------|---------------------|
...
Некоторые элементы управления, например ContextMenu, AppBarOverflowMenu и автозаполнения, включают всплывающего меню, которое отображается в расположение и направление относительно основного элемента управления (в зависимости от доступного пространства на экране). Например, если недостаточно места для открытия меню вниз (направление по умолчанию), оно откроется вверх. Нет никакой гарантии, что меню будет открываться в одном и том же направлении каждый раз.
...
Старайтесь повторять такое поведение в ваших пользовательских элементах управления. Образец кода для реализации такого поведения можно найти в [навигации с фокусом программный](focus-navigation-programmatic.md#find-the-first-and-last-focusable-element) документации.
