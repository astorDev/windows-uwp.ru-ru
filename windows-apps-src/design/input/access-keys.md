...
ключи доступа ![Primary в Microsoft Word @ no__t-1_основные ключи доступа в Microsoft Word_

ключи доступа ![Secondary в Microsoft Word @ no__t-1_вторичные ключи доступа в Microsoft Word_
...
1.  **Очевидный принцип ассоциации**: Пользователь может легко связать элемент управления с ключевым кончиком.
...
Режимы размещения: Верхний, нижний, правый, левый, скрытый, центрированный и автоматический.
