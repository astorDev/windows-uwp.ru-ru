...
Отключите все элементы пользовательского интерфейса для постоянного распознавания речи и завершите сеанс распознавания речи, сетевое подключение отсутствует. Непрерывная распознавания требуется сетевое подключение.
