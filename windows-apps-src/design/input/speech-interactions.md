...
Речь для текстового ввода может быть короткой (одно слово или одна фраза) или длинной (непрерывная диктовка). Короткая форма ввода не быть продолжительностью больше 10секунд, а длинная форма— не больше двух минут. (Ввод длинной формы можно перезапустить без участия пользователя, чтобы создать впечатление непрерывной диктовки.)
