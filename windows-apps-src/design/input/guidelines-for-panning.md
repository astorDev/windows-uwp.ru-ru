...
-   Отображайте индикаторы сдвига и полосы прокрутки, чтобы давать подсказки о расположении и размере. Скрывайте их, если в приложении реализован специальный метод навигации.
    ...
    **Примечание**в отличие от стандартной прокрутки полосы, индикаторы сдвига являются исключительно источником информации. Они не предоставляются для устройств ввода, и с ними нельзя производить никаких манипуляций.
