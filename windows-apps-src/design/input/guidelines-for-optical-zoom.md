...
> **Важные API-интерфейсы**: [**Windows.UI.Input**](https://msdn.microsoft.com/library/windows/apps/br242084), [ **входных данных (XAML)**](https://msdn.microsoft.com/library/windows/apps/br227994)
