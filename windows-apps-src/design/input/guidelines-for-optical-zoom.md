...
> **Важные API**: [**Windows.UI.Input**](https://docs.microsoft.com/uwp/api/Windows.UI.Input), [ **входных данных (XAML)** ](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input)
...
-   Используйте физические свойства инерции, следующие основные параметры.
