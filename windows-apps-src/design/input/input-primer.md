...
[Помощи взаимодействия и отслеживания](gaze-interactions.md)
...
[Surface Dial рекомендации по проектированию](windows-wheel-interactions.md)

## <a name="cortana"></a>Кортана

В Windows 10 **Cortana** расширяемости, которая позволяет обрабатывать голосовые команды от пользователя и запуска приложения для выполнения одно действие.
...
**Примечание**  существует два типа устройств пера: активный и пассивный.
...
С помощью [непрерывное множество решений для Phone](https://go.microsoft.com/fwlink/p/?LinkID=699431), новые возможности для совместимых мобильных устройств Windows 10, пользователи могут подключаться их телефоны, мыши и клавиатуры, чтобы сделать их телефоны, работают как портативного компьютера.
...
**Примечание**  OSK имеет приоритет над сенсорной клавиатуры не будет отображаться, если присутствует OSK.
