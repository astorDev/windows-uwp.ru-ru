...
С помощью [Continuum для телефонов](https://go.microsoft.com/fwlink/p/?LinkID=699431), нового интерфейса для совместимых мобильных устройств с Windows10, пользователи могут подключать своим телефонам мышь и клавиатуру, чтобы работать как на ноутбуке.
