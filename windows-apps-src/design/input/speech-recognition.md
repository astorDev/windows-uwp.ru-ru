...
> **Важные API**: [**Windows.Media.SpeechRecognition**](https://msdn.microsoft.com/library/windows/apps/dn653262)
...
Сначала мы инициализируем глобальную переменную (HResultPrivacyStatementDeclined) до значения HResult 0x80045509. См. в разделе [обработки исключений для в C\# или Visual Basic](https://msdn.microsoft.com/library/windows/apps/dn532194).
