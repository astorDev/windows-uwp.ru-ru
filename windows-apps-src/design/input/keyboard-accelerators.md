---
Description: Узнайте, как сочетания клавиш могут улучшить удобство использования и доступность приложений Windows.
...
Рекомендуется обеспечить согласованность сочетаний клавиш в приложениях Windows. Пользователи запоминают ускорители клавиатуры и ожидают получать одни и те же (или похожие) результаты.
...
## <a name="advanced-concepts"></a>Дополнительные возможности
