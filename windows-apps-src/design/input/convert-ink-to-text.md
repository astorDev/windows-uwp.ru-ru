...
**Примечание**  пользователи могут просмотреть список установленных языков, перейдя на страницу **Параметры -&gt; время и язык**. Установленные языки перечислены в разделе **Языки**.
