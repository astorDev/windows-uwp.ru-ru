...
Поле — это свойство типа [**Thickness**](https://msdn.microsoft.com/library/system.windows.thickness), поэтому ее можно настроить так, чтобы она отображалась только с определенных сторон элемента управления. См. ниже: ![Крупная фокус visual margin толщину только внизу](images/FocusThicknessSide.png)
