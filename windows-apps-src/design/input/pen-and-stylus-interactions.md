---
Description: Создавайте приложения для Windows, которые поддерживают пользовательские взаимодействия от устройств пера и пера, включая цифровой рукописный ввод для естественных операций письма и рисования.
title: Взаимодействие с пером и Windows Ink в приложениях для Windows
...
ms.locfileid: "83234906"
---
# <a name="pen-interactions-and-windows-ink-in-windows-apps"></a>Взаимодействие с пером и Windows Ink в приложениях для Windows
...
Оптимизируйте приложение Windows для ввода с помощью пера, чтобы обеспечить стандартную функциональность [**устройства с указателями**](https://docs.microsoft.com/uwp/api/Windows.Devices.Input.PointerDevice) и лучшее взаимодействие с Windows для пользователей.
