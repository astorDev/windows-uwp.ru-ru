...
**Примечание**в котором область содержимого можно сдвигать в двух направлениях, например веб-браузерах или средствах чтения электронных книг, взаимодействие в форме нажатия и удержания следует использовать для вызова контекстного меню для объектов, таких как изображения и гиперссылки.
