...
![Пример текстового потока диаграммы](images/coretext/stream-4.png) в этом случае следует вызывать [ **NotifyTextChanged** ](https://msdn.microsoft.com/library/windows/apps/dn958172) с этими аргументами:
...
![Пример текстового потока диаграммы](images/coretext/stream-6.png) пользователь нажимает клавишу ПРОБЕЛ и соответствующий [ **TextUpdating** ](https://msdn.microsoft.com/library/windows/apps/dn958176) события. Элемент управления редактированием принимает обновление текста. Это состояние элемента управления редактированием в течение короткого момента перед завершением исправления. Курсор находится в \[4, 4\].

![Пример текстового потока диаграммы](images/coretext/stream-7.png) за пределами [ **TextUpdating** ](https://msdn.microsoft.com/library/windows/apps/dn958176) обработчик событий элемента управления редактирования делает следующие исправления. Это состояние элемента управления редактированием после завершения исправления. Курсор находится в \[5, 5\].

![Пример текстового потока диаграммы](images/coretext/stream-8.png) в этом случае следует вызывать [ **NotifyTextChanged** ](https://msdn.microsoft.com/library/windows/apps/dn958172) с этими аргументами:
