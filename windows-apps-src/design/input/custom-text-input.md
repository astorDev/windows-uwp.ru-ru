---
Description: Основные текстовые интерфейсы API в пространстве имен Windows. UI. Text. Core позволяют приложению приложения Windows принимать текстовые данные из любой текстовой службы, поддерживаемой на устройствах Windows.
...
![Пример](images/coretext/stream-2.png) диаграммы потока текста существует два выбора: \[0, 1\] и \[6, 11.\] Элемент управления "поле ввода" должен сообщать только один из них; \[0, 1\] или \[6, 11\].
...
![Пример диаграммы](images/coretext/stream-3.png) потока текста если пользователь вводит "d", событие [**текступдатинг**](https://docs.microsoft.com/uwp/api/windows.ui.text.core.coretexteditcontext.textupdating) вызывается со следующими данными [**коретексттекступдатинжевентаргс**](https://docs.microsoft.com/uwp/api/Windows.UI.Text.Core.CoreTextTextUpdatingEventArgs) :

-   [**Range**](https://docs.microsoft.com/uwp/api/windows.ui.text.core.coretexttextupdatingeventargs.range) = Диапазон\[10, 10\]
...
![Пример диаграммы](images/coretext/stream-5.png) потока текста. пользователь выполняет операцию вставки, и элемент управления "поле ввода" завершается следующим текстом:

![Пример диаграммы](images/coretext/stream-4.png) потока текста. в этом случае следует вызвать [**нотифитекстчанжед**](https://docs.microsoft.com/uwp/api/windows.ui.text.core.coretexteditcontext.notifytextchanged) с этими аргументами:
...
![Пример диаграммы](images/coretext/stream-6.png) потока текста пользователь нажимает клавишу пробела и вызывается соответствующее событие [**текступдатинг**](https://docs.microsoft.com/uwp/api/windows.ui.text.core.coretexteditcontext.textupdating) . Элемент управления редактированием принимает обновление текста. Это состояние элемента управления редактированием в течение короткого момента перед завершением исправления. Точка вставки — \[4, 4\].

![Пример диаграммы](images/coretext/stream-7.png) потока текста вне обработчика событий [**текступдатинг**](https://docs.microsoft.com/uwp/api/windows.ui.text.core.coretexteditcontext.textupdating) элемент управления "поле ввода" делает следующее исправление. Это состояние элемента управления редактированием после завершения исправления. Точка вставки — \[5, 5\].

![Пример диаграммы](images/coretext/stream-8.png) потока текста. в этом случае следует вызвать [**нотифитекстчанжед**](https://docs.microsoft.com/uwp/api/windows.ui.text.core.coretexteditcontext.notifytextchanged) с этими аргументами:
