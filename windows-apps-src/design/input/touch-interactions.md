...
| [**События ManipulationDelta**](https://msdn.microsoft.com/library/windows/apps/br208946)                                         | Происходит, когда устройство ввода изменяет положение во время манипуляции.                                                                      |
