...
-   Взаимодействия не должны различаться по времени. Одно и то же взаимодействие должно приводить к определенному результату, сколько бы времени ни потребовалось на его выполнение. Зависимые от времени активации вводят обязательные задержки для пользователей, в результате чего обесценивается иммерсивный характер прямого манипулирования и снижается скорость восприятия ответа системы.
    ...
    **Обратите внимание** ,  исключением является то, что вы используете конкретные взаимодействия по времени для помощи в изучении и исследовании (например, нажатие и удержание).
...
-   События указателя, например [**PointerPressed**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerpressed) и [**PointerMoved**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointermoved), предоставляют низкоуровневые сведения для каждого сенсорного контакта, включая движение указателя и возможность отличить события нажатия и освобождения.
...
|----------------------------------------------------------------------|---------------------------------------------------------------|
| [**поинтерпрессед**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerpressed)             | Происходит при касании экрана одним пальцем.               |
| [**поинтеррелеасед**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerreleased)           | Происходит, когда тот же сенсорный контакт прекращается.                |
| [**поинтермовед**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointermoved)                 | Происходит, когда указатель перетаскивается по экрану.         |
| [**поинтерентеред**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerentered)             | Происходит, когда указатель входит в область проверки нажатия элемента. |
| [**поинтерекситед**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerexited)               | Происходит, когда указатель выходит из области проверки нажатия элемента.  |
| [**поинтерканцелед**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointercanceled)           | Происходит при ненормальном завершении сенсорного контакта.               |
| [**поинтеркаптурелост**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointercapturelost)     | Происходит, когда перехват событий указателя выполняется другим элементом.    |
| [**поинтервхилчанжед**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerwheelchanged)   | Происходит, когда изменяется значение дельта колесика мыши.         |
...
| Событие или класс                                                                                               | Описание                                                                                                                               |
|--------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Событие ManipulationStarting**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationstarting)                                   | Происходит при первом создании обработчика манипуляции.                                                                                  |
...
| [**Событие ManipulationDelta**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationdelta)                                         | Происходит, когда устройство ввода изменяет положение во время манипуляции.                                                                      |
...
| [**манипулатионстартинграутедевентаргс**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input.ManipulationStartingRoutedEventArgs)               | Предоставляет данные для события [**ManipulationStarting**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationstarting).                                         |
| [**манипулатионстартедраутедевентаргс**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input.ManipulationStartedRoutedEventArgs)                 | Предоставляет данные для события [**ManipulationStarted**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationstarted).                                           |
| [**манипулатионделтараутедевентаргс**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs)                     | Предоставляет данные для события [**ManipulationDelta**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationdelta).                                               |
| [**манипулатионинертиастартинграутедевентаргс**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input.ManipulationInertiaStartingRoutedEventArgs) | Предоставляет данные для события [**ManipulationInertiaStarting**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationinertiastarting).                           |
| [**манипулатионвелоЦитиес**](https://docs.microsoft.com/uwp/api/Windows.UI.Input.ManipulationVelocities)                                              | Описывает скорость, с которой происходят манипуляции.                                                                                         |
| [**манипулатионкомплетедраутедевентаргс**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs)             | Предоставляет данные для события [**ManipulationCompleted**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationcompleted).                                       |

 

Жест состоит из серии событий манипуляции. Каждый жест начинается с события [**ManipulationStarted**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationstarted), например при прикосновении пользователя к экрану.
...
**Обратите внимание** ,  если у вас нет монитора сенсорного экрана, вы можете протестировать код события манипуляции в симуляторе, используя интерфейс мыши и колесика мыши.
