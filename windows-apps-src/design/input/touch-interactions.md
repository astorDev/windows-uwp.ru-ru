...
> **Важные API**: [**Windows.UI.Xaml.Input**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input), [**Windows.UI.Core**](https://docs.microsoft.com/uwp/api/Windows.UI.Core), [**Windows.Devices.Input**](https://docs.microsoft.com/uwp/api/Windows.Devices.Input)
...
-   Взаимодействия не должны различаться по времени. Одно и то же взаимодействие должно приводить к определенному результату, сколько бы времени ни потребовалось на его выполнение. Зависимые от времени активации вводят обязательные задержки для пользователей, в результате чего обесценивается иммерсивный характер прямого манипулирования и снижается скорость восприятия ответа системы.
    ...
    **Примечание**  исключением используется где синхронизированного взаимодействия для помощи в обучение и изучение (для примера, нажмите и удерживайте).
...
| [**PointerWheelChanged**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.pointerwheelchanged)   | Происходит, когда изменяется значение дельта колесика мыши.         |
| [**PointerRoutedEventArgs**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Input.PointerRoutedEventArgs) | Предоставляет данные для всех событий указателя.                         |
...
| [**События ManipulationDelta**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.uielement.manipulationdelta)                                         | Происходит, когда устройство ввода изменяет положение во время манипуляции.                                                                      |
...
**Примечание**  Если у вас нет сенсорного экрана монитора, можно проверить код обработки событий в симуляторе, с помощью мыши и интерфейс колесика мыши.
