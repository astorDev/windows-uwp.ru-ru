---
Description: Создавайте приложения Windows с интуитивно понятными и удобными интерфейсами взаимодействия с пользователем, которые оптимизированы для касания, но функционально согласованы на всех устройствах ввода.
