...
Вертикальными панелями или поверхности, помогающие разделе Отключение содержимого вашего приложения мы рекомендуем использовать вместо акрил непрозрачный фон. Если ваш вертикальными панелями открыть поверх содержимого, как **Collapsed** или **Минимальный** режимы NavigationView мы рекомендуем использовать акрил приложения для сохранения контекста страницы, когда пользователь этой панели открывать.
