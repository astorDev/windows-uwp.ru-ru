...
<td>
    <p>Если у вас установлено приложение <strong style="font-weight: semi-bold">галереи элементов управления XAML</strong>, щелкните здесь, чтобы <a href="xamlcontrolsgallery:/item/Acrylic">открыть приложение и увидеть акрил в действии</a>.</p>
    <ul>
