...
Если вы используете акрил приложения на поверхностях навигации, рассмотрите возможность распространить содержимое под акриловая панель для улучшения поток в вашем приложении. С помощью NavigationView сделает это за вас автоматически. Тем не менее во избежание эффекту "зебры", не следует разместить несколько объектов акриловый края до края — это может создать нежелательных границе между двумя размытое поверхности. Акрил — инструмент, призванный сделать ваши проекты, однако при неправильном использовании, может привести к визуальному шуму.

Рассмотрите следующие шаблоны использования, чтобы выбрать оптимальный способ включения акрил в приложение.
...
![Шаблон приложения почта с информационных всплывающий элемент](images/Mail_TransientContextMenu.png)
