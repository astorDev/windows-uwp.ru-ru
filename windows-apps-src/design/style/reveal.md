...
Можно добавить эффект отображения в пользовательские элементы управления Перед выполнением, полезно знать чуть больше о том, как работает эффект. Эффект отображения состоит из двух отдельных эффектов: **Эффект отображения границы** и **Эффект отображения при наведении**.
