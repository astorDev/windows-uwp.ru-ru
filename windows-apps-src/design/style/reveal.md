...
Когда включить эффект отображения для пользовательских или с измененным элемента управления или поверхности пользовательских командных эти советы помогут оптимизировать эффект:
 
