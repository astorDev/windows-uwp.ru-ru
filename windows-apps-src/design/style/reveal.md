...
ms.locfileid: "66370434"
---
# <a name="reveal-highlight"></a>Отобразить выделение

![главное изображение](images/header-reveal-highlight.svg)

Показать, что выделение эффекта освещения, выделяющий интерактивные элементы, такие как панели команд при наведении указателя мыши рядом с ними. 

> **Важные API**: [Класс RevealBrush](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.revealbrush), [класс RevealBackgroundBrush](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.revealbackgroundbrush), [класс RevealBorderBrush](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.revealborderbrush), [класс RevealBrushHelper](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.revealbrushhelper), [VisualState класс](https://docs.microsoft.com/en-us/uwp/api/Windows.UI.Xaml.VisualState)

## <a name="how-it-works"></a>Принцип работы
Показать внимания вызовов выделения для интерактивных элементов путем предоставления контейнера элемента, когда указатель находится рядом, как показано на следующем рисунке:
...
Отображение автоматически работает для некоторых элементов управления. Для других элементов управления, вы можете включить раскрывают, назначив специальный стиль к элементу управления, как описано в разделе [Включение Показать для других элементов управления](#enabling-reveal-on-other-controls) и [Включение Показать о пользовательских элементах управления](#enabling-reveal-on-custom-controls) разделах этого статья.
...
- [**Панели команд**](../controls-and-patterns/app-bars.md)

Здесь показаны Показать выделите на нескольких разных элементов управления:
...
Можно добавить эффект отображения в пользовательские элементы управления Перед выполнением, полезно знать немного больше о том, как Показать эффект. Показать состоит из двух различных эффектов: **Показать границы** и **Показать при наведении указателя мыши**.
...
* При наведении указателя мыши раскрывают определяется **RevealBackgroundBrush**
...
При включении показывать на пользовательских или re шаблонного элемента управления или пользовательских команд поверхность эти советы помогут оптимизировать эффект:
 
* На соседние элементы с размерами, не соответствуют друг другу в высоты или ширины (особенно в списках): Удалить поведение подход границы и сохранить границы, который отображается при наведении курсора мыши только.
* Для команд элементов, часто перейдите в нее отключенного состояния: Поместите кисть границы подход backplates элементов, а также их границ, чтобы подчеркнуть их состояние.
* Для соседних элементов команд, поэтому близки они рассматривают: Добавление полей 1px между двумя элементами. 
...
- [Fluent разработка для универсальной платформы Windows](/windows/apps/fluent-design-system)
