...
ms.locfileid: "57620799"
---
# <a name="balancing-style-and-consistency"></a>Оптимальное соотношение стиля и единообразия

 

> Примечание. Эта статья содержит черновика раннее для Windows 10 RS2. Названия компонентов, терминология и функциональные возможности могут меняться.
...
3. На третьем уровне — адаптация навигации к различным устройствам и контекстам. Например, навигация на телефоне с сенсорным вводом, скорее всего, будет не такой, как на 32-дюймовом мониторе с клавиатурой и мышью, использующем жесты устройстве HoloLens или 84-дюймовом Surface со 100 точками касания.
...
**Если он выглядит так же, сделать его работают так же**
...
**Если элемент выглядит очень похоже на существующий элемент или соглашение, рассмотрим, что же**
...
**Удобство использования кроет согласованности**
