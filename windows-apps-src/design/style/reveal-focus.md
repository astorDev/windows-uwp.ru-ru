---
author: cphilippona
description: Фокус отображения — это световой эффект, анимирующий границу элементов для фокусировки, когда пользователь наводит на них фокус клавиатуры или игрового контроллера.
...
(Эффект отображения выделения влияет освещения, выделяющего интерактивные элементы, см. в разделе [отображения выделите статьи](/windows/uwp/design/style/reveal).)
