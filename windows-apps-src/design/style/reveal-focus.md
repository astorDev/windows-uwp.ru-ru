...
(Эффект отображения выделения, эффект освещения, который подсвечивает интерактивные элементы, см. в [статье отображения выделить](/windows/uwp/design/style/reveal).)
...
После задания свойства **FocusVisualKind** система автоматически применит эффект фокуса отображения ко всем элементам управления, свойство которого [UseSystemFocusVisuals](/uwp/api/Windows.UI.Xaml.Controls.Control.UseSystemFocusVisuals) задано значение **True** (значение по умолчанию для большинства элементов управления). 
