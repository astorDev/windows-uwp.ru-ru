...
(Эффект отображения выделите световой эффект, который подсвечивает интерактивные элементы, см. в [статье отображения выделения](/windows/uwp/design/style/reveal).)
