...
(Эффект отображения выделения, влияет освещения, выделяющего интерактивные элементы, см. в [статье отображения выделите](/windows/uwp/design/style/reveal).)
...
Помимо статических элементов визуальные элементы фокуса отображения компонентов анимированный свет, который пульсирует, если двигается и перемещается в направлении фокуса при перемещении фокуса.
