...
ms.locfileid: "8799341"
---
# <a name="reveal-focus"></a>Фокус отображения

![главное изображение](images/header-reveal-focus.svg)

Фокус отображения — это световой эффект для [взаимодействия на большом расстоянии](/windows/uwp/design/devices/designing-for-tv), таких как Xbox One и телевизоров. Этот эффект анимирует границу элементов для фокусировки, например кнопок, когда пользователь наводит на них фокус с геймпада или клавиатуры. По умолчанию эффект выключен, но включить его очень легко. 

(Эффект отображения выделения, эффект освещения, который подсвечивает интерактивные элементы, см. в [статье отображения выделите](/windows/uwp/design/style/reveal).)
...
Однако перед началом пользовательской настройки, полезно знать чуть больше о компонентах, составляющих фокус отображения.
