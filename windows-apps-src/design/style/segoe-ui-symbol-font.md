...
Если вы разрабатываете приложение на C#/VB/C++ и XAML, то можете использовать глифы из MDL2 Assets с помощью [перечисления Symbol](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.symbol). 
