---
description: Научитесь использовать цвета, шрифтовое оформление и значки для индивидуализации приложения UWP с помощью руководства по стилю UWP.
...
:::row::: :::column::: ![главное изображение](images/header-color.svg)
        ### [Color](color.md)
...
:::row::: :::column::: ![главное изображение](images/header-icons.svg)
        ### [Icons](icons.md)
...
:::row::: :::column::: ![главное изображение](images/header-reveal-highlight.svg)
...
:::row::: :::column::: ![главное изображение](images/header-sound.svg)
        ### [Sound](sound.md)
