---
description: Узнайте, как использовать цвета элементов и темы в приложениях Windows.
title: Цвет в приложениях Windows
ms.date: 04/07/2019
ms.topic: article
...
В приложениях Windows может использоваться светлая или темная тема. Тема определяет цвета фона, текста, значков и [общих элементов управления](../controls-and-patterns/index.md) приложения.
...
По умолчанию тема приложения Windows — это тема, выбранная пользователем в параметрах Windows, или стандартная тема устройства (например, темная тема на консоли Xbox). Однако вы можете настроить тему для вашего приложения Windows.
