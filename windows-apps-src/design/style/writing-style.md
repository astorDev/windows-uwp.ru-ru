...
:::row::: :::column::: ![Хороший текст.](images/do.svg) Выберите **фильтры** для добавления эффектов к изображению.
:::column-end::: :::column::: ![Плохой текст.](images/dont.svg) Если вы хотите добавить визуальные эффекты или изменения в изображение, выберите **фильтры.**
:::column-end::: :::row-end:::
...
:::row::: :::column::: ![Хороший текст.](images/do.svg) Перезапустите приложение, чтобы увидеть изменения.
:::column-end::: :::column::: ![Плохой текст.](images/dont.svg) Изменения будут применены после перезапуска приложения.
:::column-end::: :::row-end:::
...
:::row::: :::column::: ![Хороший текст.](images/do.svg) Картинку не удалось отправить. Если это случится снова, попробуйте перезапустить приложение. Не беспокойтесь — изображение будет на месте, когда вы вернетесь.
:::column-end::: :::column::: ![Плохой текст.](images/dont.svg) Произошла ошибка, и нам не удалось отправить изображение. Повторите попытку, а в случае повторного возникновения проблемы, возможно, потребуется перезапустить приложение. Не волнуйтесь — мы сохранили ваши данные локально, и вы увидите их, когда вернетесь в приложение.
:::column-end::: :::row-end:::
...
:::row::: :::column::: ![Хороший текст.](images/do.svg) Нам не удалось сохранить файл в этом расположении.
...
:::row::: :::column::: ![Хороший текст.](images/do.svg) Если изображение вас устраивает, нажмите **Сохранить** для его добавления в галерею. Оттуда вы сможете отправить ее друзьям.
:::column-end::: :::column::: :::column-end::: :::row-end:::
...
:::row::: :::column::: ![Хороший текст.](images/do.svg) <b>Вы не подключены.</b>
* Убедитесь, что сетевые кабели подключены.
* Убедитесь, что вы не используете режим "в самолете".
* Проверьте, включен ли ваш беспроводной коммутатор.
...
:::row::: :::column::: ![Хороший текст.](images/do.svg) <b> С каким компонентом у вас возникли проблемы?</b>
* Я забыл пароль.
* Пароль не подходит.
...
:::row::: :::column::: Многие из советов по написанию сообщений об ошибках также применяются к созданию текста для диалоговых окон в приложении. Хотя пользователи и ожидают диалоговые окна, они все-таки прерывают обычный ход событий и должны быть полезными и краткими, чтобы пользователи могли вернуться к тому, что они делали.
...
:::row::: :::column::: Текст на кнопках должен быть достаточно краткими, что пользователи могли быстро его прочитать, и достаточно понятным, чтобы функция кнопки была очевидна. Самый длинный текст на кнопке должен быть не более двух коротких слов, а многие кнопки должны содержать гораздо более короткий текст.
...
:::column-end::: :::column::: ![Хороший текст.](images/do.svg) * Установить * Поделиться :::column-end::: :::row-end:::
