...
*Калькулятор, отображаемых в "светлой" темой и Контрастная черная тема.*
...
2. В разделе **Default** создайте тот тип инструмента [Brush](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Brush), который вам необходим; чаще всего это **SolidColorBrush**. Задайте ему имя *x:Key*, указывающее его предназначение.
...
*После того как пользователь выберет параметр, на странице отображается предварительный просмотр.*  

![Высококонтрастные ресурсы](images/high-contrast-resources.png)  

*Чтобы изменить его значение можно щелкнуть каждый образец цвета на предварительной версии. Каждый образец также напрямую сопоставляется ресурс цвета XAML.*  
...
*На панели навигации, так и с помощью страницы совместно используют один и тот же цвет фона в высокой контрастности. Высокая контрастность — только для границы разделить их очень важно.*
...
*Простой список в Светлая тема (слева) и Контрастная черная тема (справа). Второй элемент выделен; Обратите внимание на то, как цвет инвертируется в высокой контрастности.*
...
*Сложного списка в Светлая тема (слева) и Контрастная черная тема (справа). При высокой контрастности вторая часть выбранного элемента не удалось обратить.*  
...
* [Пример контрастности и параметры пользовательского интерфейса](https://go.microsoft.com/fwlink/p/?linkid=231539)
* [XAML примера специальных возможностей](https://go.microsoft.com/fwlink/p/?linkid=238570)
* [Пример высокой контрастности XAML](https://go.microsoft.com/fwlink/p/?linkid=254993)
