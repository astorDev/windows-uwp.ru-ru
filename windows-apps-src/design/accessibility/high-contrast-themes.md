...
*Калькулятор, показанный в светлой теме и высокая контрастность черной теме.*
...
*После выбора пользователем параметра на странице отображается предварительный просмотр.*  
...
|--------|-------|
**системколорвиндовтекстколор** | Основной текст, заголовки, списки; любой текст, с которым невозможно осуществлять взаимодействие |
| **системколорхотлигхтколор** | Гиперссылки |
| **системколорграйтекстколор** | Отключенный пользовательский интерфейс |
| **системколорхигхлигхттекстколор** | Основной цвет текста или элементов пользовательского интерфейса, которые в настоящее время выполняются, выбраны или участвуют во взаимодействии |
| **системколорхигхлигхтколор** | Фоновый цвет текста или элементов пользовательского интерфейса, которые в настоящее время выполняются, выбраны или участвуют во взаимодействии |
| **системколорбуттонтекстколор** | Основной цвет кнопок и любых элементов пользовательского интерфейса, с которыми можно осуществлять взаимодействие |
| **системколорбуттонфацеколор** | Фоновый цвет кнопок и любых элементов пользовательского интерфейса, с которыми можно осуществлять взаимодействие |
| **системколорвиндовколор** | Фон страниц, областей, всплывающих окон и панелей |
