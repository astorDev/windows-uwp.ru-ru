---
Description: Список рекомендаций, которые следует избегать, если вы хотите создать доступное приложение Windows для приложений.
...
ms.locfileid: "82970009"
---
# <a name="accessibility-practices-to-avoid"></a>Рекомендации по специальным возможностям, которых следует избегать

Если вы хотите создать доступное приложение для приложений Windows, ознакомьтесь со списком методов, которые следует избегать: 
