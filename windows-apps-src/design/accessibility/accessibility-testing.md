...
[**Наблюдатель событий доступности (акцевент)** ](https://docs.microsoft.com/windows/desktop/WinAuto/accessible-event-watcher) проверяет, вызывает ли элемент пользовательского интерфейса приложения правильную АВТОМАТИЗАЦИЮ пользовательского интерфейса и события Microsoft Active Accessibility, когда происходят изменения пользовательского интерфейса. Изменения в пользовательском интерфейсе могут произойти при изменении фокуса или при вызове элемента интерфейса, его выборе или изменении его состояния или свойств.
...
**Выполните следующие действия, чтобы протестировать приложение с помощью экранного диктора, используя мышь и клавиатуру:**
...
**Выполните следующие действия для тестирования приложения с помощью сенсорного экрана экранного диктора:**
