...
[**Доступны отслеживание событий (AccEvent)** ](https://msdn.microsoft.com/library/windows/desktop/Dd317979) проверяет, является ли элементы пользовательского интерфейса приложения запускаются соответствующие события модели автоматизации пользовательского интерфейса и Microsoft Active Accessibility, когда происходят изменения пользовательского интерфейса. Изменения в пользовательском интерфейсе могут произойти при изменении фокуса или при вызове элемента интерфейса, его выборе или изменении его состояния или свойств.
