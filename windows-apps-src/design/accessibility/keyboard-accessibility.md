...
Все элементы управления XAML по умолчанию при фокусировке будут отображать соответствующий индикатор визуального фокуса (если для них возможна фокусировка). Существуют также потенциально внешний вид в зависимости от выбранной темы пользователя (особенно, если пользователь использует режим высокой контрастности.) Если вы используете элементы управления XAML в пользовательский Интерфейс и не заменяет шаблонов элементов управления, не нужно предпринимать дополнительных получить визуальные индикаторы фокуса в элементах управления, которые ведут себя и правильного отображения. Но если вы планируете изменить шаблон элемента управления или хотите узнать, как элементы управления XAML предоставляют индикаторы визуального фокуса, то ниже вы найдете объяснения принципа их работы в XAML и в логике элемента управления.
...
* [Взаимодействия пользователей с клавиатурой](https://docs.microsoft.com/windows/uwp/input-and-devices/keyboard-interactions)
