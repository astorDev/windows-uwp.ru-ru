...
3. Убедитесь, что текст размером для чтения

    * Windows включает в себя различные средства специальных возможностей и параметров, которые пользователи могут воспользоваться преимуществами и приспособиться к нравится исходя из потребностей и предпочтений для чтения текста. К ним относятся следующие задачи.
...
4. Визуально проверьте свой пользовательский интерфейс, чтобы удостовериться, что используется адекватный уровень контрастности текста, элементы в темах с высокой контрастностью отображаются правильно, а цвета используются надлежащим образом.
