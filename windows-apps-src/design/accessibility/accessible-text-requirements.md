...
* Глобальные параметры масштабирования и разрешения в **Параметры "->" система "->" экран "->" масштабирование и макет**. Точно доступных вариантов размера может изменяться, так как он зависит от возможностей устройства отображения.
* Параметры размер текста в **Параметры "->" специальные возможности "->" отображения**. Настройка параметров **больше текста** можно указать только размер текста в поддержки элементов управления во всех приложениях и экранов (все элементы управления текстом UWP поддерживает текст масштабирование взаимодействия без настройки или создания шаблонов). 
> [!NOTE]
