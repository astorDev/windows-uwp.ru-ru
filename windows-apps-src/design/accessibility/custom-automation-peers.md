...
* " [**Родители**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.automation.peers.automationpeer.getparent)": вызывает [**FrameworkElement. Parent**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.parent) из владельца и ищет соответствующий одноранговый узел. Эта пара не переопределяется с помощью метода Core, поэтому вы не сможете изменить ее поведение.
