...
* [**Родители**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.automation.peers.automationpeer.getparent): Вызывает [**FrameworkElement. Parent**](https://docs.microsoft.com/uwp/api/windows.ui.xaml.frameworkelement.parent) от владельца и выполняет поиск соответствующего однорангового узла. Эта пара не переопределяется с помощью метода Core, поэтому вы не сможете изменить ее поведение.
