...
Параметры приложения — это настраиваемые пользователем части приложения универсальная платформа Windows (UWP), доступ к которым осуществляется через страницу параметров приложения. Например, приложение для чтения новостей может позволить пользователю указать, какие источники новостей отображать или сколько столбцов отображать на экране, тогда как приложение Weather может позволить пользователю выбрать между градусами Цельсия и Фаренгейта. В этой статье приводятся рекомендации и рекомендации по созданию и отображению параметров приложения.

## <a name="when-to-provide-a-settings-page"></a>Когда следует указывать страницу параметров
...
Команды, являющиеся частью стандартного рабочего процесса приложения (например, изменение размера кисти в графическом приложении), не следует размещать на странице параметров. Подробнее о размещении команд см. в разделе [Основы проектирования команд](https://docs.microsoft.com/windows/uwp/layout/commanding-basics).
...
- Используйте следующие элементы управления для параметров приложения.
    ...
    - [Переключатели](../controls-and-patterns/toggles.md): Значение, чтобы разрешить пользователям устанавливать или выключать значения.
    - [Переключатели](../controls-and-patterns/radio-button.md): Чтобы позволить пользователям выбрать один элемент из набора до 5 взаимоисключающих, связанных параметров.
    - [Поле ввода текста](../controls-and-patterns/text-block.md): , Чтобы позволить пользователям вводить текст. Для поля текстового ввода используйте тип, соответствующий типу текста, который вы ожидаете получить от пользователя, например электронный адрес или пароль.
    - [Гиперссылки](../controls-and-patterns/hyperlinks.md): , Чтобы перевести пользователя на другую страницу в приложении или на внешний веб-сайт. Когда пользователь нажимает на гиперссылку, всплывающий элемент "Параметры" должен закрываться.
    - [Кнопки](../controls-and-patterns/buttons.md): Чтобы позволить пользователям немедленно инициировать действие без закрытия текущего всплывающего окна параметров.
...
- После анимации всплывающего элемента "Параметры" и заголовка анимируйте содержимое и элементы управления как единый блок. Используйте для содержимого анимацию [**enterPage**](https://docs.microsoft.com/previous-versions/windows/apps/br212672(v=win.10)) или [**EntranceThemeTransition**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.EntranceThemeTransition) со смещением влево на 100 пикселей.
...
* [Основы проектирования команд](https://docs.microsoft.com/windows/uwp/layout/commanding-basics)
* [Руководство по элементам управления ходом выполнения](https://docs.microsoft.com/windows/uwp/controls-and-patterns/progress-controls)
* [Хранение и извлечение данных приложения](https://docs.microsoft.com/windows/uwp/app-settings/store-and-retrieve-app-data)
* [**ентранцесеметранситион**](https://docs.microsoft.com/uwp/api/Windows.UI.Xaml.Media.Animation.EntranceThemeTransition)
