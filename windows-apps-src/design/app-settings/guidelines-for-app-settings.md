...
-   Используйте следующие элементы управления для параметров приложения.
    ...
    -   [Переключить коммутаторы](../controls-and-patterns/toggles.md): Чтобы пользователи могли задано значения on или off.
    -   [Переключатели](../controls-and-patterns/radio-button.md): Чтобы позволить пользователям выбрать один элемент из набора до 5 взаимно исключают друг друга, параметры, связанные с.
    -   [Текстовое поле](../controls-and-patterns/text-block.md): Чтобы разрешить пользователям вводить текст. Для поля текстового ввода используйте тип, соответствующий типу текста, который вы ожидаете получить от пользователя, например электронный адрес или пароль.
    -   [Гиперссылки](../controls-and-patterns/hyperlinks.md): Для перевода пользователя на другую страницу в приложении или на внешние веб-сайте. Когда пользователь нажимает на гиперссылку, всплывающий элемент "Параметры" должен закрываться.
    -   [Кнопки](../controls-and-patterns/buttons.md): Чтобы разрешить пользователям инициировать немедленное действие без отключения текущего всплывающее меню параметров.
...
* [Основы проектирования команды](https://docs.microsoft.com/windows/uwp/layout/commanding-basics)
