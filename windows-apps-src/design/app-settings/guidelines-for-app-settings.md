...
* [Основы проектирования команды](https://msdn.microsoft.com/library/windows/apps/dn958433)
* [Руководство по элементам управления ходом выполнения](https://msdn.microsoft.com/library/windows/apps/hh465469)
* [Store и извлечения данных приложения](https://msdn.microsoft.com/library/windows/apps/mt299098)
