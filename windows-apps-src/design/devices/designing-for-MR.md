...
Эти контроллеры обеспечивают естественное и точное взаимодействие с виртуальными объектами. Некоторые взаимодействия вы получаете без дополнительных затрат. Например, жест выделения HoloLens или нажатие клавиши Windows либо триггера контроллера движений приведут к ожидаемому ответу на ввод без написания кода с вашей стороны.
