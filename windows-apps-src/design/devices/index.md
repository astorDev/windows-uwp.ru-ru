...
С помощью Continuum для телефонов, нового интерфейса для совместимых мобильных устройств с Windows10, пользователи могут подключать их телефоны к монитору и даже использовать мышь и клавиатуру, чтобы работать как на ноутбуке. (Дополнительные сведения см. в [статье о Continuum для телефонов](https://go.microsoft.com/fwlink/p/?LinkID=699431).)
