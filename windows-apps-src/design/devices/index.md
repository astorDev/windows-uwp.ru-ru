...
С помощью Continuum для телефонов (новый интерфейс для совместимых мобильных устройств с Windows 10) пользователи могут подключать телефоны к монитору и даже использовать мышь и клавиатуру, чтобы работать как на ноутбуке. (Дополнительные сведения см. в [статье о Continuum для телефонов](https://go.microsoft.com/fwlink/p/?LinkID=699431).)
