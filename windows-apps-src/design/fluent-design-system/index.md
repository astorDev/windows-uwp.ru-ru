...
В дополнение к проектированию нашей системы проектирования Fluent статьи также показано, как написать код, который ваших проектах произойдет. Платформа UWP использует XAML, язык на основе разметки, который облегчает для создания пользовательских интерфейсов. Вот пример.
...
> Если вы не знакомы с разработкой UWP, ознакомьтесь с нашей [Начало работы с UWP страницы](https://developer.microsoft.com/windows/apps/getstarted).
