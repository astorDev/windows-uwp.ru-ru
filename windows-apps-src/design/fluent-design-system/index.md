...
![Заголовок Fluent Design](../images/ficon-2x.png)
...
![Логотип Fluent Design](images/fluentdesign_header.png)
...
> Если вы мало знакомы с разработкой для UWP, перейдите на нашу [страницу материалов для начала работы с UWP](https://developer.microsoft.com/windows/apps/getstarted).
