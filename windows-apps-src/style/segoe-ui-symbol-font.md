...
## Дополнительное рекомендации по использованию
...
Для кнопок перехода назад предусмотрены предыдущие версии глифов двух размеров, так что насыщенность внешнего кольца одинакова при 20pt и 42pt. Также доступны две новые пропорциональные хромированные кнопки перехода назад. Эти глифы разработаны для поддержки наложения.

| Код   | Символ                                                                     | Перечисление                          | Описание                               |
|--------|----------------------------------------------------------------------------|-------------------------------|-------------------------------------------|
| U+E0C4 | ![backbttnarrow20legacy](images/backbttnarrow20legacy.png)                 | BackBttnArrow20Legacy         | Стрелка кнопки перехода назад, 20pt                   |
| U+E0A6 | ![backbttnarrow42legacy](images/backbttnarrow42legacy.png)                 | BackBttnArrow42Legacy         | Стрелка кнопки перехода назад, 42pt                   |
| U+E0AD | ![backbttnmirroredarrow20legacy](images/backbttnmirroredarrow20legacy.png) | BackBttnMirroredArrow20Legacy | Перевернутая стрелка кнопки перехода назад в зеркальном отображении, 20pt |
| U+E0AB | ![backbttnmirroredarrow42legacy](images/backbttnmirroredarrow42legacy.png) | BackBttnMirroredArrow42Legacy | Перевернутая стрелка кнопки перехода назад в зеркальном отображении, 42pt |
...
## Стрелки перехода назад для HTML
...
## Глифы панели приложения AppBar
