...
Объект QueryClipsResponse имеет следующей спецификации.
 
| Участник| Тип| Описание| 
| --- | --- | --- | 
| <b>gameClips</b>| Массив GameClip| Массив игр клипы, которые выполнены запрос вплоть до предела запроса (<b>maxItems</b>).| 
| <b>pagingInfo</b>| PagingInfo| Содержит сведения, необходимые для продолжения и разбиение по страницам для последующих вызовов для списков, превышающие предел запросов (<b>maxItems</b>).| 
