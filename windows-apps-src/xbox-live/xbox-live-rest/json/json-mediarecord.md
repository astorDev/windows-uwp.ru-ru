...
Объект MediaRecord имеет следующей спецификации.
 
| Участник| Тип| Описание| 
| --- | --- | --- | 
| id| Строка| Идентификатор носители, используемые Bing каталога или каталога поставщика.| 
| Тип_идентификатора| Строка| Способ интерпретации идентификатор носителя. Возможные значения включают «bing» и «provider».| 
| name| Строка| Локализованное имя для мультимедийного содержимого.| 
