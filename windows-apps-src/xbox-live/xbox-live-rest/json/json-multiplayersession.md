...
Объект MultiplayerSession JSON имеет следующей спецификации.
...
Структура запроса, связанный с данной спецификации JSON, см. в разделе [MultiplayerSessionRequest (JSON)](json-multiplayersessionrequest.md).  
<a id="ID4EPB"></a>
