...
Перечисляет допустимые значения для заданного запроса уточнения имени и указанного типа носителя элемента. Доменом для таких URI является `eds.xboxlive.com`.
