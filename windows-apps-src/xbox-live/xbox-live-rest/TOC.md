# [Справочник по интерфейсам RESTful служб Xbox Live](atoc-xboxlivews-reference.md)
# [Справочник по идентификаторам URI](uri/atoc-xboxlivews-reference-uris.md)
## [Коды URI достижений](uri/achievements/atoc-reference-achievementsv2.md)
...
## [Коды URI игровых серверов](uri/gsdk/atoc-gsdk-uri-reference.md)
...
## [Коды URI DVR для игр](uri/dvr/atoc-reference-dvr.md)
...
## [Коды URI картинок игрока](uri/gamerpic/atoc-reference-gamerpic.md)
### [/users/me/gamerpic](uri/gamerpic/uri-usersmegamerpic.md)
#### [PUT (/users/me/gamerpic)](uri/gamerpic/uri-usersmegamerpicput.md)
## [Коды URI списков лидеров](uri/leaderboard/atoc-reference-leaderboard.md)
...
## [Коды URI списков](uri/lists/atoc-reference-lists.md)
...
## [Коды URI Marketplace](uri/marketplace/atoc-reference-marketplace.md)
...
## [Коды URI для подбора игроков](uri/matchtickets/atoc-reference-matchtickets.md)
...
## [Коды URI людей](uri/people/atoc-reference-people.md)
...
## [Коды URI сведений о присутствии](uri/presence/atoc-reference-presence.md)
...
## [Коды URI конфиденциальности](uri/privacy/atoc-reference-privacyv2.md)
...
## [Коды URI профилей](uri/profileV2/atoc-reference-profiles.md)
...
## [Коды URI репутации](uri/reputation/atoc-reference-reputation.md)
...
## [Коды URI каталога сеанса](uri/sessiondirectory/atoc-reference-sessiondirectory.md)
...
## [Коды URI журнала достижений в играх](uri/titlehistory/atoc-reference-titlehistoryv2.md)
...
## [Коды URI хранилища игр](uri/storage/atoc-reference-storagev2.md)
...
## [Коды URI проверки строк системы](uri/stringserver/atoc-reference-systemstringsvalidate.md)
...
## [Коды URI пользователей](uri/users/atoc-reference-users.md)
...
## [Коды URI статистики пользователей](uri/userstats/atoc-reference-userstats.md)
...
# [Справочник по объектам JavaScript Object Notation (JSON)](json/atoc-xboxlivews-reference-json.md)
...
## [Перечисление GameClipSource](enums/gvr-enum-gameclipsource.md)
## [Перечисление GameClipState](enums/gvr-enum-gameclipstate.md)
## [Перечисление GameClipType](enums/gvr-enum-gamecliptypes.md)
## [Перечисление GameClipUriType](enums/gvr-enum-gameclipuritype.md)
## [Перечисление GameClipVisibility](enums/gvr-enum-gameclipvisibility.md)
## [Перечисление ThumbnailSource](enums/gvr-enum-thumbnailsource.md)
## [Перечисление ThumbnailType](enums/gvr-enum-thumbnailtype.md)
## [Перечисление PermissionId](enums/privacy-enum-permissionid.md)
# [Дополнительные ссылки](additional/atoc-xboxlivews-reference-additional.md)
## [Типы авторизации](additional/authorizationtypes.md)
## [Обзор типов данных](additional/datatypeoverview.md)
## [Вспомогательные интерфейсы API EDS](additional/eds-apis.md)
## [Авторизация EDS](additional/edsauthorization.md)
## [Общие заголовки EDS](additional/edscommonheaders.md)
## [Параметры EDS](additional/edsparameters.md)
## [Уточнения запросов EDS](additional/edsqueryrefiners.md)
## [Обратный поиск видео в EDS](additional/edsreverselookup.md)
## [Таблицы EDS](additional/edstables.md)
## [Параметры разбивки по страницам](additional/pagingparameters.md)
## [Стандартные заголовки HTTP-запросов и ответов](additional/httpstandardheaders.md)
## [Стандартные коды состояния HTTP](additional/httpstatuscodes.md)
