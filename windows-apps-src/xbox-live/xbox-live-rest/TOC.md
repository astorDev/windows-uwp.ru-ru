# [Справочник по интерфейсам REST служб Xbox Live](atoc-xboxlivews-reference.md)
...
## [Коды URI для поиска сочетаний](uri/matchtickets/atoc-reference-matchtickets.md)
...
## [Вспомогательные API-интерфейсы EDS](additional/eds-apis.md)
