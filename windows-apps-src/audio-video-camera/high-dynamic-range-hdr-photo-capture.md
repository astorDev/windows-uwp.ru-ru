...
> [!IMPORTANT]
> [**OptionalReferencePhotoCaptured** ](https://msdn.microsoft.com/library/windows/apps/mt181392) не возникает на устройствах, поддерживающих оборудования HDR и поэтому не приводят к формированию опорными кадрами. В приложении должны предусматриваться случаи, при которых это событие не возникает.
