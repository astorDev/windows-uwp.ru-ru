...
## Захват фотографий с расширенным динамическим диапазоном (HDR)
...
**Важно!** [**OptionalReferencePhotoCaptured**](https://msdn.microsoft.com/library/windows/apps/mt181392) не вызывается на устройствах, которые поддерживают HDR-оборудование, а потому не создают опорные кадры. В приложении должны предусматриваться случаи, при которых это событие не возникает.
