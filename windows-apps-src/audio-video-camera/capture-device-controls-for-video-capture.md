...
description: В этой статье рассказывается, как можно с помощью элементов управления видеоустройства активировать расширенные сценарии видеозахвата, в том числе видео с расширенным динамическим диапазоном (HDR) и приоритет выдержки.
title: Доступ к элементам управления видеозахватом на устройстве
---

# Доступ к элементам управления видеозахватом на устройстве

\[ Обновлено для приложений UWP в Windows 10. Статьи, касающиеся Windows 8.x, см. в разделе [Архив](http://go.microsoft.com/fwlink/p/?linkid=619132) \]


В этой статье рассказывается, как с помощью элементов управления видеоустройства активировать расширенные сценарии видеозахвата, в том числе видео с расширенным динамическим диапазоном (HDR) и приоритет выдержки.
