...
description: Статья иллюстрирует, как с помощью элементов управления видеоустройства активировать расширенные сценарии видеозахвата (HDR-видео и приоритет выдержки).
