...
description: Класс SystemMediaTransportControls позволяет использовать встроенные в ОС системные элементы управления транспортом мультимедиа и обновлять метаданные.
