...
title: Аппаратное управление цифровыми правами RM
---

# Аппаратное управление цифровыми правами RM
...
Лучший способ определить, какое управление цифровыми правами используется, аппаратное или программное, — это изучить папку C:\Пользователи\<имя_пользователя>\AppData\Local\Packages\<имя_приложения>\\LocalState\\PlayReady\\\*
