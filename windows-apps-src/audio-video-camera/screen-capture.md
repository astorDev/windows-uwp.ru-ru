...
API-интерфейсы в пространстве имен **Windows.Graphics.Capture** требуют использования общую возможность объявлять в манифесте приложения.
