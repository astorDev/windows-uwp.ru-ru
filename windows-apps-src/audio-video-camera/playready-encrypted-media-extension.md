...
-   Обеспечивает получение нескольких лицензий в одном сообщении.
    ...
    Можно либо использовать объект PlayReady с несколькими идентификаторами ключей (Кэйидс), как в Windows 8.1, либо использовать [данные модели расшифровки содержимого (кдмдата)](https://go.microsoft.com/fwlink/p/?LinkID=626819) с несколькими кэйидс.
