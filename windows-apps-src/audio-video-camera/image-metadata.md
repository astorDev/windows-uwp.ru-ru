...
-   Многие свойства метаданных поддерживаются только некоторыми типами изображений. [**GetPropertiesAsync** ](https://msdn.microsoft.com/library/windows/apps/br226250) завершится ошибкой с кодом ошибки 0x88982F41, если один из обязательных свойств не поддерживается для образа, связанный с декодером и 0x88982F81, если изображение не поддерживает метаданные вообще. Используются следующие константы, связанное с этими кодами ошибок WINCODEC\_ERR\_PROPERTYNOTSUPPORTED и WINCODEC\_ERR\_UNSUPPORTEDOPERATION и определяются в файле заголовка winerror.h.
...
-   [**SetPropertiesAsync** ](https://msdn.microsoft.com/library/windows/apps/br226252) завершится ошибкой с кодом ошибки 0x88982F41, если один из обязательных свойств не поддерживаются изображения, связанного с помощью кодировщика.
