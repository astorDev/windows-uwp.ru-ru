...
description: API-интерфейсы в пространстве имен Windows.Media.Editing позволяют быстро разрабатывать приложения для создания композиций из исходных аудио- и видеофайлов.
