...
-   Метод [**AudioGraph.Start**](https://msdn.microsoft.com/library/windows/apps/dn914244) позволяет начать обработку звуковых данных с помощью звукового графа. Метод [**AudioGraph.Stop**](https://msdn.microsoft.com/library/windows/apps/dn914245) позволяет остановить звуковую обработку. Каждый узел графа можно запустить и остановить независимо от того, выполняется ли граф, однако при остановке графа все узлы отключаются. [**ResetAllNodes** ](https://msdn.microsoft.com/library/windows/apps/dn914242) вызывает все узлы в графе, чтобы удалить все данные в буферы аудио.
