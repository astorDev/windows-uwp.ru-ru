...
description: В этом разделе описывается асинхронное программирование в универсальной платформе для Windows (UWP), а также его представление в C#, Microsoft Visual Basic .NET, расширениях компонентов Visual C\+\+ (C\+\+/CX) и JavaScript
---
...
| Visual Basic         | оператор **Async** keyword, **Await** |
| C++/CX               | метод **task** class, **.then**      |
