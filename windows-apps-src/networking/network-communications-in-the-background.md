...
title: Сетевые подключения в фоновом режиме
ms.assetid: 537F8E16-9972-435D-85A5-56D5764D3AC2
---

# Сетевые подключения в фоновом режиме
...
Приложения используют фоновые задачи и два основных механизма для поддержания связи, когда они не находятся на переднем плане: брокер сокетов и триггеры канала управления. Приложения, использующие сокеты, могут делегировать право собственности системному брокеру сокетов, когда они выходят из переднего плана. Затем брокер активирует приложение, когда трафик поступает в сокет, передает право собственности приложению, и приложение обрабатывает входящий трафик.

## Брокер сокетов и SocketActivityTrigger

Если ваше приложение использует соединения [**DatagramSocket**](https://msdn.microsoft.com/library/windows/apps/br241319), [**StreamSocket**](https://msdn.microsoft.com/library/windows/apps/br226882) или [**StreamSocketListener**](https://msdn.microsoft.com/library/windows/apps/br226906), необходимо использовать [**SocketActivityTrigger**](https://msdn.microsoft.com/library/windows/apps/dn806009) и брокер сокетов, чтобы получить уведомление при получении трафика для вашего приложения, когда оно не находится на переднем плане.
...
-   Действия по одноразовой настройке:

    -   Создайте SocketActivityTrigger и зарегистрируйте фоновую задачу для триггера с помощью параметра TaskEntryPoint, настроенного для вашего кода для обработки полученного пакета.
