...
**Примечание** [HttpClient](https://go.microsoft.com/fwlink/p/?linkid=241637) с использованием SSL в настоящее время не поддерживается с помощью функции сетевых триггеров и [**ControlChannelTrigger**](https://msdn.microsoft.com/library/windows/apps/hh701032).
 
