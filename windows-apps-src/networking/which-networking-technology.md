...
Новая функция фоновой передачи данных в Windows10, возможность активировать постобработку после завершения передачи файла, таким образом, вы можете обновить локальные каталоги, активировать другие приложения или уведомить пользователя о завершении загрузки.
