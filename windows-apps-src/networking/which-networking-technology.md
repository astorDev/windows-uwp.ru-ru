...
description: Краткий обзор доступных сетевых технологий для разработчиков приложений UWP с рекомендациями по выбору подходящих для конкретного приложения технологий.
