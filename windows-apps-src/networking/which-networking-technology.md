...
Это новая функция фоновой передачи в Windows 10 — это возможность запускать постобработки, после завершения передачи файла, чтобы обновить локальные каталоги, активируйте другие приложения или уведомлять пользователя, после завершения загрузки.
