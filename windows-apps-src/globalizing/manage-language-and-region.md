---
author: DelfCo
Description: "Управляйте тем, как Windows производит выбор ресурсов пользовательского интерфейса и форматирует элементы пользовательского интерфейса приложения, с помощью различных языковых и региональных параметров, предлагаемых в системе Windows."
...
# <a name="manage-language-and-region"></a>Управление языковыми и региональными параметрами

<link rel="stylesheet" href="https://az835927.vo.msecnd.net/sites/uwp/Resources/css/custom.css">

Управляйте тем, как Windows производит выбор ресурсов пользовательского интерфейса и форматирует элементы пользовательского интерфейса приложения, с помощью различных языковых и региональных параметров, предлагаемых в системе Windows.
...
<li>[**Пространство имен WinJS.Resources**](https://msdn.microsoft.com/library/windows/apps/br229779)</li>
</ul>
</div>
...
Пример приложения, управляющего языковыми и региональными параметрами, приведен в разделе [Ресурсы приложения и пример локализации](http://go.microsoft.com/fwlink/p/?linkid=231501).
...
### <a name="users-can-set-their-language-preferences"></a>Пользователи могут задавать собственные языковые настройки.
...
### <a name="specify-the-supported-languages-in-the-apps-manifest"></a>Укажите поддерживаемые языки в манифесте программы.
...
### <a name="specify-the-default-language"></a>Определите язык по умолчанию.
...
### <a name="qualify-resources-with-their-language"></a>Задайте квалификаторы языка для ресурсов.
...
### <a name="create-the-application-language-list"></a>Создайте список языков приложения.
...
### <a name="set-the-http-accept-language-header"></a>Установите заголовок, определяющий допустимый язык для HTTP.
...
### <a name="use-the-apis-in-the-windowsglobalization-namespace"></a>Используйте API в пространстве имен Windows.Globalization.
