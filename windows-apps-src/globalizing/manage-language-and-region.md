---
description: Управляйте процессом выбора ресурсов интерфейса и форматирования его элементов с помощью различных языковых и региональных параметров Windows.
