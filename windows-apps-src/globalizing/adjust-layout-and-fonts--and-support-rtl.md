...
<dl>
  <dt> <p><b>Вопрос.</b> Задается ли свойство <b>FlowDirection</b> автоматически в зависимости от текущего языка? Например, если выбрать английский язык, будет ли текст отображаться слева направо, а если выбрать арабский, будет ли текст отображаться справа налево?</p></dt>

  <dd><p><b>Ответ.</b> Свойство <b>FlowDirection</b> не учитывает язык. Вы задали <b>FlowDirection</b> для языка, который сейчас отображается. См. пример кода выше.</p></dd> 
  ...
  <dd> <p><b>Ответ.</b> Если вы используете текущие рекомендации, ресурсы не содержат непосредственно направление текста. Вам необходимо определить направление текста для текущего языка. Это можно сделать двумя способами. </p>
