...
5.  Откройте страницу [developer.microsoft.com/xboxactivate](https://developer.microsoft.com/xboxactivate).
...
* Чтобы переключиться в коммерческий режим, откройте раздел **Главная страница разработчика** и перейдите на вкладку **Параметры**. В разделе **Параметры консоли** выберите **Выйти из режима разработчика**. Это приведет к перезапуску консоли в коммерческом режиме.    

  ![Активация. Шаг 13](images/activation-step-13-rs2.png)  
