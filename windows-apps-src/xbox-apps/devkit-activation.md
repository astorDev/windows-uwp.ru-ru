...
5.  [Зарегистрировать учетную запись разработчика приложения в центре партнеров](https://developer.microsoft.com/store/register).  Это первый шаг к публикации игры.

6.  Войдите в [Центр партнеров](https://partner.microsoft.com/dashboard) с допустимым, текущего центра партнеров приложения разработчика учетной записью.  Если вы не видите несколько вариантов в левой панели навигации, или не видите параметр **Создать новое приложение** в разделе « **Обзор** » ниже и активации ссылки _не будут работать_ Убедитесь, что вы полностью зарегистрировали свою учетную запись разработчика приложения из предыдущего шага.

7.  Перейдите к [partner.microsoft.com/xboxconfig/devices](https://partner.microsoft.com/xboxconfig/devices).

8.  Введите код активации, который отображается в приложении Dev Mode Activation. Количество активаций для вашей учетной записи ограничено. После активации режима разработчика центр партнеров укажет, что вы использовали одну из активаций, связанных с вашей учетной записью.
