...
_Dev Home_ — это инструмент в составе комплекта средств разработки Xbox One Development Kit, предназначенный для повышения продуктивности разработчиков. Dev Home предоставляет функциональность для настройки комплекта средств разработки и управления им.
...
#### <a name="snap-mode"></a>Режим прикрепления
...
#### <a name="tool-descriptions"></a>Описания инструментов
...
<br/>
### <a name="managing-the-size-of-the-developer-storage-allocation"></a>Управление размером хранилища разработчика

Чтобы увеличить или уменьшить объем дискового пространства, используемый в качестве хранилища разработчика, выберите пункт **Управление хранилищем разработчика** в главном меню. Измените значение панели **Хранилище разработчика**, затем выберите **Сохранить и перезапустить**, чтобы перезапустить консоль.
...
### <a name="setting-a-hostname-for-the-console"></a>Настройка имени хоста для консоли
...
## <a name="windows-device-portal"></a>Портал Windows Device Portal
...
> [!NOTE]
> Дополнительные сведения о портале WDP см. в разделе [Обзор портала устройств Windows](../debug-test-perf/device-portal.md).
