...
Чтобы определить имя хоста для комплекта средств разработки, перейдите к инструменту "Параметры консоли" и введите имя хоста в поле __Имя хоста__.  
  ...
  > 
              **Примечание**&nbsp;&nbsp;При создании имени хоста уникальность имени не задается принудительно. Старайтесь избегать дублирования имен. Один из способов решения этой задачи— создавать имя хоста на основе имени компьютера разработки, которое, как правило, является уникальным в организации.
...
- [Технологии разработчика Microsoft: портал Windows Device Portal](https://msdn.microsoft.com/windows/uwp/debug-test-perf/device-portal-xbox)
