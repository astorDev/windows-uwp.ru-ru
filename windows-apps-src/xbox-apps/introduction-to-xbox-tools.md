...
> **Примечание**
            &nbsp;&nbsp;В предварительном выпуске для разработчиков при запуске WDP в Dev Home работа среды Dev Home завершается ошибкой после ввода имени пользователя и пароля и нажатия кнопки **Сохранить**.
