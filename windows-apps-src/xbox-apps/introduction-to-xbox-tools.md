...
Пользовательский интерфейс Dev Home разделен на следующие области.
...
> **Примечание** В предварительном выпуске для разработчиков при запуске WDP в Dev Home работа среды Dev Home завершается ошибкой после ввода имени пользователя и пароля и нажатия кнопки **Сохранить**. 
