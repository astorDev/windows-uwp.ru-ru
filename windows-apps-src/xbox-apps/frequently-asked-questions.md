...
### Как прекратить участие в программе для разработчиков?
...
### Я покинул программу для разработчиков с помощью Центра разработки для Windows, но режим разработчика по-прежнему включен. Что делать?
