...
Если у вас больше нет доступа к Xbox One, вы можете отключить в центре партнеров Windows. Дополнительные сведения см. в разделе разделе **деактивация консоли с помощью центра партнеров** в разделе [Один деактивация режима разработчика Xbox](devkit-deactivation.md#deactivate-your-console-using-partner-center) . 

### <a name="i-left-the-developer-program-using-partner-center-but-im-in-still-developer-mode-what-do-i-do"></a>Я с помощью центра партнеров в программе для разработчиков, но я в режим разработчика по-прежнему. Что делать?
