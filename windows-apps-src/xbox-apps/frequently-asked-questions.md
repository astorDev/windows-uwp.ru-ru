...
Если вы больше не доступен на Xbox One, вы можете отключить ее в центре партнеров Windows. Дополнительные сведения см. в разделе **деактивировать вашей консоли, с помощью центра партнеров** статьи [Xbox одного разработчика режим деактивации](devkit-deactivation.md#deactivate-your-console-using-partner-center) раздела. 

### <a name="i-left-the-developer-program-using-partner-center-but-im-in-still-developer-mode-what-do-i-do"></a>Я оставил программы разработчика с помощью центра партнеров, но я по-прежнему режим разработчика. Что делать?
...
Вы можете [публиковать приложения](../publish/index.md) через Центр партнеров, у вас есть [учетную запись разработчика](https://developer.microsoft.com/store/register). Приложения UWP, созданные и протестированные на коммерческих консолях Xbox One, будут проходить такой же процесс проверки и публикации, как и приложения для Windows, с применением дополнительных проверок на соответствие современным стандартам Xbox One.
...
- [Известные проблемы с универсальной платформы Windows в службе Xbox One](known-issues.md)
