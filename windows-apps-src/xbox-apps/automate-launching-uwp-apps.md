...
# Автоматизация запуска приложений UWP для Windows 10
...
Объект Uri содержит методы анализа строки URI в этом формате. Дополнительные сведения см. в разделе [Класс Uri (MSDN)](https://msdn.microsoft.com/en-us/library/windows/apps/windows.foundation.uri.aspx). 
