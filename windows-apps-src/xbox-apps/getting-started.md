...
1.  Установка Visual Studio 2015 с обновлением 3 или Visual Studio 2017.
    ...
    При установке Visual Studio 2015 с обновлением 3, убедитесь, что выбор **Выборочная** Установка и установите **Средства разработки универсальных приложений Windows** , — она не является частью установки по умолчанию. Если вы разработчик на языке C++, обязательно выберите вариант **Выборочная установка** и выберите **C++**.
...
3. Выберите **x64** в раскрывающемся списке слева от кнопки зеленый воспроизведение в верхнем меню.
