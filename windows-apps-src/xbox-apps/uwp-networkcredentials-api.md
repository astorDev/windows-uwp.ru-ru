---
title: Справочник учетных данных API сети портала устройств
...
## <a name="get-existing-credentials"></a>Получение существующие учетные данные

**Запрос**

Вы можете получить список хранимых папки вместе с имя пользователя пользователь, имеющий учетные данные для этого сетевой папке.
...
Код состояния HTTP      | Описание
:------     | :-----
204 | Запрос к учетным данным выполнен успешно.
4XX | Коды ошибок
5XX | Коды ошибок
