...
# Известные проблемы с программой для разработчиков UWP для Xbox
...
**Мы хотим услышать ваши отзывы**, поэтому сообщайте о любых возникающих проблемах на форуме [Разработка приложений для универсальной платформы Windows](https://social.msdn.microsoft.com/Forums/windowsapps/en-US/home?forum=wpdevelop). 
...
## Ограничения памяти для фоновых приложений действуют лишь частично
...
## Заблокированные сетевые порты на Xbox One
