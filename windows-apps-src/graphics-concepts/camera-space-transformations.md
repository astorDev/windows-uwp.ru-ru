...
L<sub>dir</sub> = - нормы (L<sub>dir</sub> \* wvMatrix)

Для точечного освещения и вспышки направление к свету вычисляется следующим образом:

L<sub>dir</sub> = норма (V \* Lₚ), где параметры определены в следующей таблице.
...
| wvMatrix        | Удостоверение      | Матрица 4x4 значений с плавающей запятой           | Составная матрица, содержащая преобразования реального мира и представления |
...
| vMatrix         | Удостоверение      | Матрица 4x4 значений с плавающей запятой           | Матрица, содержащая преобразование представления                      |
