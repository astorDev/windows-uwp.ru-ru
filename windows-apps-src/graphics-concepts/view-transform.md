---
title: Преобразование представления
...
ms.locfileid: "57593589"
---
# <a name="view-transform"></a>Преобразование представления
...
## <a name="span-idsettingupaviewmatrixspanspan-idsettingupaviewmatrixspanspan-idsettingupaviewmatrixspansetting-up-a-view-matrix"></a><span id="Setting_Up_a_View_Matrix"></span><span id="setting_up_a_view_matrix"></span><span id="SETTING_UP_A_VIEW_MATRIX"></span>Настройка матрицу просмотра
