...
keywords: "Настройка функции трафарета глубины"
author: mtoepke
ms.author: mtoepke
ms.date: 02/08/2017
ms.topic: article
...
### <a name="span-idtwosidedstencilspanspan-idtwosidedstencilspanspan-idtwosidedstencilspanspan-idtwo-sided-stencilspantwo-sided-stencil"></a><span id="Two_Sided_Stencil"></span><span id="two_sided_stencil"></span><span id="TWO_SIDED_STENCIL"></span><span id="two-sided-stencil"></span>Двусторонний трафарет
