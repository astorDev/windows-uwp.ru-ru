...
description: Используйте параметры в этом разделе для определения пулов плиток при создании буфера.
...
<span id="Size"></span><span id="size"></span><span id="SIZE"></span>**Размер**  
...
<span id="Supported_Resource_Usage"></span><span id="supported_resource_usage"></span><span id="SUPPORTED_RESOURCE_USAGE"></span>**Использование поддерживаемых ресурсов**  
