...
<tbody>
<tr class="odd">
<td align="left"><p>[Представление буфера констант (CBV)](constant-buffer-view--cbv-.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Представление буфера вершин (VBV) и представление буфера индексов (IBV)](vertex-buffer-view--vbv-.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Представление ресурсов шейдера (SRV) и представление неупорядоченного доступа (UAV)](shader-resource-view--srv-.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Дискретизатор](sampler.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Представление целевого объекта отрисовки (RTV)](render-target-view--rtv-.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Представление трафарета глубины (DSV)](depth-stencil-view--dsv-.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Представление выходного потока (SOV)](stream-output-view--sov-.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Упорядоченное представление средства программной прорисовки (ROV)](rasterizer-ordered-view--rov-.md)</p></td>
