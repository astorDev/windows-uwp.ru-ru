...
**Примечание**    некоторые устройства поддерживают применение нескольких текстур к примитивы за один проход. См. раздел [Наложение текстур](texture-blending.md).
...
[Наложения текстуры](texture-blending.md)
