...
keywords: "Системы координат и геометрия"
...
<tbody>
<tr class="odd">
<td align="left"><p>[Системы координат](coordinate-systems.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Примитивы](primitives.md)</p></td>
<td align="left"><p>Трехмерный <em>примитив</em>— это коллекция вершин, формирующих один трехмерный объект.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[Векторы-нормали граней и вершин](face-and-vertex-normal-vectors.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Прямоугольники](rectangles.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Интерполяция треугольников](triangle-interpolation.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Векторы, вершины и кватернионы](vectors--vertices--and-quaternions.md)</p></td>
