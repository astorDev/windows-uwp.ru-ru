...
<tbody>
<tr class="odd">
<td align="left"><p>[Выборка с ближайших точек](nearest-point-sampling.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Билинейная фильтрация текстур](bilinear-texture-filtering.md)</p></td>
<td align="left"><p><em>При билинейной фильтрации</em> вычисляется взвешенное среднее значение для четырех текселей, наиболее близких к точке выборки. Этот подход к фильтрации — более точный и распространенный, чем выборка с ближайшей точки. Этот подход является эффективным, так как реализован в современном графическом оборудовании.</p></td>
</tr>
<tr class="odd">
<td align="left"><p>[Анизотропная фильтрация текстур](anisotropic-texture-filtering.md)</p></td>
<td align="left"><p><em>Анизотропия</em> — это видимое искажение в текселях трехмерного объекта, поверхность которого находится под углом относительно плоскости экрана. При сопоставлении пикселей анизотропного примитива текселям его форма искажается.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Фильтрация текстур с использованием MIP-карт](texture-filtering-with-mipmaps.md)</p></td>
