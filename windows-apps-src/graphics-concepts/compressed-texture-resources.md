...
keywords: "Ресурсы сжатых текстур"
author: PeterTurcan
ms.author: pettur
ms.date: 02/08/2017
ms.topic: article
...
<tbody>
<tr class="odd">
<td align="left"><p>[Непрозрачные и 1-разрядные альфа-текстуры](opaque-and-1-bit-alpha-textures.md)</p></td>
<td align="left"><p>Формат текстуры BC1 предназначен для непрозрачных текстур и текстур с одним прозрачным цветом.</p></td>
</tr>
<tr class="even">
<td align="left"><p>[Текстуры с альфа-каналами](textures-with-alpha-channels.md)</p></td>
...
<tr class="odd">
<td align="left"><p>[Сжатие блоков](block-compression.md)</p></td>
...
<tr class="even">
<td align="left"><p>[Форматы сжатых текстур](compressed-texture-formats.md)</p></td>
