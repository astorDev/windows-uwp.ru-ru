---
title: Устройства
description: Устройство Direct3D — это компонент Direct3D, выполняющий отрисовку графики. Устройство инкапсулирует и сохраняет состояние отрисовки, выполняет операции преобразования и освещения и растеризует изображение на поверхность.
...
<tr class="even">
<td align="left"><p><a href="windowed-vs--full-screen-mode.md">Оконные и полноэкранном режиме</a></p></td>
...
<tr class="odd">
<td align="left"><p><a href="lost-devices.md">Потерянных устройств</a></p></td>
...
<tr class="even">
<td align="left"><p><a href="swap-chains.md">Цепочкам буферов</a></p></td>
