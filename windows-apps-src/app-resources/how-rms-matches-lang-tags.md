---
Description: В предыдущем разделе (О сопоставлении и выборе ресурсов Системой управления ресурсами) приводится общий обзор сопоставления квалификаторов. В данном разделе основное внимание уделяется сопоставлению языковых тегов.
...
В предыдущем разделе ([О сопоставлении и выборе ресурсов Системой управления ресурсами](how-rms-matches-and-chooses-resources.md)) приводится общий обзор сопоставления квалификаторов. В данном разделе основное внимание уделяется сопоставлению языковых тегов.
...
Механизм оценки использует данные, содержащиеся в реестре подтегов [BCP-47](https://tools.ietf.org/html/bcp47), а также дополнительные источники данных. Он принимает во внимание градиент оценок с различными значениями качества соответствия и из нескольких допустимых вариантов выбирает вариант с наилучшей оценкой соответствия.
...
* [Общие сведения о языках профилей пользователей и языках манифестов приложений](../design/globalizing/manage-language-and-region.md)
* [Составление географических регионов (континентальной части), географических подрегионов и выбранных экономических и других групп](https://unstats.un.org/unsd/methods/m49/m49regin.htm)
