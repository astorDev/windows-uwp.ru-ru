...
Квалификатор образуется путем объединения имени и значения квалификатора. `<qualifier name>-<qualifier value>` — Это формат квалификатора. `contrast-standard` является примером квалификатор.
...
Квалификатор `homeregion` соответствует параметру страны или региона пользователя. Он представляет домашнее расположение пользователя. Его значением может быть любой действительный [тег региона BCP-47](https://go.microsoft.com/fwlink/p/?linkid=227302). то есть любой двухбуквенный код региона **ISO 3166-1 alpha-2** или трехзначный географический код для составных регионов **ISO 3166-1 numeric** (см. [Состав кодов регионов подразделения статистики ООН M49](https://go.microsoft.com/fwlink/p/?linkid=247929)). Коды выбранных экономических и других групп недействительны.

## <a name="language"></a>Язык

Квалификатор `language` соответствует параметру языка интерфейса. Его значением может быть любой действительный [тег языка BCP-47](https://go.microsoft.com/fwlink/p/?linkid=227302). Список языков см. в [реестре подтегов языков IANA](https://go.microsoft.com/fwlink/p/?linkid=227303).
...
Квалификатор `theme` используется для предоставления ресурсов, наиболее соответствующих установленному по умолчанию параметру режима приложения или переопределению приложения с использованием [Application.RequestedTheme](/uwp/api/windows.ui.xaml.application.requestedtheme).
...
* [Действующие пикселей и коэффициент масштабирования](../design/layout/screen-sizes-and-breakpoints-for-responsive-design.md#effective-pixels-and-scale-factor)
...
* [Обнаружение платформы ваше приложение работает](../porting/wpsl-to-uwp-input-and-sensors.md#detecting-the-platform-your-app-is-running-on)
...
* [ООН статистики деления M49 композиции коды регионов](https://go.microsoft.com/fwlink/p/?linkid=247929)
* [Реестр подтегов языка IANA](https://go.microsoft.com/fwlink/p/?linkid=227303)
* [Настройка макета и шрифтов, добавление поддержки написания справа налево](../design/globalizing/adjust-layout-and-fonts--and-support-rtl.md)
