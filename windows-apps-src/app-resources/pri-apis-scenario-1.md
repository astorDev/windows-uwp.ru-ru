...
В этом сценарии мы показали, как использовать [API-интерфейсы индексирования ресурсов пакетов (PRI)](https://docs.microsoft.com/windows/desktop/menurc/pri-indexing-reference) для создания индексатора ресурсов. Мы добавили строковые ресурсы и файлы ресурсов в индексатор ресурсов. Затем мы использовали индексатор ресурсов для созданного двоичного PRI-файла. И, наконец, мы создали дамп PRI-файла в формате XML, чтобы убедиться, что он содержит сведения, которые мы ожидали.
