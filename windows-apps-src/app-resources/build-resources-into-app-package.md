---
Description: Некоторым видам приложений (многоязычные словари, средства перевода и т. д.) необходимо переопределить поведение пакета приложения по умолчанию и встроить ресурсы в пакет приложения, а не в отдельные пакеты ресурсов. В этом разделе объясняется, как это сделать.
title: Создание ресурсов в пакете приложения
template: detail.hbs
ms.date: 11/14/2017
ms.topic: article
