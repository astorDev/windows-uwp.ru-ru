...
Для некоторых квалификаторов, например масштаба и контрастности, всегда есть минимальная степень соответствия. Например кандидатом указанием для «масштаб 100» соответствует контексте «масштабирования-400» в определенной степени небольшой, хотя и не, а также является кандидатом, соответствующих требованиям для «масштаб — 200"или (для идеального) «масштабирования-400».
