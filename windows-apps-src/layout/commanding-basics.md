---
description: Командные элементы приложения UWP — это интерактивные элементы интерфейса, позволяющие пользователю выполнять разнообразные действия.
title: Проектирование команд для приложений универсальной платформы Windows
ms.assetid: 1DB48285-07B7-4952-80EF-02B57D4469F2
label: Основы проектирования команд
шаблон: detail.hbs
---
...
<p>Дополнительные сведения о команде см. в статье [Guidelines for command bar](https://msdn.microsoft.com/library/windows/apps/hh465302).</p></td>
</tr>
<tr class="odd">
...
<p>Подробнее о контекстных меню см. в статье [Guidelines for context menu](https://msdn.microsoft.com/library/windows/apps/hh465308).</p></td>
</tr>
<tr class="even">
...
<p>Диалоговые окна могут отвлекать и должны использоваться только в определенных ситуациях. Подробнее см. в разделе [When to confirm or undo actions](#whentoconfirm).</p></td>
</tr>
<tr class="odd">
...
<p>Всплывающий элемент можно закрыть, нажав на участок экрана за его пределами. Подробнее о всплывающих элементах управления см. в статье [Dialogs, menus, and popups](../controls-and-patterns/dialogs-popups-menus.md).</p></td>
</tr>
</tbody>
</table>
