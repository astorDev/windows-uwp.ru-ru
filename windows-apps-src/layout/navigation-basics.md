...
### <span id="Peer_navigation_elements"></span><span id="peer_navigation_elements"></span><span id="PEER_NAVIGATION_ELEMENTS"></span>Одноранговые элементы навигации
...
![навигация по одноранговым элементам](images/nav/nav-lateralmovement.png)

Для навигации по одноранговым элементам рекомендуется использовать вкладки или панель навигации.
...
<tbody>
<tr class="odd">
<td align="left"><p>[Вкладки и элемент управления "Сводка"](../controls-and-patterns/tabs-pivot.md)</p>
...
<tr class="even">
<td align="left"><p>[Панель навигации](../controls-and-patterns/nav-pane.md)</p>
...
<tbody>
<tr class="odd">
<td align="left"><p>[Центр](../controls-and-patterns/hub.md)</p>
...
<tr class="even">
<td align="left"><p>[Основные и подробные данные](../controls-and-patterns/master-details.md)</p>
...
<td align="left"><p>Позволяет пользователю перемещаться по журналу навигации в приложении и, в зависимости от устройства, из приложения в приложение. Дополнительные сведения см. в разделе [Обеспечьте поддержку функций навигации системного уровня в своем приложении](#backnavigation) далее в этой статье.</p></td>
</tr>
</tbody>
</table>
