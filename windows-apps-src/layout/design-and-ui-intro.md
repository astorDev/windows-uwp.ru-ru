---
Description: В этой статье описываются компоненты, преимущества и требования универсальной платформы Windows (UWP) с точки зрения проектирования. Узнайте, что платформа предоставляет бесплатно и какие средства находятся в вашем распоряжении.
title: Введение в проектирование приложений универсальной платформы Windows (UWP)
ms.assetid: 50A5605E-3A91-41DB-800A-9180717C1E86
label: Введение в проектирование приложений UWP
template: detail.hbs
---
...
-   При разработке вы можете игнорировать плотность пикселей и фактическое разрешение экрана. Выполняйте разработку с учетом эффективного разрешения (разрешения в эффективных пикселях) класса размера (определение классов размеров мы дадим позже в [этой статье](#sizeclasses)).
...
<td align="left"><strong>Элементы навигации</strong>
          <p>Элементы навигации помогают пользователям выбрать то содержимое, которое они хотят отобразить. Примеры элементов навигации включают [tabs and pivots](../controls-and-patterns/tabs-pivot.md), [hyperlinks](../controls-and-patterns/hyperlinks.md) и [nav panes](../controls-and-patterns/nav-pane.md).</p>
<p>Элементы навигации подробно освещаются в статье [Navigation design basics](navigation-basics.md).</p>
<strong>Командные элементы</strong>
          <p>Командные элементы служат для выполнения действий, таких как управление, сохранение или предоставление общего доступа к содержимому. Примеры командных элементов: [button](../controls-and-patterns/buttons.md) и [command bar](../controls-and-patterns/app-bars.md). К командным элементам могут также относиться сочетания клавиш, которые фактически не отображаются на экране.</p>
<p>Командные элементы подробно освещаются в статье [Command design basics](commanding-basics.md).</p>
...
<p>Элементы содержимого подробно освещаются в статье [Content design basics](content-basics.md).</p></td>
</tr>
</tbody>
</table>
...
## <span id="Why_tailor_your_app_for_specific_device_families_and_screen_sizes_"></span><span id="why_tailor_your_app_for_specific_device_families_and_screen_sizes_"></span><span id="WHY_TAILOR_YOUR_APP_FOR_SPECIFIC_DEVICE_FAMILIES_AND_SCREEN_SIZES_"></span>Настройка приложения под конкретные устройства и размеры экранов.
...
## <span id="Responsive_design_techniques"></span><span id="responsive_design_techniques"></span><span id="RESPONSIVE_DESIGN_TECHNIQUES"></span>Методы создания отзывчивого дизайна
...
### <span id="Reposition"></span><span id="reposition"></span><span id="REPOSITION"></span>Изменение положения
...
### <span id="Resize"></span><span id="resize"></span><span id="RESIZE"></span>Изменение размера
...
### <span id="Reflow"></span><span id="reflow"></span><span id="REFLOW"></span>Адаптация
...
### <span id="_____________Reveal___________"></span><span id="_____________reveal___________"></span><span id="_____________REVEAL___________"></span> Отображение
...
### <span id="Replace"></span><span id="replace"></span><span id="REPLACE"></span>Замена
...
### <span id="_____________Re-architect___________"></span><span id="_____________re-architect___________"></span><span id="_____________RE-ARCHITECT___________"></span> Изменение архитектуры
