...
-   [
            ...
            ](https://msdn.microsoft.com/library/windows/apps/hh968021): отвечает за появление созданных визуальных элементов в элементах управления элементами, размещая указанное заполнение вокруг каждого элемента.
-   [
              **TextBlock.Padding**
