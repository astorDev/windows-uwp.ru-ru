...
-   Событие [**LayoutUpdated**](https://msdn.microsoft.com/library/windows/apps/br208722) создается, когда меняется какой-либо аспект макета элемента. Это справедливо не только для панелей. Данное событие определено в классе [**FrameworkElement**](https://msdn.microsoft.com/library/windows/apps/br208706).
