...
Пакет SDK Windows10 запустить средство WinAppDeployCmd из командной строки или файла сценария, нужен лишь. При установке приложения с помощью WinAppDeployCmd.exe, используется.appx/.msix файл или AppxManifest (для свободных файлов) для загрузки неопубликованного приложения на устройство Windows10. Эта команда не устанавливает сертификат, необходимый вашему приложению. Для запуска приложения, устройство Windows10 должен быть в режиме разработчика или уже установлен сертификат.
