...
Обратите внимание, что пакет приложения, файлы, которые не применимы к пользователю не будут установлены (x86 и пакеты немецкого языка). 
