...
Хотя задача HockeyApp позволяет указать путь к файлу символов, рекомендуется включать символы (APPXSYM-файлы) в пакет.
...
Он создает APPXUPLOAD-файл, который можно отправить в Store.
