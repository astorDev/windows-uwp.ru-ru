...
## <a name="set-up-a-continuous-deployment-build-that-submits-a-package-to-the-store"></a>Настройка сборки непрерывного развертывания, которая отправляет пакет в Магазин 
