...
description: Узнайте, как пометить пакеты как обязательные в центре партнеров и написать код для загрузки и установки обновлений пакетов в вашем приложении.
ms.date: 04/04/2018
ms.topic: article
...
1. Войдите [Центр партнеров](https://partner.microsoft.com/dashboard) и перейдите на страницу обзора для вашего приложения.
