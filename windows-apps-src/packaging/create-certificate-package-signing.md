...
> [!NOTE]
> Самозаверяющие сертификаты предназначены только для тестирования. Когда будете готовы к публикации приложения в хранилище или из других мест проведения, переключитесь в сертификат известного преподавателя. Если этого не сделать может привести к невозможности приложения устанавливаются вашим клиентам.
