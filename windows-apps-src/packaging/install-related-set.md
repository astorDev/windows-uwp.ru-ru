...
4.  [Набор инструментов, чтобы создать связанный набор](https://blogs.msdn.microsoft.com/appinstaller/2017/05/12/tooling-to-create-a-related-set/)
5.  [Создание связанного набора и дополнительные пакеты](https://docs.microsoft.com/windows/uwp/packaging/optional-packages)
...
Если основной пакет приложения представляет собой файл appxbundle или .msixbundle, используйте `<MainBundle>` показано ниже. Если пакет основного приложения файл с расширением .appx или .msix, воспользуйтесь `<MainPackage>` вместо `<MainBundle>` во фрагменте кода. 
