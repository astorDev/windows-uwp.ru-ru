...
> [!NOTE]
> Для поддержки этих новых возможностей требуется Установщик приложений версии выше 1.0.12271.0.
...
#### <a name="requirements-for-protocol-activation-scheme"></a>Требования для схемы активации протокола
   - Веб-серверы, поддерживающие запросы диапазона байтов (HTTP/1.1)
   - Пакеты приложений должны размещаться на серверах с поддержкой протокола HTTP/1.1   
