...
Эта структура упаковки создаст файл пакета одной плоскими приложения с помощью x x64 пакет архитектуры и пакетом активов «Мультимедиа». 
