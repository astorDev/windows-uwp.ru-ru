...
- **Пакет приложения (AppX или .msix)**  
    Файл, содержащий ваше приложение в формате, который можно загрузить неопубликованным на ваше устройство. Любой файл пакета одного приложения, созданные с помощью Visual Studio, **не** предназначенного для отправки в центр разработки и должен использоваться для загрузки неопубликованных приложений и тестирования только. Если требуется отправить приложение в Центр разработки, воспользуйтесь файлом отправки пакета приложения.  
