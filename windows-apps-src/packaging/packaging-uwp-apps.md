...
В Windows 10 вы можете отправить пакет приложения, пакет приложений или файл отправки пакета готового приложения в центре разработки для Windows. Самым удобным из этих вариантов является отправка файла отправки пакета. 

## <a name="types-of-app-packages"></a>Типы пакетов приложений

- **Пакет приложения (AppX или .msix)**  
    Файл, содержащий ваше приложение в формате, который можно загрузить неопубликованным на ваше устройство. Любой файл пакета одного приложения, созданные с помощью Visual Studio, **не** предназначен для отправки в центр разработки и должен использоваться для загрузки неопубликованных приложений и тестирования только в качестве примера. Если требуется отправить приложение в Центр разработки, воспользуйтесь файлом отправки пакета приложения.  
