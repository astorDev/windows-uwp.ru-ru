...
3.  Выберите "Да" в первом диалоговое окно с запросом, если вы хотите выполнить сборку пакетов для отправки в центр партнеров, а затем нажмите кнопку Далее.  
