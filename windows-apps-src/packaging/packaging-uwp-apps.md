...
После выполнения вышеперечисленных действий ваше приложение будет готово к распространению. Если у вас есть бизнес-приложения (LOB), которое предназначено не для продажи, для внутреннего, вы можете отправлять установить на любом устройстве с Windows10.
