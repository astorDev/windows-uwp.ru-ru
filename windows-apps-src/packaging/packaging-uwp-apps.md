...
-   Для загрузки неопубликованного приложения на Windows10 мобильное устройство с использовать средства [WinAppDeployCmd.exe](install-universal-windows-apps-with-the-winappdeploycmd-tool.md) .
