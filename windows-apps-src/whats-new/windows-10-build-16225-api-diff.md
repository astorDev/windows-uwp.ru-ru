---
author: QuinnRadich
title: "Изменения API Windows 10 (сборка 16225)"
description: "Разработчики могут использовать следующий список для определения новых или измененных пространств имен в предварительной сборке Windows10 SDK (сборка16190)"
keywords: "что нового, новые возможности, обновление, тестовый, тестируемые возможности, API, 16225"
ms.author: quradic
ms.date: 7/6/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16225"></a>Новые API в предварительной сборке Windows 10 SDK (сборка 16225)

Новые и обновленные пространства имен API, которые стали доступными для [участников программы предварительной оценки Windows](https://insider.windows.com/) в предварительной сборке Windows10 SDK (сборка 16225).

Ниже приведен полный список документации для предварительного выпуска, опубликованной для пространств имен, добавленных или измененных с момента последнего публичного выпуска Windows10 [версии1703](windows-10-version-1703-api-diff.md). **Обратите внимание, что документация по предварительным выпускам может быть неполной и меняться, эти API могут быть переименованы или удалены в последующих сборках.**
