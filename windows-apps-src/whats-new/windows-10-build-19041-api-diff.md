---
title: Изменения API Windows 10 (сборка 19041)
description: Разработчики могут использовать следующий список для определения новых или измененных пространств имен в Windows 10 сборки 19041
...
ms.locfileid: "83342876"
---
# <a name="new-apis-in-windows-10-build-19041"></a>Новые API в Windows 10 (сборка 19041)

В Windows 10 сборки 19041, также известной как пакет SDK версии 2004, доступны новые и обновленные пространства имен API. Ниже приведен полный список документации, опубликованной для пространств имен, которые были добавлены или изменены в этом выпуске.

Сведения об API, добавленных в предыдущем официальном выпуске, см. в статье [New APIs in Windows 10 build 17763](windows-10-build-18362-api-diff.md) (Новые API в WIndows 10 сборки 17763).
...
#### <a name="language"></a>[Язык](https://docs.microsoft.com/uwp/api/windows.globalization.language)
