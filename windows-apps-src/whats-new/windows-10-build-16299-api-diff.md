...
#### <a name="corewindowhttpsdocsmicrosoftcomuwpapiwindowsuicorecorewindow"></a>[Объект corewindow](https://docs.microsoft.com/uwp/api/windows.ui.core.corewindow)
...
#### <a name="comboboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscombobox"></a>[поле со списком](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.combobox)
...
#### <a name="controlhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscontrol"></a>[Элемент управления](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### <a name="blockhttpsdocsmicrosoftcomuwpapiwindowsuixamldocumentsblock"></a>[Блок](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)
