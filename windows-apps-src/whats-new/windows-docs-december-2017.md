---
title: Что нового в документации Windows в декабре 2017 г. — разработка приложений UWP
description: Новые возможности, видео и руководства для разработчиков добавлены в документацию для разработчиков Windows 10 в декабре 2017 г.
...
ms.locfileid: "57645319"
---
# <a name="whats-new-in-the-windows-developer-docs-in-december-2017"></a>Что нового в документации для разработчиков Windows в декабре 2017 г.
...
### <a name="windows-mixed-reality-enthusiasts-guide"></a>Смешанная реальность в Windows: Руководство по кого
...
![Совместная работа Майкрософт в центре партнеров](images/microsoft_collaborate_screenshot.PNG)
...
Теперь всем разработчикам, которые присоединились к программе предварительной оценки центра разработки можно использовать надстройки подписки продавать цифровых продуктов в свое приложение приложения (например, функции приложений или цифрового содержимого) с автоматических повторяющихся расчетных периодов. Дополнительные сведения см. в разделе [Включение надстроек с подпиской для вашего приложения](../monetize/enable-subscription-add-ons-for-your-app.md).

## <a name="developer-guidance"></a>Руководство для разработчиков

### <a name="color"></a>Цвет

Мы добавили новые рекомендации по использованию цвета в приложениях для оптимального взаимодействия с пользователем. Они включают сценарии использования API, а также общие рекомендации по проектированию пользовательского интерфейса и специальных возможностей. Мы также обновили список цветов элементов пользователя, доступных на консоли Xbox. [Ознакомьтесь с обновленной статье цвет.](../design/style/color.md)
