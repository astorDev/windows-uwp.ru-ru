...
ms.locfileid: "5516342"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Новые API в Windows 10 сборки 17763

Новые и обновленные API для пространств имен, которые стали доступны для разработчиков в Windows 10 сборки 17763 (также известной как 2018 года октября Update или версия 1809). Ниже приведен полный список документации, опубликованной для пространств имен, которые были добавлены или изменены в этом выпуске.
...
#### [<a name="clipboard"></a>Буфер обмена](https://docs.microsoft.com/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### [<a name="compositionobject"></a>CompositionObject (Объект композиции)](https://docs.microsoft.com/uwp/api/windows.ui.composition.compositionobject)
...
#### [<a name="compositor"></a>Компоновщик](https://docs.microsoft.com/uwp/api/windows.ui.composition.compositor)
...
#### [<a name="autosuggestbox"></a>Элемент управления AutoSuggestBox](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.autosuggestbox)
...
#### [<a name="border"></a>Рамка](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### [<a name="control"></a>Элемент управления](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### [<a name="frame"></a>Кадр](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
#### [<a name="menubar"></a>В строке](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.menubar)

В строке <br> MenuBar.Items <br> MenuBar.ItemsProperty <br> В строке. #ctor
...
#### [<a name="panel"></a>Панель](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
#### [<a name="richeditbox"></a>Элемент управления RichEditBox](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.richeditbox)
...
#### [<a name="treeview"></a>TreeView (иерархическое представление)](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.treeview)
