---
title: Изменения API 17763 сборки Windows 10
description: Разработчики могут использовать перечисленные ниже, чтобы определить новые или измененные пространств имен в Windows 10 сборки 17763
keywords: новые возможности, что новые, обновления, Windows 10, новые, API-интерфейсы, 17763, октябрь
ms.date: 10/02/2018
ms.topic: article
...
ms.locfileid: "57596329"
---
# <a name="new-apis-in-windows-10-build-17763"></a>Новые интерфейсы API в Windows 10 сборки 17763

Новые и обновленные пространства имен API были выпущены для разработчиков в Windows 10 сборки 17763 (также известный как октября 2018 г. обновление или версия 1809). Ниже приведен полный список документации, опубликованной для пространств имен, которые были добавлены или изменены в этом выпуске.

Сведения о API, добавленных в предыдущем выпуске общедоступной, см. в разделе [новые интерфейсы API в обновлении Windows 10 апреля](windows-10-build-17134-api-diff.md).
...
#### <a name="clipboardhttpsdocsmicrosoftcomuwpapiwindowsapplicationmodeldatatransferclipboard"></a>[Буфер обмена](https://docs.microsoft.com/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="packagehttpsdocsmicrosoftcomuwpapiwindowsapplicationmodelpackage"></a>[Пакет](https://docs.microsoft.com/uwp/api/windows.applicationmodel.package)
...
#### <a name="displaypathhttpsdocsmicrosoftcomuwpapiwindowsdevicesdisplaycoredisplaypath"></a>[Отображаемый путь|показ пути](https://docs.microsoft.com/uwp/api/windows.devices.display.core.displaypath)
...
## <a name="windowsmedia"></a>Пространстве
...
#### <a name="launcherhttpsdocsmicrosoftcomuwpapiwindowssystemlauncher"></a>[Средство запуска](https://docs.microsoft.com/uwp/api/windows.system.launcher)
...
#### <a name="compositorhttpsdocsmicrosoftcomuwpapiwindowsuicompositioncompositor"></a>[Компоновщик](https://docs.microsoft.com/uwp/api/windows.ui.composition.compositor)
...
#### <a name="borderhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsborder"></a>[Границы](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### <a name="controlhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolscontrol"></a>[Управление](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.control)
...
#### <a name="datepickerhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsdatepicker"></a>[Выбор даты](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.datepicker)
...
#### <a name="gridhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolsgrid"></a>[Сетка](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.grid)
...
#### <a name="panelhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolspanel"></a>[Панель](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.panel)
...
#### <a name="tooltiphttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstooltip"></a>[Подсказка](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
...
#### <a name="brushhttpsdocsmicrosoftcomuwpapiwindowsuixamlmediabrush"></a>[Кисть](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
