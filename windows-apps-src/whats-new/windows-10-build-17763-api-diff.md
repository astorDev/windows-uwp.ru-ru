...
#### [<a name="border"></a>границы](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.border)
...
#### [<a name="frame"></a>кадров](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.frame)
...
в строке <br> MenuBar.Items <br> MenuBar.itemsproperty <br> MenuBar.MenuBar
...
#### [<a name="tooltip"></a>подсказка](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.tooltip)
...
#### [<a name="brush"></a>кисть](https://docs.microsoft.com/uwp/api/windows.ui.xaml.media.brush)
