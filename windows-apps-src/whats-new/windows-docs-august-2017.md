...
Используйте новое расширение [Windows Template Studio](https://aka.ms/wtsinstall) для Visual Studio 2019, чтобы быстро создать приложение UWP с нужными страницами, платформой и функциями. Расширение, выполняющее функции мастера, с помощью проверенных способов существенно упрощает и ускоряет добавление функциональных возможностей в приложение.
