...
Используйте новое расширение [Windows Template Studio](https://aka.ms/wtsinstall) для Visual Studio 2017, чтобы быстро создать приложение UWP с нужными страницами, платформой и функциями. Расширение, выполняющее функции мастера, с помощью проверенных способов существенно упрощает и ускоряет добавление функциональных возможностей в приложение.
...
Из [руководства для разработчиков Xbox Live](https://docs.microsoft.com/en-us/windows/uwp/xbox-live/) вы узнаете, как использовать API Xbox Live для подключения игры к социальной игровой сети Xbox Live.

С помощью [программы Xbox Live Creators Program](https://docs.microsoft.com/en-us/windows/uwp/xbox-live/get-started-with-creators/get-started-with-xbox-live-creators) любой разработчик игр UWP сможет разработать и опубликовать игру с поддержкой Xbox Live как для ПК, так и для Xbox One.

См. сведения о программах и функциях, доступных разработчикам Xbox Live, в разделе с [обзором программ для разработчиков Xbox Live](https://docs.microsoft.com/en-us/windows/uwp/xbox-live/developer-program-overview).
...
В [этом видео](https://channel9.msdn.com/Blogs/One-Dev-Minute/Getting-Started-with-Windows-Template-Studio) дан более обстоятельный обзор Windows Template Studio. Когда решите приступить к работе, [установите расширение](https://aka.ms/wtsinstall) или [просмотрите исходный код и документацию](https://aka.ms/wtsinstall).