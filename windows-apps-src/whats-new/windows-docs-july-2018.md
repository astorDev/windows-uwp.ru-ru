...
) Объясняется, что WebVR, почему их следует использовать и как приступим к разработке для него.
...
* [WebVR руководства разработчика (начальная страница)](https://docs.microsoft.com/microsoft-edge/webvr/): обновленный внешний вид и больших изображений и значков и новые демонстрационное.
