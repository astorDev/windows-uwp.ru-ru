...
[Прогрессивные веб-приложения (PWA)](https://developer.microsoft.com/windows/pwa) — это просто веб-приложений, [постепенно расширенный](https://wikipedia.org/wiki/Progressive_enhancement) с собственные функции подобного приложения с поддержкой платформ и движков браузера, например запуск из homescreen установки, автономную поддержку и Push-уведомлений уведомления. В Windows 10 с помощью модуля Microsoft Edge (EdgeHTML), PWA хотят преимущество запуск [независимо от окно браузера, как приложения UWP.](https://docs.microsoft.com/microsoft-edge/progressive-web-apps/windows-features)
...
Доступно в Windows 10 Insider Preview сборки 17713, ["Блокнот" был обновлен с множество новых функций](http://aka.ms/ant-man). Масштабирование, обтеканием найти и заменить и поддержка окончания строк Unix/Linux (перевод строки) и Mac (CR) теперь доступны участникам [Программы предварительной оценки](https://insider.windows.com/). 
...
Мы добавили несколько новых разделов [WebVR документации](https://docs.microsoft.com/microsoft-edge/webvr/
):
...
* [WebVR руководство разработчика (начальная страница)](https://docs.microsoft.com/microsoft-edge/webvr/): обновленный внешний вид и с больших изображений и значков и новая Демонстрация.
...
* [Почему не позволяют разработчикам изменение звукового устройства по умолчанию?](https://www.youtube.com/watch?v=6aNUoVfbnmg&feature=youtu.be)
