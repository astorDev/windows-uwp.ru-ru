...
description: Разработчики могут использовать следующий список для определения новых или измененных пространств имен в Windows 10 сборки 17134
...
ms.locfileid: "57592449"
---
# <a name="new-apis-in-windows-10-build-17134"></a>Новые API в Windows 10 сборки 17134

В Windows 10 сборки 17134, также известной как April Update или версия 1803, доступны новые и обновленные API для пространств имен. Ниже приведен полный список документации, опубликованной для пространств имен, которые были добавлены или изменены в этом выпуске.
...
#### <a name="languagehttpsdocsmicrosoftcomuwpapiwindowsglobalizationlanguage"></a>[язык](https://docs.microsoft.com/uwp/api/windows.globalization.language)
...
### <a name="windowsmediahttpsdocsmicrosoftcomuwpapiwindowsmedia"></a>[пространстве](https://docs.microsoft.com/uwp/api/windows.media)
...
#### <a name="textboxhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolstextbox"></a>[Текстовое поле](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.textbox)
...
#### <a name="webviewhttpsdocsmicrosoftcomuwpapiwindowsuixamlcontrolswebview"></a>[веб-представления](https://docs.microsoft.com/uwp/api/windows.ui.xaml.controls.webview)
