---
author: QuinnRadich
title: "Изменения API Windows 10 (сборка 16190)"
description: "Разработчики могут использовать следующий список для определения новых или измененных пространств имен в SDK Preview Windows10 (сборка16190)"
keywords: "что нового, новые возможности, обновление, тестовый, тестируемые возможности, API, 15021"
ms.author: quradic
ms.date: 5/11/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16190"></a>Новые API в SDK Preview Windows 10 (сборка 16190)

Новые и обновленные пространства имен API, которые стали доступными для [участников программы предварительной оценки Windows](https://insider.windows.com/) в SDK Preview Windows10 (сборка 16190). Этот выпуск сопровождает [конференцию разработчиков MicrosoftBuild2017](https://developer.microsoft.com/windows/projects/events/build/2017?ocid=wdgbld17_intreferral_devcenterhp_null_null_devcenter_hppost&utm_campaign=wdgbld17&utm_medium=internalreferral&utm_source=devcenterhp&utm_content=devcenter_hppost).

Ниже приведен полный список документации для предварительного выпуска, опубликованной для пространств имен, добавленных или измененных с момента последнего публичного выпуска Windows10 [версии1703](windows-10-version-1703-api-diff.md). Обратите внимание, что документация к предварительному выпуску может быть неполной и может быть изменена.
