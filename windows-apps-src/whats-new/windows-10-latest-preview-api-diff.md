---
author: QuinnRadich
title: "Изменения API Windows 10 (сборка 16257)"
description: "Разработчики могут использовать следующий список для определения новых или измененных пространств имен в текущей предварительной сборке Windows10 SDK"
keywords: "что нового, новые возможности, обновление, тестовый, тестируемые возможности, API, 16257"
ms.author: quradic
ms.date: 8/17/2017
ms.topic: article
ms.prod: windows
...
---
# <a name="new-apis-in-the-windows-10-sdk-preview-build-16257"></a>Новые API в предварительной сборке Windows10 SDK (сборка 16257)

Новые и обновленные пространства имен API, которые стали доступными для [участников программы предварительной оценки Windows](https://insider.windows.com/) в предварительной сборке Windows10 SDK (сборка 16257).

Ниже приведен полный список документации для предварительного выпуска, опубликованной для пространств имен, добавленных с момента последнего публичного выпуска Windows10 [версии1703](windows-10-version-1703-api-diff.md). **Обратите внимание, что документация по предварительным выпускам может быть неполной и меняться, эти API могут быть переименованы или удалены в последующих сборках.** Также прилагается список пространств имен API, измененных или переименованных с момента выпуска предыдущих предварительных сборок SDK.
...
#### [<a name="magnetometer"></a>магнитометр](https://docs.microsoft.com/uwp/api/windows.devices.sensors.magnetometer)
...
#### [<a name="block"></a>текста](https://docs.microsoft.com/uwp/api/windows.ui.xaml.documents.block)
...
## <a name="apis-changed-or-removed-since-build-16232"></a>API, измененные или удаленные с момента выхода сборки 16232

Следующие API-интерфейсы стали доступны в сборке 16232 или ранее, однако теперь отсутствуют в этой сборке. Они были переименованы или полностью удалены, документация по ним более не предоставляется.
...
## <a name="apis-changed-or-removed-since-build-16225"></a>API, измененные или удаленные с момента выхода сборки 16225

Следующие API-интерфейсы стали доступны в сборке 16225 или ранее, однако теперь отсутствуют в этой сборке. Они были переименованы или полностью удалены, документация по ним более не предоставляется.
