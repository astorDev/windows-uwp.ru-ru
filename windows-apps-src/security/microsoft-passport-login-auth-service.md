...
-   Так как вы будете использовать Ауссервице при удалении учетной записи, ссылка на Аккаунселпер на кнопке\_забыть\_пользователь\_щелчок метода может быть удалена. Метод должен выглядеть следующим образом.
