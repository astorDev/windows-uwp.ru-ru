...
> **Примечание**  сведения, представленные в этом разделе даны некоторые рекомендации, но вы должны самостоятельно, как разработчик приложения, который публикации приложений в Microsoft Store, чтобы убедиться в том, что приложение соответствует всем применимым законам и нормативам.

 

Подробнее о министерстве торговли США и управлении промышленности и безопасности см. в разделе [Об управлении промышленности и безопасности](https://go.microsoft.com/fwlink/p/?LinkID=245644).

Сведения о Правилах экспортного управления (EAR), которые регулируют экспорт технологий, содержащих средства шифрования, см. в статье [Директивы EAR для объектов, использующих шифрование](https://go.microsoft.com/fwlink/p/?LinkID=245645).
...
> **Важные**  учитывать не только код, созданный для приложения, но также все программное обеспечение библиотеки, служебные программы и компоненты операционной системы, которые приложение включает в себя или ссылки на.
...
Полный актуальный перечень приложений для шифрования см. в статье [Директивы EAR для объектов, использующих шифрование](https://go.microsoft.com/fwlink/p/?LinkID=245645).
...
Если у вас нет ECCN, см. статью [Вопросы и ответы по ECCN](https://go.microsoft.com/fwlink/p/?LinkID=245646).
