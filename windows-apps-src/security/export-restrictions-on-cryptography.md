...
> **Примечание**приведены некоторые рекомендации, но это длительные операции, как разработчик, публикующий приложения в магазине Майкрософт убедитесь, что ваше приложение соответствует требованиям всех применимых законов и нормативных актов.
