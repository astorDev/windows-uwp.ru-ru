...
## <a name="create-a-windows-store-app-that-uses-certificate-authentication"></a>Создание приложения Магазина Windows, использующего проверку подлинности сертификата
