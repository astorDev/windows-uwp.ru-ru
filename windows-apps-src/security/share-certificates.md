...
## Включение служб Microsoft IIS сопоставление сертификатов клиентов
...
## Настройка веб-службы на использование проверки подлинности сертификата клиента
...
7.  Вы можете проверить правильность настройки веб-службы, открыв браузер и введя следующий веб-адрес: https://&lt;server-name&gt;.&lt;domain-name&gt;/FirstContosoBank/Service1.asmx. Например, https://myserver.example.com/FirstContosoBank/Service1.asmx. Если ваша веб-служба настроена правильно, вы получите предложение выбрать сертификат клиента, чтобы получить доступ к веб-службе.
...
## Создание приложения Магазина Windows, использующего проверку подлинности сертификата
...
**Совет.** Можно использовать makecert.exe, чтобы создать PFX-файл для использования с данным кратким руководством. Подробнее об использовании makecert.exe см. в разделе [MakeCert](https://msdn.microsoft.com/library/windows/desktop/aa386968).
