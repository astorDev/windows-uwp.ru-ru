...
**Совет**  makecert.exe можно использовать для создания PFX-файл для использования с этим кратким руководством. Подробнее об использовании makecert.exe см. в разделе [MakeCert](https://docs.microsoft.com/windows/desktop/SecCrypto/makecert).
