...
**Разработчики**, которые хотят получить доступ к этим API, могут отправить соответствующие запросы посредством портала разработчиков. Он может либо сразу предоставить доступ, либо потребовать утверждения издателя или администратора. Разработчики могут также просмотреть документацию API и пример кода на портале разработчиков, чтобы быстро принять API, предложенные веб-службой.
