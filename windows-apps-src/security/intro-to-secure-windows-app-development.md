...
Дополнительные сведения о Windows Hello см. в разделе [Руководство по Windows Hello](https://docs.microsoft.com/windows/keep-secure/microsoft-passport-guide) и [Руководство по Windows Hello для разработчиков](microsoft-passport.md).
