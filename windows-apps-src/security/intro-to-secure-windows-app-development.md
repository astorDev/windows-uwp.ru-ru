...
## 2.1.1. Брокер веб-проверки подлинности
...
## 2.4 Microsoft Passport и Windows Hello
...
## 3. Методы безопасности для данных в процессе передачи
...
## 3.1 Проверка подлинности удаленной системой
...
## 3.3 Публикация и обеспечение безопасного доступа к API REST
...
## 4. Методы безопасности для данных в состоянии покоя
...
## 4.1 Модель приложения для Windows
...
## 4.2 Защита сохраненных учетных данных
...
## 4.3 Выявление несанкционированных изменений сообщений (коды проверки подлинности сообщения (MAC), хэши и подписи)
