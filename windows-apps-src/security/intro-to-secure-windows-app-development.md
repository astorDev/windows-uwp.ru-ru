...
-   [Средство выбора учетных данных](https://github.com/Microsoft/Windows-universal-samples/blob/master/Samples/CredentialPicker)
-   [Блокировка устройства с помощью входа в Azure](https://github.com/Microsoft/Windows-universal-samples/blob/master/Samples/DeviceLockdownAzureLogin)
...
-   [Управление учетными записями Web](https://github.com/Microsoft/Windows-universal-samples/blob/master/Samples/WebAccountManagement)
