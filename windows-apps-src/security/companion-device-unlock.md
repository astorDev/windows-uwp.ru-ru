...
---
# Разблокировка Windows с помощью устройств-компаньонов (IoT) для Windows Hello
...
### Регистрация и дальнейшая связь между компьютером и устройствами-компаньонами Windows Hello
...
### Обнаружение, установка и первоначальная регистрация приложения устройства-компаньона Windows Hello
...
### Поставщик учетных данных для устройств-компаньонов Windows Hello
...
### Одна регистрация для повсеместного использования
...
## Модель API платформы сопутствующих устройств Windows Hello
...
| StoppingAuthentication        | Проверка подлинности пройдена успешно и пользователь увидел рабочий стол. Пора завершить фоновую задачу.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
