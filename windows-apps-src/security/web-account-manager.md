...
## <a name="show-the-accountsettingspane"></a>Отображение AccountSettingsPane
...
Поставщики услуг предоставляют документацию, описывающую области, которые необходимо указать для получения токенов, которые будут использоваться с их службой. 
...
* Сведения о OneDrive см. в разделе [Аутентификация OneDrive и вход в систему](https://dev.onedrive.com/auth/msa_oauth.htm#authentication-scopes). 
...
## <a name="save-account-state"></a>Сохранение состояния учетной записи
...
## <a name="log-out-an-account"></a>Выход из учетной записи 
