...
Если пользователь хочет получить доступ к материалу, защищенному ключом, процесс проверки подлинности начинается с ввода пользователем PIN-кода или биометрического жеста для разблокировки устройства. Этот процесс иногда называют "освобождением ключа".
