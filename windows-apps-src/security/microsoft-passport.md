...
Полный пример кода см. в [образце кода Windows Hello на GitHub](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/MicrosoftPassport).
...
- [Общие сведения о Windows Hello](https://support.microsoft.com/help/17215)
- [Сведения о реализации Windows Hello](https://docs.microsoft.com/windows/keep-secure/microsoft-passport-guide)
- [Пример кода Windows Hello на GitHub](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/MicrosoftPassport)
