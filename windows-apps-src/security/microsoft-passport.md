...
- [Обзор Windows Hello](https://windows.microsoft.com/windows-10/getstarted-what-is-hello)
- [Сведения о реализации для Windows Hello](https://technet.microsoft.com/itpro/windows/keep-secure/microsoft-passport-guide)
