...
# Создание приложение для входа с использованием Microsoft Passport
...
-   Откройте Visual Studio2015 и выберите «Файл > Создать > Проект».
...
## Упражнение 2. Страницы приветствия и выбора пользователя
...
## Упражнение 3. Регистрация нового пользователя Passport
...
* [MicrosoftPassport и WindowsHello](microsoft-passport.md)
