...
ms.locfileid: "57627459"
---
# <a name="get-the-stack-trace-for-an-error-in-your-app"></a>Получение трассировки стека при возникновении ошибки в приложении

Используйте этот метод в API аналитики для Microsoft Store, чтобы получить трассировку стека при возникновении ошибки в приложении. Этот метод позволяет скачать трассировку стека только для ошибок приложения, возникших за последние 30 дней. Трассировки стека, также доступны в **сбоев** раздел [отчет о работоспособности](../publish/health-report.md) в центре партнеров.
...
|---------------|--------|---------------|------|
| applicationId | Строка | Код продукта в Магазине для приложения, по которому требуется получить трассировку стека. Идентификатор Store можно найти в [страницу удостоверения](../publish/view-app-identity-details.md) в центре партнеров. Пример кода продукта в Магазине: 9WZDNCRFJ3Q8. |  Да  |
