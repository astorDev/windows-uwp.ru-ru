...
description: Используйте этот метод в API аналитики для Microsoft Store для получения ежедневных данные об использовании приложений в заданном диапазоне дат и других дополнительных фильтров.
title: Получение ежедневных использование приложений
ms.author: mhopkins
ms.date: 08/15/2018
ms.topic: article
ms.prod: windows
