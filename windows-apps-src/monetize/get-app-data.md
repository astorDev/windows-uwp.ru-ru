...
Используйте следующие методы API отправки Магазина Windows, чтобы получить данные для ваших приложений. Вводные сведения об API отправки Магазина Windows см. в разделе [Создание отправок и управление ими с помощью служб Магазина Windows](create-and-manage-submissions-using-windows-store-services.md).
