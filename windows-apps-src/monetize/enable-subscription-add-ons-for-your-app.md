...
* Пользователи могут управлять своей подпиской на странице [https://account.microsoft.com/services](https://account.microsoft.com/services) своей учетной записи Майкрософт. Пользователи могут использовать эту страницу для просмотра всех приобретенных подписок, отмены подписки и изменения способа оплаты, связанного с подпиской.
...
1. [Создайте надстройку отправки](../publish/add-on-submissions.md) для вашей подписки в центре партнеров и публикация отправки. При выполнении процесса отправки надстройки обратите особое внимание на следующие свойства.

    * [Тип продукта](../publish/set-your-add-on-product-id.md#product-type): Обязательно выберите **подписки**.

    * [Период подписки](../publish/enter-add-on-properties.md#subscription-period): Выберите повторяющихся период выставления счетов для вашей подписки. Изменить периодичность подписки после публикации надстройки невозможно.
    ...
    * [Пробный период](../publish/enter-add-on-properties.md#free-trial): Попробуйте выбрать 1 неделя или 1 месяц пробного периода для вашей подписки, чтобы пользователи могли попробовать содержимое подписки, прежде чем покупать его. Изменить или удалить пробный период после публикации надстройки с подпиской невозможно.
    ...
    * [Видимость](../publish/set-add-on-pricing-and-availability.md#visibility): Если вы создаете надстройка тестирования, которая будет использоваться для проверки возможности покупки в приложении для своей подписки, рекомендуется выбирать один из **скрыты в Store** параметры. В противном случае можно выбрать оптимальную для вашего сценария видимость.

    * [Цены на](../publish/set-add-on-pricing-and-availability.md?#pricing): Выберите цену на подписку в этом разделе. Повысить стоимость подписки после публикации надстройки невозможно. Однако можно в дальнейшем снизить стоимость.
        > [!IMPORTANT]
...
* У вас есть [создан Отправка приложения](https://docs.microsoft.com/windows/uwp/publish/app-submissions) в центре партнеров и это приложение публикуется в Store. При необходимости можно настроить приложение, чтобы его нельзя было найти в Магазине, пока вы его тестируете. Подробнее см. в [руководстве по тестированию](in-app-purchases-and-trials.md#testing).
* У вас есть [создания подписки надстройки для приложения](../publish/add-on-submissions.md) в центре партнеров.
...
Пользователи могут использовать страницу [https://account.microsoft.com/services](https://account.microsoft.com/services) в учетной записи Майкрософт для просмотра всех приобретенных подписок, отмены подписки и изменения способа оплаты, связанного с подпиской. Если пользователь отменяет подписку с помощью этой страницы, он по-прежнему имеет доступ к этой подписке в течение текущего периода выставления счетов. Он не получает возврат денежных средств за какую-либо часть текущего периода выставления счетов. В конце текущего периода выставления счетов подписка будет отключена.
...
* Пользователи не могут менять периоды подписки на странице [https://account.microsoft.com/services](https://account.microsoft.com/services) своей учетной записи Майкрософт. Переключиться на другую подписку период, клиентам необходимо отменить их текущей подписки и затем будет приобретена подписка с периодом другую подписку из вашего приложения.
