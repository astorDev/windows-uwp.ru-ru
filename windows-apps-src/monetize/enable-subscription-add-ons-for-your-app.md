...
1. [Создайте отправку надстройки](../publish/add-on-submissions.md) для подписки в центре партнеров и опубликуйте отправку. При выполнении процесса отправки надстройки обратите особое внимание на следующие свойства.
...
* Вы [создали отправку приложения](https://docs.microsoft.com/windows/uwp/publish/app-submissions) в центре партнеров, и это приложение публикуется в магазине. При необходимости можно настроить приложение, чтобы его нельзя было найти в Магазине, пока вы его тестируете. Подробнее см. в [руководстве по тестированию](in-app-purchases-and-trials.md#testing).
* Вы [создали надстройку подписки для приложения](../publish/add-on-submissions.md) в центре партнеров.
...
* Пользователи не могут менять периоды подписки на странице [https://account.microsoft.com/services](https://account.microsoft.com/services) своей учетной записи Майкрософт. Чтобы переключиться на другой период подписки, клиенты должны отменить текущую подписку, а затем приобрести подписку с другим периодом подписки из вашего приложения.
...
* Обновление существующих подписок после настройки видимости надстройки подписки для **отмены приобретения**. Дополнительные сведения см. [в разделе Настройка цен и доступности надстроек](../publish/set-add-on-pricing-and-availability.md) .
