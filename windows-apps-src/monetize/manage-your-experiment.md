---
author: mcleanbyron
Description: "После определения эксперимента на информационной панели Центра разработки и добавления соответствующего кода в приложение вы можете активировать свой эксперимент и просмотреть его результаты на информационной панели."
title: "Управление экспериментом на панели мониторинга Центра разработки"
...
# <a name="manage-your-experiment-in-the-dev-center-dashboard"></a>Управление экспериментом на панели мониторинга Центра разработки

После [определения эксперимента на информационной панели Центра разработки](define-your-experiment-in-the-dev-center-dashboard.md) и [добавления соответствующего кода](code-your-experiment-in-your-app.md) в приложение, вы можете активировать свой эксперимент и просмотреть его результаты на информационной панели. Получив все необходимые данные, вы можете завершить эксперимент и решить, следует ли продолжать использовать значения вариантов в элементах управления для всех приложений или переключиться на значения вариантов в одном из других ваших вариантов.
