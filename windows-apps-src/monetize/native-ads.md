...
4.  В своем коде замените тестовые значения (параметры *applicationId* и *adUnitId* конструктора **NativeAdsManagerV2**) действительными значениями, сгенерированными в Центре разработки.
