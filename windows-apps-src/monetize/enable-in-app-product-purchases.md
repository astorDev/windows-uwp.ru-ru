...
1.  **Создание маркера продажи из приложения**
  ...
  > [!NOTE]
  > Маркер продажи из приложения, используемый в коде должен соответствовать значению [код продукта](../publish/set-your-add-on-product-id.md#product-id) , указывается при [определении соответствующей надстройки для приложения в центре партнеров](../publish/add-on-submissions.md).
...
В центре партнеров перейдите к приложения и [Создание надстройки](../publish/add-on-submissions.md) , соответствующую предлагаемому продукту в приложении. Определите код продукта, тип, цену и другие свойства для надстройки. Убедитесь, что настройка идентична выполненной в WindowsStoreProxy.xml настройке при тестировании.
  ...
  > [!NOTE]
  > Маркер продажи из приложения, используемый в коде должно соответствовать значению [код продукта](../publish/set-your-add-on-product-id.md#product-id) , указываемое при определении соответствующей надстройки в центре партнеров.
