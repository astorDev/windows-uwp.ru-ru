...
ms.locfileid: "6451413"
---
# <a name="get-insights-data"></a>Получение аналитических данных

Используйте этот метод в API аналитики Microsoft Store для получения аналитических данных, связанных с приобретения, работоспособности и использования метрик для приложения во время диапазоне дат или с учетом других дополнительных фильтров. Эта информация также доступна в [аналитический отчет](../publish/insights-report.md) в центре партнеров.
...
| Тип данных     | string | Одна из следующих строк, указывающая общая аналитика область, которая описывает этот аналитические сведения:<p/><ul><li><strong>приобретение</strong></li><li><strong>работоспособности</strong></li><li><strong>Использование</strong></li></ul>   |
