...
| startDate | date | Начальная дата диапазона дат аналитика данных для извлечения. По умолчанию используется текущая дата минус 30 дней. |  Нет  |
...
| insightDate                | string | Дата, на котором мы определили изменение определенного метрики. Эту дату представляет собой конце недели, в котором обнаружено значительное повышение или уменьшение показатель, по сравнению с недели до этого. |
...
| PercentChange            | string |  Процент измененного Метрика для своей базы всем клиентам.  |
...
| Дата              | строка |  Дата, на котором мы определили изменения, связанные с текущей аналитические сведения или текущего измерения.   |
