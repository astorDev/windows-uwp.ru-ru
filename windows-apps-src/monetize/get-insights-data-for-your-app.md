...
| Значение               | Тип   | Описание                           |
|---------------------|--------|-------------------------------------------|
| applicationId       | string | Код продукта в магазине для приложения, по которой запрашиваются данные сведения.     |
...
| Тип данных     | string | Одна из следующих строк, указывающая общая аналитика область, которая описывает это представление:<p/><ul><li><strong>приобретение</strong></li><li><strong>работоспособности</strong></li><li><strong>Использование</strong></li></ul>   |
...
| Имя измерения           | string |  Имя метрики, описанные в текущей измерения. Примеры включают **EventType**, **рынка**, **DeviceType**, **PackageVersion**, **AcquisitionType**, **AgeGroup** и **Пол**.   |
