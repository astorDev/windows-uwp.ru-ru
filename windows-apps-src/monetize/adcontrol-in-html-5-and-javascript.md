...
> [!NOTE]
> Значения *applicationId* и *adUnitId*, приведенные в данном примере, являются [значениями тестового режима](set-up-ad-units-in-your-app.md#test-ad-units). Перед отправкой приложения необходимо [Заменить эти значения действительными значениями](set-up-ad-units-in-your-app.md#live-ad-units) из центра партнеров.
