...
| Описание           | Строка  | Описание приложения в Магазине.  |
...
| устройств           |  Массив  | Массив из одного или нескольких из следующих строк, указывающих типы устройств, которые поддерживает приложение: **ПК**, **Phone**, **Xbox**, **IoT**, **Server**, и **Holographic**.  |
| platformVersions           | Массив  |  Массив из одного или нескольких из следующих строк, которые указывают платформы, которые поддерживает приложение: **Зависимости Windows.Universal**, **Windows.Windows8x**, и **Windows.WindowsPhone8x**.  |
