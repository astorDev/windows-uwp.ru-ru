...
| devices           |  array  | Массив из одной или нескольких следующих строк, означающих типы устройств, которые поддерживает приложение: **PC**, **Phone**, **Xbox**, **IoT**, **Server** и **Holographic**.  |
| platformVersions           | array  |  Массив из одной или нескольких следующих строк, означающих платформы, которые поддерживает приложение: **Windows.Universal**, **Windows.Windows8x** и **Windows.WindowsPhone8x**.  |
