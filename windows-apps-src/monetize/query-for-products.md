...
| productTypes      | Перечисление&lt;строки&gt;       | Указывает, какие типы продуктов должны возвращаться в результатах запроса. Поддерживаются следующие типы продуктов: **приложение**, **устойчивая**, **игра**и **унманажедконсумабле**.     | Да       |
