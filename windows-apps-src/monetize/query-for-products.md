...
| inAppOfferToken      | string             | Строка идентификатора указанная разработчиком продукта, назначенная элементу в центре партнеров. Пример кода продукта — *product123*. | Нет       |
