...
|---------------|--------|--------------|
| Authorization | Строка | Обязательный. Токен учетной записи Майкрософт для текущего вошедшего в систему пользователя приложения в виде **носителя** &lt; *маркера*&gt;. |
...
| Поле      | Тип   | Описание         |
|------------|--------|------------------|
| предложения      | Массив  | Массив кодов продуктов для надстроек, связанных с целевыми предложениями, доступными для текущего пользователя. Эти коды продуктов указанные в **целевых предложений** страницы для вашего приложения в центре партнеров.            |
...
* [Управление целевых предложениями, с помощью служб Store](manage-targeted-offers-using-windows-store-services.md)
