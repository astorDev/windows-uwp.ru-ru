...
|---------------|--------|---------------|------|
| applicationId | string | *ProductId* игры на Xbox One, для которой запрашиваются данные о покупках. Чтобы получить *productId* вашей игры, перейдите к игре в программе аналитики XDP и получите *productId* по URL-адресу. Кроме того Если загрузить данные о приобретениях из аналитического отчета центра партнеров, *productId* включается в TSV-файл. |  Да  |
...
| acquisitionType     | строка  | <p>Одна из следующих строк, указывающих тип приобретения:</p> <ul><li>«Бесплатный»</li><li>«Пробная версия»</li><li>«Выплаты»</li><li>«Рекламный код»</li><li>«Iap»</li><li>«Подписки Iap»</li><li>«Private аудитория»</li><li>«Подготовка порядок»</li><li>«Xbox Game Pass» (или «Game Pass», если запрашиваются данные до 23 марта 2018 г.)</li><li>«Диск»</li><li>«Prepaid Code»</li><li>«Плата порядок состоянию»</li><li>«Отмена состоянию порядок»</li><li>«Не удалось порядок состоянию»</li></ul>                                                                                                    |
