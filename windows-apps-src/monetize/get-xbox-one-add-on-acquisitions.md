...
| addonProductId | string | *ProductId* надстройки, по которому требуется получить данные о покупках.  | Да  |
...
| addonProductName    | строка  | Отображаемое имя надстройки. Это значение отображается только в данных ответа при *aggregationLevel* параметра установлено значение **день**, если вы не укажете поле **addonProductName** в параметре *groupby* .                                                                                                                                                                                                            |
...
| deviceType          | строка  | <p>Одна из следующих строк, указывающая тип устройства, на котором было выполнено приобретение:</p> <ul><li>«КОМПЬЮТЕР»</li><li>«Телефон»</li><li>«Консоль»</li><li>«IoT»</li><li>«Сервер»</li><li>«Планшет»</li><li>«Holographic»</li><li>«Неизвестно»</li></ul>                                                                                                  |
...
| acquisitionType     | строка  | <p>Одна из следующих строк, указывающих тип приобретения:</p> <ul><li>«Бесплатный»</li><li>«Пробная версия»</li><li>«Платные»</li><li>«Рекламный код»</li><li>«Iap»</li><li>«Подписки Iap»</li><li>«Private аудитории»</li><li>«Подготовка порядок»</li><li>«Xbox Game Pass» (или «Game Pass», если запрашиваются данные до 23 марта 2018 г.)</li><li>«Диск»</li><li>«Prepaid Code»</li><li>«Плата порядок состоянию»</li><li>«Отмена порядок состоянию»</li><li>«Не удалось порядок состоянию»</li></ul>                                                                                                    |
