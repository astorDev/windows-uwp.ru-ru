...
При создании *целевых предложение* в **выполнить охват > целевые предложения** страницы для вашего приложения в центре партнеров, используйте *целевые Microsoft Store предлагает API* в коде приложения для Получение сведений о, которая помогает реализовывать взаимодействие в приложении для целевых предложения. Дополнительные сведения о целевых предложениях и способах их создания на информационной панели см. в разделе [Использование целевых предложений для повышения вовлеченности и количества конверсий](../publish/use-targeted-offers-to-maximize-engagement-and-conversions.md).
