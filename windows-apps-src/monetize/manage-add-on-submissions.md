...
Используйте следующие методы для получения, создания, обновления, фиксации и удаления отправки надстройки. Прежде чем использовать эти методы, надстройка должна уже существовать в вашей учетной записи центра партнеров. Надстройку можно создать в центре партнеров, [указав тип продукта и кода продукта](../publish/set-your-add-on-product-id.md) или с помощью методов API отправки Microsoft Store в описано в [Управление надстройками](manage-add-ons.md).
...
>    * При вызове [метода PUT для обновления отправки надстройки](update-an-add-on-submission.md) сведения в значении *sales* будут игнорироваться. Вы можете продолжать использовать центр партнеров, чтобы изменить данные продажи для отправки надстройки.
