...
|---------------|--------|---------------------|
| элементы | Массив | Массив объектов, содержащий данные о каждой надстройке подписки, на которую имеет право указанный пользователь. Дополнительные сведения о данных в каждом объекте см. в следующей таблице.  |
