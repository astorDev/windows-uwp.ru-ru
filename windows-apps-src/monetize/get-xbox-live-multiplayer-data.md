...
ms.locfileid: "57662039"
---
# <a name="get-xbox-live-multiplayer-data"></a>Получение многопользовательских данных в Xbox Live


Используйте этот метод в API аналитики для Microsoft Store для получения многопользовательских данных для своей [игры с поддержкой Xbox Live](../xbox-live/index.md) с разбивкой по дням или месяцам. Эта информация также доступна в [отчет по аналитике в Xbox](../publish/xbox-analytics-report.md) в центре партнеров.
