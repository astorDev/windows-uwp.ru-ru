...
ms.locfileid: "67321767"
---
# <a name="get-xbox-live-multiplayer-data"></a>Получение многопользовательских данных в Xbox Live


Используйте этот метод в API аналитики для Microsoft Store для получения многопользовательских данных для своей [игры с поддержкой Xbox Live](https://docs.microsoft.com/gaming/xbox-live/index.md) с разбивкой по дням или месяцам. Эта информация также доступна в [отчет по аналитике в Xbox](../publish/xbox-analytics-report.md) в центре партнеров.
...
|------------|--------|-------------------------------------------------------|
| Значение      | array  | Массив объектов, содержащих многопользовательские данные, где каждый объект представляет собой набор данных для указанного периода в днях или месяцах, сгруппированных времени по заданным значениям **filter** и **groupby**. Дополнительные сведения о данных в каждом объекте см. в разделах [Многопользовательская аналитика по дням](#daily-multiplayer-analytics) и [Многопользовательская аналитика по месяцам](#monthly-multiplayer-analytics).     |
...
| deviceType          | строка | Одна из следующих строк, указывающая тип устройства, с которого поступили многопользовательские данные:<p/><ul><li><strong>Консоль</strong></li><li><strong>ПК</strong></li><li>**Неизвестный**</li></ul>  |
...
| dailySessionCount     | number |  Количество многопользовательских сессий для игры в указанную дату.  |
| engagementDurationMinutes     | number |  Общее количество минут, в течение которых пользователи участвовали в многопользовательских сеансах игры в указанную дату.  |
| dailyActiveUsers     | number |  Общее количество активных пользователей многопользовательских сессий для игры в указанную дату.  |
| dailyActiveDevices     | number |  Общее количество активных устройств в многопользовательских сессиях для игры в указанную дату.  |
| dailyNewUsers     | number |  Общее количество новых пользователей многопользовательских сессий для игры в указанную дату.  |
| monthlyActiveUsers     | number |  Общее количество активных пользователей многопользовательских сессий в месяце, на который приходится указанная дата.  |
| monthlyActiveDevices     | number | Общее количество активных устройств в многопользовательских сессиях для игры в месяц, на который приходится указанная дата.   |
| monthlyNewUsers     | number |  Общее количество новых пользователей многопользовательских сессий для игры в месяце, на который приходится указанная дата.  |
...
| deviceType          | строка | Одна из следующих строк, указывающая тип устройства, с которого поступили многопользовательские данные:<p/><ul><li><strong>Консоль</strong></li><li><strong>ПК</strong></li><li>**Неизвестный**</li></ul>  |
| subscriptionName     | строка |  Имя подписки, используемой для многопользовательских данных. Возможные значения включают **Xbox Game Pass** и **""** (если нет подписки).  |
| monthlySessionCount     | number |  Количество многопользовательских сессий для игры за указанный месяц.   |
| engagementDurationMinutes     | number |  Общее количество минут, в течение которых пользователи участвовали в многопользовательских сеансах игры за указанный месяц.  |
| monthlyActiveUsers     | number | Общее количество активных пользователей многопользовательских сессий за указанный месяц.   |
| monthlyActiveDevices     | number | Общее количество активных устройств в многопользовательских сессиях для игры за указанный месяц.   |
| monthlyNewUsers     | number |  Общее количество новых пользователей многопользовательских сессий для игры за указанный месяц.  |
| averageDailyActiveUsers     | number |  Среднее количество активных пользователей многопользовательских сессий в день для игры за указанный месяц.  |
| averageDailyActiveDevices     | number |  Среднее количество активных устройств в многопользовательских сессиях для игры за указанный месяц.  |
