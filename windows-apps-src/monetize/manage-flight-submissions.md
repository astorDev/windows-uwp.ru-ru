...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, отправки тестового пакета"
...
# <a name="manage-package-flight-submissions-using-the-windows-store-submission-api"></a>Управление отправками тестовых пакетов с помощью API отправки Магазина Windows

API отправки Магазина Windows предоставляет методы, которые можно использовать для управления отправками тестового пакета для приложений, включая постепенные выпуски пакетов. Введение в API отправки Магазина Windows, включая необходимые условия для использования этого API, см. в разделе [Создание отправок и управление ими с помощью служб Магазина Windows](create-and-manage-submissions-using-windows-store-services.md).
...
<td align="left">[Получение существующей отправки тестового пакета](get-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">GET</td>
...
<td align="left">[Получение состояния существующей отправки тестового пакета](get-status-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions```</td>
<td align="left">[Создание новой отправки тестового пакета](create-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">PUT</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}```</td>
<td align="left">[Обновление существующей отправки тестового пакета](update-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/commit```</td>
<td align="left">[Фиксация новой или обновленной отправки тестового пакета](commit-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">DELETE</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}```</td>
<td align="left">[Удаление отправки тестового пакета](delete-a-flight-submission.md)</td>
</tr>
</tbody>
</table>
...
3. [Создание отправки тестового пакета](create-a-flight-submission.md) путем выполнения следующего метода в API отправки Магазина Windows. Этот метод создает новую выполняющуюся отправку, которая является копией последней опубликованной отправки.
  ...
  Тело ответа содержит три элемента: идентификатор новой отправки, данные для новой отправки (в том числе все описания и информацию о ценах), а также URI подписанного URL-адреса (Shared Access Signature, SAS) для передачи любых пакетов для отправки в хранилище BLOB-объектов Azure.
...
Чтобы программным образом включить постепенный выпуск пакета для отправки тестового пакета, выполните следующие действия, используя методы в API отправки Магазина Windows.
...
<td align="left">[Получение сведений о постепенном выпуске для отправки тестового пакета](get-package-rollout-info-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/updatepackagerolloutpercentage```</td>
<td align="left">[Обновление процента пользователей, которые будут получать постепенный выпуск для отправки тестового пакета](update-the-package-rollout-percentage-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/haltpackagerollout```</td>
<td align="left">[Остановка постепенного выпуска для отправки тестового пакета](halt-the-package-rollout-for-a-flight-submission.md)</td>
</tr>
<tr>
<td align="left">POST</td>
<td align="left">```https://manage.devcenter.microsoft.com/v1.0/my/applications/{applicationId}/flights/{flightId}/submissions/{submissionId}/finalizepackagerollout```</td>
<td align="left">[Завершение постепенного выпуска для отправки тестового пакета](finalize-the-package-rollout-for-a-flight-submission.md)</td>
</tr>
</tbody>
</table>
...
Для управления отправками тестовых пакетов методы API отправки Магазина Windows используют следующие ресурсы данных JSON.
