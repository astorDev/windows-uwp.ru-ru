...
ms.locfileid: "6279226"
---
# <a name="commit-an-app-submission"></a>Фиксация отправки приложения


Используйте этот метод в API отправки Microsoft Store для фиксации новой или обновленной отправки приложения в центр партнеров. Действие фиксации оповещает партнеров Центр отправки данных о передаче (в том числе всех связанных пакетов и изображений). В ответ центр партнеров фиксирует изменения в данных отправки для их внедрения и публикации. После успешного завершения операции фиксации, изменения в отправку отображаются в центре партнеров.
