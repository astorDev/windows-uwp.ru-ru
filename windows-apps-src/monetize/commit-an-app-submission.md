...
description: "Используйте этот метод в API отправки Магазина Windows, чтобы фиксировать новую или обновленную отправку приложения в Центр разработки для Windows."
...
ms.prod: windows
ms.technology: uwp
keywords: "Windows 10, UWP, API отправки Магазина Windows, фиксация отправки приложения"
