...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, принятие отправки приложения"
...
# <a name="commit-an-app-submission-using-the-windows-store-submission-api"></a>Фиксация отправки приложения с помощью API отправки Магазина Windows
