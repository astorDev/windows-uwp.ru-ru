...
description: "Используйте этот метод в API отзывов Магазина Windows, чтобы отправлять ответы на отзывы о вашем приложении."
