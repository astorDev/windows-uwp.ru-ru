...
| IsPublic | Boolean |  Если задать **значение true**, ваш ответ будет отображаться ваше приложение в описании в магазине, непосредственно под отзывом пользователя и будет виден всем пользователям. Если задать **значение false** и пользователь не отказался от получения ответов по электронной почте, ваш ответ будет отправлен клиенту по электронной почте, и он не будут видны другим пользователям вашего приложения в магазине. Если указать **значение false** и пользователь отказался от получения ответов на отзывы по электронной почте, будет возвращена ошибка.   |  Да  |
