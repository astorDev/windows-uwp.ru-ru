...
author: mcleanbyron
ms.assetid: 
description: "Используйте этот метод в API аналитики для Магазина Windows, чтобы скачать CAB-файл для ошибки в вашем приложении."
