...
# <a name="get-package-flights-for-an-app-using-the-windows-store-submission-api"></a>Получение тестовых пакетов для приложения с помощью API отправки Магазина Windows
