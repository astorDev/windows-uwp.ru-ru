...
description: Используйте этот метод в API отправки Microsoft Store, чтобы фиксировать новую или обновленную отправку надстройки в Центре разработки для Windows.
