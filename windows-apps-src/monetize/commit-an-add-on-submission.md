...
ms.locfileid: "6855668"
---
# <a name="commit-an-add-on-submission"></a>Фиксация отправки надстройки

Используйте этот метод в API отправки Microsoft Store для фиксации новой или обновленной надстройки (также называется внутренним продуктом приложения или IAP) отправки в центр партнеров. Действие фиксации оповещает партнеров Центр отправки данных о передаче (в том числе всех связанных значков). В ответ центр партнеров фиксирует изменения в данных отправки для их внедрения и публикации. После успешного завершения операции фиксации, изменения в отправку отображаются в центре партнеров.
