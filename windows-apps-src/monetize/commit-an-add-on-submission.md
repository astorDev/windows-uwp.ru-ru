...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, принятие отправки надстройки, внутренний продукт приложения, IAP"
...
# <a name="commit-an-add-on-submission-using-the-windows-store-submission-api"></a>Фиксация отправки надстройки с помощью API отправки Магазина Windows
...
| Имя        | Тип   | Описание                                                                 |
|---------------|--------|-----------------------------------------------------------------------------|
| inAppProductId | string | Обязательный. Код продукта в Магазине, принадлежащий надстройке, которая содержит отправку для фиксации. Этот код отображается на панели мониторинга Центра разработки, а также добавляется в данные ответов для запросов на [Получение всех надстроек](get-all-add-ons.md) и [Создание надстройки](create-an-add-on.md). |
