...
description: Используйте этот метод в API отправки Microsoft Store для фиксации новой или обновленной отправки надстройки в центре партнеров.
...
| 409  | Указанная Отправка найдена, однако ее не удалось зафиксировать в текущем состоянии или надстройка использует компонент центра партнеров, [в настоящее время не поддерживается API отправки в Microsoft Store](create-and-manage-submissions-using-windows-store-services.md#not_supported). |
