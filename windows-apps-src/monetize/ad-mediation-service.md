...
Служба рекламного посредника интегрируется с большим количеством рекламных сетей, чтобы вам не нужно было выполнять эту работу. После отображения рекламы в вашем приложении с помощью Microsoft Advertising SDK, можно изменить параметры mediation ad [в центре партнеров](../publish/in-app-ads.md#mediation-settings) отображение баннера из нескольких сетей ad. Вы можете использовать преимущества получения рекламы от новых рекламных сетей без необходимости вносить изменения в код.
