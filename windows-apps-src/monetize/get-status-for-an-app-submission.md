...
# <a name="get-the-status-of-an-app-submission-using-the-windows-store-submission-api"></a>Получение состояния отправки приложения с помощью API отправки Магазина Windows
