...
* Любые группы объявлений, связанные с вашим приложением, будут отключены. Эти единицы отключенное ad нельзя удалить из учетной записи центра DePartnerv. Если вы обновляете свое приложение для использования [Microsoft Advertising SDK](https://aka.ms/ads-sdk-uwp), игнорируйте эти группы объявлений и создавайте новые.
...
## <a name="part-1-determine-whether-you-need-to-update-your-uwp-app"></a>Часть 1. Определить, нужно ли вам обновить приложения универсальной платформы Windows
...
## <a name="part-2-install-the-latest-sdk"></a>Часть 2. Установите последнюю версию пакета SDK
...
3.  Установите [Microsoft Advertising SDK](https://aka.ms/ads-sdk-uwp).

## <a name="part-3-update-your-project"></a>Часть 3. Обновить проект
...
## <a name="part-4-test-and-republish-your-app"></a>Часть 4. Тестирование и повторно опубликовать приложение

Протестируйте свое приложение, чтобы убедиться, что рекламные баннеры отображаются должным образом.

Если предыдущая версия приложения уже доступны в Store, [Создание новой отправки](../publish/app-submissions.md) для обновленного приложения в центре партнеров, чтобы повторно опубликовать приложение.
