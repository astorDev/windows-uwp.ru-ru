...
# Обновление приложения для использования последних библиотек Microsoft Advertising

Начиная с января 2017г. мы больше не будем показывать рекламные баннеры в приложениях, в которых используются старые выпуски рекламного пакета SDK Майкрософт. Если у вас есть приложение (уже опубликованное в Магазине или находящееся на стадии разработки), в котором рекламные баннеры отображаются с помощью элементов управления **AdControl** или **AdMediatorControl**, вам может потребоваться обновить приложение для использования последней версии рекламного SDK, чтобы ваше приложение продолжило получать рекламные баннеры в январе 2017г. Следуйте инструкциям в этой статье, чтобы определить, затрагивает ли это изменение ваше приложение и узнать, как его обновить.

Если это изменение затрагивает ваше приложение и вы не обновите его для использования последнего рекламного SDK, начиная с января 2017г. вы будете наблюдать следующее поведение:
...
<span id="part-2" />
## Часть 2. Установите последнюю версию SDK
...
### Проекты для Windows 8.1 или Windows Phone 8.1 (XAML или JavaScript/HTML)
...
### Проекты Silverlight для Windows Phone 8.x
...
## Часть 4. Протестируйте свое приложение и заново опубликуйте его
