...
Начиная с января 2017 г. мы больше не будем показывать рекламные баннеры в приложениях, в которых используются старые выпуски рекламного пакета SDK Майкрософт. Если у вас есть приложение (уже опубликованное в Магазине или находящееся на стадии разработки), в котором рекламные баннеры отображаются с помощью элементов управления **AdControl** или **AdMediatorControl**, вам может потребоваться обновить приложение для использования последней версии рекламного SDK, чтобы ваше приложение продолжило получать рекламные баннеры в январе 2017 г. Следуйте инструкциям в этой статье, чтобы определить, затрагивает ли это изменение ваше приложение и узнать, как его обновить.

Если это изменение затрагивает ваше приложение и вы не обновите его для использования последнего рекламного SDK, начиная с января 2017 г. вы будете наблюдать следующее поведение:
...
>**Примечание**&nbsp;&nbsp;Если вы ранее обновили свое приложение для использования [Microsoft Store Services SDK](http://aka.ms/store-services-sdk) (для приложений UWP) или [Microsoft Advertising SDK для Windows и Windows Phone 8.x](http://aka.ms/store-8-sdk) (для приложений Windows 8.1 и Windows Phone 8.x), в вашем приложении уже используются последние доступные рекламные SDK, и никакие дополнительные изменения вносить не нужно.
...
Если предыдущая версия вашего приложения уже доступна в Магазине, [создайте новую отправку](https://msdns.microsoft.com/windows/uwp/publish/app-submissions) для обновленного приложения в информационной панели Центра разработки для Windows, чтобы опубликовать приложение заново.
