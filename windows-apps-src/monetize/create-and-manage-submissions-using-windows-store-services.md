...
description: Используйте API отправки Microsoft Store для программным образом создавать и администрировать отправки для приложений, которые зарегистрированы в вашей учетной записи центра партнеров.
