...
| b2bKey         | строка | Ключ идентификатора Магазина Windows, [сгенерированный из клиентского кода вашего приложения](view-and-grant-products-from-a-service.md#step-4).                                                                                                                                                                                                                                                        | Да      |
| devOfferId     | строка | Идентификатор определенного разработчиком предложения, который появится в элементе коллекции после покупки.                                                                                                                                                                                                                                 | Нет       |
