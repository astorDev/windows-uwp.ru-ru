...
|----------------|--------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| availabilityId | Строка | Идентификатора доступности приобретаемого продукта из каталога Магазина Windows.                                                                                                                                                                                                                                     | Да      |
| b2bKey         | Строка | Ключ идентификатора Магазина Windows, представляющий личность пользователя.                                                                                                                                                                                                                                                        | Да      |
...
| friendlyName              | Строка                      | Понятное имя для заказа. Недоступно для заказов, осуществляемых с помощью API покупок Магазина Windows.                                                               | Да      |
...
| Параметр | Тип   | Описание                           | Обязательный |
|-----------|--------|---------------------------------------|----------|
| client    | Строка | Идентификатор клиента, создавшего заказ. | Нет       |
...
| productId               | Строка         | Код продукта Магазина Windows для данной позиции.                                                               | Да      |
...
| skuId                   | Строка         | Код SKU Магазина Windows для позиции.                                                                   | Да      |
| taxAmount               | Десятичный        | Сумма налогов для позиции.                                                                            | Да      |
| taxType                 | Строка         | Тип применимых налогов.                                                                       | Да      |
| Title                   | Строка         | Локализованное название позиции.                                                                        | Да      |
