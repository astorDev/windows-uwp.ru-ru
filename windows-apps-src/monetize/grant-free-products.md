...
description: Используйте этот метод в API покупок Магазина Windows, чтобы предоставить бесплатное приложение или внутренний продукт приложения определенному пользователю.
