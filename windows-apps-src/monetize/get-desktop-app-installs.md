...
ms.locfileid: "57612979"
---
# <a name="get-desktop-application-installs"></a>Получение данных об установках классического приложения


Использовать этот URI REST для получения данных агрегатные установки в формате JSON для классического приложения, добавленные в [программы приложения Windows Desktop](https://msdn.microsoft.com/library/windows/desktop/mt826504). Этот URI позволяет получить данные установки во время указанного диапазона дат и другие необязательные фильтры. Эта информация также доступна в [устанавливает отчетов](https://msdn.microsoft.com/library/windows/desktop/mt826504) для классических приложений в центре партнеров.
...
|---------------|--------|---------------|------|
| applicationId | Строка | Идентификатор продукта классического приложения, для которого требуется извлечь данных установки. Чтобы получить идентификатор продукта для настольного приложения, открыть любой [analytics отчетов для своего настольного приложения в центре партнеров](https://msdn.microsoft.com/library/windows/desktop/mt826504) (такие как **устанавливает отчетов**) и получить идентификатор продукта из URL-адрес. |  Да  |
...
| deviceType          | Строка | Один из следующих строк, которое указывает тип устройства, на котором установлен классического приложения:<p/><ul><li><strong>ПК</strong></li><li><strong>Сервер</strong></li><li><strong>Планшета</strong></li><li><strong>Неизвестный</strong></li></ul> |
...
* [Приложение Windows Desktop](https://msdn.microsoft.com/library/windows/desktop/mt826504)
