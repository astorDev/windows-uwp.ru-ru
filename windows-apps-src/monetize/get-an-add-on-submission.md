...
>**Внимание!**&nbsp;&nbsp;В ближайшее время корпорация Майкрософт изменит модель данных ценообразования для отправок надстроек в Центре разработки для Windows. После реализации этого изменения ресурс **Цены** в данных ответа при использовании этого метода будет пустым, и вы временно не сможете получать данные о ценах и продажах для отправки надстройки с помощью этого метода. В дальнейшем мы обновим API отправки Магазина Windows для внедрения нового способа программного доступа к информации о ценах для отправок надстроек. Подробнее см. в описании [ресурса "Цены"](manage-add-on-submissions.md#pricing-object).
