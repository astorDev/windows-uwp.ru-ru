...
description: Инструкции по добавлению приложения и рекламного блока значения идентификатора из центра партнеров в ваше приложение перед отправкой приложения в магазин.
