...
* Установка [Microsoft Advertising SDK](https://marketplace.visualstudio.com/items?itemName=AdMediator.MicrosoftAdvertisingSDK) с помощью Visual Studio 2015 или более поздней версии.
...
6.  В файле main.js проекта добавьте код, который создает объект **AdScheduler**. Передайте объект **MediaPlayer**, в котором размещено видеосодержимое. Код должен быть размещен так, чтобы он выполнялся после [WinJS.UI.processAll](https://docs.microsoft.com/previous-versions/windows/apps/hh440975).
