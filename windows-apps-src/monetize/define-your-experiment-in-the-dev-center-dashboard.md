...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, Microsoft Store Services SDK, A/B-тестирование, эксперименты"
...
# <a name="define-your-experiment-in-the-dev-center-dashboard"></a>Определение эксперимента на информационной панели Центра разработки
