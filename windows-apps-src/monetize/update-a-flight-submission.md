...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, отправка тестового пакета, обновление"
...
# <a name="update-a-package-flight-submission-using-the-windows-store-submission-api"></a>Обновление отправки тестового пакета с помощью API отправки Магазина Windows
