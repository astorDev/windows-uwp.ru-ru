---
author: mcleanbyron
description: "Используйте этот метод в API аналитики для Магазина Windows для получения данных о воронке приобретений приложения в заданном диапазоне дат или с учетом других дополнительных фильтров."
...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, службы Магазина, API аналитики для Магазина Windows, приобретение, воронка"
...
Вот несколько примеров параметров *filter*:
...
|------------|--------|-------------------------------------------------------|
| Value      | массив  | Массив объектов, содержащий сводную информацию о воронке приобретений для данного приложения. Дополнительные сведения о данных в каждом объекте см. далее в разделе [значения воронки](#funnel-values).                                                                                                                      |
