...
description: Используйте API рекламных акций Microsoft Store программным образом управлять рекламными кампаниями для приложений, которые зарегистрированы в учетной записи центра партнеров вашей или вашей организации.
