...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, отправка тестового пакета"
...
# <a name="get-a-package-flight-submission-using-the-windows-store-submission-api"></a>Получение отправки тестового пакета с помощью API отправки Магазина Windows
