...
* Создание отправки тестового пакета для приложения в центре партнеров. Это можно сделать в центре партнеров или это можно сделать с помощью метода [создания отправки тестового пакета](create-a-flight-submission.md) .
...
| 409  | Отправка тестового пакета не принадлежит указанному тестовому пакету, или приложение использует компонент центра партнеров, [в настоящее время не поддерживается API отправки в Microsoft Store](create-and-manage-submissions-using-windows-store-services.md#not_supported). |   
