...
|-------------|------------|--------|--------|
|  [аппрецеипт](#appreceipt)  |    Нет        |  0 или 1  |  Содержит информацию о покупках для текущего приложения.            |
|  [продуктрецеипт](#productreceipt)  |     Нет       |  0 или более    |   Содержит сведения о покупке из приложения для текущего приложения.     |
...
|  **рецеиптдате**  |    Дата подписания и загрузки квитанции.           |  
|  **рецеиптдевицеид**  |   Определяет устройство, используемое для запроса этой квитанции.         |  |
...
|  Атрибут  |  Описание   |
|-------------|-------------------|
|  **Удостоверения**  |    Идентифицирует покупку.           |
