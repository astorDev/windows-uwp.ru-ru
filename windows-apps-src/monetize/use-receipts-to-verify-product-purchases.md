...
|  Подпись  |      Да      |  1   |   Этот элемент — стандартная [конструкция XML-DSIG](https://go.microsoft.com/fwlink/p/?linkid=251093). Он содержит элемент **SignatureValue** с подписью, который можно использовать для проверки квитанции, а также элемент **SignedInfo**.      |
