...
title: "Получение всех надстроек с помощью API отправки Магазина Windows"
ms.author: mcleans
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, надстройки, внутренние продукты приложения, IAP"
...
# <a name="get-all-add-ons-using-the-windows-store-submission-api"></a>Получение всех надстроек с помощью API отправки Магазина Windows
