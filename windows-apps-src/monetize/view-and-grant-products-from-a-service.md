...
Для создания маркеров доступа используйте OAuth 2.0 API в службе, следуя инструкциям из раздела [Вызовы для связи между службами с помощью учетных данных клиентов](https://azure.microsoft.com/documentation/articles/active-directory-protocols-oauth-service-to-service/). Для каждого маркера укажите следующие параметры.
