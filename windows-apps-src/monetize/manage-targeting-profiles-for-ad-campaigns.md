...
description: "Используйте этот метод в API рекламных акций Магазина Windows для управления профилями таргетинга в рекламных кампаниях."
title: "Управление профилями таргетинга рекламных кампаний"
ms.author: mcleans
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
...
# <a name="manage-targeting-profiles-for-ad-campaigns"></a>Управление профилями таргетинга рекламных кампаний


Используйте эти методы в API рекламных акций Магазина Windows для выбора пользователей, регионов и типов продуктов, по которым вы хотите производить таргетинг для каждой линии поставки в рекламной кампании. Профили таргетинга можно создавать и повторно использовать для нескольких линий поставки.

Дополнительные сведения о связи между профилями таргетинга, кампаниями, линиями поставки и рекламными материалами см. в разделе [Проведение рекламных кампаний с помощью служб Магазина Windows](run-ad-campaigns-using-windows-store-services.md#call-the-windows-store-promotions-api).
...
|  targetingType   |  строка   |  Принимает одно из следующих значений: <ul><li>**Auto**: задайте это значение, чтобы разрешить Майкрософт выбирать профиль таргетинга, исходя из параметров вашего приложения в Центре разработки.</li><li>**Manual**: задайте это значение, чтобы определить собственный профиль таргетинга.</li></ul>     |  Нет     |  Auto    |   Да    |       
