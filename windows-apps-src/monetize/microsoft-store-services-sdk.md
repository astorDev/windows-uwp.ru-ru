...
Microsoft Store Services SDK предоставляет функции, которые помогают повышать интерес пользователей к приложениям универсальной платформы Windows (UWP), например отправление целевых уведомлений в приложениях и проведение A / b-тестированием в приложениях. Этот пакет SDK является расширением Visual Studio 2015 и более поздних версий Visual Studio.
