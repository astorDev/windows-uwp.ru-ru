...
2.  Если вы используете Visual Studio 2015, щелкните **Рекламный посредник**, а затем — **Настроить**, чтобы открыть окно **Рекламный посредник**. Если вы используете Visual Studio 2013, просто щелкните **Рекламный посредник** на левой панели **диспетчера служб**.
...
3.  В окне **Ad Mediator** (Visual Studio 2015) или **Диспетчер служб** (Visual Studio 2013) щелкните **Выбрать рекламные сети**, выберите необходимые рекламные сети, а затем в окне **Выбор рекламных сетей** нажмите кнопку **ОК**.
...
На следующем снимке экрана показаны требуемые возможности для некоторых рекламных сетей в приложении на XAML Windows 8.1 или Windows Phone 8.1.
...
-   UWP и Windows 8.1 XAML: 300 x 250 (Ш x В).
-   Windows Phone 8.1 XAML: 400 в ширину × 67 в высоту.
-   Windows Phone 8 и Windows Phone 8.1 Silverlight: 480 x 80 (Ш x В).
...
-   Windows 10 и Windows 8.1:
    -   160 × 600
    -   250 × 250 (Обратите внимание, что в этом размере доступно очень мало объявлений. Для достижения максимальных значений eCPM и отношения показов к попыткам рекомендуется использовать другие размеры.)
    -   300 × 250
    -   300 × 600
    -   728 × 90
...
Код для использования в приложении UWP, Windows 8.1 или Windows Phone, в котором используются C# и XAML
...
Код для использования в приложении Windows Phone Silverlight
