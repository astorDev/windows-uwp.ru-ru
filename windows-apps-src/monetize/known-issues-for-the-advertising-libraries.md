...
* [HTML и JavaScript, руководство по устранению неполадок](html-and-javascript-troubleshooting-guide.md)
...
* Выберите единицу ad в центре партнеров, размер которого больше или меньше, чем размер **AdControl** в коде приложения.
...
Если вы видите тестовые объявления в приложении, то ваш код работает и может отображать рекламу. Если проблемы сохраняются, обратитесь в [службу поддержки по продукту](https://developer.microsoft.com/en-us/windows/support). На этой странице **свяжитесь с нами**.
...
Когда единое динамической ad обслуживает теста рекламы, состояние устройства ad показывает **активный и обслуживанием теста ads** в центре партнеров. В настоящее время это неактуально для телефонных приложений.
...
![ReferenceError\-обозреватель решений](images/13-19629921-023c-42ec-b8f5-bc0b63d5a191.jpg)
