...
Если актуального рекламного объявления — это единица показывает тестовые объявления, статус рекламной единицы показано **Активная и показывает тестовые объявления** в центре партнеров. В настоящее время это неактуально для телефонных приложений.
