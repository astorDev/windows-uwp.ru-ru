...
* [Руководство по устранению неполадок HTML и JavaScript](html-and-javascript-troubleshooting-guide.md)
* [XAML и C# руководство по устранению неполадок](xaml-and-c-troubleshooting-guide.md)
...
* Выбор единицы рекламы в центре партнеров с размером, который больше или меньше размера **адконтрол** в коде приложения.
...
Если вы видите тестовые объявления в приложении, то ваш код работает и может отображать рекламу. Если проблемы сохраняются, обратитесь в [службу поддержки по продукту](https://developer.microsoft.com/en-us/windows/support). На этой странице выберите **связаться с нами**.
...
Когда активная единица рекламы обслуживает тестовые объявления, в центре партнеров отображается состояние единицы рекламного объявления: **активно и обслуживание тестов** . В настоящее время это неактуально для телефонных приложений.
...
![референцееррор\-solutionexplorer](images/13-19629921-023c-42ec-b8f5-bc0b63d5a191.jpg)
