...
ms.prod: windows
ms.technology: uwp
keywords: "windows 10, uwp, API отправки Магазина Windows, отправка надстройки, обновление, надстройка, IAP"
...
# <a name="update-an-add-on-submission-using-the-windows-store-submission-api"></a>Обновление отправки надстройки с помощью API отправки Магазина Windows
