...
Подробнее об использовании этого метода в процессе создания отправки надстройки с помощью API отправки Магазина Windows см. в статье [Управление отправками надстроек](manage-add-on-submissions.md).

>**Внимание!**&nbsp;&nbsp;В ближайшее время корпорация Майкрософт изменит модель данных ценообразования для отправок надстроек в Центре разработки для Windows. После реализации этого изменения ресурс **Цены** в теле запроса при использовании этого метода будет игнорироваться, и вы временно не сможете изменять цены и данные о продажах для отправки надстройки с помощью этого метода. В дальнейшем мы обновим API отправки Магазина Windows для внедрения нового способа программного доступа к информации о ценах для отправок надстроек. Подробнее см. в описании [ресурса «Цены»](manage-add-on-submissions.md#pricing-object).
...
| submissionId | строка | Обязательный. Идентификатор отправки для обновления. Этот идентификатор отображается на информационной панели Центра разработки, а также включается в данные ответов для запросов на [Создание отправки надстройки](create-an-add-on-submission.md).  |
