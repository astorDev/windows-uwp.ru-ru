...
description: Если приложение предлагает большой каталог IAP-продуктов, то для облегчения управления каталогом вы можете выполнить действия, описанные в этом разделе.
...
**Примечание.** Начиная c Windows 10 в Магазине отсутствует ограничение на количество продуктов на одну учетную запись разработчика. В предыдущих выпусках в Магазине действовало ограничение в 200 продуктов на одну учетную запись разработчика. Процесс, описанный в этом разделе, можно использовать для обхода этого ограничения.
