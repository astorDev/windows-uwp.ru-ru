...
# <a name="get-add-ons-for-an-app-using-the-windows-store-submission-api"></a>Получение сведений о надстройках для приложения с помощью API отправки Магазина Windows
