...
description: "Создание приложения для демонстрации в розничных магазинах (RDX-приложения)— приложения, которое можно запускать и демонстрационном, и в обычном режиме"
...
---
#  Создание приложения для демонстрации в розничных магазинах (RDX-приложения)
...
### Покажите лучшее, на что способно ваше приложение
...
### Демонстрируйте приложение быстро
...
### Позаботьтесь о комфорте пользователя
...
## Подготовка базы кода для разработки режима демонстрации в розничных магазинах
...
### Что происходит в процессе очистки по умолчанию?
...
### Как хранить данные между сеансами пользователя?
