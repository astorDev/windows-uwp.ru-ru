...
Как приложений, учитывающих RDX предназначены для демонстрации эффективность приложения для розничных покупателей, они соответствуют техническим требованиям и соблюдать конфиденциальность Германии в Microsoft Store имеет для всех RDX-приложения.
...
* **Соответствие требованиям к размеру приложений магазина розничной торговли**. Размер приложения не должен превышать 800МБ. Если RDX-учитывать приложение не соответствует требованиям размер, обратитесь непосредственно к обсудить этот вопрос команда розничного магазина Windows.
