---
author: mcleanbyron
description: Используйте этот метод в API аналитики для Microsoft Store для получения данных о классических приложений.
...
| Тип данных     | string | Строка, указывающая общая аналитика область, которая сообщает этого исследования. В настоящее время этот метод поддерживает только **работоспособности**.    |
...
| Имя измерения           | string |  Имя метрики, описанные в текущего измерения. Примеры включают **EventType**, **рынка**, **DeviceType**и **PackageVersion**.   |
