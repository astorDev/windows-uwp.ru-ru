...
| Direction | строка |  Направление изменения (**положительное** или **отрицательное**).   |
| Date              | строка |  Дата, на котором мы определили изменений, связанных с текущей insight или текущего измерения.   |
