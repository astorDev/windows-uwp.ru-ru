...
Используйте следующие методы в API отправки Магазина Windows для управления надстройками (также называются внутренними продуктами приложения или IAP) для приложений. Введение в API отправки Магазина Windows см. в разделе [Создание отправок и управление ими с помощью служб Магазина Windows](create-and-manage-submissions-using-windows-store-services.md).
