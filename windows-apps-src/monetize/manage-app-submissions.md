...
# <a name="manage-app-submissions-using-the-windows-store-submission-api"></a>Управление отправками приложений с помощью API отправки Магазина Windows
...
## <a name="manage-a-gradual-package-rollout-for-an-app-submission"></a>Управление постепенным выпуском пакета для отправки приложения
...
### <a name="app-submission"></a>Отправка приложения
...
### <a name="base-listing"></a>Базовое описание
...
|  sales               |   array      |  **Не рекомендуется**. Массив объектов, содержащих сведения о продажах для приложения. Дополнительные сведения см. далее в разделе [Продажа](#sale-object).    |     
...
>**Важно!**&nbsp;&nbsp;Ресурс **Продажа** более не поддерживается, и в настоящее время невозможно получить или изменить данные продажи для отправки приложения с помощью API отправки в Магазин Windows:
...
### <a name="package-delivery-options-object"></a>Объект параметров доставки пакета
...
### <a name="package-rollout-object"></a>Объект выпуска пакета
