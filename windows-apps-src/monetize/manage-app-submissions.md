...
|  localMultiplayerMinPlayers               |   ssNoversion      |   Определяет минимальное поддерживаемое число игроков, поддерживаемое игрой в локальном многопользовательском режиме.   |     
|  localMultiplayerMaxPlayers               |   ssNoversion      |   Определяет максимальное поддерживаемое число игроков, поддерживаемое игрой в локальном многопользовательском режиме.  |     
|  localCooperativeMinPlayers               |   ssNoversion      |   Определяет минимальное поддерживаемое число игроков, поддерживаемое игрой в локальном совместном режиме.  |     
|  localCooperativeMaxPlayers               |   ssNoversion      |   Определяет максимальное поддерживаемое число игроков, поддерживаемое игрой в локальном совместном режиме.  |     
...
* [Отправки приложений в центре партнеров](https://docs.microsoft.com/windows/uwp/publish/app-submissions)
