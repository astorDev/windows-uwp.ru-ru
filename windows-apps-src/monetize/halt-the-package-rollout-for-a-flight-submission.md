...
# <a name="halt-the-package-rollout-for-a-package-flight-using-the-windows-store-submission-api"></a>Остановка выпуска тестового пакета с использованием API отправки Магазина Windows
