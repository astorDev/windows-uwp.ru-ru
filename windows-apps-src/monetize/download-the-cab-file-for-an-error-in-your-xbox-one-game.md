...
Используйте этот метод в API аналитики для Microsoft Store, чтобы скачать CAB-файл, связанный с определенной ошибкой в игры Xbox One, которое было добавлено через портал разработчика Xbox (XDP) и доступны на информационной панели центра разработки аналитики XDP. Этот метод позволяет скачать только CAB-файла для ошибок, возникших за последние 30 дней.
