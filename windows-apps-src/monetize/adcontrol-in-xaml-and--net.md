...
> [!NOTE]
> Microsoft Advertising SDK также поддерживает приложения XAML, которые реализуются с использованием C++. Полный пример с проектом см. в разделе [рекламы примеров на GitHub](https://aka.ms/githubads).
...
2.  В центре партнеров, перейдите в раздел [рекламы в приложении](../publish/in-app-ads.md) страницы и [создать единицу ad](set-up-ad-units-in-your-app.md#live-ad-units). В качестве типа рекламного блока укажите **Баннер**. Запишите идентификатор рекламного блока и идентификатор приложения.
    > [!NOTE]
...
4.  В коде, замените значения модульного тестирования ad (**ApplicationId** и **AdUnitId**) с динамические значения, созданные в центре партнеров.

5.  [Отправить приложение](../publish/app-submissions.md) к Store, с помощью центра партнеров.

6.  Просмотрите ваши [рекламу отчеты о производительности](../publish/advertising-performance-report.md) в центре партнеров.
