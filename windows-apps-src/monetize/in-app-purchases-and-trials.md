...
* [Коды продукта в Магазине](#store_ids)
...
* Для любого продукта вы также можете получить код продукта в Магазине программными средствами с помощью свойства [StoreId](https://msdn.microsoft.com/library/windows/apps/windows.services.store.storeproduct.storeid.aspx) объекта [StoreProduct](https://msdn.microsoft.com/library/windows/apps/windows.services.store.storeproduct.aspx), представляющего продукт.
