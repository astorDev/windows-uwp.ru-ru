...
В этой статье представлены рекомендации по повышению удобства работы с рекламными баннерами и межстраничными объявлениями в ваших приложениях. Общие рекомендации по проектированию интерфейса приложений см. в разделе [Проектирование и пользовательский интерфейс](https://developer.microsoft.com/windows/apps/design).
