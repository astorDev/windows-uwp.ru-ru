...
* Использовать готовые рекламные блоки (то есть рекламные блоки, полученные из центра партнеров) во время разработки и тестирования, или в эмуляторе.
