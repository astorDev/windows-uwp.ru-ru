...
* С помощью динамической ad единицы (то есть ad единицы, полученный из центра партнеров) во время разработки и тестирования, или в эмуляторе.
...
* Размещения рекламы в viewbox для уменьшения размера рекламных объявлений, чтобы разрешить дополнительные рекламных объявлений на странице, чем обычно.
