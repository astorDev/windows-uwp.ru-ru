...
| Сценарий       | Методы      |
|---------------|--------------------|
| Приобретение и установка |  <ul><li>[Получение сведений о приобретениях приложения](get-app-acquisitions.md)</li><li>[Получение сведений о покупках надстройки](get-in-app-acquisitions.md)</li><li>[Получение сведений об установках приложения](get-app-installs.md)</li></ul> |
