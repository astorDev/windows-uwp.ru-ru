...
## <a name="step-6-replace-the-simulated-license-api-methods-with-the-actual-api"></a>Шаг 6. Замените имитации методы API лицензии фактический интерфейс API
