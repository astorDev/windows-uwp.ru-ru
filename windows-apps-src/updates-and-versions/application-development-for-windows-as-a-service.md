...
**Обновления компонентов** Установка новых возможностях, возможности и возможности на устройствах, которые уже под управлением Windows 10. Поскольку обновления компонентов содержат полную копию Windows, они также применяются пользователями для установки Windows 10 на имеющиеся устройства под управлением Windows 7 или Windows 8.1 и на новые устройства без операционной системы. Корпорация Майкрософт рассчитывает публикации обновлений частично annually. 
...
В процессе разработки Windows 10 Майкрософт оптимизировала цикл разработки и выпуска продуктов Windows с тем, чтобы ускорить доставку нужных пользователям компонентов, функций и возможностей взаимодействия. Майкрософт также создала новые способы доставки и установки обновлений компонентов и качества, упрощающих развертывание и текущее обслуживание, расширила базу сотрудников, которым можно выполнять обновление до новейших возможностей Windows, а также снизила совокупную стоимость владения. Поэтому мы реализовали новые параметры обслуживания — называются Semi-Annual Channel и Long-Term Servicing Channel (LTSC) —, которые обеспечивают pragmatic поддерживать больше устройств более в корпоративных средах, чем раньше.

Показано в следующей таблице описаны различные каналы обслуживания и их основные атрибуты.

| Тип обслуживания | Доступность новых обновлений компонентов для установки | Обслуживания времени существования | Основные преимущества | Поддерживаемые выпуски |
| --- | --- | --- | --- | --- |
...
В рамках временного периода, в течение которого выполнялась доработка Windows 7, к решению проблем совместимости применялся реактивный подход. В Windows 8 мы начали рассматривать это по-разному, работа в Windows, чтобы обеспечить совместимость этого конструктора, а не думать в последнюю очередь. На данный момент Windows 10 обладает самыми широкими предварительно встроенными возможностями совместимости по сравнению с остальными версиями ОС. Нам удалось добиться этого благодаря следующему:
-   **Данные телеметрии приложения**: Это помогает нам понять популярность приложения в экосистеме Windows о том, тестирование на совместимость.
-   **Партнерские отношения с ISV**: Работать напрямую с внешними партнерами для предоставления их с данными и устранения проблем, с которыми столкнулись пользователи.
-   **Проектирование решения, вышестоящего обнаружения**: Партнера с помощью функции команд, чтобы сократить количество критических изменений в Windows. Проверка совместимости является этапом, который должны пройти наши группы по разработке функций.
-   **Обмен данными**: Жестко контролировать изменения в API и улучшенное взаимодействие.
-   **Фокус-тестирование и обратная связь цикл**: Участников программы предварительной оценки Windows получать потерянная сборки, которые Помогите нам улучшить наши возможности для поиска проблемы совместимости перед выпуском финальной сборке клиентам. Такая обратная связь позволяет нам не только выявлять ошибки, но также гарантирует то, что мы предоставляем нашим пользователям нужные функции.
...
Версия ОС была изменена (повышена) вместе с выпуском Windows 10. Это значит, что внутренний номер версии был изменен на 10.0. Как и раньше, мы хотим сделать все возможное для обеспечения совместимости с приложениями и устройствами после изменения номера версии ОС. Для большинства категорий приложений (без зависимые компоненты ядра) изменения не скажется негативно функциональных возможностей приложения, и существующие приложения по-прежнему работают в Windows 10.
...
### <a name="step-1-become-a-windows-insider-and-participate-in-flighting"></a>Шаг 1. Станьте участником программы предварительной оценки Windows и принять участие в фокус-тестирование
...
Так как у вас будет доступ к предварительной версии сборки Windows 10, Windows 10 Mobile и новейшую версию пакета Windows SDK и эмулятор, вы получите все средства в вашем распоряжении, для разработки отличных приложений и изучите новые возможности в универсальной платформы Windows и Microsoft Store.
...
### <a name="step-2-test-your-scenarios"></a>Шаг 2. Тестирование ваших сценариев
...
### <a name="step-4-register-on-ready-for-windows"></a>Шаг 4. Регистрация на Ready For Windows
...
[Параметры для обновлений и обновлений для обслуживания Windows 10](https://technet.microsoft.com/itpro/windows/manage/introduction-to-windows-10-servicing)
