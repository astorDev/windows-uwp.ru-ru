...
**Обновления компонентов** установки добавляются новые компоненты и возможности на устройствах, которые уже используют Windows10. Поскольку обновления компонентов содержат полную копию Windows, они также применяются пользователей для установки Windows10 на имеющиеся устройства под управлением Windows 7 или Windows8.1 и на новых устройствах установки без операционной системы. Корпорация Майкрософт планирует публиковать обновления осенью. 
...
Во время разработки Windows10 Майкрософт оптимизировала тем цикл разработки и выпуска продуктов Windows, чтобы предоставить компонентов, функций и возможностей взаимодействия доставку нужных быстрее, чем когда-либо. Майкрософт также создала новые способы доставки и установки обновлений компонентов и качества, упрощающих развертывание и текущее обслуживание, расширила базу сотрудников, которым можно выполнять обновление до новейших возможностей Windows, а также снизила совокупную стоимость владения. Поэтому были реализованы новые параметры обслуживания — называемые Semi-Annual Channel и Long-Term Servicing Channel (LTSC) — которые предоставляют практичные решения для обеспечения более актуальную дополнительных устройств в корпоративных средах, чем было возможно ранее.
...
В Windows 7, к решению проблем совместимости применялся реактивный подход. В Windows8 мы взглянули на это по-разному, чтобы убедиться, что совместимость была по проектированию, а не являлась доработкой. Windows10 является наиболее совместимый структуры версию ОС до даты. Нам удалось добиться этого благодаря следующему:
...
-   Если вы используете [GetVersion](https://go.microsoft.com/fwlink/?LinkID=780555) API, помните, что поведение этого интерфейса изменилось, начиная Windows8.1.
...
Поскольку вы получите доступ к предварительным сборкам Windows10, Windows10 Mobile последнюю версию Windows SDK и эмулятора, вы получите все средства в вашем распоряжении для создания замечательных приложений и изучения новых возможностей универсальной платформы Windows и Microsoft Store.
