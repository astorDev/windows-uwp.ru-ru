...
Дополнительные сведения см. в статье [Введение в вопросы обслуживания Windows 10](https://technet.microsoft.com/itpro/windows/manage/introduction-to-windows-10-servicing).
...
## <a name="key-changes-since-windows-7-to-ensure-app-compatibility"></a>Основные изменения, внесенные в Windows с момента выхода Windows 7, для обеспечения совместимости приложений
...
-   При использовании API-интерфейса [GetVersion](http://go.microsoft.com/fwlink/?LinkID=780555) следует помнить, что поведение этого интерфейса изменилось, начиная с Windows 8.1.
