...
**Переустановкой:** Убедитесь, что работу функций приложения можно восстановить, переустановив приложение после обновления компьютера до Windows10 из ОС нижнего уровня версии. Если приложение не прошло проверку обновлением и вам не удалось устранить причину этих проблем, это значит, что, возможно, восстановить работу функций поможет переустановка. Передача переустановкой означает, что части приложения может не были перенесены в Windows10.
