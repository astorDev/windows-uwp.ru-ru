...
Приведенный ниже показано, как для запуска сканирования, использование программного триггера, который перестанет проверку после его проверок один штрихкод.
