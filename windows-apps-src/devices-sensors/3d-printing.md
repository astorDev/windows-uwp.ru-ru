...
| [Создание пакета 3MF](generate-3mf.md) | Описание структуры типа файлов формате создания 3D и как он может быть создания и обработки с помощью Windows.Graphics.Printing3D API. |
