...
description: "В этом руководстве описано, как предоставить доступ в пользовательском режиме для GPIO, I2C, SPI и UART в Windows10 IoT Базовая."
...
### Приложение C. Пример сценария Powershell для создания ресурсов GPIO
