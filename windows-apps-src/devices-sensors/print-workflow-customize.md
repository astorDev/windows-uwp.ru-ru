...
* `Disabled`: Приложения рабочего процесса не будет активирована.
* `Uninitialized`: Приложения рабочего процесса будет активироваться, если в системе установлена DCA рабочего процесса. Если приложение не установлено, печать продолжится. 
* `Enabled`: Если в системе установлен DCA рабочего процесса будет активирована контракта рабочего процесса. Если приложение не установлено, произойдет сбой печати. 
