...
description: "Чтобы обеспечить лучшее взаимодействие с пользователями, возможно, потребуется интегрировать приложение с внешними устройствами или датчиками."
ms.author: dbirtolo
ms.date: 02/08/2017
ms.topic: article
ms.prod: windows
