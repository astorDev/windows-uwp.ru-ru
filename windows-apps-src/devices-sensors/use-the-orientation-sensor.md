...
-   [Пример датчик ориентации](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/OrientationSensor)
-   [Пример простого ориентации датчика](https://github.com/Microsoft/Windows-universal-samples/tree/master/Samples/SimpleOrientationSensor)
