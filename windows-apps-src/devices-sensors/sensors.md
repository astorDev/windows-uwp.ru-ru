...
Положение устройства в пространстве выражается через кватернион и матрицу преобразования поворота. [
...
Примеры, демонстрирующие использование нескольких различных датчиков, см. в разделе [Примеры датчиков Windows](http://go.microsoft.com/fwlink/?LinkID=616041).
