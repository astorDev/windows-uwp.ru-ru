...
| [Поддержка оборудования](pos-device-support.md) | Список известных устройств, совместимых с API UWP [Windows. Devices. PointOfService](https://docs.microsoft.com/uwp/api/Windows.Devices.PointOfService) . |
| [Сканер штрихкодов](pos-barcodescanner.md) | Индекс статей со сканером штрихкодов. |
| [Считыватель магнитных полос](pos-magnetic-stripe-reader.md) | Индекс статей в модуле чтения магнитной полосы.
| [поспринтер](pos-printer.md) | Индекс статей в Поспринтер. |