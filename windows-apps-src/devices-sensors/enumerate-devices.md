...
Чтобы скачать пример, показывающий более сложное применение API [**Windows.Devices.Enumeration**](https://docs.microsoft.com/uwp/api/Windows.Devices.Enumeration), перейдите [по этой ссылке](https://go.microsoft.com/fwlink/?LinkID=620536).
...
-   [**Обнаружения и запуска (по)** ](https://docs.microsoft.com/uwp/api/Windows.Media.DialProtocol)
