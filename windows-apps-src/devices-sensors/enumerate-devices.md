...
| **DeviceInformation.Kind**       | Указывает вид объекта устройства, представленного объектом [**DeviceInformation**](https://msdn.microsoft.com/library/windows/apps/BR225393). Это не категория или тип устройства. Одно устройство может быть представлено несколькими различными объектами **DeviceInformation** разных видов. Возможные значения этого свойства и их взаимосвязи приводятся в разделе [**DeviceInformationKind**](https://msdn.microsoft.com/en-us/library/windows/apps/windows.devices.enumeration.deviceinformationkind.aspx).                           |
