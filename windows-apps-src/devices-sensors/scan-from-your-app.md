...
description: Узнайте, как сканировать содержимое из приложения с помощью планшетного сканера, сканера с модулем подачи или автоматически настраиваемого источника.
---
...
**Примечание** Если пользователь поместит сканируемый документ в податчик, сканер, наоборот, будет сканировать из планшета. Если пользователь попытается сканировать из пустого податчика, задание сканирования не создаст ни одного отсканированного файла.
