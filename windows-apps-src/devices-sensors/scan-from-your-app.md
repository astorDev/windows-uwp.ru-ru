...
**Важные**   [ **Windows.Devices.Scanners** ](https://msdn.microsoft.com/library/windows/apps/Dn264250) API-интерфейсы являются частью рабочего стола [семейства устройств](https://msdn.microsoft.com/library/windows/apps/Dn894631). Приложения могут использовать эти API-интерфейсы только для настольной версии Windows 10.
