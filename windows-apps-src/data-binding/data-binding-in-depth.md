...
При использовании C++/WinRT или визуального элемента C++ расширения компонентов (C++/CX), то вам потребуется добавить [ **BindableAttribute** ](https://msdn.microsoft.com/library/windows/apps/Hh701872) для любого класса среды выполнения, который вы хотите использовать атрибута[ {Binding} ](https://msdn.microsoft.com/library/windows/apps/Mt204782) расширения разметки с.
...
Если вы используете C++/WinRT или визуального элемента C++ расширения компонентов (C++/CX) затем, чтобы использовать [{Binding}](https://msdn.microsoft.com/library/windows/apps/Mt204782) расширения разметки, вам потребуется добавить [ **BindableAttribute** ](https://msdn.microsoft.com/library/windows/apps/Hh701872) для любого класса среды выполнения, который вы хотите выполнить привязку для атрибута. Чтобы использовать [{x: Bind}](https://msdn.microsoft.com/library/windows/apps/Mt204783), этот атрибут не требуется.
