...
Как видно выше, для форматирования гибкость мы используем разметки передавать строку формата в преобразователь через параметр преобразователя. В примерах кода, показанный в этом разделе, только C# преобразователь значений упрощает использование этого параметра. Однако можно легко передавать строку формата стиле C++ в качестве параметра преобразователя и использовать его в преобразователь значений с помощью функции форматирования, например **wprintf** или **swprintf**.
